...
The left-hand menu (item 2 in the image link:#ManagingGateways-image.png[ link:#ManagingGateways-image]) allows you to perform several tasks, detailed in this section.

=== Gateways

Displays the screen shown link:#ManagingGateways-image.png[], which allows you to create/edit or operate on gateways.
...
. Go to the gateway list in Gateway designer by clicking *Gateways* in the global left-hand menu (see image link:#ManagingGateways-image.png[ link:#ManagingGateways-image]).
