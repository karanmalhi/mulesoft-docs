...
image:anypoint-data-gateway-1.png[image]
...
You can also find additional information in the link:/release-notes/anypoint-data-gateway-release-notes[Release Notes].
