...
All of your gateways to Salesforce are exposed through a single endpoint to a single of your lighting connect connections in Salesforce.

You can access the Salesforce settings menu by clicking the *Edit* button for a particular gateway, then selecting *Publish*.
...
If you enter the settings of any individual gateway – by clicking *Edit* -> *Settings* – you will see a different URL for the endpoint that exposes it. This endpoint is not valid for Salesforce connections, but still useful for connecting to other things.
====
