...
These settings do not affect the Gateway's connection to Salesforce. To set up the endpoint, user and password that will expose all of your  gateways together to Salesforce, go to the *Salesforce* tab on the left.
...
Click the *Salesforce* tab to publish your gateways to Salesforce, exposed through a single endpoint to a single of your lighting connect connections in Salesforce.

You can also access this same menu if you click the *Edit* button for a particular gateway, then select *Publish*.
