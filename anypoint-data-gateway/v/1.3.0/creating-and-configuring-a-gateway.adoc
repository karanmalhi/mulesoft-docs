...
Roles and permissions in Gateway Designer match those defined in Anypoint Platform. For details, see *User Roles and Permissions* in link:/anypoint-data-gateway/v/1.1.0/managing-gateways[Managing Gateways].
...
For details on removing a Cloud Extender connection, see the *Cloud Extender* section in link:/anypoint-data-gateway/v/1.1.0/managing-gateways[Managing Gateways].
...
Download these SAP libraries from the official SAP link:https://websmp109.sap-ag.de/connectors[download site]. You need a SAP user ID to download.

For more information on SAP libraries, refer to the link:http://help.sap.com/saphelp_nwpi711/helpdata/en/48/70792c872c1b5ae10000000a42189c/content.htm?frameset=/en/48/707c54872c1b5ae10000000a42189c/frameset.htm&current_toc=/en/b4/3f9e64bff38c4f9a19635f57eb4248/plain.htm&node_id=444&show_children=false[SAP help portal].
...
The RFC transport is link:http://www.mulesoft.org/documentation/download/attachments/124125785/SAP_transport.zip?version=1&modificationDate=1426784273177[available for download].
...
* Learn about defining connections and parameters, viewing and modifying existing gateways in link:/anypoint-data-gateway/v/1.1.0/managing-gateways[Managing Gateways].
