...
* Create your first gateway following the steps in link:/anypoint-data-gateway/v/1.1.0/creating-and-configuring-a-gateway[Creating and Configuring a Gateway].
