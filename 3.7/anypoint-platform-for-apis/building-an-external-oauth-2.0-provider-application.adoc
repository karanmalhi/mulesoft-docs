...
The following is an example of the wrapper.conf file with the Client ID and Client Secret statements: +
 +
image:/docs/download/attachments/129335755/ApiGwSettings.png?version=1&modificationDate=1435887600134[image]
+
...
. Open the Leagues App by browsing to http://localhost:8080/api/teams resource. +
 +
image:/docs/download/attachments/129335755/LeaguesListing.png?version=1&modificationDate=1435887989306[image]
...
. Again in the browser, open the RAML console at http://localhost:8080/console/. From here you can make calls to the Leagues API using its simple UI. +
 +
image:/docs/download/attachments/129335755/LaLiga.png?version=1&modificationDate=1435888164449[image]
...
+
image:/docs/download/attachments/132351937/Pasted+image+at+2015_07_24+09_53+AM.png?version=1&modificationDate=1437745812222[image]
+

. Click *Save*.
. Download the latest version of the proxy +
 +
image:/docs/download/attachments/129335755/Pasted+image+at+2015_07_08+05_38+PM.png?version=1&modificationDate=1436387968450[image]
...
. Edit the OAuth Provider module: +
 +
image:/docs/download/attachments/129335755/OAuthProviderModule.png?version=1&modificationDate=1435898012351[image]
...
`anypoint.platform.client_id=<your org client secret>` +
 ...
 +
image://https://developer.mulesoft.com/docs/download/attachments/129335755/AESExtProvider.png?version=1&modificationDate=1435900766263[image]
