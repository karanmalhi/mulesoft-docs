...
If you are using API Gateway 2.0, you don't need to generate a proxy – you can skip the next section and go directly to the *Automatic - On Premises* tab link:#ProxyingYourAPI-deploy[below].

== Generating a Proxy

. Log into https://anypoint.mulesoft.com/#/signin[Anypoint Platform] and click *APIs*:
+
image:/docs/download/attachments/131039906/APstart.png?version=1&modificationDate=1435710371727[image]

. In the API administration screen, click an API:
+
image:/docs/download/attachments/131039906/APIadmin.png?version=1&modificationDate=1435710710101[image] 

. Click *Configure endpoint* in the *API Status* section.
+
image:/docs/download/attachments/131039906/api+status+new+empty.png?version=1&modificationDate=1434053057971[image]

. Configure parameters as follows:
+
image:/docs/download/attachments/131039906/ConfigEndpoint20qa.png?version=1&modificationDate=1435797230435[image]
...
*** If you have a RAML for your API, pick link:#ProxyingYourAPI-raml[RAML].
*** If you have a WSDL to expose, pick link:#ProxyingYourAPI-soap[WSDL].
...
. In the API Status section of the API version page, click *Deploy proxy* to deploy your proxy application to CloudHub. +
 image:/docs/download/attachments/131039906/ApiStatus20qa1.png?version=1&modificationDate=1435797802573[image]
...
. In the deploy menu, pick an application name that becomes the access name at cloudhub.io, choose an environment, and if needed, change the API Gateway version. By default, Mule uses the API name you chose when you created your API, but you can change the CloudHub application name as needed. +
 image:/docs/download/attachments/131039906/DeployProxyAccess20qa.png?version=1&modificationDate=1435798074540[image]
...
+
image:/docs/download/attachments/131039906/api+status+new+configured+green.png?version=1&modificationDate=1434053057963[image]
+
[NOTE]
...
+
image:/docs/download/attachments/131039906/ReDeployProxy.png?version=1&modificationDate=1435728680552[image]
...
. Click *API Status* > *Download proxy*. Your API downloads by your browser as a .zip file. This .zip file is a deployable proxy application with all of the settings you have configured for your proxy. You can download the zip file for the latest or an earlier API Gateway version: +
 image:/docs/download/attachments/131039906/DownloadProxy20qa.png?version=1&modificationDate=1435886049177[image]
...
+
image:/docs/download/attachments/131039906/conf_api.png?version=1&modificationDate=1436805129205[image]

. In the endpoint configuration screen shown below, fill in the required information for the API you would like to manage.
+
image:/docs/download/attachments/131039906/conf_endpoint_props.png?version=1&modificationDate=1436805305275[image]

. Click **Save & deploy**. You should see a window like the one shown below.
+
image:/docs/download/attachments/131039906/deploy_proxy.png?version=1&modificationDate=1436805361619[image]
+
[NOTE]
====
...
image:/docs/download/attachments/131039906/no_server.png?version=1&modificationDate=1436809129982[image]

As you can see, the screen gives you the option to add a new API Gateway. See Step 1 link:#ProxyingYourAPI-register[above].
====
...
image:/docs/download/attachments/131039906/proxyHTTPS+on+two+stages.png?version=1&modificationDate=1436365881544[image]
...
. In the Configure Endpoint menu, select HTTPS as a *scheme* on the dropdown menu.
. You will then have to download the proxy and link:#ProxyingYourAPI-modify[modify] it in order to include an HTTPS Configuration element inside the proxy itself, together with necessary HTTPS credentials. 
...
. If the default certificate of your JMV is not enough and you need to include other HTTPS credentials, then you must now download the proxy and link:#ProxyingYourAPI-modify[modify] it to include your own credentials.
+
[NOTE]
If you want to be able to deploy it in the Anypoint Studio engine – mostly for debugging purposes –, you will need to create a  link:#ProxyingYourAPI-domain[domain]  project in Studio and reference it, or download and import link:/docs/download/attachments/131039906/api-gateway.zip?version=1&modificationDate=1438021121689[this domain file].
...
image:/docs/download/attachments/131039906/rest+proxy.png?version=1&modificationDate=1436546875561[image]
...
image:/docs/download/attachments/131039906/soap+proxy.png?version=1&modificationDate=1436547369177[image]
...
image:/docs/download/attachments/131039906/raml+proxy.png?version=1&modificationDate=1436547589774[image]
...
[TIP]
If you want to include HTTPS support, you may have to include a second HTTP listener config that supports HTTPS and listens on port 8082, depending on where you want to deploy to. See link:#ProxyingYourAPI-https[Using HTTPS] for more details.
...
+
image:/docs/download/attachments/131039906/MuleProjectDomain.png?version=2&modificationDate=1436379955614[image]
