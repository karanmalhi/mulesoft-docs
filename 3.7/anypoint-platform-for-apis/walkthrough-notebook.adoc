...
This doc will lead you through the creation of a basic API Notebook to contact a simple API, it is part of a larger link:/docs/display/current/Anypoint+Platform+for+APIs+Walkthrough[Walkthrough] that covers all you can do in the Anypoint Platform for APIs.

The same steps shown here apply to building an API Notebook out of any other existing API that has a RAML interface. If the API you wish to interface with does not have a RAML file, you can link:/docs/display/current/Walkthrough+Proxy[create a proxy for it].
...
image:/docs/download/attachments/122752400/home.png?version=1&modificationDate=1403618735227[image]
...
|===
+
image:/docs/download/attachments/122752400/agent.png?version=1&modificationDate=1403721608769[image]
...
+
image:/docs/download/attachments/122752400/create+API+Client.png?version=1&modificationDate=1403558350643[image]
...
image:/docs/download/attachments/122752400/execute.png?version=1&modificationDate=1403559763590[image]
...
image:/docs/download/attachments/122752400/code.png?version=1&modificationDate=1403725366898[image]

== Step 5: Push Play

You can execute all code cells in your Notebook sequentially by clicking the "play" button in the toolbar.

image:/docs/download/attachments/122752400/play.png?version=1&modificationDate=1403645759867[image]
...
image:/docs/download/attachments/122752400/save.png?version=1&modificationDate=1403725817192[image]
...
image:/docs/download/attachments/122752400/share.png?version=1&modificationDate=1403725049567[image]
