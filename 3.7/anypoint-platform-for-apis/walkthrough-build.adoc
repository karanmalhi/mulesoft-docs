...
|===
+
image:/docs/download/attachments/122752477/2015-07-14_17-12-18.png?version=1&modificationDate=1436904880596[image] +
+
...
+
image:/docs/download/attachments/122752477/package+explorer.png?version=1&modificationDate=1405348019321[image]
...
+
image:/docs/download/attachments/122752477/router+flow.png?version=1&modificationDate=1436904927677[image]

* A flow for every operation described on your RAML file. This is where we'll build up the functionality of your API.
+
image:/docs/download/attachments/122752477/other+flows+initial+state.png?version=1&modificationDate=1436904965483[image]
+
[WARNING]
...
+
image:/docs/download/attachments/122752477/exceptions.png?version=1&modificationDate=1405108731464[image]
+
...
+
image:/docs/download/attachments/122752477/other+flows+w+wsc.png?version=1&modificationDate=1436905044071[image] +
+
...
+
image:/docs/download/attachments/122752477/get+to+a+GE.png?version=1&modificationDate=1405109485002[image] +
+
...
+
image:/docs/download/attachments/122752477/GE.png?version=1&modificationDate=1405109769743[image]
+
Click OK.
...
+
image:/docs/download/attachments/122752477/WSC+configured.png?version=1&modificationDate=1405111245896[image]
+
...
+
image:/docs/download/attachments/122752477/other+flows+w+dw.png?version=1&modificationDate=1436905327501[image]
...
+
image:/docs/download/attachments/122752477/input+example.png?version=1&modificationDate=1436907455951[image]
+
...
+
image:/docs/download/attachments/122752477/dataweave1.png?version=1&modificationDate=1436908322947[image]
