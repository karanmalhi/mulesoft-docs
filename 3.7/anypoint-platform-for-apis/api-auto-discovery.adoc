...
[tabs]
------
[tab,title="Gateway Runtime 2.2 or Never"]
....
...
image:/docs/download/attachments/122752564/autodiscoveryyesorno.png?version=1&modificationDate=1418935386132[image]
...
image:/docs/download/attachments/122752564/nonRAMLAutoD.png?version=1&modificationDate=1418935386147[image]
