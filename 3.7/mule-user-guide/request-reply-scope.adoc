...
This document assumes that you understand the difference between link:/docs/display/current/Flows+and+Subflows[synchronous and asynchronous flows]. Furthermore, you're also familiar with link:/docs/display/current/Scopes[Scopes] in general.
...
* Learn more about link:/docs/display/current/Flows+and+Subflows[synchronous and asynchronous flows].
