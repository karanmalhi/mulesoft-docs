= DataWeave Tutorial
:keywords: studio, anypoint, esb, transform, transformer, format, aggregate, rename, split, filter convert, xml, json, csv, pojo, java object, metadata, dataweave, data weave, datamapper, dwl, dfl, dw, output structure, input structure
...
For more advanced examples, see link:/docs/display/current/DataWeave+Examples[DataWeave Examples].
...
+
image:/docs/download/attachments/132351219/tut1.png?version=1&modificationDate=1436393596416[image]
...
+
image:/docs/download/attachments/132351219/new+weave.png?version=1&modificationDate=1436393596399[image]
...
image:/docs/download/attachments/132351219/input.png?version=1&modificationDate=1436393596372[image]
...
image:/docs/download/attachments/132351219/tut12.png?version=1&modificationDate=1436393596425[image]
...
image:/docs/download/attachments/132351219/add+metadata.png?version=1&modificationDate=1437401503192[image]
...
image:/docs/download/thumbnails/132351219/ex2output.png?version=1&modificationDate=1437499558746[image]
+

. Drag a link:/docs/display/current/Web+Service+Consumer[Web Service Consumer] to your flow. Create a global configuration for it by clicking the green plus sign in its properties editor. In the *WSDL Location* field, paste the following URL: **http://tshirt-service.cloudhub.io/?wsdl**.  Note that all of the other fields in the configuration element are completed automatically when you do this. Then click *Ok*.
...
image:/docs/download/thumbnails/132351219/ex2inputexpected.png?version=1&modificationDate=1437499739741[image]
+
...
image:/docs/download/attachments/132351219/ex2+flow.png?version=1&modificationDate=1436393596349[image]
...
+
image:/docs/download/attachments/132351219/initial+full+dw.png?version=1&modificationDate=1437500165185[image]
...
image:/docs/download/thumbnails/132351219/ex3+metadata.png?version=1&modificationDate=1436393596364[image]

. Add a Transform Message element to your flow after the Salesforce connector, open its properties editor.
+

image:/docs/download/attachments/132351219/ex3+flow.png?version=1&modificationDate=1436393596357[image]
...
* See our https://developer.mulesoft.com/docs/dataweave[DataWeave Language reference]
* See more advanced examples in link:/docs/display/current/DataWeave+Examples[DataWeave Examples]
