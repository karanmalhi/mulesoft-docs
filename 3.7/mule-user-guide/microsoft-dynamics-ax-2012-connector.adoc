...
*Release Notes*:  link:/docs/display/current/Microsoft+Dynamics+AX+2012+Connector+Release+Notes[Microsoft Dynamics AX 2012 Connector Release Notes]
...
* Install the link:/docs/display/current/Windows+Gateway+Services+Guide[Windows Gateway Services] 
...
=== Document Service (invoke-document-service-operation)
...
* link:/docs/display/current/Windows+Gateway+Services+Guide[Windows Gateway Services]
