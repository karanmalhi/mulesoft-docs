...
*Note*: See the https://developer.mulesoft.com/docs/display/current/DotNet+Connector+Release+Notes[DotNet Connector Release Notes] for information on changes to this software package.
...
This document assumes that you are familiar with Mule, the link:/docs/display/current/Anypoint+Studio+Essentials[Anypoint Studio interface], and link:/docs/display/current/Global+Elements[Global Elements]. Further, it is assumed that you are familiar with the Microsoft .NET Framework.
...
* Anypoint Studio, the graphical interface to Mule ESB. See link:/docs/display/current/Download+and+Launch+Anypoint+Studio[Download and Launch Anypoint Studio] for details
...
+
image:/docs/download/attachments/132809176/SolutionExplorer.png?version=1&modificationDate=1436989756830[image]
+
. The Mule project settings window opens:
+
image:/docs/download/attachments/132809176/MuleProjSettings.png?version=3&modificationDate=1437001917573[image]
...
 image:/docs/download/attachments/132809176/VisStudioOutput.png?version=1&modificationDate=1436990468393[image]
...
image:/docs/download/thumbnails/132809176/DotNetConnectorXML.png?version=1&modificationDate=1436992986404[image]
...
image:/docs/download/attachments/132809176/DotNetResourceTest.png?version=1&modificationDate=1436993034135[image]
...
image:/docs/download/attachments/132809176/DebugDotNet_1.png?version=1&modificationDate=1436990566433[image]
...
image:/docs/download/attachments/132809176/DebugDotNet_2.png?version=1&modificationDate=1436990669738[image] 
