...
[WARNING]
Note that this document is divided into two sections and contains separate information for versions 3.7.0 and 3.6.x. Make sure you're checking the section that matches the runtime version you're using.
...
In Studio, to instance this connector as an HTTP Request Connector (and not an link:#[HTTP Listener Connector]), you must place it into the *Process* section of a flow (that is, anywhere except the beginning).

image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="add request connector.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="basic request.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="basic request2.png"]

====== Minimum Configuration for the Global Element

At the very least, you need to provide a *host* and a *port*

image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="httpexchange.png"]
...
After you have defined the request-config, to actually send an HTTP request you need to configure a flow with an http://httprequest[http:request] element. In the connector instance, provide a *Path* and a *Method*, as well as a reference to a global element
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="minimum.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="raml library-w data.png"]
...
|Enable Datasense |The *Enable DataSense* checkbox allows Studio to use link:/docs/display/current/DataSense[DataSense] to expose metadata from the RAML file and interact with it on other elements in Studio.
|===
...
 image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="query params.png"] +
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="query params 2.png"]

For this example, you must first link:/docs/display/current/Variable+Transformer+Reference[generate a variable] named `customMap`. If you assign that variable a value through the following MEL expression:
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="uriparams.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="uriparams2.png"]
...
For this example you need to link:/docs/display/current/Variable+Transformer+Reference[create a variable] named `customMap`. If you set that variable to the MEL expression `#[{'p1':'v1', 'p2':'v2'}]`, it will generate a GET request to http://www.example.com/test/v1/v2 +
 +
...
 image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="headers1.png"] +
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="w properties builders.jpg"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="headers2.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="set payload.jpg"]
...
An HTTP response is mapped to the Mule Message in exactly the same way that the HTTP request is mapped to a Mule Message in the link:#[HTTP Listener Connector], except that the following elements don't apply to HTTP responses:
...
As with the link:#[HTTP Listener Connector], when HTTP responses have a content type of `application/x-www-form-urlencoded` or `multipart/form-data`, the HTTP Request Connector automatically carries out a parsing of the message. If you wish, you can disable this parsing functionality bydoing the following: +
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="source and target.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="attachments.jpg"]
...
See link:#[TLS Configuration] for more details.
...
[tabs]
------
[tab,ttile="Studio Visual Editor"]
....
...
In Studio, to instance this connector as an HTTP Request Connector (and not an link:/docs/display/current/HTTP+Listener+Connector[HTTP Listener Connector]), you must place it into the *Process* section of a flow (ie: anywhere except the beginning).

image:/docs/download/attachments/122751350/add+request+connector.png?version=1&modificationDate=1421089782041[image]
...
image:/docs/download/attachments/122751350/basic+request.png?version=1&modificationDate=1421159690082[image]
...
image:/docs/download/attachments/122751350/basic+request2.png?version=1&modificationDate=1421159839169[image]

====== Minimum Configuration for the Global Element

At the very least, you need to provide a *host* and a *port*

image:/docs/download/attachments/122751350/httpexchange.png?version=1&modificationDate=1433269204296[image]

*The above configuration will perform a GET request to http://www.example.com/test*
....
[tab,ttile="XML Editor"]
....
For example:
...
image:/docs/download/attachments/122751350/minimum.png?version=1&modificationDate=1421089782432[image]
...
image:/docs/download/attachments/122751350/raml+library-w+data.png?version=1&modificationDate=1428336119406[image]
...
 image:/docs/download/attachments/122751350/query+params.png?version=1&modificationDate=1421089782543[image] +
...
image:/docs/download/attachments/122751350/query+params+2.png?version=1&modificationDate=1421089782499[image]
...
image:/docs/download/attachments/122751350/uriparams.png?version=1&modificationDate=1421089782650[image]
...
image:/docs/download/attachments/122751350/uriparams2.png?version=1&modificationDate=1421089782674[image]
...
 image:/docs/download/attachments/122751350/headers1.png?version=1&modificationDate=1421089782409[image] +
...
image:/docs/download/attachments/122751350/w+properties+builders.jpg?version=1&modificationDate=1421089782685[image]
...
image:/docs/download/attachments/122751350/headers2.png?version=1&modificationDate=1421089782417[image]
...
image:/docs/download/attachments/122751350/set+payload.jpg?version=1&modificationDate=1421089782593[image]
...
An HTTP response is mapped to the Mule Message in exactly the same way that the HTTP request is mapped to a Mule Message in the link:/docs/display/current/HTTP+Listener+Connector[HTTP Listener Connector], except that the following elements don't apply to HTTP responses:
...
image:/docs/download/attachments/122751350/source+and+target.png?version=1&modificationDate=1421092524776[image]
...
image:/docs/download/attachments/122751350/attachments.jpg?version=1&modificationDate=1421089782087[image]
...
See link:/docs/display/current/TLS+Configuration[TLS Configuration] for more details.
...
* link:/docs/display/current/HTTP+Listener+Connector[HTTP Listener Connector]
...
* Consult a reference to the deprecated predecessor of this element, the HTTP endpoint link:/docs/display/current/HTTP+Request+Connector[HTTP Transport Reference]
