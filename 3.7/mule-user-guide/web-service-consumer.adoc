...
image:/docs/download/attachments/122752084/first+diagram.png?version=1&modificationDate=1436884358673[image]
...
image:/docs/download/attachments/122752084/wsc_workflow2.png?version=2&modificationDate=1436884877239[image]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="wsc_global.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="wsc_local.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="properties soap.jpg"] 
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="metadata_in.png"]

===== Message State After Web Service Consumer

image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="metadata_out.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="wsc_security.png"]
...
. Enter values in the required fields. For a full list of elements, attributes and default values, consult  link:#[Web Service Consumer Reference] .
...
Add child elements to the global link:#[ws:consumer-config] element you configured in your application. Configure the child elements' attributes according to the code sample below. For a full list of elements, attributes and default values, consult link:#[Web Service Consumer Reference].
...
By default, the WSC consumer runs over a default configuration for the link:#[HTTP Request Connector]. If you need it to instead run over a configuration of the connector that uses HTTPS (or an HTTP configuration that is different from the default) follow the steps below:
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="global elements1.jpg"]

. For the Global Element type, select *HTTP Request Configuration*

image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="http global element.png"]
...
image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="ssl tls.png"]

. In your instance of the Web Service Consumer in your flow, click on the green plus sign next to Connector Configuration

image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="adding https ref.jpg"]

. In the *References* tab, select your newly created HTTPS Global Element for the *Connector Ref* field

image:/docs/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="adding https ref2.jpg"]
...
image:/docs/download/attachments/122752084/code+example.png?version=3&modificationDate=1436898376764[image]
...
This document assumes that you are familiar with Anypoint Studio; review the chapter on link:/docs/display/current/Anypoint+Studio+Essentials[Anypoint Studio Essentials] to learn more about developing with Mule ESB's graphical user interface. This document also assumes you are familiar with the link:/docs/display/current/Datamapper+User+Guide+and+Reference[Anypoint DataMapper] transformer, link:/docs/display/current/Global+Elements[Global Elements], and link:/docs/display/current/DataSense[DataSense].
...
For more information on best design-time practices with DataSense and DataMapper, consult the link:/docs/display/current/DataSense#DataSense-DataSenseBestPractices[DataSense documentation].
...
image:/docs/download/attachments/122752084/wsc_global.png?version=1&modificationDate=1410984989498[image] +
...
image:/docs/download/attachments/122752084/wsc_local.png?version=1&modificationDate=1410984989511[image]
...
image:/docs/download/attachments/122752084/wsc_dm_output.png?version=1&modificationDate=1410984989467[image]
...
image:/docs/download/attachments/122752084/mapping_records.png?version=1&modificationDate=1410984989374[image]
...
image:/docs/download/attachments/122752084/change_element.png?version=1&modificationDate=1410984989291[image]
...
image:/docs/download/attachments/122752084/able_to_map.png?version=1&modificationDate=1410984989185[image]
...
image:/docs/download/attachments/122752084/properties+soap.jpg?version=1&modificationDate=1410984989428[image] 
...
image:/docs/download/attachments/122752084/payload2body.png?version=1&modificationDate=1410984989412[image]

===== Example Mapping: Message Payload to SOAP Header

image:/docs/download/attachments/122752084/payload2Header.png?version=1&modificationDate=1410984989419[image]
...
image:/docs/download/attachments/122752084/metadata_in.png?version=1&modificationDate=1410984989390[image]

===== Message State After Web Service Consumer

image:/docs/download/attachments/122752084/metadata_out.png?version=1&modificationDate=1410984989405[image]
...
image:/docs/download/attachments/122752084/wsc_security.png?version=1&modificationDate=1410984989519[image]

. Based on the security requirements of the Web service provider, select to apply *Username Token* security, or a *WS-Security Timestamp* or both.
. Enter values in the required fields. For a full list of elements, attributes and default values, consult  link:/docs/display/current/Web+Service+Consumer+Reference[Web Service Consumer Reference] .
. Click *OK* to save your security settings.
...
By default, the WSC consumer runs over a default configuration for the link:/docs/display/current/HTTP+Request+Connector[HTTP Request Connector]. If you need it to instead run over a configuration of the connector that uses HTTPS (or an HTTP configuration that is different from the default) follow the steps below:
...
. Click the Global Elements tab, below the canvas and create a new Global Element
image:/docs/download/attachments/122752084/global+elements1.jpg?version=1&modificationDate=1410984989311[image]

. For the Global Element type, select *HTTP Request Configuration*

image:/docs/download/attachments/122752084/http+global+element.png?version=1&modificationDate=1418750346309[image]

. Complete the required fields in the *General* tab (host and port)
. Then select the *TLS/SSL* tab and configure the fields related to the HTTPS authentication

image:/docs/download/attachments/122752084/ssl+tls.png?version=1&modificationDate=1418751119633[image]

. In your instance of the Web Service Consumer in your flow, click on the green plus sign next to Connector Configuration

image:/docs/download/attachments/122752084/adding+https+ref.jpg?version=1&modificationDate=1410984989212[image]

. In the *References* tab, select your newly created HTTPS Global Element for the *Connector Ref* field

image:/docs/download/attachments/122752084/adding+https+ref2.jpg?version=1&modificationDate=1410984989228[image]
...
[source]
----
<ws:consumer-config name="Web_Service_Consumer" wsdlLocation="tshirt.wsdl.xml" service="TshirtService" port="TshirtServicePort" serviceAddress="http://tshirt-service.cloudhub.io/?wsdl" connectorConfig="HTTP_Request_Configuration"/>
----
...
image:/docs/download/attachments/122752084/final+flow.png?version=1&modificationDate=1418417985134[image]
...
http://www.mulesoft.org/schema/mule/ee/tracking http://www.mulesoft.org/schema/mule/ee/tracking/current/mule-tracking-ee.xsd">
 
    <ws:consumer-config name="Web_Service_Consumer" wsdlLocation="tshirt.wsdl.xml" service="TshirtService" port="TshirtServicePort" serviceAddress="http://tshirt-service.cloudhub.io/?wsdl" doc:name="Web Service Consumer"/>
 
...
* Learn more about how to use the link:/docs/display/current/Datamapper+User+Guide+and+Reference[DataMapper transformer].
