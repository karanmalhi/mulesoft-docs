...
|defaultObjectSerializer-ref |string |no |  |An optional reference to an ObjectSerializer to be used as the application's default
|defaultProcessingStrategy |flowProcessingStrategyType |no |  |The default processing strategy to use in all flows which don't specify otherwise
|===
