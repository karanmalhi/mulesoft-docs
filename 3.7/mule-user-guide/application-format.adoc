...
You can share libraries between applications via the link:/docs/display/current/Mule+Application+Deployment+Descriptor[*application deployment descriptor*] attribute.
