...
*Release Notes*:  https://developer.mulesoft.com/docs/display/current/Microsoft+SharePoint+2013+Connector+Release+Notes[Microsoft SharePoint 2013 Connector Release Notes]

*Samples*: https://developer.mulesoft.com/docs/download/attachments/122752058/sharepoint-connector-samples.zip?version=1&modificationDate=1423089325206[sharepoint-connector-samples.zip]

*FAQ*:  https://developer.mulesoft.com/docs/display/current/Microsoft+SharePoint+2013+Connector#MicrosoftSharePoint2013Connector-faq[Frequently Asked Questions]
...
* link:/docs/display/current/Transformers[Studio Transformers]    
*  link:/docs/display/current/Flow+Reference+Component+Reference[Flow References]
