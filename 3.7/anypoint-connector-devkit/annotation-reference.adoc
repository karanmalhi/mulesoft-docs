...
|*Argument +
Passing* |link:#AnnotationReference-inhean[@InboundHeaders] link:#AnnotationReference-ivhean[@InvocationHeaders] link:#AnnotationReference-literalan[@Literal] link:#AnnotationReference-outhan[@OutboundHeaders] +
