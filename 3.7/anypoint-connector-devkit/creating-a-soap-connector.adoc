...
*Sample WSDL*: link:/docs/download/attachments/132351382/sunsetriseservice.wsdl?version=1&modificationDate=1436504967538[sunsetriseservice.wsdl] 
...
. Code the next provider implementation of the abstract class, in this case, for male Tshirts:
+
[source]
----
...
The output from the previous headers will be the ones within the **soap:Header** element in the next envelope:
