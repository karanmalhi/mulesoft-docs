...
For more information, see http://blogs.mulesoft.org/introducing-integration-paas-ipaas/[here].
...
You can find the self-service pricing http://www.mulesoft.com/cloudhub/cloudhub-pricing[here]. If you have higher message volumes or need different support SLAs,  contact us at cloudhub-support@mulesoft.com.
...
As CloudHub deploys on Amazon EC2, IP addresses are chosen from the Amazon EC2 IP pool. For a list of these ranges,  see Amazon EC2 Public IP Ranges: https://forums.aws.amazon.com/ann.jspa?annID=1701.
