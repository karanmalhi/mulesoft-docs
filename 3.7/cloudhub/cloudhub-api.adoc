...
All APIs require HTTP basic authentication. Your username will control which environment you're accessing and is of the form "user@enviornment". For example, if your username is joe and you have an environment called "Development", your username will be joe@Development.  If you don't specify an environment, it will default to production.
