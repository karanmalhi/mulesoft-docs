...
... Extend the contract for each of the following (new) fields, and set their format to be “urn:oasis:names:tc:SAML:2.0:attrname-format:basic” +
1. email, company, lastname, firstname
...
1. Keep default values except for binding, where the value must be “POST”.
2. Set the “Endpoint URL” to “https://anypoint.mulesoft.com/accounts/login/receive-id”.
