...
* link:#Mule2.2.0ReleaseNotes-EnhancedExpressionSupport[Enhanced Expression Support]
* link:#Mule2.2.0ReleaseNotes-SupportforSpringSecurity2.0[Support for Spring Security 2.0]
* link:#Mule2.2.0ReleaseNotes-SupportforSpring-firstDeploymentsforMuleEmbeddedinaWebapp[Support for Spring-first Deployments for Mule Embedded in a Webapp]
* link:#Mule2.2.0ReleaseNotes-SimplifiedMessageStyles[Simplified Message Styles]
* link:#Mule2.2.0ReleaseNotes-AdditionalImprovements[Additional Improvements]
* link:#Mule2.2.0ReleaseNotes-IssuesResolvedfor2.2.0[Issues Resolved for 2.2.0]
