...
*link:#AnypointStudioMarch2015with3.6.1Runtime-UpdateSite2ReleaseNotes-MigrationGuide[Skip to Migration Guide]*
...
[TIP]
Upgrading from an existing instance of Anypoint Studio or previous Mule runtime version? Refer to the link:#AnypointStudioMarch2015with3.6.1Runtime-UpdateSite2ReleaseNotes-migration[Migration Guide].
...
[TIP]
To replace the deprecated HTTP connector for the new link:/docs/display/current/HTTP+Connector[high-performance HTTP Connector], refer to link:/docs/display/current/Migrating+to+the+New+HTTP+Connector[Migrating to the New HTTP Connector].

If you wish to install a previous runtime or a community runtime, follow the instructions to link:/docs/display/current/Adding+Community+Runtime[add additional runtimes] to your new instance of Studio.
...
* For further details on Anypoint Studio with 3.6.1 Runtime, see the link:/docs/display/current/Mule+ESB+3.6.1+Release+Notes[Mule ESB 3.6.1 Release Notes]
