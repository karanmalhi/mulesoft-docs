...
Where appropriate, we have applied a _*Version 1.2 only* _ marker to identify features or functionality that are available only in the Enterprise runtime.

link:/documentation/display/current/Installing+Anypoint+Enterprise+Security[Install Anypoint Enterprise Security1.2] to take advantage of the latest and greatest!  +
