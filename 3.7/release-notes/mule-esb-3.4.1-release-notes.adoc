...
* link:/documentation/display/34X/Installing+Extensions[Add 3.4.1 runtime to your Mule Studio instance] +
...
For most use cases, Mule ESB 3.4.1 does not change the link:/documentation/display/34X/Hardware+and+Software+Requirements[hardware and software system requirements] established by Mule ESB 3.4.0.
...
You will need to copy the configuration from the previously backed up files. Look at link:/documentation/display/33X/Persisting+Environment+Data[this guide] to determine the list of changes you need to copy over. Do not override the files with the old ones. Only jackrabbit-repo.xml can be safely overwritten.
...
You will need to copy the configuration from the previously backed up files. Look at link:/documentation/display/33X/Persisting+Transaction+Data[this guide] to determine the list of changes you need to copy over. Do not override the files with the old ones. Only jackrabbit-repo.xml can be safely overwritten.
