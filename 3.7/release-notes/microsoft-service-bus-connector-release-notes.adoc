...
*Connector Guide*: link:/documentation/display/current/Microsoft+Service+Bus+Connector[Microsoft Service Bus Connector]
...
* Learn about the connector using the link:/documentation/display/current/Microsoft+Service+Bus+Connector[Microsoft Service Bus Connector] guide. 
* Read the link:/documentation/display/current/Microsoft+Service+Bus+Connector+FAQ[Microsoft Service Bus Connector FAQ].
