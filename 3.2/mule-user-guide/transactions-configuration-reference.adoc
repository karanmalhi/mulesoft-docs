...
This page provides reference information on the elements you configure for transactions. For more information on transactions, see link:/documentation-3.2/display/32X/Transaction+Management[Transaction Management].
