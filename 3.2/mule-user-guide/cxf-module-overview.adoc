...
For information about what standards are supported, see link:/documentation-3.2/display/32X/Supported+Web+Service+Standards[Supported Web Service Standards].
