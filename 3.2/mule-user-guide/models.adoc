...
To configure a model, you add the `<model>` element to your Mule configuration file. You then add services within the model. For configuration details, see the link:/documentation-3.2/display/32X/Model+Configuration+Reference[Model Configuration Reference].
