...
For a list of configuration patterns that ship with Mule, see link:/documentation-3.2/display/32X/Using+Mule+Configuration+Patterns[Using Mule Configuration Patterns].
