...
This page describes how to use a standalone CXF-generated client with Mule. This approach is different from the link:/documentation-3.2/display/32X/Consuming+Web+Services+with+CXF[outbound router] approach, which is typically a more appropriate fit for most applications.
