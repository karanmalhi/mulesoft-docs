image:/documentation-3.2/download/attachments/53248056/javascript-component-48x32.png?version=1&modificationDate=1320441916208[image]
...
image:/documentation-3.2/download/attachments/53248056/Javascript2way.png?version=1&modificationDate=1324415253875[image]
...
image:/documentation-3.2/download/attachments/53248056/Javascript1way.png?version=1&modificationDate=1324415253870[image]
...
image:/documentation-3.2/download/attachments/53248056/JavascriptPropGen.png?version=1&modificationDate=1326924036682[image]
...
Use the *Advanced* tab to optionally configure interceptors and (depending on the interceptor) enter Spring values. You also have the option to specify script properties, which are key/value pairs used to alter or change properties in the script. See the link:/documentation-3.2/display/32X/Script+Component+Reference[Script Component Reference] page for information on using the advanced tab.

image:/documentation-3.2/download/attachments/53248056/JavascriptPropAdv2.png?version=1&modificationDate=1324324104326[image]
...
image:/documentation-3.2/download/attachments/53248056/JavascriptPropDoc.png?version=1&modificationDate=1324316568736[image]
...
Refer to the generic link:/documentation-3.2/display/32X/Script+Component+Reference[Script Component Reference] to see how a script works with one-way and request-response endpoints.
