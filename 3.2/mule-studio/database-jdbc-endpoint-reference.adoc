...
[TIP]
For details about exchange patterns, see: link:/documentation-3.2/display/32X/Mule+Studio+Essentials#MuleStudioEssentials-AboutMainFlows[About Main Flows]
