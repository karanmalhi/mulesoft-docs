...
image:analyzing-message-flows-1.png[image]
...
image:analyzing-message-flows-2.png[image]
...
image:analyzing-message-flows-3.png[image]
...
image:analyzing-message-flows-4.png[image]
...
image:analyzing-message-flows-5.png[image]
...
image:analyzing-message-flows-6.png[image]
...
image:analyzing-message-flows-7.png[image]
...
For more information on reading stream-based payloads, such as CXF streams, see how to apply an object-to-byte-array stream transformer in the section "Viewing Message Payload When Using Streams" in the link:/mule-management-console/analyzing-flow-processing-and-payloads[Analyzing Flow Processing and Payloads] topic.
...
image:analyzing-message-flows-8.png[image]
