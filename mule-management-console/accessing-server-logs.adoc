...
For complete information on log files, see link:/mule-management-console/working-with-logs[Working with Logs].
...
image:accessing-server-logs-2.png[image]
