...
image:analyzing-flow-processing-and-payloads-1.png[image]
...
image:analyzing-flow-processing-and-payloads-2.png[image]
...
image:analyzing-flow-processing-and-payloads-3.png[image]
...
image:analyzing-flow-processing-and-payloads-4.png[image]
...
image:analyzing-flow-processing-and-payloads-5.png[image]
...
image:analyzing-flow-processing-and-payloads-6.png[image]

You can expand any of the information panes by clicking the image:analyzing-flow-processing-and-payloads-7.png[image] icon at the top-right corner of each pane. For example, you can see an almost full-screen view of the *Message Properties* pane as shown below.

image:analyzing-flow-processing-and-payloads-8.png[image]

To go back to the original view, click the image:analyzing-flow-processing-and-payloads-9.png[image] icon at the the top-right corner.
...
+
image:analyzing-flow-processing-and-payloads-10.png[image]
+
...
+
image:analyzing-flow-processing-and-payloads-11.png[image]
+
...
If you want to enable an MMC user to stop Flow Analyzer, assign the `Audit Flows - Admin Functions` permission to the user group that the user belongs. Refer to link:/mule-management-console/managing-mmc-users-and-roles[Managing MMC Users and Roles] for details on assigning permissions.
...
* link:/mule-management-console/tracking-flows[Tracking Flows] provides more information on using the Flows tab and setting up flow tracking, a prerequisite for flow analysis.
* link:/mule-management-console/analyzing-message-flows[Analyzing Message Flows] takes you through using the Flow Analyzer panes in detail.
* link:/mule-management-console/debugging-message-processing[Debugging Message Processing] illustrates the general steps for debugging an application's message processing.
* link:/mule-management-console/debugging-the-loan-broker-example-application[Debugging the Loan Broker Example Application] shows how to use the console Flow Analyzer screen to find an application logic bug.
* link:/mule-user-guide/routers[Using Message Processors to Control Message Flow] provides reference information for the available Mule message processors or routers.
