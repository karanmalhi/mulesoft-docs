...
image:architecture-of-the-mule-management-console-1.png[image]
...
* the MMC agent
* JMX functionality exposed by Mule. (For more information on JMX management, see the link:/mule-user-guide/jmx-management[JMX Management] page)
...
* link:/mule-management-console/installing-mmc[Install] MMC.
* Learn more about link:/mule-management-console/setting-up-mmc[how to set up] MMC.
* Get oriented to the link:/mule-management-console/orientation-to-the-console[console].
* Get familiar with the link:/mule-management-console/mmc-rest-api[MMC REST API].
