...
This page describes how you might use the Flows tab and its screens. See link:/mule-management-console/analyzing-message-flows[Analyzing Message Flows] for details on the Flow Analyzer tab.
...
The figure below shows an example of the Flows screen. +
 image:tracking-flows-1.png[image] +
...
image:tracking-flows-2.png[image]
...
The figure below shows you might use the Flows screens to track events processing on a flow. Get detailed data by clicking the flow from the summary table, then expand the event processing chart to see when the event processing occurred and how the time was apportioned. +
 image:tracking-flows-3.png[image]

When you see that there's a problem with a flow or application, switch to the Flow Analyzer tab to track the flow and trace the problem further. See link:/mule-management-console/analyzing-message-flows[Analyzing Message Flows].
