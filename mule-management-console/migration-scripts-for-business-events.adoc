...
+
image:migration-scripts-for-business-events-1.png[image]
+
...
+
image:migration-scripts-for-business-events-2.png[image] +
+
. Type the SQL statement for Business Events migration into the empty field, then click *Run*. +
image:migration-scripts-for-business-events-3.png[image] +
+
. H2 will run the SQL statement, then print a success message: +
+
image:migration-scripts-for-business-events-4.png[image] +
. Optionally, run the link:#MigrationScriptsforBusinessEvents-hddrop[script to drop indexes].
. Disconnect the H2 Web client by clicking the disconnect button, image:migration-scripts-for-business-events-5.png[image] usually the first in the toolbar at the top left corner of the screen.
