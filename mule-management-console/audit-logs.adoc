...
image:audit-logs-4.jpeg[image]

(A section of the output is omitted here).

image:audit-logs-5.jpeg[image]
...
The management console, can also access the logs of registered Mule servers. Click link:/mule-management-console/accessing-server-logs[this link] for details.
