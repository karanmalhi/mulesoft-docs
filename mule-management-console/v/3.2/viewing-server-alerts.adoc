...
This page describes the Alerts screen that is specific to a particular server. See the link:/mule-management-console/v/3.2/working-with-alerts[Viewing Alerts] page for complete details on defining and managing alerts.
...
link:/mule-management-console/v/3.2/monitoring-applications[<< Previous: *Monitoring Applications*]

link:/mule-management-console/v/3.2/viewing-system-memory[Next: *Viewing System Memory* >>]
