...
This page provides examples of using link:/documentation-3.2/display/32X/Automating+Tasks+Using+Scripts[scripts]. You can copy and modify these example scripts for your own use. The scripts include placeholders where you must substitute your own values or parameters.
...
link:/documentation-3.2/display/32X/Automating+Tasks+Using+Scripts[<< Previous: *Automating Tasks Using Scripts*]
