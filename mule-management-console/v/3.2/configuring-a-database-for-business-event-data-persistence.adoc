= *[mmc:Mule 3.2]* Configuring a Database for Business Event Data Persistence
...
image:/documentation-3.2/download/attachments/51053762/create-user.png?version=1&modificationDate=1315606278294[image]
