= *[mmc:Mule 3.2]* Reliability Patterns
...
image:/documentation-3.2/download/attachments/51053747/reliability-pattern-VM.png?version=1&modificationDate=1315603913078[image]
...
image:/documentation-3.2/download/attachments/51053747/reliability-pattern-JMS.jpg?version=1&modificationDate=1315603913091[image]
...
link:/documentation-3.2/display/32X/Monitoring+a+Cluster[<< Previous: *Monitoring a Cluster*]

link:/documentation-3.2/display/32X/Deploying+Applications[Next: *Deploying Applications* >>]
