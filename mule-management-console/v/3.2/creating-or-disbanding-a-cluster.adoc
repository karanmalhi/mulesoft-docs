...
You can also create and disband clusters programmatically using REST APIs. See link:/mule-management-console/v/3.2/managing-clusters-using-rest-apis[Managing Clusters Using REST APIs].
