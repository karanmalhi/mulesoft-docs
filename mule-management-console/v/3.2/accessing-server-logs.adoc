...
For complete information on log files, see link:/mule-management-console/v/3.2/working-with-logs[Working with Logs].
...
link:/mule-management-console/v/3.2/working-with-mule-server-instances[<< Previous: *Working with Mule Server Instances*]

link:/mule-management-console/v/3.2/monitoring-a-server[Next: *Monitoring a Server* >>]
