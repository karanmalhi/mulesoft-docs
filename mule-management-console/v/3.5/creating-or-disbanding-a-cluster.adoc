...
The ticket file stores information as key=value pairs. For a list of the parameters allowed in this file, see link:/mule-user-guide/v/3.5/creating-and-managing-a-cluster-manually[Creating and Managing a Cluster Manually].
...
* Read more about link:/mule-user-guide/v/3.5/creating-and-managing-a-cluster-manually[Configuring Cluster Nodes] manually.
