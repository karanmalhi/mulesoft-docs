...
. If you are also planning to link:#PersistingMMCDatatoMySQL-PersistingTransactionData[persist transaction data] to MySQL, delete the string `tracking-h2` and replace it with `tracking-mysql`.
...
. If you are also planning to link:#PersistingMMCDatatoMySQL-PersistingEnvironmentData[persist environment data] to MySQL, delete the string `env-derby` and replace it with `env-mysql`.
...
image:/documentation/download/attachments/122752002/admin_shell.png?version=1&modificationDate=1400518258970[image]
...
image:/documentation/download/attachments/122752002/admin_shell2.png?version=1&modificationDate=1400518258978[image]
