...
From the Management Console or the Console's link:/documentation/display/current/REST+API+Reference[REST API] you can dynamically add or remove nodes to or from a cluster without disbanding it.

This page details the procedure to add or remove a node in the Management Console. For details on performing these operations using the REST API, consult the link:/documentation/display/current/Clusters[REST API Clusters] documentation.
...
image:/documentation/download/attachments/122751992/servers.list-numbered.png?version=1&modificationDate=1365696428813[image]
...
image:/documentation/download/attachments/122751992/rem.cluster.png?version=1&modificationDate=1365195774250[image]
