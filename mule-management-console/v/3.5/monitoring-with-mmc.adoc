...
This section assumes that you have a clear picture of what link:/mule-management-console/v/3.7[what MMC is for] and that you have already link:/mule-management-console/v/3.7/installing-mmc[installed the Management Console] in your machine.
