...
* The MMC console application file (mmc.war) deployed in a link:/mule-user-guide/v/3.5/hardware-and-software-requirements[supported web application server]
