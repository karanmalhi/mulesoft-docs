...
image::/docs/download/attachments/122750904/Dashboard.jpg?version=1&modificationDate=1421450224700[image]
...
+
image:/docs/download/attachments/122750904/1-conn.parameters.png?version=1&modificationDate=1421450225366[image]
...
image::/docs/download/attachments/122750904/2-auth_user.png?version=1&modificationDate=1421450225692[image]
...
image::/docs/download/attachments/122750904/4-initial_DB_objects.png?version=1&modificationDate=1421450226023[image]
...
+
image:/docs/download/attachments/122750904/5-create_obj_wizard-ob_classes.png?version=1&modificationDate=1421450226505[image]

. Click *Organizational Unit*.

. Click *Add*, then click *Next*. The next window is the *Distinguished Name* window:
+
image:/docs/download/attachments/122750904/7-create_obj_wizard-DN.png?version=1&modificationDate=1421450227874[image]
...
+
image:/docs/download/attachments/122750904/8-create_obj_wizard-attrs.png?version=1&modificationDate=1421450228512[image]
+
...
+
image:/docs/download/attachments/122750904/9-create_obj_wizard-user_attrs.png?version=1&modificationDate=1421450228856[image]
...
+
image:/docs/download/attachments/122750904/10-create_obj_wizard-user_pass.png?version=1&modificationDate=1421450229204[image]
...
image:/docs/download/attachments/122750904/11-create_obj_wizard-groupmember.png?version=1&modificationDate=1421450229546[image]
...
image::/docs/download/attachments/122750904/12-mmc-userlist.png?version=1&modificationDate=1421450229883[image]
...
image::/docs/download/attachments/122750904/13-mmc-limited_dashboard.png?version=1&modificationDate=1421450230280[image]
