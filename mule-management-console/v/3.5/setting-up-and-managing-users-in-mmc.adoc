...
This page takes you through the basics of setting up users via the Management Console. Refer to link:/docs/display/current/Managing+MMC+Users+and+Roles[Managing MMC Users and Roles] for information on setting user groups and assigning permissions.

[NOTE]
====
This page describes adding and managing users via the Management Console. You can also add and manage users using LDAP, but note that once you enable authentication through LDAP, the *Users* link is no longer available in the Management Console. See link:/docs/display/current/Setting+Up+and+Managing+Users+via+LDAP[Setting Up and Managing Users via LDAP] for more information.
====
...
[NOTE]
====
The default groups are Administrators, Deployers, Monitors, and Server Administrators. If you need to create more groups or roles, see link:/docs/display/current/Managing+MMC+Users+and+Roles[Managing MMC Users and Roles].
====
...
* Refer to link:/docs/display/current/Managing+MMC+Users+and+Roles[Managing MMC Users and Roles] for information on how to define user groups, or roles, and assign permissions to those groups.
