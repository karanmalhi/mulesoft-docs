...
If you are upgrading to MMC 3.4.2, and your current MMC installation is configured to link:/mule-management-console/v/3.4/setting-up-and-managing-users-via-ldap[manage users via LDAP], you will need to migrate your existing LDAP configuration to your new MMC 3.4.2 installation.
...
* Learn how to link:/mule-management-console/v/3.4/upgrading-to-mmc-3.4.2-with-an-external-database[upgrade to MMC 3.4.2 with an external database].
