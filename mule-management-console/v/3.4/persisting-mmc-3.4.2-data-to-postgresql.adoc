...
This document will cover how to persist environment and transaction data to PostgreSQL databases. Follow the instructions to link:#PersistingMMC3.4.2DatatoPostgreSQL-PostgreSQLInstallation[install PostgreSQL], then follow the specific instructions for link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingEnvironmentData[environment data] or link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingTransactionData[transaction data] persistence to set up your user, create your database, and configure your MMC instance to persist your data.
...
* *link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingEnvironmentData[Persisting Environment Data to PostgreSQL]*
* *link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingTransactionData[Persisting Transaction Data to PostgreSQL]*
...
* PostgresSQL driver, included with the MMC installation. See the link:#PersistingMMC3.4.2DatatoPostgreSQL-DatabaseDriver[Database Driver] section for details
...
The next step is to create the database user. Follow the relevant setup instructions below, depending on whether you are setting up a database for link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingEnvironmentData[environment data] or link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingTransactionData[transaction data]. 

== Persisting Environment Data

To set up PostgreSQL to persist your MMC environment data, you need to complete four steps:

. link:#PersistingMMC3.4.2DatatoPostgreSQL-envuser[Create the database user]
. link:#PersistingMMC3.4.2DatatoPostgreSQL-envdb[Create the database]
. link:#PersistingMMC3.4.2DatatoPostgreSQL-envverify[Verify the database]
. link:#PersistingMMC3.4.2DatatoPostgreSQL-envsetup[Set up MMC]
...
image:/docs/download/attachments/98310028/postgres_db.png?version=1&modificationDate=1389200671026[image]
...
. If you are also planning to link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingTransactionData[persist transaction data] to PostgreSQL, delete the string `tracking-h2` and replace it with `tracking-postgres`.
...
. link:#PersistingMMC3.4.2DatatoPostgreSQL-transactionuser[Create the database user]
. link:#PersistingMMC3.4.2DatatoPostgreSQL-transactiondb[Create the database]
. link:#PersistingMMC3.4.2DatatoPostgreSQL-transactionverify[Verify the database]
. link:#PersistingMMC3.4.2DatatoPostgreSQL-transactionsetup[Set up MMC]
...
See the section link:#PersistingMMC3.4.2DatatoPostgreSQL-DatabaseDriver[Database Driver] in this document to install or verify your installation of the PostgreSQL database driver.
...
. If you are also planning to link:#PersistingMMC3.4.2DatatoPostgreSQL-PersistingEnvironmentData[persist environment data] to PostgreSQL, delete the string `env-derby` and replace it with `env-postgres`.
