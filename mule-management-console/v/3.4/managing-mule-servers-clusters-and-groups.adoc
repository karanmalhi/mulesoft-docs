...
This document assumes that you are familiar with the basic link:/mule-management-console/v/3.4/architecture-of-the-mule-management-console[Architecture of the Mule Management Console], and that you have installed either the link:/mule-management-console/v/3.4/installing-the-production-version-of-mmc[production] or the link:/mule-management-console/v/3.4/installing-the-trial-version-of-mmc[trial version] of MMC. Also, ideally there should be at least one active Mule instance that you can control from your installed MMC.
