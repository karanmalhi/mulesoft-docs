...
* Select an operator (that is, the condition for selecting values that match the key) from the pull-down list. You can choose operators such as equals, like, greater than, and less than. The operators available in the pull-down list vary depending on the key you select. For example, if you select http://eventtimestamp/[event:timestamp] as the key, you can choose from a list of arithmetic operators: Equals, Greater than, Greater than or equals, Less Than, or Less than or equals. If you select an event attribute as the key, such as `event: exceptionDetails`, you can choose either the operators Equals, Starts with Contains, Ends with, Is empty, or Is not empty.
...
image:/docs/download/attachments/95393680/event-search.png?version=1&modificationDate=1374598897225[image]
...
image:/docs/download/attachments/95393680/event-search-mult-keys.png?version=1&modificationDate=1374598896259[image]
...
image:/docs/download/attachments/95393680/search-results.png?version=1&modificationDate=1374598895932[image]
...
image:/docs/download/attachments/95393680/filtered-search-results.png?version=1&modificationDate=1374598896610[image]
...
[NOTE]
Note that you can customize the transaction Id in your Mule application to make it more meaningful. See link:/docs/display/34X/Business+Events[Business Events] for more details.
...
image:/docs/download/attachments/95393680/details.png?version=1&modificationDate=1374598895531[image]
...
image:/docs/download/attachments/95393680/filtered-events.png?version=1&modificationDate=1374598895180[image]
...
image:/docs/download/attachments/95393680/event-properties.png?version=1&modificationDate=1374598894797[image]

Or if default tracking is enabled, you can click on an exception event to get details.

image:/docs/download/attachments/95393680/exception-details.png?version=1&modificationDate=1374598896912[image]
