...
This page provides examples of using link:/mule-management-console/v/3.7/automating-tasks-using-scripts[scripts]. You can copy and modify these example scripts for your own use. The scripts include placeholders where you must substitute your own values or parameters.
