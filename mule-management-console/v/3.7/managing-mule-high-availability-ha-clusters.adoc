...
[NOTE]
For an overview of clusters, including benefits and best practices, see link:/mule-user-guide/v/3.7/mule-high-availability-ha-clusters[Mule High Availability HA Clusters].
