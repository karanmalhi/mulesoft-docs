...
The management console, can also access the logs of registered Mule servers. Click link:/mule-management-console/v/3.7/accessing-server-logs[this link] for details.
