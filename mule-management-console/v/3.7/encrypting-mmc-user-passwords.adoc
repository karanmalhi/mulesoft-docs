...
. Download and unpack the file link:_attachments/mmc-userpassencryptools.zip[mmc-userpassencryptools.zip]. When you unpack it, the file expands to a directory with two files, `mmc-encrypter-1.0.jar` and `autorun.groovy.script`.
