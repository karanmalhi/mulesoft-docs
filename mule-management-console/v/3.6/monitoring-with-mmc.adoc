...
This section assumes that you have a clear picture of what link:/mule-management-console/v/3.6/_fixed[what MMC is for] and that you have already link:/mule-management-console/v/3.6/installing-mmc[installed the Management Console] in your machine.
