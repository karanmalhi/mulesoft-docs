...
See the Mule ESB page link:http://www.mulesoft.org/documentation/display/MULE3USER/Tuning+Performance[Tuning Performance] for more detailed information on performance tuning.
