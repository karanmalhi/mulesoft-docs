...
This page describes how you might use the Flows tab and its screens. See link:/mule-management-console/v/3.6/analyzing-message-flows[Analyzing Message Flows] for details on the Flow Analyzer tab.
...
When you see that there's a problem with a flow or application, switch to the Flow Analyzer tab to track the flow and trace the problem further. See link:/mule-management-console/v/3.6/analyzing-message-flows[Analyzing Message Flows].
