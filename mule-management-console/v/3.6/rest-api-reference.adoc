...
For details on the management console API, consult link:/documentation/display/current/Using+the+Management+Console+API[Using the Management Console API].
...
* link:/docs/display/current/Deployments[Deployments]
* link:/docs/display/current/Repository+of+Applications[Repository of Applications]
...
image:/documentation/download/attachments/122752015/index.of.operations.png?version=1&modificationDate=1350932468800[image]
...
The title of this section is the http://en.wikipedia.org/wiki/Uniform_Resource_Identifier[URI] of the REST resource documented in the section. For example, the first section in the link:/documentation/display/current/Deployments[Deployments] page is:

__________
*_/api/deployments_*
__________

A single document may contain more than one Resource section. In such cases, the first section always corresponds to the http://en.wikipedia.org/wiki/Uniform_Resource_Identifier#Relationship_to_URL_and_URN[URL], and subsequent sections refer to URIs. For example, in the link:/documentation/display/current/Servers[Servers] page, the first Resource section is `/api/Servers`; subsequent sections are `/api/Servers/{serverId`}, `/api/Servers/{serverId}/applications`, etc.
...
image:/documentation/download/attachments/122752015/tabs.png?version=1&modificationDate=1350932480003[image]
...
image:/documentation/download/attachments/122752015/clicking_req_and_RESULT-3.png?version=1&modificationDate=1350932509617[image]
...
image:/documentation/download/attachments/122752015/response.png?version=1&modificationDate=1350932519513[image]
...
image:/documentation/download/attachments/122752015/error_codes.png?version=1&modificationDate=1350932526897[image]

* *MMC Version*: Specifies from which version of MMC the operation is available.

image:/documentation/download/attachments/122752015/MMC_version.png?version=1&modificationDate=1350932537661[image]
