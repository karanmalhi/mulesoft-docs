...
This page takes you through the basics of setting up users via the Management Console. Refer to link:/mule-management-console/v/3.6/managing-mmc-users-and-roles[Managing MMC Users and Roles] for information on setting user groups and assigning permissions.

[NOTE]
====
This page describes adding and managing users via the Management Console. You can also add and manage users using LDAP, but note that once you enable authentication through LDAP, the *Users* link is no longer available in the Management Console. See link:/mule-management-console/v/3.6/setting-up-and-managing-users-via-ldap[Setting Up and Managing Users via LDAP] for more information.
====
...
[NOTE]
====
The default groups are Administrators, Deployers, Monitors, and Server Administrators. If you need to create more groups or roles, see link:/mule-management-console/v/3.6/managing-mmc-users-and-roles[Managing MMC Users and Roles].
====
