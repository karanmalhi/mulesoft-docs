...
. If you have not yet created a cluster, then create a cluster as described in link:/mule-management-console/v/3.6/creating-or-disbanding-a-cluster[Creating or Disbanding a Cluster].
...
For more information on managing application deployments, see link:/mule-management-console/v/3.6/deploying-applications[Deploying Applications] and link:/mule-management-console/v/3.6/maintaining-the-server-application-repository[Maintaining the Server Application Repository].
