...
* link:#ScriptingExamples-WhentoUseScripts[When to Use Scripts]
* link:#ScriptingExamples-AlertingExamples[Alerting Examples]
* link:#ScriptingExamples-ExampleEmailAlerts[Example Email Alerts]
* link:#ScriptingExamples-InsertingExpressionsinEmailSubjectorBody[Inserting Expressions in Email Subject or Body]
* link:#ScriptingExamples-ScripttoPerformSNMPEscalationforanAlert[Script to Perform SNMP Escalation for an Alert]
* link:#ScriptingExamples-ScripttoImplementaCustomAction[Script to Implement a Custom Action]
* link:#ScriptingExamples-ScripttoRestartaServer[Script to Restart a Server]
