...
image:/docs/download/attachments/95393714/server-config.png?version=1&modificationDate=1374598974277[image]
...
image:/docs/download/attachments/95393714/select-chart.png?version=1&modificationDate=1374598974663[image]
