...
[NOTE]
Note that you can customize the transaction Id in your Mule application to make it more meaningful. See link:/docs/display/33X/Business+Events[Business Events] for more details.
