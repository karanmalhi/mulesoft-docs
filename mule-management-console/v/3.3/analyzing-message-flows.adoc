...
* link:#AnalyzingMessageFlows-DefineSelectionParameters[Define Selection Parameters]
* link:#AnalyzingMessageFlows-StartDataCollection[Start Data Collection]
* link:#AnalyzingMessageFlows-ControlDataCollection[Control Data Collection]
* link:#AnalyzingMessageFlows-SearchtheMessageList[Search the Message List]
* link:#AnalyzingMessageFlows-GetDetailsAboutaMessage[Get Details About a Message]
* link:#AnalyzingMessageFlows-UnderstandingtheMessageProcessorsandMessageContent[Understanding the Message Processors and Message Content]
...
image:/documentation/download/attachments/122752005/define-audit.png?version=1&modificationDate=1301101947115[image]
...
image:/documentation/download/attachments/122752005/audit-list.png?version=1&modificationDate=1301101947123[image]
...
image:/documentation/download/attachments/122752005/audit-search.png?version=1&modificationDate=1301101947133[image]
...
image:/documentation/download/attachments/122752005/msg-details1.png?version=1&modificationDate=1301101947106[image]
...
image:/documentation/download/attachments/122752005/msg-details2.png?version=1&modificationDate=1301101947092[image]
...
image:/documentation/download/attachments/122752005/details-1.png?version=1&modificationDate=1301101987610[image]
...
image:/documentation/download/attachments/122752005/details-2.png?version=1&modificationDate=1301101987622[image]
...
For more information on reading stream-based payloads, such as CXF streams, see how to apply an object-to-byte-array stream transformer in the section "Viewing Message Payload When Using Streams" in the link:/documentation/display/current/Analyzing+Flow+Processing+and+Payloads[Analyzing Flow Processing and Payloads] topic.
...
image:/documentation/download/attachments/122752005/properties.png?version=1&modificationDate=1301101987631[image]
