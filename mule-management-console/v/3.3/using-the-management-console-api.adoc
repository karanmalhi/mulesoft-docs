...
For full details on all operations that are possible via REST, including usage and output examples, consult the link:/docs/display/current/REST+API+Reference[REST API Reference].
...
For details on these operations, consult the link:/docs/display/current/REST+API+Reference[REST API Reference].
...
[TIP]
====
The link:/docs/display/current/REST+API+Reference[REST API Reference] contains full details of all operations that available on the management console's REST API, including examples of input data and results.
====
