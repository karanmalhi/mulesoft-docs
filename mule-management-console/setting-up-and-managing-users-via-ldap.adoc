...
[NOTE]
The Mule Management Console provides REST APIs for link:/mule-management-console/using-the-management-console-api[programmatic access to much of the console's functionality], including cluster management, applications, flows and deployments. You can also use the REST API to configure link:/mule-management-console/using-the-management-console-api[automated replication of LDAP user groups].
...
image:setting-up-and-managing-users-via-ldap-1.jpeg[image]
...
. Open the *LDAP* menu, then click on *New Connection*. The *Network Parameter* window pops up. +
 +
image:setting-up-and-managing-users-via-ldap-2.png[image]
...
image:setting-up-and-managing-users-via-ldap-3.png[image]
...
image:setting-up-and-managing-users-via-ldap-4.png[image]
...
. In the *Entry Creation Method* window, click *Create entry from scratch*, then click *Next*. The wizard takes you to the *Object Classes* window: +
 +
image:setting-up-and-managing-users-via-ldap-5.png[image]
...
. In the *Available object classes* input box, begin typing *OrganizationalUnit*. The search box automatically selects available objects that match your search. +
 +
image:setting-up-and-managing-users-via-ldap-6.png[image]

. Click *OrganizationalUnit*.
. Click *Add*, then click *Next*. The next window is the *Distinguished Name* window: +
 +
image:setting-up-and-managing-users-via-ldap-7.png[image]
...
. Click *Next*. The wizard takes you to the *Attributes* pop-up window: +
 +
image:setting-up-and-managing-users-via-ldap-8.png[image]
 +
...
. To add these attributes, click the *New Attribute* icon (highlighted below). +
 +
image:setting-up-and-managing-users-via-ldap-9.png[image]
...
. In the *Options* window, click *Finish*. +
 +
image:setting-up-and-managing-users-via-ldap-10.png[image]
...
image:setting-up-and-managing-users-via-ldap-11.png[image]
...
image:setting-up-and-managing-users-via-ldap-12.png[image]
...
image:setting-up-and-managing-users-via-ldap-13.png[image]
...
* Refer to link:/mule-management-console/managing-mmc-users-and-roles[Managing MMC Users and Roles] for information on how to define user groups, or roles, and assign permissions to those groups.
