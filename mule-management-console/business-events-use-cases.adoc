...
For more details about how to define and enable custom or default events in your Mule application, see link:/mule-user-guide/business-events[Business Events].
...
image:business-events-use-cases-1.png[image]
...
image:business-events-use-cases-4.png[image]
