...
image:automating-tasks-using-scripts-1.png[image]
...
image:automating-tasks-using-scripts-2.png[image]
...
+
image:automating-tasks-using-scripts-3.png[image]
...
. Click *Save*.
+
image:automating-tasks-using-scripts-4.png[image]
+
[CAUTION]
...
link:/mule-management-console/scripting-examples[*Scripting Examples*]
