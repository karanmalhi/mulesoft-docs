...
link:/anypoint-platform-for-apis/creating-a-policy-walkthrough[*Skip to Code*]
...
image:creating-a-policy-walkthrough-1.png[image]
...
image:creating-a-policy-walkthrough-2.png[image]
...
The Policy Configuration is an XML file that implements the actual execution of the policy. The configuration achieves this by leveraging the link:/mule-fundamentals/elements-in-a-mule-flow[elements] available when creating a link:/mule-fundamentals/[Mule ESB] application. All of the elements usable in Mule ESB can be used in a custom policy.
...
All we need to do in this case is filter the incoming request, so add a link:/mule-user-guide/filters-configuration-reference[message filter], which is a standard Mule element.
...
image:creating-a-policy-walkthrough-3.jpeg[image]
...
image:creating-a-policy-walkthrough-3.png[image]
...
image:creating-a-policy-walkthrough-4.png[image]
...
image:creating-a-policy-walkthrough-5.png[image]
