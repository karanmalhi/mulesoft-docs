...
image:anypoint-platform-for-apis-system-architecture-1.jpeg[image]
...
image:anypoint-platform-for-apis-system-architecture-2.jpeg[image]
...
The Anypoint Platform is certified via WhiteHat Sentinel. https://www.whitehatsec.com/sentinel_services/sentinel_services.html[image:anypoint-platform-for-apis-system-architecture-3.png[image]]
