...
+
OR:
* A proxy for your API and you are ready to deploy it to your API Gateway. (If you didn't create an API yet but you want to jump in here, you can download and use link:#[this example proxy application].)
...
+
image:/docs/download/attachments/131039910/deploy+ch.png?version=1&modificationDate=1434054765418[image]
...
+
image:/docs/download/attachments/131039910/deploy+ch+2.png?version=1&modificationDate=1434054962924[image]
...
+
image:/docs/download/attachments/131039910/Screen+Shot+2015-06-10+at+5.28.09+PM.png?version=1&modificationDate=1434055064736[image]
+
[TIP]
...
image:/docs/download/attachments/131039910/CHOrganizationName.png?version=1&modificationDate=1435878392373[image]
...
image:/docs/download/attachments/131039910/OrgClientIDSecret.png?version=2&modificationDate=1435878925495[image]

*Business Group info:*

image:/docs/download/attachments/131039910/BizGroupInfo.png?version=1&modificationDate=1435882362239[image]
====
+
Copy the following:
+
