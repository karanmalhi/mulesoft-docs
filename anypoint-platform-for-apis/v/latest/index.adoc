...
If you created an account on a version of the platform released prior to July 30, 2014, documentation can be found link:/anypoint-platform-for-apis/anypoint-platform-for-apis-previous-release[here].
====
