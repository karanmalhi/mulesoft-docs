...
[WARNING]
====
This policy can only be applied in a Gateway version 2.0 or newer. On older versions of the Gateway Runtime, you can instead apply the link:/anypoint-platform-for-apis/oauth-2.0-provider-and-token-validation-policies[OAuth 2.0 Provider and Token Validation Policies].
====
