...
. Add the RAML snippet to the API's RAML in Designer. The updated RAML should look like link:https://drive.google.com/file/d/0B984XvA0spP_NXlQY0hRZ29VeWM/view?usp=sharing[this one].
