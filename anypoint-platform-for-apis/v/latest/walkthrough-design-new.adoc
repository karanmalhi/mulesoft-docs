...
This walkthrough assumes that you have already created an API version details page for the T-Shirt Service API, which we covered in link:/anypoint-platform-for-apis/walkthrough-intro-create[Create an API]. After logging into link:https://anypoint.mulesoft.com[Anypoint Platform], you clicked the version number of your project:

image:ap-click-vnum.png[Click the version number for more details]

This guide also assumes you clicked *Define API in API designer*:

image:api-def-define.png[clicked Define API in API designer]

This guide assumes you then left Anypoint Platform and are now ready to start editing in API Designer.

== Starting

You are now ready to start by clicking *Edit in API designer*:
