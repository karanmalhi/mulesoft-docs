...
+
[WARNING]
*Note*: When deploying to CloudHub, you can only perform an automatic deploy if you use HTTP listener. If you use HTTPS, you must customize the proxy to add your HTTPS credentials and then perform a manual deploy to CloudHub, or deploy on premise.
