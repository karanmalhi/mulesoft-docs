...
The Mule Runtime beta version 3.8-M1 can also be used in this tutorial. As of 3.8, the both the Mule Runtime and the Gateway Runtime are merged into one.
