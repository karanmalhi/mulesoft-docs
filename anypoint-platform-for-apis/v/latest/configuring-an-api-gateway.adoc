...
. In the **Work with:** field in the Install wizard, enter link:https://studio.mulesoft.org.s3.amazonaws.com/r3/api-gateway/
...
* link:https://cloudhub.io/login.html[Log in] to CloudHub. If you haven't already done so, create an account now.
