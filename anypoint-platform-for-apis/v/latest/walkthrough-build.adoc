...
+
. Notice the folder structure that was created in the package explorer of the project. You build your API's functionality in the `t-shirt.xml` file, located in the `src/main/api` folder.
+
