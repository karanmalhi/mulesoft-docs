...
. If you have not downloaded the Mule standalone runtime, click link:/mule-user-guide/v/3.7/installing[here] and follow the steps to install the latest version.
