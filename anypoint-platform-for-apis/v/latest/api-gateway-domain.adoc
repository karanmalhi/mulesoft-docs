...
+
[CAUTION]
This means that the API Gateway runtime reserves that port when is started. If you are already using that port, you  receive a message saying that the port is already in use, and all auto-generated proxies fail.
+
