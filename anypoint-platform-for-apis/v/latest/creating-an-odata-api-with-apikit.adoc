...
* link:https://github.com/mulesoft/apikit/tree/1.8-BETA[APIKit 2.0 Beta]
...
== Using the APIKit 2.0 SDK

To use this functionality, you must link:https://github.com/mulesoft/apikit/tree/1.8-BETA[download and install APIKit 2.0 Beta]. Also, ensure you have the latest version of Studio and Mule 3.7 or later runtime (see the prerequisites <<Prerequisites,above>>).
