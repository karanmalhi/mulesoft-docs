...
. <<import,Import>> the application template into Studio.
...
. link:https://github.com/mulesoft/apikit-odata-template[Download] the template for the APIKit OData extension.
...
. The `model.json` file contains the structure of the supported entity model. Enter the values for the entities and fields of your specific entity model. (For details on the entity model, <<Supported Data Types>> in this page, or consult the link:https://github.com/mulesoft/apikit-odata-template[full specification]).
...
A full working example of a MySQL data gateway, built using the template, is link:https://github.com/mulesoft/apikit-odata-example[available for viewing and download] in GitHub.
