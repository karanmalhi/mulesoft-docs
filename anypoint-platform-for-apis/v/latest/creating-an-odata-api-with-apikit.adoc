...
* APIKit with OData Extension, which you download from within Studio (see <<"Installing the APIKit Extension in Studio",below>>)
...
. In the *Work with:* field in the Install wizard, enter: `http://apikit-nightly.s3.amazonaws.com/k2-odata`.
