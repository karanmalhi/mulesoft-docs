...
Once you have the latest version of Anypoint Studio and with the Mule 3.7 runtime, the basic high-level steps are the following:
...
TIP: For the complete specification of the data model, see the link:https://github.com/mulesoft-labs/apikit-odata-template/blob/master/README.md[README file] in the APIKit OData template. You can also access a list of fully-written link:https://github.com/mulesoft-labs/apikit-odata-template/blob/master/examples-edm-types.md[examples of EDM types.]
