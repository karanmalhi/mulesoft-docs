...
+
image:giveportalaccess.png[giveportalaccess]
...
image:incontextperms.png[incontextperms]
...
image:APExtIdentityTab.png[APExtIdentityTab]
...
Mapping:
+
image:APJUSetExGrpMap.png[APJUSetExGrpMap]
