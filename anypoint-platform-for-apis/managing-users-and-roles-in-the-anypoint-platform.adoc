...
+
image:selectapi.png.png[selectapi.png]
...
+
image:giveportalaccess.png.png[giveportalaccess.png]
...
image:incontextperms.png.png[incontextperms.png]
...
image:APExtIdentityTab.png.png[APExtIdentityTab.png]
...
+
image:RolesAddRole.png.png[RolesAddRole.png]

. Specify a role name and description. Click *Add role* to add the role:
+
image:APNewRoleJU.png.png[APNewRoleJU.png] +

. In the *Roles* menu, click the name of the new role:
+
image:APClickRole.png.png[APClickRole.png] +

.  Click *Set external group mapping*:
+
image:APJUInfo.png.png[APJUInfo.png] +
...
Mapping:
+
image:APJUSetExGrpMap.png.png[APJUSetExGrpMap.png]
