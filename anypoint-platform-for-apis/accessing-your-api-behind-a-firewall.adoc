...
Go to the API Designer for your API. On the right pane, check the API is behind a firewall box, which bypasses the proxy.image:accessing-your-api-behind-a-firewall-1.png[image]
