...
Go to the API Designer for your API. On the right pane, check the API is behind a firewall box, which bypasses the proxy.image:Screen+Shot+2014-09-03+at+6.09.09+PM.png[Screen+Shot+2014-09-03+at+6.09.09+PM]
