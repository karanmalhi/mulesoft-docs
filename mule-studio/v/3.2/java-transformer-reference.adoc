image:/documentation-3.2/download/attachments/55083237/Java.png?version=1&modificationDate=1325875150599[image]
...
[cols=",",]
|===
|image:/documentation-3.2/images/icons/emoticons/information.gif[image] |The *Java Transformer* was called a *Custom Transformer* in previous versions of Mule ESB.
...
image:/documentation-3.2/download/attachments/55083237/JavaExampleFlow.png?version=1&modificationDate=1327608007853[image]
...
image:/documentation-3.2/download/attachments/55083237/JavaGeneralTransformerClass.png?version=1&modificationDate=1327348753188[image]
...
To configure Spring bean settings, click the *Add Property* image:/documentation-3.2/images/icons/emoticons/add.gif[image] button, then enter a name and its associated value or reference. Spring bean configuration data can be saved in a persistent store and restored at a later time.

image:/documentation-3.2/download/attachments/55083237/JavaGeneralTransformerProperty.png?version=1&modificationDate=1328235891770[image]
...
. click the *Add Property* image:/documentation-3.2/images/icons/emoticons/add.gif[image] button

. select the *Advanced* tab
. click the *Add Sub-elements* image:/documentation-3.2/images/icons/emoticons/add.gif[image] button

. choose a property element to configure

image:/documentation-3.2/download/attachments/55083237/JavaGeneralTransformerAdvanced.png?version=1&modificationDate=1325880094103[image]
...
image:/documentation-3.2/download/attachments/55083237/JavaPropAdv.png?version=1&modificationDate=1327444765327[image]
...
image:/documentation-3.2/download/attachments/55083237/JavaDoc.png?version=1&modificationDate=1325880094119[image]
...
image:/documentation-3.2/download/attachments/55083237/HTTPTransformerFlow.png?version=1&modificationDate=1328062183185[image]
...
[cols=",",]
|===
|image:/documentation-3.2/images/icons/emoticons/information.gif[image] |You may reuse these Global endpoint and connector references across multiple building block instances within your project. If you decide not use Global references, you must configure HTTP (i.e., Host, Port, and Path, etc.) for the requested resource directly on your HTTP endpoint instance.
...
* Click the HTTP endpoint *References* tab on the *Properties* pane of your HTTP endpoint instance, then click the add image:/documentation-3.2/images/icons/emoticons/add.gif[image] button to the right of the *Connector reference * text box.

* Click the *Global Elements* tab below the *Message Flow* canvas, click the *Create* button, click the image:/documentation-3.2/images/icons/emoticons/add.gif[image] next to Connectors, select **HTTP/HTTPS**, then click OK to complete the operation.
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorGen.png?version=1&modificationDate=1328216054067[image]
...
image:/documentation-3.2/images/icons/arrow_closed_active_16.gif[image] Click here for XML Schema Information
...
image:/documentation-3.2/images/icons/arrow_closed_active_16.gif[image] Click here for XML code
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorAdv.png?version=1&modificationDate=1328127055243[image]
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorSec.png?version=1&modificationDate=1328127077969[image]
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorProp.png?version=1&modificationDate=1328127055228[image]

[cols=",",options="header",]
|====
|Panel |Description
|*Spring Properties* |click the add image:/documentation-3.2/images/icons/emoticons/add.gif[image] button to enter the name, value and reference of the *Spring* property you want to define. After the property window appears, click the *Advanced* tab to configure *Spring* sub-element properties.
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorPro.png?version=1&modificationDate=1328127055239[image]
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorTim.png?version=1&modificationDate=1328127077973[image]
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorProxy.png?version=1&modificationDate=1328127077963[image]
...
image:/documentation-3.2/download/attachments/55083237/GlobalConnectorDoc.png?version=1&modificationDate=1328127055253[image]
...
image:/documentation-3.2/download/attachments/55083237/BodyToParameterMap.png?version=1&modificationDate=1328219967028[image]
...
image:/documentation-3.2/download/attachments/55083237/SelectMapLookupClass.png?version=1&modificationDate=1328144021601[image]
...
image:/documentation-3.2/download/attachments/55083237/JavaGeneralTransformerSettings.png?version=1&modificationDate=1328236307622[image]
...
For more information, see the Mule ESB page link:/documentation-3.2/display/32X/Creating+Custom+Transformers[Creating Custom Transformers]
