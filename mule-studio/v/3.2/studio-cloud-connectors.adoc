...
image:magento.png[magento] |Magento |An e-commerce Web application based on open source technologies. |link:/documentation-3.2/display/32X/Magento+Cloud+Connector+Reference[Magento Cloud Connector Reference]


image:salesforce.png[salesforce] |Salesforce |A Web-based API for querying, creating, and updating information within Customer Relationship Management (CRM) software from Salesforce. |link:/documentation-3.2/display/32X/Salesforce+Cloud+Connector+Reference[Salesforce Cloud Connector Reference]


image:twitter.png[twitter] |Twitter |An online API service that supports Web-based social networking and micro-blogging. |link:/documentation-3.2/display/32X/Twitter+Cloud+Connector+Reference[Twitter Cloud Connector Reference]
