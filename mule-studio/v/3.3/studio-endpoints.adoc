...
|image:http.png[http] |HTTP |Sends and receives messages via the HTTP transport protocol. Turn on security to send HTTPS messages via SSL. |one-way, *request-response* |link:/docs/display/34X/HTTP+Endpoint+Reference[HTTP Reference]
