...
image:/docs/download/attachments/95393402/WMQgeneral.png?version=1&modificationDate=1374598472676[image]
...
image:/docs/download/attachments/95393402/WMQadvanced.png?version=1&modificationDate=1374598472403[image]
...
image:/docs/download/attachments/95393402/WMQreferences.png?version=1&modificationDate=1374598472138[image]
...
image:/docs/download/attachments/95393402/WMQdocumentation.png?version=1&modificationDate=1374598471833[image]
...
See the link:/docs/display/34X/Mule+WMQ+Transport+Reference[Mule WMQ Transport Reference] for details on setting the properties for a WMQ endpoint using an XML editor.
