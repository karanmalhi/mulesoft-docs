...
* link:#CreatingCustomPolicies-WritingaPolicy[Writing a Policy]
* link:#CreatingCustomPolicies-ConfiguringTcatServertoUseaPolicy[Configuring Tcat Server to Use a Policy]
* link:#CreatingCustomPolicies-BuildingaPolicy[Building a Policy]
* link:#CreatingCustomPolicies-InstallingaCustomPolicy[Installing a Custom Policy]
...
You will now have a JAR located at `custom-policy/target/galaxy-custom-policy-VERSION.jar`, where VERSION is the version of Tcat Server you are using.
