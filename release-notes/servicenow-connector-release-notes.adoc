...
*Guide:* link:/mule-user-guide/servicenow-connector[ServiceNow Connector]
...
 image:servicenow-connector-release-notes-1.png[image]
...
* link:/mule-user-guide/servicenow-connector[ServiceNow Connector] document.
