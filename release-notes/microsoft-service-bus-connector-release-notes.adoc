...
*Connector Guide*: link:/mule-user-guide/microsoft-service-bus-connector[Microsoft Service Bus Connector]
...
* Learn about the connector using the link:/mule-user-guide/microsoft-service-bus-connector[Microsoft Service Bus Connector] guide. 
* Read the link:/mule-user-guide/microsoft-service-bus-connector-faq[Microsoft Service Bus Connector FAQ].
