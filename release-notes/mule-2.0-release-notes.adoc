...
For those interested in creating an XML Namespace for their custom module/transport (or just want to know the gory details of how it works), read link:/mule-user-guide/creating-a-custom-xml-namespace[How to Create an XML Namespace].
