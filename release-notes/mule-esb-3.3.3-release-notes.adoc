...
* *Support for multiple runtimes* *in Studio*  Beyond the Community runtime, you can download multiple Enterprise runtimes in Studio, using different runtimes with your Studio projects as desired.  Read more about link:/mule-user-guide/installing-extensions[installing extra runtimes in Studio].
