...
* link:/release-notes/microsoft-sharepoint-connector-release-notes[Microsoft SharePoint Connector Release Notes]
...
* link:/mule-user-guide/anypoint-connectors[Anypoint Connectors overview]
