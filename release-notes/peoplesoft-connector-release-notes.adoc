...
Guide: link:/mule-user-guide/peoplesoft-connector[PeopleSoft Connector]
...
* Read more about the link:/mule-user-guide/peoplesoft-connector[PeopleSoft Connector], including examples of how to use it
