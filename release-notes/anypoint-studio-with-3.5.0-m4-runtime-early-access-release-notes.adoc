...
* *link:#[Anypoint Connector DevKit in Studio]*: To build your own Anypoint Connector, you can use the link:/anypoint-connector-devkit/[Anypoint Connector DevKit]. In the Early Access release of Anypoint Studio, you can add a module that enables you to access DevKit functionality directly in Studio. Includes New Anypoint Connector wizard to easily create new connector projects.
