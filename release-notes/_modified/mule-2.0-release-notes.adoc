...
For those interested in creating an XML Namespace for their custom module/transport (or just want to know the gory details of how it works), read link:/documentation/display/current/Creating+a+Custom+XML+Namespace[How to Create an XML Namespace].
