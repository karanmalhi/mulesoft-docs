...
Skip to link:#MuleESB3.3.1ReleaseNotes-MigratingfromMuleESB3.3.0to3.3.1[Migration Guide]
...
* Ability to link:/mule-user-guide/flow-reference-component-reference[reference flows] in multiple configuration files in a project
...
* Improved behavior of link:/mule-user-guide/choice-flow-control-reference[Choice Flow Control]
...
|DEVKIT-50 |@Optional @Default(#link:#[payload]) doesn't work when payload is a list
