...
These release notes apply to both the Community and the Enterprise runtimes of Mule ESB 3.6.0. Where appropriate, we have applied an _*Enterprise*_ marker to identify features or functionality that are available only in the Enterprise runtime.

*Note*: Mule ESB 3.6.n uses log4j2. Ensure that you're using the latest logging configuration. For more information about this change, see link:/documentation/display/current/Logging+in+Mule[Logging in Mule].
...
* For details on Anypoint Studio January 2015 release (that comes with 3.6.0 Runtime), see the link:/documentation/display/current/Anypoint+Studio+January+2015+with+3.6.0+Runtime+Release+Notes[Anypoint Studio January 2015 with 3.6.0 Runtime Release Notes]
