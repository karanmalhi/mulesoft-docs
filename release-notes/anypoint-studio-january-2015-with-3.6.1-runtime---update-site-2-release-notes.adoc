...
This January 2015 release is an update to the Studio January 2015 with 3.6.0 runtime, and complements the link:/documentation/display/current/Anypoint+Studio+January+2015+with+3.6.0+Runtime+Release+Notes[Anypoint Studio January 2015 with 3.6.0 Runtime Release Notes].
