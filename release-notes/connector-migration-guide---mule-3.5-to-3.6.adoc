...
image:connector-migration-guide-mule-3.5-to-3.6-1.png[image]
...
image:connector-migration-guide-mule-3.5-to-3.6-2.png[image]
...
|link:/mule-user-guide/anypoint-connectors[Anypoint Connectors] |MuleSoft connector user guides.
|http://www.mulesoft.org/connectors[Connectors] |Connectors available from MuleSoft or third party sources.
|link:/anypoint-connector-devkit/[Anypoint Connector DevKit] |Connector development information.
|link:/anypoint-connector-devkit/annotation-reference[Annotation Reference] |Describes DevKit elements that start with an at sign(@), which you can use in your connector to identify classes and functions for Anypoint functionality.
|===
