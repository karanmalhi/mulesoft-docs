...
*Guide* :  link:/documentation/display/current/HL7+Global+Connector[HL7 Global Connector]
...
* Learn more about link:/documentation/display/current/Mule+Healthcare+Toolkit[HL7 connector].
