...
|STUDIO-6221|SVR] Apply light theme to Studio (Carl's & James' design)
...
|STUDIO-6660|Deploy to CH] clubhub.url system property not being read
...
|STUDIO-6710|Studio Visual Re-design - Global icons don't update when changing to Light theme
...
* Refer to MuleSoft’s link:https://docs.mulesoft.com/[MuleSoft Documentation] for instructions on how to use the new features and improved functionality in Anypoint Studio with 3.7.0 Runtime.
