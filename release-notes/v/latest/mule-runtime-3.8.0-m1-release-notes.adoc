...
* This release unifies link:/anypoint-platform-for-apis/api-gateway-101[API Gateway] Runtime with the core Mule runtime, simplifying development and operations. Please see the link:release-notes/api-gateway-to-runtime-to-mule-3.8-m1-migration-guide[migration guide] for information on how to migrate.
...
When migrating from an API Gateway Runtime, follow this link:release-notes/api-gateway-to-runtime-to-mule-3.8-m1-migration-guide[migration guide].
...
* link:release-notes/api-gateway-to-runtime-to-mule-3.8-m1-migration-guide[migration guide]
