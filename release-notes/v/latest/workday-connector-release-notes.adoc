...
* Refer to the link:/release-notes/workday-connector-6.0-migration-guide[Workday Connector 6.0 or above Migration Guide]to learn how to upgrade to Workday connector v6.0 or above.
