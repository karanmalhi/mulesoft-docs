...
Release Notes for version 2.0.1 of the Oracle EBS Connector. These release notes accompany the link:/mule-user-guide/v/3.7/oracle-ebs-connector[Oracle E-Business Suite Connector] guide.
