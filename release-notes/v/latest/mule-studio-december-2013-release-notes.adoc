...
* *New and Improved CloudHub features:* New Enterprise link:/cloudhub/virtual-private-cloud[Virtual Private Cloud] and support for link:/cloudhub/managing-schedules[poll scheduling] and link:/mule-user-guide/v/3.7/batch-processing[batch processing].
