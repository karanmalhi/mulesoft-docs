...
image:/documentation/download/attachments/122752566/36TestConnection.png?version=1&modificationDate=1419355330047[image]
...
image:/documentation/download/attachments/122752566/36BasicAuthTypeStrategy.png?version=1&modificationDate=1420477952340[image]
