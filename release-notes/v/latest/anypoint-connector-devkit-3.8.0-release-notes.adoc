...
** Further DevKit SOAP Connect functionality includes link:/anypoint-connector-devkit/v/3.7/soap-connect-session-management#enriching[SOAP message body enrichment] with the session token
