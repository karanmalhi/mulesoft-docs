...
Release Notes for version 2.0.0 of the SuccessFactors Connector. These release notes accompany the link:/mule-user-guide/v/3.7/successfactors-connector[SuccessFactors Connector] guide.
