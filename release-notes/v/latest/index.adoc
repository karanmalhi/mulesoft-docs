...
|API Gateway Runtime |link:/release-notes/api-gateway-2.0.3-release-notes[2.0.3] |A simpler runtime, optimized for building proxies for APIs. These enable you to track usage and apply policies.
|===
