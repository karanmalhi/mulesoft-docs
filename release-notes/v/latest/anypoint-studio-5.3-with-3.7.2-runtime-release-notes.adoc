...
*Note*: If you are installing Anypoint Studio on a Mac computer with OSX that has no java installed, the OS might requrie that you first download and install link:http://www.oracle.com/technetwork/java/javase/downloads/java-archive-downloads-javase6-419409.html[JDK 1.6]. Install JDK 1.6 first and then install JDK 1.7.
