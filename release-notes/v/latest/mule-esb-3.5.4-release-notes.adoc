...
MuleSoft is pleased to announce the release of Mule 3.5.4, an Enterprise Only mainenance release for 3.5.x users. We updated libraries due to security vulnerabilities, including commons-collections and fixed more than 70 bugs.
