...
Release Notes for version 2.0.0 of the PeopleSoft Connector. These Release Notes accompany the http://www.mulesoft.org/documentation/display/current/PeopleSoft+Connector[PeopleSoft Connector Documentation Guide].
