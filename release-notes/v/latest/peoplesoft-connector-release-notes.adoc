...
Release Notes for version 2.0.0 of the PeopleSoft Connector. These Release Notes accompany the /mule-user-guide/v/3.7/peoplesoft-connector[PeopleSoft Connector Documentation Guide].
