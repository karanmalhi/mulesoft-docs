...
Amazon Simple Notification Service (SNS) provides hosted multi-protocol "push" messaging for applications. The Anypoint Connector for Amazon SNS allows Mule applications to interact with Amazon SNS.

*Guide:* link:/mule-user-guide/v/3.7/amazon-sns-connector[Amazon SNS Connector]
...
* Issue with Region Endpoint URLs has been fixed.
...
* Read more about the link:/mule-user-guide/v/3.7/amazon-sns-connector[Amazon SNS Connector], including examples of how to use it
