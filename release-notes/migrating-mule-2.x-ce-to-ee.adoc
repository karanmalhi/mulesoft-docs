...
. Install `mule-<version>-EE` into a new directory (see link:/mule-user-guide/installing[Installing Mule]). Do not overwrite your existing Mule Community installation.
