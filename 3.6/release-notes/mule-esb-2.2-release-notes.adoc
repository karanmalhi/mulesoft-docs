...
Mule Enterprise 2.2 includes many new features and fixes developed on Mule Community Edition. For a list of these fixes, see link:/documentation/display/current/Legacy+Mule+Release+Notes[Mule 2 Release Notes].
