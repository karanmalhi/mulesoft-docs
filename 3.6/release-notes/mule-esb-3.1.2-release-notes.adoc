...
Mule version 3.1.2 builds on the features added in link:/documentation/display/current/Mule+ESB+3.1.1+Release+Notes[version 3.1.1] and fixes the following issues.
