...
* Migrating the early access 2 (EA2) release to the current GA 2.2.5 release. This migration requires extra steps. Please see the http://www.mulesoft.org/display/mmc/Trouble+Shooting+Tips#TroubleShootingTips-MigratingfromEA2ReleasetoGARelease[Trouble Shooting Tips].
