...
* link:/documentation/display/34X/Installing+Extensions[Add 3.4.3 runtime to your Mule Studio instance]
...
For most use cases, Mule ESB 3.4.3 does not change the link:/documentation/display/34X/Hardware+and+Software+Requirements[hardware and software system requirements] established by Mule ESB 3.4.1.  https://www.mulesoft.com/contact[Contact MuleSoft] with any questions about system requirements.

== Fixed and Improved in This Release

* link:#MuleESB3.4.3ReleaseNotes-CEFixes[Community Edition Fixes]
* link:#MuleESB3.4.3ReleaseNotes-CEImps[Community Edition Improvements]
* link:#MuleESB3.4.3ReleaseNotes-EEFixes[Enterprise Edition Fixes]
* link:#MuleESB3.4.3ReleaseNotes-EEImps[Enterprise Edition Improvements]
