...
The improvements and fixes that Mule ESB 3.2.4 introduces require no specific migration activities for Mule ESB. For more details on how to migrate from previous versions of Mule ESB, access the link:/documentation/display/current/Legacy+Mule+Migration+Notes[library of Migration Guides].
