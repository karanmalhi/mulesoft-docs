...
|===
|Key |Type |Summary |Child of
|serverGroupdId |String |ID of the server group to be listed. Invoke link:#ServerGroups-listAll[LIST ALL] to obtain it |—
|===
...
|===
|Key |Type |Summary |Child of
|serverGroupdId |String |ID of the server group to be removed. Invoke link:#ServerGroups-listAll[LIST ALL] to obtain it |—
|===
