...
image:/documentation/download/attachments/122751984/MMC-architecture.png?version=1&modificationDate=1383614345854[image]
...
* the MMC agent
* JMX functionality exposed by Mule. (For more information on JMX management, see the link:/documentation/display/current/JMX+Management[JMX Management] page)
...
* link:/documentation/display/current/Installing+MMC[Install] MMC.
* Learn more about link:/documentation/display/current/Setting+Up+MMC[how to set up] MMC.
* Get oriented to the link:/documentation/display/current/Orientation+to+the+Console[console].
* Get familiar with the link:/documentation/display/current/MMC+REST+API[MMC REST API].
