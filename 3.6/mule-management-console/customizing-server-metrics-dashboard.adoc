...
image:/documentation/download/attachments/122751964/server-config.png?version=1&modificationDate=1299545845673[image]
...
image:/documentation/download/attachments/122751964/select-chart.png?version=1&modificationDate=1299545845655[image]
