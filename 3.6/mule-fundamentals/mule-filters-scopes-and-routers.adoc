...
image:/documentation/download/attachments/122751602/36Expression.png?version=1&modificationDate=1418403236557[image]
...
* *NEXT STEP*: Read on about link:/documentation/display/current/Mule+Exception+Strategies[exception strategies].
* Skip ahead to understand the structure of a link:/documentation/display/current/Mule+Message+Structure[Mule message].
* View link:/documentation/display/current/Anypoint+Exchange[examples].
