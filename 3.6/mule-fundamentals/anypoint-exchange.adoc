...
*APIs* are RAML files that describe an API's structure, they can be referenced by an link:/documentation/display/current/HTTP+Request+Connector[HTTP Request Connector] to expose metadata to Studio.
...
|image:/documentation/download/thumbnails/127107892/sync.png?version=1&modificationDate=1431371869146[image] |image:/documentation/download/thumbnails/127107892/salesforce-integration-templates-broadcast.png?version=1&modificationDate=1431371869101[image] |image:/documentation/download/thumbnails/127107892/bisync.png?version=1&modificationDate=1431371868914[image] |image:/documentation/download/thumbnails/127107892/salesforce-integration-templates-aggregate.png?version=1&modificationDate=1431371869094[image] |image:/documentation/download/thumbnails/127107892/salesforce-integration-templates-synchronize.png?version=1&modificationDate=1431371869115[image]
...
image:/documentation/download/attachments/127107892/exchange+icon.png?version=1&modificationDate=1431371868952[image]

* By searching for a connector that you don't have in your palette, and clicking *Search the Exchange for _<connector>_* : +
image:/documentation/download/attachments/127107892/exchange+search.png?version=1&modificationDate=1431371868959[image]

* Through Anypoint Studio's drop-down menu:  *File* > *New* > *Project From Template*
* On the link:/documentation/display/current/HTTP+Request+Connector[HTTP Request Connector] 's global element, through the link *Search RAML Exchange*
* Through the http://mulesoft.com/exchange[Exchange website]  +
...
image:/documentation/download/attachments/127107892/Exchange.png?version=1&modificationDate=1431371868966[image]
...
For APIs you can also view the API's link:/documentation/display/current/Engaging+Users+of+Your+API[API Portal.]
...
[NOTE]
Some connectors may be viewable via Exchange but not yet installable through it, they soon will be. If the connector you need is not yet available for installation in Exchange, you can install it using the link:/documentation/display/current/Installing+Connectors[install new software] menu.
...
+
image:/documentation/download/attachments/127107892/connector.png?version=1&modificationDate=1431371868921[image]
...
+
image:/documentation/download/attachments/127107892/on+palette.png?version=1&modificationDate=1431371869038[image]
...
+
image:/documentation/download/attachments/127107892/exchange+1.png?version=1&modificationDate=1431374151561[image]
+
...
+
image:/documentation/download/attachments/127107892/example+on+package+explorer.png?version=1&modificationDate=1431371868939[image]
...
. The example is now complete! You can deploy it to see what's its outcome, run it on link:/documentation/display/current/Studio+Visual+Debugger[debug mode] to examine what occurs with the Mule Message on each step, or modify it at will.
...
+
image:/documentation/download/attachments/127107892/exchange+2.png?version=1&modificationDate=1431374467408[image]

. You can now see this project available in your package explorer, take a look at the files it contains:
+
image:/documentation/download/attachments/127107892/package+explorer.png?version=1&modificationDate=1431371869045[image]
+
[NOTE]
...
+
image:/documentation/download/attachments/127107892/mule.env.png?version=1&modificationDate=1431371869014[image]
+
...
+
image:/documentation/download/attachments/127107892/environments.png?version=1&modificationDate=1431371868929[image] 
+
...
+
image:/documentation/download/attachments/127107892/play.png?version=1&modificationDate=1431371869053[image]

. Now your app is now ready to link:/documentation/display/current/Deploying+Mule+Applications[Deploy].

== Referencing a RAML File

When using the link:/documentation/display/current/HTTP+Request+Connector[HTTP Request Connector], you can reference a http://raml.org[RAML] file, which makes configuring the connector and the rest of your flow extremely easy. By referencing the RAML file, the connector offers you smart autocomplete options based on how the RAML file describes the available resources, methods and parameters. The metadata that the connector exposes can help you map it to other elements and reference its outputs elsewhere in the flow.
...
+
image:/documentation/download/attachments/127107892/raml+library.png?version=1&modificationDate=1431371869072[image]
...
image:/documentation/download/thumbnails/127107892/submit.png?version=1&modificationDate=1431371869139[image]
...
image:/documentation/download/attachments/127107892/publish.png?version=1&modificationDate=1431371869064[image]
...
image:/documentation/download/attachments/127107892/export.png?version=1&modificationDate=1431371868974[image]
...
+
image:/documentation/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="import2.png"]
+
...
+
image:/documentation/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="import3e.png"]
+
...
+
image:/documentation/plugins/servlet/confluence/placeholder/unknown-attachment?locale=en_GB&version=2[image,title="using1e.png"]

==== APIs

If you have a http://raml.org[RAML] definition file that describes your API, or if you have an API Portal to document it interactively, you can expose these to others in your organization using Exchange. If someone in your organization wants to connect to your API via the HTTP connector in Studio, referencing the API's RAML file exposes the API's metadata, making integration a lot easier. See the link:#AnypointExchange-raml[Reference a RAML File] section above for more information. If your API is registered in the Anypoint Platform for APIs, you can also link to its portal from the Exchange, which provides very versatile interactive tools for easing your internal user's engagement with it.
...
* Learn the different ways you can link:/documentation/display/current/Deploying+Mule+Applications[Deploy] your app.
