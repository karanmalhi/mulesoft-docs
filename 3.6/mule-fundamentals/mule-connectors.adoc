...
image:/documentation/download/thumbnails/122751603/connector.png?version=1&modificationDate=1397751792577[image]link:/documentation/display/current/Anypoint+Connectors[Anypoint Connectors] receive or send messages between Mule and one or more external sources, such as files, databases, or Web services. Connectors can act as message sources by working as inbound endpoints, they can act as a message processor that performs an operation in middle of a flow, or they can fall at the end of a flow and act as the recipient of the final payload data. 
...
image:/documentation/download/attachments/122751603/endpointbased.png?version=2&modificationDate=1420652707057[image]
...
image:/documentation/download/attachments/122751603/operationbased.png?version=2&modificationDate=1420652736714[image]
...
* *NEXT STEP*: Read on about link:/documentation/display/current/Mule+Components[components].
