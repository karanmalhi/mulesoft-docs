...
Typically, a message source comes in the form of an link:/documentation/display/current/Anypoint+Connectors[*Anypoint Connector*]. 
...
image:/documentation/download/attachments/122751595/Message+source+and+queue.png?version=1&modificationDate=1385423609106[image]
...
Under certain conditions, flows do not need to be triggered by message sources. For instance, a link:/documentation/display/current/Flow+Reference+Component+Reference[Flow Reference Component] can trigger a different flow in the same application. Similarly, the link:/documentation/display/current/Async+Scope+Reference[Async Scope] can trigger a another flow that executes asynchronously, (i.e. in parallel with the originating flow).
...
image:/documentation/download/attachments/122751595/request+response+endpoints.png?version=1&modificationDate=1385423609149[image]
...
image:/documentation/download/attachments/122751595/processing+strategies.png?version=1&modificationDate=1385423609116[image]

For further details, see link:/documentation/display/current/Flow+Processing+Strategies[Flow Processing Strategies].
...
Studio provides four pre-packaged error handling strategies to handle exceptions thrown at various points during the message processing sequence. For details, see link:/documentation/display/current/Error+Handling[Error Handling].
...
image:/documentation/download/attachments/122751595/catalog-flow-schematic-2.png?version=1&modificationDate=1385423609024[image]
...
image:/documentation/download/attachments/122751595/mule+application+architecture.png?version=1&modificationDate=1418397646638[image]
...
* call various other link:/documentation/display/current/Flows+and+Subflows[flows]  +

== See Also

* *NEXT STEP:* Learn about how link:/documentation/display/current/Flows+and+Subflows[flows and subflows] work together in an application.
* Examine an link:/documentation/display/current/Flow+Architecture+Advanced+Use+Case[advanced use case] showing a more complex flow architecture.
