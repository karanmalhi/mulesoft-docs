...
image:/documentation/download/attachments/122751590/full+flow.png?version=1&modificationDate=1418135401396[image]
...
+
image:/documentation/download/attachments/122751590/add+component.png?version=1&modificationDate=1418135832074[image]
+
image:/documentation/download/attachments/122751590/add+component2.png?version=1&modificationDate=1418135851830[image]
+
image:/documentation/download/attachments/122751590/add+component3.png?version=1&modificationDate=1418135873539[image]
+
...
+
image:/documentation/download/attachments/122751590/add+component4.png?version=1&modificationDate=1418135901904[image]
+
. Your choice router should now match the image shown.
+
image:/documentation/download/attachments/122751590/choice+closeup.png?version=1&modificationDate=1418135921114[image]
+
[NOTE]
====
...
image:/documentation/download/attachments/122751590/Studio-CBRTutorial_step1_unconfigured_notes.png?version=1&modificationDate=1398970034772[image]
...
+
image:/documentation/download/attachments/122751590/http+long.png?version=1&modificationDate=1419019130826[image]
+
...
+
image:/documentation/download/attachments/122751590/global+element.png?version=1&modificationDate=1418143567983[image]
[cols=",",options="header",]
|===
|Field |Value
...
image:/documentation/download/attachments/122751590/filter+new.png?version=1&modificationDate=1418220960582[image]
...
image:/documentation/download/attachments/122751590/set+variable.png?version=2&modificationDate=1418160820547[image]
...
+
image:/documentation/download/attachments/122751590/hola.png?version=1&modificationDate=1418148298630[image]
+
...
image:/documentation/download/attachments/122751590/bonjour.png?version=1&modificationDate=1418148323449[image]
+
...
+
image:/documentation/download/attachments/122751590/set+english.png?version=2&modificationDate=1418160806672[image]
+
...
+
image:/documentation/download/attachments/122751590/hello.png?version=1&modificationDate=1418148363774[image]
+
...
image:/documentation/download/attachments/122751590/logger.png?version=1&modificationDate=1418149728135[image]
...
+
image:/documentation/download/attachments/122751590/cbr-deploy-readout.png?version=1&modificationDate=1398973201949[image]
...
+
image:/documentation/download/attachments/122751590/CBRtutorial_addlogger.png?version=1&modificationDate=1398970034601[image]
+
[tabs]
------
[tab,title="Studio Visual Editor"]
...
Click the *Logger* to open its Properties Editor, then configure as per the table below.
+
image:/documentation/download/attachments/122751590/cbrlogger2.png?version=1&modificationDate=1398973376374[image] +
+
[cols=",",options="header",]
|=====
|Field |Value
...
+
image:/documentation/download/attachments/122751590/CBR-extracttosubflow.png?version=1&modificationDate=1398970034529[image]
...
+
image:/documentation/download/attachments/122751590/AddaSubflow.png?version=2&modificationDate=1418160990408[image]
...
+
image:/documentation/download/attachments/122751590/altaddsubflow1.png?version=2&modificationDate=1418161194970[image]
...
+
image:/documentation/download/attachments/122751590/altaddsubflow2.png?version=2&modificationDate=1418161210818[image]
...
+
image:/documentation/download/attachments/122751590/altaddsubflow3.png?version=2&modificationDate=1418161226898[image]
...
+
image:/documentation/download/attachments/122751590/configflowref.png?version=1&modificationDate=1398974513490[image]
+
...
==== image:/documentation/download/thumbnails/122751580/icon-question-blue-big%281%29.png?version=1&modificationDate=1405024031156[image] Hints
...
==== image:/documentation/download/thumbnails/122751580/icon-checkmark-blue-big%283%29.png?version=1&modificationDate=1405024031099[image] Answer
...
+
image:/documentation/download/attachments/122751590/AddRR.png?version=2&modificationDate=1418161300960[image]
+
. Drag the existing three message processors into the Round Robin scope, as shown.
+
image:/documentation/download/attachments/122751590/cbr-ec2.png?version=1&modificationDate=1398970034489[image]
+
...
+
image:/documentation/download/attachments/122751590/cbr-ec3.png?version=1&modificationDate=1398970034500[image]
+
. Press *enter* to start a new line, then paste the code twice to create three sets of processor chains. 
+
image:/documentation/download/attachments/122751590/cbr-ec4.png?version=1&modificationDate=1398970034509[image]
+
...
+
image:/documentation/download/attachments/122751590/cbr-ec5.png?version=1&modificationDate=1398970034519[image]
+
In the visual editor, the subflow looks like this:
+
image:/documentation/download/attachments/122751590/cbr-ec-subflow.png?version=1&modificationDate=1398970034457[image]
...
image:/documentation/download/attachments/122751590/Studio-stopcbrapp.png?version=1&modificationDate=1398970034939[image]
