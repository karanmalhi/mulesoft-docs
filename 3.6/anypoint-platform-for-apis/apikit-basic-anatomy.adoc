...
image:/documentation/download/attachments/122752390/basic_anatomy.png?version=1&modificationDate=1409000162741[image]
...
image:/documentation/download/attachments/122752390/apikitmainflow.png?version=1&modificationDate=1409000162736[image]
...
image:/documentation/download/attachments/122752390/APIkitconsole-tutorial.png?version=1&modificationDate=1409000162712[image]

== How it Works

The following outlines the high-level steps an APIkit-built API takes to process end user requests.

image:/documentation/download/attachments/122752390/how_it_works.png?version=1&modificationDate=1409000162754[image]
...
* Follow the link:/documentation/display/current/APIkit+Tutorial[APIkit Tutorial] to install APIkit, then build, deploy and test a REST API.
* Learn more about APIkit features and functionality in the link:/documentation/display/current/APIkit+Beyond+the+Basics[Beyond the Basics] documentation.
