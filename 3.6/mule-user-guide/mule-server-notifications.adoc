...
For a list of notification types, see link:/documentation/display/current/Notifications+Configuration+Reference[Notifications Configuration Reference]. For a list of notification listener interfaces, see link:#MuleServerNotifications-interfaces[Notification Interfaces] below.
