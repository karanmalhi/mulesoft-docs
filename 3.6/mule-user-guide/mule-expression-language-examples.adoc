...
This document assumes you are familiar with Mule Expression Language's link:/documentation/display/current/Mule+Expression+Language+Basic+Syntax[basic syntax] and are comfortable building and running Mule applications using link:/documentation/display/current/Anypoint+Studio+Essentials[Mule Studio] or XML.

If you aren't yet familiar with how to access information about the Mule messages that pass through your applications, consider following this link:/documentation/display/current/Mule+Message+Tutorial[tutorial], which walks you through both examining your Mule message and its data structure and writing simple MEL expressions.
...
+
image:/documentation/download/thumbnails/122752119/greeting+flow.png?version=1&modificationDate=1418927912908[image]
...
+
image:/documentation/download/attachments/122752119/greet2.png?version=1&modificationDate=1418938446316[image]
...
+
image:/documentation/download/attachments/122752119/greeting3.png?version=1&modificationDate=1419001403612[image] +
...
In this example, like in the previous one, the Mule application saves a CSV file with user data and returns a greeting. The call to the service includes two parameters, `username` and `age`. The service stores these two parameters and adds a third boolean parameter that evaluates if the user is above a certain age (if `age ``> 18`). In this case, however, the mapping between input and output fields and the generation of the third field is performed by a link:/documentation/display/current/Datamapper+User+Guide+and+Reference[DataMapper] component.
...
+
image:/documentation/download/attachments/122752119/greeting4.png?version=1&modificationDate=1419006774170[image]
...
+
image:/documentation/download/attachments/122752119/mel+ex+datamapper.png?version=1&modificationDate=1419008048272[image]
...
|===
+
image:/documentation/download/attachments/122752119/MELex4-input.png?version=1&modificationDate=1397167796303[image]

. For the Output, click *Edit Fields*, then give the output a *Name*, select a *Delimiter*, and create three fields, as shown: 
+
image:/documentation/download/attachments/122752119/MELex4-output.png?version=1&modificationDate=1397167796316[image]
...
+
image:/documentation/download/attachments/122752119/mel+ex+datamapper2.png?version=1&modificationDate=1419012267687[image]
...
. In a new flow, drag an HTTP connector, followed by an Expression Component, a Set Payload transformer, a File endpoint, and another Set Payload transformer. +
 image:/documentation/download/attachments/122752119/greeting+5.png?version=1&modificationDate=1419014275725[image]
...
+
image:/documentation/download/attachments/122752119/greeting+6.png?version=1&modificationDate=1419014318671[image]
...
* Access the Mule Expression Language link:/documentation/display/current/Mule+Expression+Language+Reference[Reference] and link:/documentation/display/current/Mule+Expression+Language+Tips[Tips].
* Want to learn more about how to get information about the Mule message so that you can work with it using MEL? Try out this link:/documentation/display/current/Mule+Message+Tutorial[tutorial]. 
