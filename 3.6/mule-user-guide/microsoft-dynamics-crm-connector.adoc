...
image:/documentation/download/attachments/124487132/CRMGlobalElementProps.png?version=1&modificationDate=1426305803972[image]
...
image:/documentation/download/attachments/124487132/CRMdemoflow1.png?version=1&modificationDate=1426305803957[image]
...
+
image:/documentation/download/attachments/124487132/HTTPconfigref.png?version=1&modificationDate=1426305804001[image]

. Set *localhost*, port *localhost* and path to *query*
+
image:/documentation/download/attachments/124487132/MSDyCRMHTTPconfig.png?version=1&modificationDate=1426305804030[image]
...
+
image:/documentation/download/attachments/124487132/CRMConfigRef.png?version=1&modificationDate=1426305803869[image]
...
. Specify your access to the CRM server: *Username*, *Password*, *Organization Service URL*, and *Authentication Scheme*. Click *OK* - See link:#MicrosoftDynamicsCRMConnector-crmauth[CRM Authentication] for information on each authentication scheme. +
 image:/documentation/download/attachments/124487132/CRMproperties.png?version=1&modificationDate=1426305803980[image]
...
image:/documentation/download/attachments/124487132/CRMQueryBuilder.png?version=1&modificationDate=1426305803986[image]
