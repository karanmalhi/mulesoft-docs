...
image:/documentation/download/attachments/122751350/add+request+connector.png?version=1&modificationDate=1421089782041[image]
...
image:/documentation/download/attachments/122751350/basic+request.png?version=1&modificationDate=1421159690082[image]
...
image:/documentation/download/attachments/122751350/basic+request2.png?version=1&modificationDate=1421159839169[image]

===== Minimum Configuration for the Global Element

At the very least, you need to provide a *host* and a *port*

image:/documentation/download/attachments/122751350/request+config+2.png?version=1&modificationDate=1421089782557[image]
...
image:/documentation/download/attachments/122751350/minimum.png?version=1&modificationDate=1421089782432[image]
...
image:/documentation/download/attachments/122751350/raml+library-w+data.png?version=1&modificationDate=1428336119406[image]
...
image:/documentation/download/attachments/122751350/query+params.png?version=1&modificationDate=1421089782543[image]
...
image:/documentation/download/attachments/122751350/query+params+2.png?version=1&modificationDate=1421089782499[image]
...
image:/documentation/download/attachments/122751350/uriparams.png?version=1&modificationDate=1421089782650[image]
...
image:/documentation/download/attachments/122751350/uriparams2.png?version=1&modificationDate=1421089782674[image]
...
 image:/documentation/download/attachments/122751350/headers1.png?version=1&modificationDate=1421089782409[image] +
...
image:/documentation/download/attachments/122751350/w+properties+builders.jpg?version=1&modificationDate=1421089782685[image]
...
image:/documentation/download/attachments/122751350/headers2.png?version=1&modificationDate=1421089782417[image]
...
In order to send parameters in a POST request, the payload of the Mule message should be a Map with the names and the values of the parameters to send. Hence, one way of sending form parameters in your request is adding a Set Payload element before the HTTP Request Connector to make the payload of your message equal to the form parameters you must send:
 ...
 image:/documentation/download/attachments/122751350/set+payload.jpg?version=1&modificationDate=1421089782593[image]
...
image:/documentation/download/attachments/122751350/attachments.jpg?version=1&modificationDate=1421089782087[image]
