...
* #MicrosoftServiceBusConnector-ListQueues:%C2%A0[List Queues:** **]
* #MicrosoftServiceBusConnector-UpdateQueue:[Update Queue:]
* link:#MicrosoftServiceBusConnector-DeleteQueue[Delete Queue]
* link:#MicrosoftServiceBusConnector-ServiceBusTopicObject[ServiceBusTopic Object]
* link:#MicrosoftServiceBusConnector-ServiceBusTopicDescriptionObject[ServiceBusTopicDescription Object]

link:#MicrosoftServiceBusConnector-%C2%A0CreateTopic[ Create Topic]

link:#MicrosoftServiceBusConnector-GetTopic[Get Topic]

link:#MicrosoftServiceBusConnector-ListTopics[List Topics]

link:#MicrosoftServiceBusConnector-UpdateTopic[Update Topic]

link:#MicrosoftServiceBusConnector-DeleteTopic[Delete Topic]

link:#MicrosoftServiceBusConnector-Subscriptions[Subscriptions]

* link:#MicrosoftServiceBusConnector-ServiceBusSubscriptionObject[ServiceBusSubscription Object]
* link:#MicrosoftServiceBusConnector-ServiceBusSubscriptionDescriptionObject[ServiceBusSubscriptionDescription Object]
* link:#MicrosoftServiceBusConnector-CreateSubscription[Create Subscription]
* link:#MicrosoftServiceBusConnector-Get%C2%A0Subscription[Get  Subscription]
* link:#MicrosoftServiceBusConnector-ListSubscriptions[List Subscriptions]
* link:#MicrosoftServiceBusConnector-UpdateSubscription[Update Subscription]

link:#MicrosoftServiceBusConnector-%C2%A0[ ]

link:#MicrosoftServiceBusConnector-Rules[Rules]

* link:#MicrosoftServiceBusConnector-ServiceBusRuleObject[ServiceBusRule Object]
* link:#MicrosoftServiceBusConnector-ServiceBusRuleDescriptionObject[ServiceBusRuleDescription Object]
* link:#MicrosoftServiceBusConnector-ServiceBusRuleFilterObject[ServiceBusRuleFilter Object]
* link:#MicrosoftServiceBusConnector-ServiceBusRuleActionObject[ServiceBusRuleAction Object]
* link:#MicrosoftServiceBusConnector-CreateRule[Create Rule]
* link:#MicrosoftServiceBusConnector-%C2%A0GetRule[ Get Rule +
 ]
* link:#MicrosoftServiceBusConnector-ListRules[List Rules]
* link:#MicrosoftServiceBusConnector-%C2%A0UpdateRule[ Update Rule +
 ]
* link:#MicrosoftServiceBusConnector-DeleteRule[Delete Rule]

link:#MicrosoftServiceBusConnector-SeeAlso[See Also]
...
*Release Notes:* link:/documentation/display/current/Microsoft+Service+Bus+Connector+Release+Notes[Microsoft Service Bus Connector Release Notes]
...
image:/documentation/download/attachments/123338810/demo+flow.png?version=2&modificationDate=1423160020993[image]

. Drag an HTTP connector into the canvas, and click to open the properties editor console.
. Click the green plus symbol: +
 +
 image:/documentation/download/attachments/123338810/DotNetHTTP0.png?version=1&modificationDate=1422373241911[image]
...
image:/documentation/download/attachments/123338810/DotNetHTTP1.png?version=1&modificationDate=1422373798666[image]
 +
...
. Click the Connection Configuration green arrow image:/documentation/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)]: +
 ...
 +
 image:/documentation/download/attachments/123338810/ServiceBusGeneral.png?version=1&modificationDate=1423104042643[image] +

. Click the Service Bus type: +
 +
 image:/documentation/download/attachments/123338810/ServiceBusGlobalType.png?version=1&modificationDate=1423104100957[image] +

 +
  +
.  Azure Service Bus: +
 +
 image:/documentation/download/attachments/123338810/ServiceBusAzure.png?version=1&modificationDate=1423104345753[image] +
...
image:/documentation/download/attachments/123338810/ServiceBusWindowsGen.png?version=1&modificationDate=1423104749676[image]
[cols=",",options="header",]
|===
|Field |Description
|*Name* |Enter a name for the global element.
...
+
image:/documentation/download/attachments/123338810/Service+Bus+Config.png?version=1&modificationDate=1422451852085[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
* *Author* (String)
* *Link* (String)
* *Topic Descriptio*n (ServiceBusTopicDescription)
...
* Learn more about the Microsoft Service Bus connector in the link:/documentation/display/current/Microsoft+Service+Bus+Connector+FAQ[Microsoft Service Bus Connector FAQ].
* For code samples that illustrate more advanced scenarios, refer to link:/documentation/download/attachments/123338810/service-bus-connector-samples.zip?version=1&modificationDate=1422537297705[service-bus-connector-samples.zip].
* Learn how to link:/documentation/display/35X/Installing+Connectors[Install and Configure Anypoint Connectors] in Anypoint Studio.
