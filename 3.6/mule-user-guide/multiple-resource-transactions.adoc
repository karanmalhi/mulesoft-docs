...
Refer to link:/documentation/display/current/Transaction+Management[Transaction Management] for details on how to configure a Multiple Resource transaction.
