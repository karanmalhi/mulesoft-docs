...
Follow the detailed steps to link:/documentation/display/current/Installing+Connectors[install Anypoint Connectors] on your instance of Studio, then proceed to the sections below to learn how to use multiple versions of connectors in Studio.
...
This document assumes basic familiarity with link:/documentation/display/current/Anypoint+Connectors[Anypoint Connectors] in Mule. Further, it assumes you have followed the instructions to link:/documentation/display/current/Installing+Connectors[install one or more versions of an Anypoint Connector] on your instance of Studio, and now wish to use the connectors in your Studio applications.
...
+
image:/documentation/download/attachments/122752028/multversions.png?version=1&modificationDate=1373655787812[image] +
...
[TIP]
Studio does not support the ability to change the connector version in your project by manually editing the** **`mule-project.xml` file. Follow the link:#WorkingwithMultipleVersionsofConnectors-SelectingaVersionofaConnector[procedure above] to instruct Studio to use a particular version of a connector; use the link:#WorkingwithMultipleVersionsofConnectors-ChangingYourConnectorVersionPreferences[procedure below] to adjust the version after you have made a selection.
...
+
image:/documentation/download/attachments/122752028/CCpreferences.png?version=1&modificationDate=1398111253609[image]
...
+
image:/documentation/download/thumbnails/122752028/remove_library1.png?version=1&modificationDate=1389289552262[image]
...
+
image:/documentation/download/attachments/122752028/AddCCdependencies.png?version=1&modificationDate=1398111342799[image]

. Check the boxes associate with the connector dependencies you wish to add to your project's classpath.
+
image:/documentation/download/attachments/122752028/addlibrary2.png?version=1&modificationDate=1398111477056[image]
...
+
image:/documentation/download/attachments/122752028/CCprefs-old.png?version=1&modificationDate=1398111626116[image]

== See Also

* To learn more about installing connectors, extensions, and plugins in Anypoint Studio, access link:/documentation/display/current/Installing+Connectors[Installing Connectors].
* Learn more about link:/documentation/display/current/Anypoint+Connectors[Anypoint Connectors] in Mule.
