...
Mule artifacts use a particular type of classloaders that provide a way to change the link:/documentation/display/current/Classloader+Control+in+Mule[default classloading behaviour.] By default, these fine grain classloaders behave using a parent first schema, but they can be configured  to define how specific classes and packages have to managed during the classloading process.
...
image:/documentation/download/attachments/125305363/chart.png?version=1&modificationDate=1427815677958[image]
