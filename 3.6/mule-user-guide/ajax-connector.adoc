...
image:/documentation/download/attachments/122752083/Studio-ajax-gen.png?version=1&modificationDate=1397944108572[image]
...
image:/documentation/download/attachments/122752083/Studio-ajax-outbound-adv.png?version=1&modificationDate=1397944345561[image]
...
image:/documentation/download/attachments/122752083/Studio-ajax-trans.png?version=1&modificationDate=1397944779612[image]
...
* For details on setting the properties for an Ajax endpoint using an XML editor, see the link:/documentation/display/current/AJAX+Transport+Reference[Ajax Transport Reference] discussion in the Mule ESB User Guide.
