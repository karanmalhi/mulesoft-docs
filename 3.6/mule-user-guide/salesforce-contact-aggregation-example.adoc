...
image:/documentation/download/attachments/122752072/contact_aggr_flows.png?version=1&modificationDate=1395415422032[image]
...
....
image:/documentation/download/attachments/122752072/gatherDataFlow.png?version=1&modificationDate=1395416092399[image]
....
...
|*Display Name* |`query all contacts from SalesForce instance A` .6+|image:/documentation/download/attachments/122752072/sfdcconfiguration1.png?version=1&modificationDate=1398120171417[image]
...
|*Name* |`SalesforceA` .18+|image:/documentation/download/attachments/122752072/SFglobalelem.png?version=1&modificationDate=1395421611509[image]
...
|===
|Parameter |Value |Properties Editor
|*Max active* |`5` .7+|image:/documentation/download/attachments/122752072/SFglobalelem-connpooltab.png?version=1&modificationDate=1395423173404[image]
|*Max idle* |`5`
...
|===
|Parameter |Value |Properties Editor
|*Do not use a Reconnection strategy* |Checked .2+|image:/documentation/download/attachments/122752072/SFglobalelem-reconntab.png?version=1&modificationDate=1395423366114[image]
