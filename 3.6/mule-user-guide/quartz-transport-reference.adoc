...
* See the link:/documentation/display/current/Quartz+Connector[Quartz Connector] for details on setting the properties for a Quartz endpoint in Studio's visual editor.
