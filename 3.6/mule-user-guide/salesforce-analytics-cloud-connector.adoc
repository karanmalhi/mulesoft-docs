...
+
image:/documentation/download/attachments/126387376/PS_0001B_installing_new.png?version=1&modificationDate=1429535970165[image]

. Enter a name for your new project and leave the remaining options with their default values.
+
image:/documentation/download/attachments/126387376/newProject.jpg?version=1&modificationDate=1429539977138[image]
...
+
image:/documentation/download/attachments/126387376/global+type.jpg?version=1&modificationDate=1429548897766[image]
...
+
image:/documentation/download/attachments/126387376/basic+authentication.jpg?version=2&modificationDate=1429550894228[image]
+
[NOTE]
====
...
+
image:/documentation/download/attachments/126387376/OAuth.jpg?version=1&modificationDate=1429604508943[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Description
...
+
image:/documentation/download/attachments/126387376/oauthtab.jpg?version=1&modificationDate=1429609198506[image]
+
[width="100%,cols=",",options="header"]
|=======
|Field |Description
...
+
image:/documentation/download/attachments/126387376/connectorconfig.jpg?version=1&modificationDate=1429618837567[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Description
...
[tab,title="Studio Visual Editor"]
....
image:/documentation/download/attachments/126387376/demo+batch.jpg?version=1&modificationDate=1429621192490[image]

. Create a Mule project in your Anypoint Studio.

. Drag a Batch processor into the canvas:
+
image:/documentation/download/attachments/126387376/image04.jpg?version=1&modificationDate=1429631647902[image]

. Into the Input section of the Batch processor, drag a File connector and configure it as follows:
+
image:/documentation/download/attachments/126387376/image06.jpg?version=2&modificationDate=1429632518444[image]
+
[width="100%",cols=",",options="header"]
|====
|Field |Value
...
+
image:/documentation/download/attachments/126387376/eglobal.jpg?version=1&modificationDate=1429635800471[image]

. On the Choose Global Type window, click **Salesforce Analytics Cloud: Basic Authentication**.
+
image:/documentation/download/attachments/126387376/eglobaltype.jpg?version=1&modificationDate=1429635892780[image]

. Configure the global element properties.

. Configure the remaining parameters of the Salesforce Analytics Cloud connector:
+
image:/documentation/download/attachments/126387376/create+data+set.jpg?version=1&modificationDate=1429637205736[image]
+
[width="100%",cols=",",options="header"]
|======
|Field |Value
...
+
image:/documentation/download/attachments/126387376/MessageEnricher.jpg?version=1&modificationDate=1429634429638[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:/documentation/download/attachments/126387376/2config.jpg?version=2&modificationDate=1429639266273[image]
+
[cols=",",options="header",]
|=====
|Field |Value
...
+
image:/documentation/download/attachments/126387376/image11.jpg?version=1&modificationDate=1429640846289[image]

. In the *Source* field, select **Payload - InputStream** and click the
image:http://www.mulesoft.org/documentation/download/attachments/125305793/edit+button.png?version=1&modificationDate=1427997357552[image](Edit) button located to the right of the *Type* drop down list.

. In the *Type* field select *CSV*
+
image:/documentation/download/attachments/126387376/image12.jpg?version=1&modificationDate=1429641444825[image]

. Browse to the folder where you have the input csv file.

. Click *Create Mapping*.
+
image:/documentation/download/attachments/126387376/image13.jpg?version=1&modificationDate=1429641745036[image]
...
+
image:/documentation/download/attachments/126387376/image14.jpg?version=1&modificationDate=1429641970016[image]
...
+
image:/documentation/download/attachments/126387376/3config.jpg?version=1&modificationDate=1429642238517[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
