...
*Release Notes*: link:/documentation/display/current/CMIS+Connector+Release+Notes[CMIS Connector Release Notes]
...
* A global element for CMIS for use by all the CMIS connectors in your Mule application. For more information, see link:/documentation/display/current/Global+Elements[Mule Global Elements].
...
[tab,title="Studio Visual Editor"]
....
image:/documentation/download/attachments/122752082/image017.jpg?version=1&modificationDate=1417372734065[image]

. Drag an HTTP endpoint into a new flow, and configure it as follows:
+
image:/documentation/download/attachments/122752082/http.png?version=1&modificationDate=1417372750549[image] +
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:/documentation/download/attachments/122752082/global+element.png?version=1&modificationDate=1417373132361[image]
...
+
image:/documentation/download/attachments/122752082/connector+parameters.png?version=1&modificationDate=1417373870879[image]
+
[cols=",",options="header",]
|===
|Field |Vealu
...
+
image:/documentation/download/attachments/122752082/groovy.png?version=1&modificationDate=1417516692103[image]
+
...
+
image:/documentation/download/attachments/122752082/second+cmis.png?version=1&modificationDate=1417415590972[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:/documentation/download/attachments/122752082/ObjecttoJson.png?version=1&modificationDate=1417520054746[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
* Learn about link:/documentation/display/current/Endpoint+Configuration+Reference[Configuring Endpoints] 
