...
] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jms/namespace-overview.html[SchemaDoc] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image](client ack, local, XA) |image:http://www.mulesoft.org/documentation/images/icons/emoticons/error.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |one-way, request-response |one-way |org.mule.transport:mule-transport-jms
...
* Supports local (JMS), distributed (XA), and multi-resource link:/documentation/display/current/Transaction+Management[transactions]  _*Enterprise*_
...
*WebSphere MQ*
 ...
 _*Enterprise*_
Mule Enterprise includes an link:/documentation/display/current/Mule+WMQ+Transport+Reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
...
For performance it is important to use the "Caching Connection Strategy" between your JMS Connector and the actual JMS ConnectionFactory implementation. For more information, see "link:#JMSTransportReference-Cachingconnectionfactory[Caching connection factory]" below.
====
...
http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has link:/documentation/display/current/ActiveMQ+Integration[simplified configuration].
...
* link:/documentation/display/current/HornetQ+Integration[HornetQ]
* link:/documentation/display/current/Open+MQ+Integration[Open MQ]
* link:/documentation/display/current/Solace+JMS[Solace JMS]
* link:/documentation/display/current/Tibco+EMS+Integration[Tibco EMS]
