...
*Release Notes:* link:/documentation/display/current/DotNet+Connector+Release+Notes[DotNet Connector Release Notes]
...
image:/documentation/download/thumbnails/123700191/01ConnectorDotNET.png?version=1&modificationDate=1423524701769[image]
...
image:/documentation/download/attachments/123700191/demoflow.png?version=2&modificationDate=1423527801169[image]

The Set Payload transformer generates the JSON content and sets it as the payload of the Mule message:

image:/documentation/download/attachments/123700191/Setpayload.png?version=1&modificationDate=1423525156544[image]
...
image:/documentation/download/attachments/123700191/public+object.png?version=1&modificationDate=1423525185471[image]

Specify the name of the .NET method you want to invoke:

image:/documentation/download/attachments/123700191/DOTNET+Method.png?version=1&modificationDate=1423525216468[image]
...
+
image:/documentation/download/attachments/123700191/MessageObject.png?version=1&modificationDate=1423525252364[image]
...
image:/documentation/download/attachments/123700191/public+object+execute+complex.png?version=2&modificationDate=1423525405347[image]
...
image:/documentation/download/attachments/123700191/xml+data+tp+dotnet+connector.png?version=2&modificationDate=1423530463962[image]

The .NET connector is configured to invoke the *ExecuteXml* method. The following shows the method’s signature:

image:/documentation/download/attachments/123700191/public+object+execute+xml.png?version=1&modificationDate=1423525766761[image]
...
image:/documentation/download/attachments/123700191/set+property.png?version=1&modificationDate=1423525370849[image] +
...
image:/documentation/download/attachments/123700191/datamapper+support.png?version=2&modificationDate=1423528941776[image]

Example for a complex mapping:

image:/documentation/download/attachments/123700191/complex+mapping.png?version=1&modificationDate=1423526208747[image]
...
image:/documentation/download/attachments/123700191/full+trust.png?version=1&modificationDate=1423526261029[image]
...
image:/documentation/download/attachments/123700191/execute+scope.png?version=1&modificationDate=1423526338800[image]
...
image:/documentation/download/attachments/123700191/transform+dll+config.png?version=1&modificationDate=1423526304393[image]
...
+
image:/documentation/download/attachments/123700191/assembly+reference.png?version=1&modificationDate=1423526419574[image]
...
A Mule link:/documentation/display/current/Global+Elements[Global Element] allows you to define connector parameters once, then reference the same set of parameters from any number of individual connectors in your application. In this example, we create a .NET global element which will be referenced by the .NET connector in our application's flow.
...
+
image:/documentation/download/attachments/123700191/GAC.png?version=1&modificationDate=1423526464985[image]
+
...
+
image:/documentation/download/attachments/123700191/Legacy.png?version=1&modificationDate=1423526497278[image]
+
...
+
image:/documentation/download/attachments/123700191/External+Assembly+1.png?version=1&modificationDate=1423526546214[image]
+
[width="50%",cols=",",options="header"]
|===
|Parameter |Value
...
image:/documentation/download/attachments/123700191/project+resource.png?version=1&modificationDate=1423526571150[image]
+
[width="50%",cols=",",options="header"]
|===
|Parameter |Value
...
image:/documentation/download/attachments/123700191/datasense+support.png?version=1&modificationDate=1423526600179[image]
...
* Learn more about the DotNet connector in the link:/documentation/display/current/DotNet+Connector+FAQs[DotNet Connector FAQs].
