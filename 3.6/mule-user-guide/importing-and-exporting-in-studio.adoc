...
image:/documentation/download/attachments/122752250/import.png?version=1&modificationDate=1405028180655[image]
...
image:/documentation/download/attachments/122752250/exporting.png?version=1&modificationDate=1405028180647[image]

[cols=",",options="header"]
|===
|Option |Description
|*Anypoint Studio Project to Mule Deployable Archive* |Export a Mule project to a .zip file.
|*Mule extension Update Site* |Specific to link:/documentation/display/current/Anypoint+Connector+DevKit[DevKit] connector extension projects, this option allows you to export the project to an update website. This option only appears if you have installed the DevKit plugin for Anypoint Studio.
|*Mule Project to CloudHub* |Publish your project to link:/documentation/display/current/CloudHub[CloudHub] in order to deploy on the cloud.
|*Publish to Application Repository* |Publish your project to the link:/documentation/display/current/MMC+Walkthrough[Mule Management Console] application repository.
|===
...
+
*image:/documentation/download/attachments/122752250/export+documentation.png?version=1&modificationDate=1419950907314[image]*
...
+
image:/documentation/download/attachments/122752250/exported+doc.png?version=1&modificationDate=1419951238724[image]

== See Also

* Explore a few link:/documentation/display/current/Anypoint+Exchange[example applications] in Anypoint Studio.
* Read about link:/documentation/display/current/Importing+a+Maven+Project+into+Studio[Importing a Maven Project into Studio].
* Find out more about link:/documentation/display/current/Enabling+Maven+Support+for+a+Studio+Project[Enabling Maven Support for a Studio Project].
