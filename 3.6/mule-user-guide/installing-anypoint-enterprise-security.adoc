...
+
image:/documentation/download/attachments/122752335/security_palette.png?version=1&modificationDate=1367967554899[image]
...
* You are using Mule ESB with a valid Enterprise license. (Learn more about link:/documentation/display/current/Installing+an+Enterprise+License[installing an Enterprise licence] on your existing instance of Mule.)
...
* Refer to the link:/documentation/display/current/Anypoint+Enterprise+Security+1.2+Release+Notes[Anypoint Enterprise Security Release Notes] for details about what is included with version 1.2.
