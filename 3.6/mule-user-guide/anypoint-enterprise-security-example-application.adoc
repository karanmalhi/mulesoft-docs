...
This document assumes that you have link:/documentation/display/current/Installing+Anypoint+Enterprise+Security[installed the Anypoint Enterprise Security] extensions.

It also assumes you are familiar with the link:/documentation/display/current/Anypoint+Studio+Essentials[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more link:/documentation/display/current/First+Day+with+Mule[Anypoint Studio Tutorials].
...
+
image:/documentation/download/attachments/122752330/full+example+flow.png?version=1&modificationDate=1420813429492[image]
...
image:/documentation/download/attachments/122752330/example+signature+1.png?version=1&modificationDate=1420814985043[image]
...
image:/documentation/download/attachments/122752330/global_signature.png?version=1&modificationDate=1399071796673[image]
...
image:/documentation/download/attachments/122752330/encrypt1.png?version=1&modificationDate=1399071875173[image]
...
+
image:/documentation/download/attachments/122752330/global_XML_encrypt.png?version=1&modificationDate=1367968577270[image]
...
image:/documentation/download/attachments/122752330/get_cc_info_response.png?version=1&modificationDate=1367968577155[image]
...
image:/documentation/download/attachments/122752330/decrypt1.png?version=1&modificationDate=1399071973747[image]
...
image:/documentation/download/attachments/122752330/get_secret_file_response.png?version=1&modificationDate=1367968577197[image]

== See Also

* For more information on encryption in Mule, refer to link:/documentation/display/current/Mule+Message+Encryption+Processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, refer to link:/documentation/display/current/Mule+Digital+Signature+Processor[Mule Digital Signature Processor].
