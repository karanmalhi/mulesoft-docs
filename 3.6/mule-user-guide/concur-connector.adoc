...
* A consumer key assigned by Concur; refer to the detailed documentation on how to link:/documentation/display/current/Using+a+Connector+to+Access+an+OAuth+API[use the Concur connector to access an OAuth API].

*Release Notes*: link:/documentation/display/current/Concur+Connector+Release+Notes[Concur Connector Release Notes]
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. (Read more about link:/documentation/display/current/Installing+an+Enterprise+License[Installing an Enterprise License].)

== Configuring the Concur Connector

To use the Concur connector in your Mule application, you must configure:

* A global Concur element that is used by all the Concur connectors in the application (read more about link:/documentation/display/current/Global+Elements[global elements in Mule]).
...
+
image:/documentation/download/attachments/122752036/ConcurGlobalElementProps.png?version=1&modificationDate=1408487288982[image]
+
...
|===
+
image:/documentation/download/attachments/122752036/ex2.png?version=1&modificationDate=1401914014564[image]
+
[NOTE]
====
...
|===
+
image:/documentation/download/attachments/122752036/conc1.png?version=1&modificationDate=1401997668028[image]
...
|====
+
image:/documentation/download/attachments/122752036/ex3.png?version=1&modificationDate=1401914770277[image]
...
|====
+
image:/documentation/download/attachments/122752036/ex4.png?version=1&modificationDate=1401914899272[image]
...
|====
+
image:/documentation/download/attachments/122752036/conc2.png?version=1&modificationDate=1401997817902[image]
...
|===
+
image:/documentation/download/attachments/122752036/conc3.png?version=1&modificationDate=1401997860475[image]
...
* Access the link:/documentation/display/current/Concur+Connector+Release+Notes[release notes] for the Concur Connector.
