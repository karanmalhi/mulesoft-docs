...
A choice flow control uses link:/documentation/display/current/Mule+Expression+Language+MEL[expressions] to evaluate the content of a message, then it routes the message to one of the *routing options* within its scope (see image below). It directs messages to the first routing option in the scope that matches the routing configurations (evaluates to true). If none of expressions evaluate to true, the choice flow control directs the message to the *default* (`else`) route.

image:/documentation/download/attachments/122752239/Choice_schematic.png?version=1&modificationDate=1366822104596[image]
...
....
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of link:/documentation/display/current/Elements+in+a+Mule+Flow[building blocks] that form the flow (below). 

image:/documentation/download/attachments/122752239/choice+flow+2.png?version=2&modificationDate=1420471776172[image]
....
...
+
image:/documentation/download/attachments/122752239/Studio_Choice_routingoptions.png?version=3&modificationDate=1425603493315[image]
...
+
image:/documentation/download/attachments/122752239/ChoiceClickHere.png?version=1&modificationDate=1425613790764[image]

. In the Route Properties dialog, enter: `#[flowVars.language == 'Spanish']`
+
image:/documentation/download/attachments/122752239/ChoiceRouteProperties.png?version=1&modificationDate=1425613989518[image]
...
+
image:/documentation/download/attachments/122752239/Studio_Choice_default_routeproperties.png?version=1&modificationDate=1366828420905[image]
...
+
image:/documentation/download/attachments/122752239/HolaAmigos.png?version=1&modificationDate=1425676240023[image]
...
+
image:/documentation/download/attachments/122752239/VarSetLangToEnv.png?version=1&modificationDate=1426540637793[image]
...
+
image:/documentation/download/attachments/122752239/SetPayLoadEnglish.png?version=1&modificationDate=1426540796238[image] 
...
+
image:/documentation/download/attachments/122752239/choice+select+default+1.png?version=1&modificationDate=1420473398394[image]

. Check the *Otherwise* box (see below), then click *OK*.
+
image:/documentation/download/attachments/122752239/select+default.png?version=1&modificationDate=1420473562252[image]
...
+
image:/documentation/download/attachments/122752239/select+default+2.png?version=1&modificationDate=1420473583881[image]
...
image:/documentation/download/attachments/122752239/FinalFlow.png?version=1&modificationDate=1425607739645[image]

== See Also

* For more information on the Choice Flow Control, see the link:/documentation/display/current/Routers[Choice] section on the Routing Message Processors page.
