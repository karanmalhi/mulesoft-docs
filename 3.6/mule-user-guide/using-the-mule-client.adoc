...
* link:#UsingtheMuleClient-UsingSendandDispatch[Using Send and Dispatch]
* link:#UsingtheMuleClient-ConfiguringtheMuleClient[Configuring the Mule Client]
* link:#UsingtheMuleClient-MuleClientasaWebServicesClient[MuleClient as a Web Services Client]
* link:#UsingtheMuleClient-PerforminganEventRequestCall[Performing an Event Request Call]
* link:#UsingtheMuleClient-AssociatingPropertieswiththeMessage[Associating Properties with the Message]
* link:#UsingtheMuleClient-WhenNottoUsetheMuleClient[When Not to Use the Mule Client]
* link:#UsingtheMuleClient-HandlingMessageCollections[Handling Message Collections]
* link:#UsingtheMuleClient-FutureResults[Future Results]
* link:#UsingtheMuleClient-UsingtheRemoteDispatcher[Using the Remote Dispatcher]
* link:#UsingtheMuleClient-SendingMessagestoComponentsDirectly[Sending Messages to Components Directly]
...
. The Mule URL endpoint: any valid link:/documentation/display/current/Mule+Endpoint+URIs[Mule Endpoint] used to determine the transport, endpoint, and other information about delivery of the message. This can also be an endpoint name stored in configuration.
...
For SOAP support, you can use the Mule link:/documentation/display/current/CXF+Module+Reference[CXF Module Reference].
...
If you do not set the wire format, the serialization format is used. For more information on transformers, see link:/documentation/display/current/Using+Transformers[Using Transformers].
