...
Mule 3.6.0 and later versions provide basic support for version 3.0 of the spec. This means that any feature of the spec is supported as long as it doesn't rely on schema awareness, high order functions, or streaming.
