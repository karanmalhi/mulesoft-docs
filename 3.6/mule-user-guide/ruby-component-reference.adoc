...
[TIP]
====
Placing a Ruby Component is actually the same as placing a link:/documentation/display/current/Script+Component+Reference[Script component] and then selecting the Ruby engine.
====
...
image:/documentation/download/attachments/122752212/ruby_general.png?version=1&modificationDate=1398893677686[image]
...
image:/documentation/download/attachments/122752212/ruby_advanced.png?version=1&modificationDate=1398893795183[image]
