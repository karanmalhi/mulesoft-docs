...
This type of bridge can be combined with filters for easy message routing. For fast XPath routing of messages, you can use the link:/documentation/display/current/SXC+Module+Reference[SXC Module Reference].

Alternatively, you can use link:/documentation/display/current/Bridge+Pattern[Bridge Pattern].
...
See the link:/documentation/display/current/Proxying+Web+Services+with+CXF[Proxying Web Services with CXF] for more details.
