...
* See how to configure the link:/documentation/display/current/HTTP+Connector[HTTP Connector]
* See how link:/documentation/display/current/Authentication+in+HTTP+Requests[authentication] works in the HTTP Connector
* Refer to the link:/documentation/display/current/HTTPS+Transport+Reference[deprecated HTTPS Transport]
