...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a link:/documentation/display/current/Java+Component+Reference[Java Component] that works very similarly.

image:/documentation/download/attachments/122752211/basic+conf.png?version=1&modificationDate=1416579825255[image]
...
image:/documentation/download/attachments/122752211/advanced+conf.png?version=1&modificationDate=1416579846071[image]
...
* Read more about the link:/documentation/display/current/JavaScript+Component+Reference[JavaScript Component]
* Read more about the link:/documentation/display/current/Ruby+Component+Reference[Ruby Component]
* Read more about the link:/documentation/display/current/Groovy+Component+Reference[Groovy Component]
* Read more about the link:/documentation/display/current/Python+Component+Reference[Python Component]
* Read more about the link:/documentation/display/current/Java+Component+Reference[Java Component]
