...
image:/documentation/download/attachments/122752029/Studio-file-gen.png?version=1&modificationDate=1397945886019[image]

*Outbound endpoint:*

image:/documentation/download/attachments/122752029/outb_general_tab.png?version=1&modificationDate=1420831329994[image]
...
image:/documentation/download/attachments/122752029/Studio-file-adv.png?version=1&modificationDate=1397946858621[image]
...
image:/documentation/download/attachments/122752029/Studio-file-trans.png?version=1&modificationDate=1397947051930[image]
...
See the link:/documentation/display/current/File+Transport+Reference[File Transport Reference] for details on setting the properties for a File endpoint using an XML editor.
