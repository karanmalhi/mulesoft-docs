...
+
image:/documentation/download/thumbnails/122752068/pack_explorer.png?version=1&modificationDate=1405096093321[image]
....
...
|===
|Attribute, required |Use |Properties Editor
|*Name* |Use to define unique identifier for the global Database Connector element in your application. .6+|image:/documentation/download/attachments/122752068/global_elem-generic_DB-gral_tab.png?version=1&modificationDate=1405006923581[image]
...
|Attribute, Optional |Use |Properties Editor
3+|*General tab*
|*Enable DataSense* |Use to "turn on" DataSense, which enables Mule to make use of message metadata during design time. Default: `true`. |image:/documentation/download/attachments/122752068/config_enable_DS.png?version=1&modificationDate=1405006923492[image]
3+|*Advanced tab*
...
|*Use XA Transactions* |Enable to indicate that the created datasource must support extended architecture (XA) transactions. Default: `false`. |image:/documentation/download/attachments/122752068/use_XA_transact.png?version=1&modificationDate=1405006923681[image]
|===
....
