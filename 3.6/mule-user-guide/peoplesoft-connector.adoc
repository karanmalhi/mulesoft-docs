...
*Release Notes:* link:/documentation/display/current/PeopleSoft+Connector+Release+Notes[PeopleSoft Connector Release Notes].
...
image:/documentation/download/attachments/124879388/CI+archtecture.jpg?version=1&modificationDate=1426761562696[image]
...
. In Studio, select *File* > *New* > *Mule Project*. +
 image:/documentation/download/attachments/124879388/PS_0001B_installing_new.png?version=1&modificationDate=1426775322237[image] +
...
. Enter a name for your new project and leave the remaining options with their default values. Make sure the *Use Maven* option is not selected. +
 image:/documentation/download/attachments/124879388/PS_0001_installing.png?version=1&modificationDate=1426773683357[image] +

. Select the *Create a .gitignore file* check box.
. Click *Next* to verify that Java 1.7 is set as your default JRE. +

+
image:/documentation/download/attachments/124879388/JRE1.7.png?version=5&modificationDate=1427741933468[image]
+
  
...
+
[WARNING]
 If the *Use Maven* option is inactive, displaying the _Maven is currently disabled, *configure Maven*_ message, click the *Configure Maven* link to browse and select the *Maven installation home directory* on your local drive. link:/documentation/display/current/Maven+Support+in+Anypoint+Studio[Learn more about setting your Maven preferences in Anypoint Studio].
+
image:/documentation/download/attachments/124879388/PS_0001C_installing_maven.png?version=1&modificationDate=1426775509677[image]
...
To use the PeopleSoft connector in your Mule application, you must configure a global PeopleSoft element that can be used by all the PeopleSoft connectors in the application (read more about link:/documentation/display/current/Global+Elements[global elements]).
...
  image:/documentation/download/attachments/124879388/ConnectorCfgPS.png?version=1&modificationDate=1427637784358[image]

. Click *Ok*.
. Configure the parameters according to instructions below. +
image:/documentation/download/attachments/124879388/PS_0002_globalelement.png?version=2&modificationDate=1426878046701[image]
+
[width="100%",cols="50%,50%",options="header",]
|===
|Field |Description
...
image:/documentation/download/attachments/124879388/PS_0003_globalelement_success.png?version=1&modificationDate=1426773981957[image]

After the psjoa.jar file is attached, it appears in the lib/peoplesoft directory of your project's root folder.

image:/documentation/download/thumbnails/124879388/PS_0004_globalelement_libsfolder.png?version=1&modificationDate=1426774083973[image]
...
image:/documentation/download/attachments/124879388/PS_0005_globalelement_invalidlibs.png?version=1&modificationDate=1426774171733[image]
...
+
image:/documentation/download/attachments/124879388/PS_0006_globalelement_whitelist.png?version=3&modificationDate=1427741627881[image] 

.. On the pop-up window, select the (+) plus button to set the names of your component interfaces.
+
image:/documentation/download/attachments/124879388/PS_0007_globalelement_whitelist2.png?version=1&modificationDate=1426774344858[image]

.. Right-click a metadata item and click *Edit the selected metadata field* to enter the values. +
 image:/documentation/download/attachments/124879388/Edit+Meta+Data.png?version=1&modificationDate=1426883630928[image]
...
+
image:/documentation/download/attachments/124879388/configparameters.jpg?version=1&modificationDate=1426866499786[image]
+
[width="100%",cols="50%,50%",options="header",]
|===
|Field |Description
...
image:/documentation/download/attachments/124879388/Sampleflow.jpg?version=1&modificationDate=1426761562756[image]
...
. Access PeopleSoft connectorlink:/documentation/display/current/PeopleSoft+Connector+Release+Notes[release notes].
