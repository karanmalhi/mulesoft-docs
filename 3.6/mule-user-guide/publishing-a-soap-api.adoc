...
image:/documentation/download/attachments/122752042/SOAP-flow1.png?version=1&modificationDate=1400263533778[image]
...
image:/documentation/download/attachments/122752042/CXF-1.png?version=1&modificationDate=1400263982600[image]

image:/documentation/download/attachments/122752042/CXF-2.png?version=1&modificationDate=1400263998482[image]
...
+
image:/documentation/download/attachments/122752042/basic+flow.png?version=3&modificationDate=1419967079830[image]
+
+
+
...
+
image:/documentation/download/attachments/122752042/CXF-3.png?version=1&modificationDate=1400264287239[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:/documentation/download/attachments/122752042/CXFflow2.png?version=1&modificationDate=1400264495230[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:/documentation/download/attachments/122752042/basic+flow2.png?version=3&modificationDate=1419967109160[image] +
+
...
+
image:/documentation/download/attachments/122752042/basic+flow3.png?version=1&modificationDate=1419965976630[image]
+
...
+
image:/documentation/download/attachments/122752042/CXFex2.png?version=1&modificationDate=1400265759259[image] +
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:/documentation/download/attachments/122752042/OrderAPIadv.png?version=1&modificationDate=1400265855964[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
. Configure the *CXF component* as per the image and table below. At runtime, the output of this component is a POJO.
+
image:/documentation/download/attachments/122752042/newCXForderapi.png?version=1&modificationDate=1400522030795[image] +
+
...
image:/documentation/download/attachments/122752042/newCXForderapi-genfromwsdl.png?version=1&modificationDate=1400522119095[image]
