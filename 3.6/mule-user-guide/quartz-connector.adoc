...
Note that you also have the option to use a Poll scope at the beginning of a flow, which also supports Cron expressions and watermarks. Read more about the link:/documentation/display/current/Poll+Reference[Poll scope].
====
...
image:/documentation/download/attachments/122752078/studio-quartz-gen.png?version=1&modificationDate=1397964240096[image]
...
image:/documentation/download/attachments/122752078/studio-quartz-adv.png?version=1&modificationDate=1397964258611[image]
...
image:/documentation/download/attachments/122752078/studio-quartz-trans.png?version=1&modificationDate=1397964285461[image]
...
* See the link:/documentation/display/current/Quartz+Transport+Reference[Quartz Transport Reference] for details on setting the properties for a Quartz endpoint using an XML editor.
...
* Read about the link:/documentation/display/current/Poll+Reference[Poll scope].
