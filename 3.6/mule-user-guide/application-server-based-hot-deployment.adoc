...
To deploy Mule as a service to Tomcat or Tcat Server, see link:/documentation/display/current/Deploying+Mule+as+a+Service+to+Tomcat[Deploying Mule as a Service to Tomcat].
