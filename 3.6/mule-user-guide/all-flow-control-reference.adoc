...
Access the documentation for the link:/documentation/display/current/Scatter-Gather[Scatter-Gather flow control] to take advantage of the newly-designed functionality.
====
