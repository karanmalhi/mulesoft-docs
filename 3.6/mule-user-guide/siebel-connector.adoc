...
*Release Notes*: link:/documentation/display/current/Siebel+Connector+Release+Notes[Siebel Connector Release Notes]
...
The Siebel Object Manager lets a connector use a generic interface that doesn’t depend on a customized installation. To discover the metadata of Siebel objects in design time, use link:/documentation/display/current/DataSense[DataSense] in Anypoint Studio. The Siebel connector takes advantage of the Siebel Repository to show a list of available objects as well as their structures in a Siebel custom installation.
...
image:/documentation/download/attachments/125862322/Integration+architecture.png?version=1&modificationDate=1428653537056[image]
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to arrange for either license. See also link:/documentation/display/current/Installing+an+Enterprise+License[Installing an Enterprise License].
...
+
image:/documentation/download/attachments/125862322/PS_0001B_installing_new.png?version=1&modificationDate=1428674012123[image]

. Enter a name for your new project and leave the remaining options with their default values. +
 image:/documentation/download/attachments/125862322/New+Project.png?version=1&modificationDate=1428674229509[image]
...
[NOTE]
====
If you intend to use a Siebel connector in conjunction with a link:/documentation/display/current/Datamapper+User+Guide+and+Reference[DataMapper transformer] to map and transform data, you can make use of Anypoint Studio's link:/documentation/display/current/DataSense[DataSense] functionality. You can enable DataSense as part of configuring the global element. 

* Follow the DataSense instructions to drop the transformer into your flow, then link:/documentation/display/current/Testing+Connections[test the connection] to Siebel using the Siebel connector. 
