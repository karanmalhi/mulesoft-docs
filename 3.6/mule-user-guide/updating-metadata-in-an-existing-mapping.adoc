...
image:/documentation/download/attachments/122752172/image043.png?version=1&modificationDate=1365653906238[image]
...
image:/documentation/download/attachments/122752172/image049.png?version=1&modificationDate=1365654338878[image]
...
image:/documentation/download/attachments/122752172/image046.png?version=1&modificationDate=1365654291313[image]
...
2.     In the Input pane of the DataMapper view, click the  *Infer Metadata* icon, then select  *Reload Metadata*. +
 image:/documentation/download/attachments/122752172/image047.png?version=1&modificationDate=1365654231803[image]

The Input pane in the DataMapper will now display the  `Phone` field, as shown below.

image:/documentation/download/attachments/122752172/image048.png?version=1&modificationDate=1365654264050[image]
...
image:/documentation/download/attachments/122752172/image050.png?version=1&modificationDate=1365654391055[image]
