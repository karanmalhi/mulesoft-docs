...
image:/documentation/download/attachments/122752176/image2013-4-10+11%3A13%3A18.png?version=1&modificationDate=1365617596994[image]

NOTE: All data types expose an input property Error Policy, that is used to specify how to handle bad input data in the mapping. For the semantics of Error Policy, see link:/documentation/display/current/DataMapper+Input+Error+Policy+for+Bad+Input+Data[DataMapper Input Error Policy for Bad Input Data].
...
|Error Policy |Input |How to handle bad input data. See link:/documentation/display/current/DataMapper+Input+Error+Policy+for+Bad+Input+Data[DataMapper Input Error Policy for Bad Input Data] for details.
|===
