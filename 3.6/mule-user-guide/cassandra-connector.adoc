...
*Release Notes*: link:/documentation/display/current/Cassandra+Connector+Release+Notes[Cassandra Connector Release Notes]
...
* A global CassandraDB element for use by all the CassandraDB connectors in an application. For more information, see link:/documentation/display/current/Global+Elements[Mule Global Elements].
...
+
image:/documentation/download/attachments/122752088/Config.png?version=1&modificationDate=1406713924118[image]
+
...
image:/documentation/download/attachments/122752088/cassandra.png?version=1&modificationDate=1420482958559[image]
...
+
image:/documentation/download/attachments/122752088/addconfig.png?version=1&modificationDate=1406796741461[image]
...
+
image:/documentation/download/attachments/122752088/cassandra+conf+1.png?version=1&modificationDate=1420483934380[image]
+
[width="100%",cols=",",options="header"]
|=====
|Field |Value
...
* Access the link:/documentation/display/current/Cassandra+Connector+Release+Notes[CassandraDB connector release notes]. 
