...
*Release Notes*: link:/documentation/display/current/ServiceNow+Connector+Release+Notes[ServiceNow Connector Release Notes]
...
+
image:/documentation/download/attachments/122752069/snow-screen.png?version=1&modificationDate=1415175755200[image] 
...
* A global ServiceNow element to be used by all the ServiceNow connectors in the application (read more about link:/documentation/display/current/Global+Elements[global elements in Mule]).
...
+
image:/documentation/download/attachments/122752069/serviceNowge.png?version=1&modificationDate=1401832737190[image]
+
...
|*Type* |Select the ServiceNow table to act upon. For a complete list, see the link:/documentation/display/current/ServiceNow+Connector+Release+Notes[ServiceNow Release Notes].
...
+
image:/documentation/download/attachments/122752069/HTTPConnectorProperties.png?version=1&modificationDate=1407803355125[image]
...
+
image:/documentation/download/attachments/122752069/Setusername.png?version=1&modificationDate=1401898946815[image] +
+
