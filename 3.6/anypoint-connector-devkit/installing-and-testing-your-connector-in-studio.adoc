...
This document assumes you have link:/documentation/display/current/Creating+an+Anypoint+Connector+Project[created a connector project]. 
...
This command creates an update site that you can use to install the connector in Anypoint Studio. For more information about how to package your connector, check link:/documentation/display/current/Packaging+Your+Connector+for+Release[Packaging Your Connector for Release].

The *Install or Update*  feature also automatically installs your connector in Anypoint Studio.

image:/documentation/download/attachments/122752369/barn-studio-icon.png?version=1&modificationDate=1405522138818[image]
...
+
image:/documentation/download/attachments/122752369/36BarnConnector.png?version=1&modificationDate=1418955612159[image]
...
+
image:/documentation/download/attachments/122752369/config1.png?version=1&modificationDate=1405522138848[image]
+
[cols=",",options="header"]
|===
|Parameter |Value
...
+
image:/documentation/download/attachments/122752369/config.png?version=1&modificationDate=1405522138840[image]
+
. In the *My Property*, *Username*, and *Password* fields, enter any string as the value, then click *OK*. +
 +
image:/documentation/download/attachments/122752369/global-elements.png?version=1&modificationDate=1405522138867[image]
+
...
+
image:/documentation/download/attachments/122752369/browser.png?version=1&modificationDate=1405522138833[image]
...
* *NEXT STEP:* Implement link:/documentation/display/current/Authentication[authentication] on your connector.
