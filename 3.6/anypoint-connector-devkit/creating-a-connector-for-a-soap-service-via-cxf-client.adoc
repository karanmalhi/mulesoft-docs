...
* This document provides two ways of developing a SOAP connector – link:#CreatingaConnectorforaSOAPServiceViaCXFClient-CreateSOAPConnector[Creating a SOAP Connector] creates a connector using the Mule 3.5.2 and later WSDL-to-connector approach. The second approach uses WSDL2Java and starts with link:#CreatingaConnectorforaSOAPServiceViaCXFClient-CXFArchitecture[CXF-Based Connector Architecture].
...
+
image:/documentation/download/attachments/122752418/SunsetRiseCreateConnector.png?version=2&modificationDate=1421419049283[image]
+
...
+
image:/documentation/download/attachments/122752418/ConnectorInstallUpdate.png?version=1&modificationDate=1421422089000[image]
+
...
+
image:/documentation/download/thumbnails/122752418/SunsetRiseConnector.png?version=1&modificationDate=1421437627717[image]
+
...
+
image:/documentation/download/attachments/122752418/SunriseSunset.png?version=1&modificationDate=1421446909412[image] 
...
image:/documentation/download/attachments/122752418/image2013-8-11+17%3A21%3A7.png?version=1&modificationDate=1405522619931[image]
...
Example files are available in the attached link:/documentation/download/attachments/122752418/CxfExampleFiles.zip?version=1&modificationDate=1421446819133[CxfExampleFiies.zip] file for the sections of this document that follow.
...
See link:/documentation/display/current/Setting+Up+API+Access[Setting Up Your API Access] for steps that may be required to gain access to other APIs, including how to get access to the WSDL file.
...
image:/documentation/download/attachments/122752418/SunsetFiles.png?version=1&modificationDate=1421445689778[image]
...
You must add the t`arget/generated-sources/cxf` folder from the previous step to the build path as recognized by your IDE.

. Import or re-import your Maven project to your IDE, as described in "Importing a Maven Project into Eclipse/Anypoint Studio" in link:/documentation/display/current/Creating+an+Anypoint+Connector+Project[Creating an Anypoint Connector Project].
. Look for the folder `target/generated-sources/cxf`.
. Right-click the folder name, then select *Build Path* > *Use as Source Folder*.
+
image:/documentation/download/attachments/122752418/SOAP1.png?version=1&modificationDate=1405522620046[image]
...
The different authentication methods are discussed in link:/documentation/display/current/Authentication+Methods[Authentication Methods]; find your authentication method and refer to the examples for guidance on how to add authentication handling in the proxy client.
====
...
DevKit enforces JavaDoc documentation of your methods. One of the things you must add is an XML sample of the inputs required by each connector method. link:/documentation/display/current/Annotation+Reference[Learn more about Javadoc annotations for DevKit].
...
See link:/documentation/display/current/Connector+Reference+Documentation[Creating DevKit Connector Documentation] for full information on filling in the JavaDoc for your connector.
...
See link:/documentation/display/current/Installing+and+Testing+Your+Connector+in+Studio[Installing and Testing Your Connector] for the steps to follow in order to build your connector and install it into Studio.
...
image:/documentation/download/attachments/122752418/SunsetRiseFlow.png?version=1&modificationDate=1421414420935[image]

image:/documentation/download/attachments/122752418/studio-config.png?version=2&modificationDate=1421403641946[image]
...
* Check out some of the other link:/documentation/display/current/Anypoint+Connector+Examples[examples]
* Example files are available in the attached link:/documentation/download/attachments/122752418/CxfExampleFiles.zip?version=1&modificationDate=1421446819133[CxfExampleFiies.zip] file for the WSDL2Java sections of this document
