...
To build a custom Anypoint Connector for Studio, you can use the Anypoint Connector DevKit. In Anypoint Studio, you can add an extension module that enables you to use link:/documentation/display/current/Anypoint+Connector+DevKit[Anypoint Connector DevKit].
...
+
image:/documentation/download/attachments/125305485/new+proj2.png?version=1&modificationDate=1427835621957[image]
+
Create an Anypoint Connector Project: +
+
image:/documentation/download/attachments/125305485/CreateConnector36.png?version=1&modificationDate=1427835621785[image]
+
...
image:/documentation/download/attachments/125305485/RESTtype.png?version=1&modificationDate=1427835622023[image]

* *Java SDK*. See link:/documentation/display/current/Creating+a+Connector+Using+a+Java+SDK[Creating a Connector Using a Java SDK]:
+
image:/documentation/download/attachments/125305485/GenericType.png?version=1&modificationDate=1427835621871[image]
+
* *SOAP*. Refer to "WSDL location" later in this table:
+
image:/documentation/download/attachments/125305485/SOAPOptions.png?version=1&modificationDate=1427835622268[image]
+
* *REST*. Refer to link:/documentation/display/current/Implementing+a+REST+Connector[Implementing a REST Connector]:
+
|*Authentication*
|Click an authentication choice for how your connector accesses its resource: link:/documentation/display/current/Connection+Management[Connection Management], link:/documentation/display/current/OAuth+V1[OAuth V1], or link:/documentation/display/current/OAuth+V2[OAuth V2].
...
|Provides methods to display metadata on the resource's entities. For more information, see link:/documentation/display/current/Adding+DataSense[Adding DataSense].
|*Add DataSense Query Method*
|Adds method for the DataSense Query Language. For more information, see link:/documentation/display/current/Adding+DataSense+Query+Language[Adding DataSense Query Language].
|===
+
...
See also: "Creating a Compressed Project File" in link:/documentation/display/current/Packaging+Your+Connector+for+Release[Packaging Your Connector for Release].
...
+
image:/documentation/download/attachments/125305485/ViewButton.png?version=1&modificationDate=1427835622291[image]
+
. Click *Devkit* and *OK* to open the DevKit Perspective.
+
image:/documentation/download/attachments/125305485/DevKitView.png?version=1&modificationDate=1427835621859[image]
+
. Click any item in the *Devkit* perspective to display the code which defines it, for example: +
+
image:/documentation/download/attachments/125305485/DevKitPerspective.png?version=1&modificationDate=1427835621835[image] 
...
image:/documentation/download/attachments/125305485/ConnectorHelpInfo.png?version=1&modificationDate=1427835621764[image]

For more information on @Connector and other Anypoint Connector DevKit annotations, see the link:/documentation/display/current/Annotation+Reference[Annotation Reference].
...
image:/documentation/download/attachments/125305485/screen23.png?version=1&modificationDate=1427835622235[image]
...
+
image:/documentation/download/attachments/125305485/InstallOrUpdate.png?version=1&modificationDate=1427835621908[image] 
+
...
For example:
+
image:/documentation/download/attachments/125305485/36ConnectorFlow.png?version=1&modificationDate=1427835621632[image]

== More DevKit Actions

The plugin also provides actions in the tool bar:

image:/documentation/download/attachments/125305485/actions.jpg?version=1&modificationDate=1427835621670[image]

The same actions can be accessed by right-clicking your project in the package explorer:

image:/documentation/download/attachments/125305485/screen21.png?version=1&modificationDate=1427835622216[image]
...
image:/documentation/download/attachments/125305485/screen18.png?version=1&modificationDate=1427835622172[image] +
...
image:/documentation/download/attachments/125305485/screen24.png?version=1&modificationDate=1427835622246[image]

This is what a sample looks like, which is an XML file. There are a few simple templates you can use within them:

image:/documentation/download/attachments/125305485/screen25.png?version=1&modificationDate=1427835622257[image]
...
image:/documentation/download/attachments/125305485/screen11_1.png?version=1&modificationDate=1427835622113[image]
...
+
image:/documentation/download/attachments/125305485/add+global+element.jpg?version=1&modificationDate=1427835621684[image]
+
...
+
image:/documentation/download/attachments/125305485/DevKitProperty.png?version=1&modificationDate=1427835621848[image]
...
image:/documentation/download/attachments/125305485/MyProcessor.png?version=1&modificationDate=1427835621919[image] 
...
image:/documentation/download/attachments/125305485/Content.png?version=1&modificationDate=1427835621774[image]
...
image:/documentation/download/attachments/125305485/import.jpg?version=1&modificationDate=1427835621881[image]
...
+
image:/documentation/download/attachments/125305485/36ReqdDeps.png?version=1&modificationDate=1427835621659[image]
...
* *NEXT:* Continue to link:/documentation/display/current/Authentication[Choose and Implement your Authentication] method for your API.
* Learn more about the link:/documentation/display/current/Connector+Project+Structure[Connector Project structure].
