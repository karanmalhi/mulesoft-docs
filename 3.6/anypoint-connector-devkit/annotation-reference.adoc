...
See also: link:/documentation/display/current/Connection+Management[Connection Management]  link:#AnnotationReference-cnctan[@Connect]  link:#AnnotationReference-coidan[@ConnectionIdentifier]  link:#AnnotationReference-discan[@Disconnect]  link:#AnnotationReference-invan[@InvalidateConnectionOn]  +
...
See also:  link:/documentation/display/current/Connection+Management[Connection Management]   link:#AnnotationReference-cnctan[@Connect]   link:#AnnotationReference-discan[@Disconnect]   link:#AnnotationReference-invan[@InvalidateConnectionOn]   +
 link:#AnnotationReference-recan[@ReconnectOn]   link:#AnnotationReference-valcan[@ValidateConnection]    
...
image:/documentation/download/attachments/122752404/Screen+Shot+2014-12-30+at+1.06.11+PM.png?version=1&modificationDate=1419957006536[image]
...
The @OverrideAtProcessor annotation is deprecated in Mule 3.6 and newer and exists only for backward compatibility.
...
See also:  link:/documentation/display/current/Connection+Management[Connection Management]   link:#AnnotationReference-cnctan[@Connect]   link:#AnnotationReference-coidan[@ConnectionIdentifier]   link:#AnnotationReference-invan[@InvalidateConnectionOn]   +
 link:#AnnotationReference-recan[@ReconnectOn]   link:#AnnotationReference-valcan[@ValidateConnection]    
...
image:/documentation/download/attachments/122752404/friendlyName-screenshot.png?version=1&modificationDate=1418620449853[image]
...
See also:  link:/documentation/display/current/Connection+Management[Connection Management]   link:#AnnotationReference-cnctan[@Connect]    link:#AnnotationReference-coidan[@ConnectionIdentifier]    link:#AnnotationReference-discan[@Disconnect]    +
 link:#AnnotationReference-recan[@ReconnectOn]   link:#AnnotationReference-valcan[@ValidateConnection]    
...
Specifies link:/documentation/display/current/Mule+Expression+Language+MEL[Mule Expression Language (MEL)] as a method parameter without the DevKit resolving the expression. You can use any MEL code with this annotation.
...
image:/documentation/download/attachments/122752404/password-screenshot.png?version=1&modificationDate=1418620425418[image]
...
image:/documentation/download/attachments/122752404/placement-1-screenshot.png?version=1&modificationDate=1418620328514[image]
...
image:/documentation/download/attachments/122752404/placement-2-screenshot.png?version=1&modificationDate=1418620387059[image]
...
See also:  link:/documentation/display/current/Connection+Management[Connection Management]  link:#AnnotationReference-cnctan[@Connect]  link:#AnnotationReference-coidan[@ConnectionIdentifier]  link:#AnnotationReference-discan[@Disconnect]  link:#AnnotationReference-invan[@InvalidateConnectionOn]  link:#AnnotationReference-recan[@ReconnectOn]  
