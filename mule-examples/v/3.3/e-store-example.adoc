...
+
image:/docs/download/attachments/87687923/e-store_intro.png?version=1&modificationDate=1348773027879[image]
...
This example application contains six Mule flow files (see image below), each of which contains several flows. Organized according to function, these flow files serve different purposes within the application. +
 +
 image:/docs/download/attachments/87687923/e-store_flows.png?version=1&modificationDate=1348773050873[image]
...
image:/docs/download/attachments/87687923/e-store_universe.png?version=1&modificationDate=1348773073213[image]
...
image:/docs/download/attachments/87687923/config_tab.png?version=1&modificationDate=1348773098289[image]
====
...
image:/docs/download/attachments/87687923/estore.png?version=1&modificationDate=1340053761771[image]
...
image:/docs/download/attachments/87687923/model.png?version=1&modificationDate=1340134465855[image]
...
image:/docs/download/attachments/87687923/Screen+Shot+2012-06-18+at+6.43.27+PM.png?version=1&modificationDate=1340055830621[image]
...
image:/docs/download/attachments/87687923/ajax_and_JMS.png?version=1&modificationDate=1348773168079[image]
...
image:/docs/download/attachments/87687923/listproductsA.png?version=1&modificationDate=1348773204719[image]

image:/docs/download/attachments/87687923/listproductsB.png?version=1&modificationDate=1348773217745[image]
...
image:/docs/download/attachments/87687923/allProducts.png?version=1&modificationDate=1348773233873[image]
...
image:/docs/download/attachments/87687923/get_method.png?version=1&modificationDate=1348773250669[image]
...
image:/docs/download/attachments/87687923/dataMapping1.png?version=1&modificationDate=1348773266214[image]
...
image:/docs/download/attachments/87687923/expression_transform.png?version=1&modificationDate=1348773286321[image]
...
image:/docs/download/attachments/87687923/fetch_subflow.png?version=1&modificationDate=1348773301967[image]
...
image:/docs/download/attachments/87687923/SOAP_VanGogh.png?version=1&modificationDate=1348773321613[image]
...
image:/docs/download/attachments/87687923/listofproducts.png?version=1&modificationDate=1348773340481[image]
...
The E-store application enables users to add items to a virtual shopping cart. The following diagram illustrates the actions the E-store application performs to add an item to a cart. +
 +
 image:/docs/download/attachments/87687923/model2.png?version=1&modificationDate=1340134513636[image]
...
image:/docs/download/attachments/87687923/add_to_cart_flow.png?version=1&modificationDate=1348773363262[image]!
...
image:/docs/download/attachments/87687923/property_variable.png?version=1&modificationDate=1348773382112[image]
...
+
image:/docs/download/attachments/87687923/add_to_cart_flow2.png?version=1&modificationDate=1348773396546[image]
...
+
image:/docs/download/attachments/87687923/global_jdbc_all.png?version=1&modificationDate=1348773430104[image]
...
The E-store application enables users to view the items, including their cost, in the virtual shopping cart. The following diagram illustrates the actions the E-store application performs to display cart contents to the end user. +
 +
 image:/docs/download/attachments/87687923/showcart.png?version=1&modificationDate=1340140898486[image]
...
image:/docs/download/attachments/87687923/front_show_cart.png?version=1&modificationDate=1348773511843[image]
...
image:/docs/download/attachments/87687923/show_cart_flow.png?version=1&modificationDate=1348773536393[image]
...
image:/docs/download/attachments/87687923/subflow_showCart.png?version=1&modificationDate=1348952626284[image]
...
+
image:/docs/download/attachments/87687923/choice_router.png?version=1&modificationDate=1348773572474[image]
...
image:/docs/download/attachments/87687923/fetch_from_Barbers.png?version=1&modificationDate=1348773589557[image]
...
image:/docs/download/attachments/87687923/fetch_from_VanGoghs.png?version=1&modificationDate=1348773604935[image]
...
After it sends each item in the collection through foreach’s message processors, Mule uses another DataMapper to convert and consolidate the updated product information (see image below). DataMapper also calculates each item’s subtotal by multiplying the product’s price by the quantity the end user requested. +
 +
 image:/docs/download/attachments/87687923/dataMapper-subflow.png?version=1&modificationDate=1348773617941[image]
...
In DataMapper’s *Input* pane, Mule displays fields from the payload which represent the names of the rows in the cart table in the Derby database. Mule stored these product details as message properties when it called Barber’s Paradise and Van Gogh’s Paint’s Web services for updated product details. The two message enrichers, each named **Store product details as message property (enrich)**, stored the product details as properties (see image below). +
 +
 image:/docs/download/attachments/87687923/enriched_productdetails.png?version=1&modificationDate=1348773634357[image]
...
Mule then transforms the Java object (a map) to a string to prepare the contents for a grand total calculation. The variable transformer uses an expression to calculate, then set the `grandTotal` variable on the payload (see image below). Recall that Mule created an empty `grandTotal` variable earlier in the subflow; this transformer simply populates the empty variable. +
 +
 image:/docs/download/attachments/87687923/grandTotal.png?version=1&modificationDate=1348773652968[image]
...
Mule returns the message to the *e-storeFrontend-showCart* flow, which uses AJAX to send the response to the end user’s browser. +
 +
 image:/docs/download/attachments/87687923/showCart_browser.png?version=1&modificationDate=1348773669942[image]
...
The following diagram illustrates the actions the E-store application performs to recalculate the Grand Total, then authorize the payment and submit vendor orders. +
 +
 image:/docs/download/attachments/87687923/checkout.png?version=1&modificationDate=1340149360591[image]
...
When an end user clicks the *Checkout* tab on the GUI, the client-side interface activates the *e-storeFrontend-getCartTotal* flow in the `e-storeFrontend.mflow file` (see image below). +
 +
 image:/docs/download/attachments/87687923/getGrandTotal.png?version=1&modificationDate=1348773753107[image]
...
The *e-storeFrontend-getCartTotal* flow sends a response to the end user’s browser which displays the Grand Total of the cart on the *Checkout* page. +
 +
 image:/docs/download/attachments/87687923/grandTotal_browser.png?version=1&modificationDate=1348773772466[image]
...
image:/docs/download/attachments/87687923/doCheckout_flow.png?version=1&modificationDate=1348773787178[image]
...
The JMS endpoint in the *doCheckout* flow listens for requests the *e-storeFrontend-doCheckout* flow sends to the `estore.doCheckout` JMS queue (see image below). +
 +
 image:/docs/download/attachments/87687923/partA.png?version=1&modificationDate=1348952658559[image] +


image:/docs/download/attachments/87687923/partB.png?version=1&modificationDate=1348952672655[image] +

 image:/docs/download/attachments/87687923/partD.png?version=1&modificationDate=1348952701668[image]
...
Using a flow reference component, Mule sends the message to the *subflow-showCart* for processing, then uses expressions to enrich the payload with two properties: the `grandTotal` and `cartContents` (see message enricher image below). +
 +
 image:/docs/download/attachments/87687923/enrich_total_contents.png?version=1&modificationDate=1348773845292[image]
...
image:/docs/download/attachments/87687923/authorization_subflows.png?version=1&modificationDate=1348773859430[image]
...
In the *PaymentAuthorizationToBank* subflow, Mule first prepares a request to send to the bank by removing its `cartContent` property. This prevents Mule from unnecessarily sending a list of the cart’s contents to the bank (see image of property transformer below). +
 +
 image:/docs/download/attachments/87687923/remove_property.png?version=1&modificationDate=1348773879299[image]
...
The enricher uses the results of the subflow’s processing to enrich the message with two more properties: `paymentResult` and `paymentReason`. +
 +
 image:/docs/download/attachments/87687923/xpath_enricher.png?version=1&modificationDate=1348773893875[image]
...
image:/docs/download/attachments/87687923/choice_sucess_fail.png?version=1&modificationDate=1348773908848[image]
...
+
image:/docs/download/attachments/87687923/choice_orderProvider.png?version=1&modificationDate=1348773924187[image]
...
image:/docs/download/attachments/87687923/mapped_orders.png?version=1&modificationDate=1348773945402[image]
...
image:/docs/download/attachments/87687923/place_VanGogh_order.png?version=1&modificationDate=1348773964247[image]
...
Each Web service provider responds with an order number, which Mule transforms from an object to a string. Then, using an expression transformer, Mule sets each vendor’s order number into the `orders` LinkedList variable created earlier in the flow (see image below). +
 +
 image:/docs/download/attachments/87687923/add_order_numbers.png?version=1&modificationDate=1348773979519[image]
...
Mule returns the message to the *e-storeFrontend-doCheckout* flow, which uses AJAX to send the response to the end user’s browser. +
 +
 image:/docs/download/attachments/87687923/doCheckout_browser.png?version=1&modificationDate=1348773993234[image]
...
When a user clicks the *Clear cart contents* button on the GUI, the client-side interface activates the *e-storeFrontend-clearCart* flow in the `e-storeFrontend.mflow file` (see image below). +
 +
 image:/docs/download/attachments/87687923/clear_cart_flow.png?version=1&modificationDate=1348774007190[image]
...
image:/docs/download/attachments/87687923/clearCart_flow.png?version=1&modificationDate=1348774032783[image]
...
Referencing the global JDBC connector, this flow uses an outbound JDBC endpoint to execute the `clearCart` query (see images below). In the embedded Derby database, this query deletes the contents of the cart table associated with the end user’s session ID. +
 +
 image:/docs/download/attachments/87687923/clear_cart_query.png?version=1&modificationDate=1348774048539[image]
...
While this document does not explore the 3rd-party Web services in detail, you can examine their contents in Mule Studio. Double-click one of the 3rd-party `.mflow` files in the *Package Explorer* to open the configuration in a separate canvas tab (see image below).  +
 +
 image:/docs/download/attachments/87687923/bank_open.png?version=1&modificationDate=1348774061453[image]
