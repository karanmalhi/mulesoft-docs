...
+
image:/docs/download/attachments/87687921/successful_populate.png?version=1&modificationDate=1346208725811[image]
...
+
image:/docs/download/attachments/87687921/processed.png?version=1&modificationDate=1346208747091[image]
...
image:/docs/download/attachments/87687921/config_tab.png?version=1&modificationDate=1346208772917[image]
====
...
image:/docs/download/attachments/87687921/process_flow.png?version=1&modificationDate=1346208798653[image]
...
image:/docs/download/attachments/87687921/JDBC_endpoitns.png?version=1&modificationDate=1346208828552[image]
====
...
image:/docs/download/attachments/87687921/choice_properties_2.png?version=1&modificationDate=1346208864051[image]
...
image:/docs/download/attachments/87687921/error_occurred.png?version=1&modificationDate=1346208924313[image]
...
image:/docs/download/attachments/87687921/populate_flow.png?version=1&modificationDate=1346208941668[image]
...
If an error occurs during processing, this catch exception strategy mimics the actions of the Process flow's exception strategy. The only difference between exception strategies is the content the set payload transformer sets on the payload; the Populate flow’s error message reads, `DB already populated`. +
 +
 image:/docs/download/attachments/87687921/db_populated.png?version=1&modificationDate=1346208970966[image]
...
image:/docs/download/attachments/87687921/global_elements_tab.png?version=1&modificationDate=1346209010830[image]
...
image:/docs/download/attachments/87687921/connectors_reference.png?version=1&modificationDate=1346209041780[image]
