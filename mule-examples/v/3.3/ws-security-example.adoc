...
This application also includes several variations of a *client-side Web service* to ensure a functional example. These *service-clients* enable end users to submit salutation requests to the server-side Web service. Refer to the link:#WS-SecurityExample-Client-SideFlows[Client-Side Flows] section below for more details.

This document will help you understand some of the ways you can apply security to a SOAP Web service in Mule ESB applications. To understand more about Mule ESB’s ability to integrate services and systems, access the link:/docs/display/33X/Mule+Examples[Mule examples] and see other applications in action.
...
. Complete the procedure in link:/docs/display/33X/Mule+Examples[Examples and Exercises] to create, then run the Security template in Mule Studio, or the Security example in Mule Standalone (Mule ESB without Studio).
. Open your Web browser.
. In the address bar, type
. Press *enter* to elicit a response from the WS-Security application (see image below).
+
image:/docs/download/attachments/87687911/first_response.png?version=1&modificationDate=1348242711136[image]
...
+
image:/docs/download/attachments/87687911/second_response.png?version=1&modificationDate=1348242728791[image]
...
+
image:/docs/download/attachments/87687911/secure_client.png?version=1&modificationDate=1348242747804[image]
...
+
image:/docs/download/attachments/87687911/console1.png?version=1&modificationDate=1348242766312[image]
...
+
image:/docs/download/attachments/87687911/response.png?version=1&modificationDate=1348242783823[image]
...
image:/docs/download/attachments/87687911/config_tab.png?version=1&modificationDate=1348242798373[image]
====

=== UnsecureService Flow

image:/docs/download/attachments/87687911/unsecure_flow.png?version=1&modificationDate=1348242815669[image]
...
The request-response **link:/docs/display/33X/HTTP+Endpoint+Reference[HTTP Endpoint] **in this flow receives the end user request. Because it has a two-way message exchange pattern, this HTTP endpoint is responsible for both receiving and returning messages.
...
image:/docs/download/attachments/87687911/http_endpoints.png?version=1&modificationDate=1348242838042[image]
====

A JAX-WS service, the **link:/docs/display/33X/SOAP+Component+Reference[SOAP Component]** in this flow evaluates the message according to its security configurations. In this case, the Web service is unsecure (see image below) so the SOAP component processes all requests it receives. +
image:/docs/download/attachments/87687911/no_security.png?version=1&modificationDate=1348242857736[image]
...
The **link:/docs/display/33X/Java+Component+Reference[Java Component]** executes a simple script to prepare a personalized salutation for the end user.
...
. Double-click the `Greeter.java` file to open it in a new tab on the Studio canvas (see image below). +
 +
 image:/docs/download/attachments/87687911/see_java.png?version=1&modificationDate=1348242899245[image]
...
image:/docs/download/attachments/87687911/usernameToken_flow.png?version=1&modificationDate=1348243347338[image]
...
+
image:/docs/download/attachments/87687911/usernameToken.png?version=1&modificationDate=1348242930242[image]
...
Refer to the link:#WS-SecurityExample-Client-SideFlows[client-side flows] section below for more details.
====
...
image:/docs/download/attachments/87687911/uersnameTokenSigned.png?version=1&modificationDate=1348243414273[image]
...
image:/docs/download/attachments/87687911/usernameTokenSigned.png?version=1&modificationDate=1348242967168[image]
...
+
image:/docs/download/attachments/87687911/see_java2.png?version=1&modificationDate=1348242981005[image]
====
...
image:/docs/download/attachments/87687911/keystore.png?version=1&modificationDate=1348243015189[image]
...
image:/docs/download/attachments/87687911/UsernameTokenEncrypted.png?version=1&modificationDate=1348243034584[image]
...
image:/docs/download/attachments/87687911/decryption.png?version=1&modificationDate=1348243047376[image]
...
image:/docs/download/attachments/87687911/double_click.png?version=1&modificationDate=1348243062077[image]
...
image:/docs/download/attachments/87687911/samltoken_flow.png?version=1&modificationDate=1348243077805[image]
...
image:/docs/download/attachments/87687911/validator_bean.png?version=1&modificationDate=1348243092844[image]
////
 View the XML
...
image:/docs/download/attachments/87687911/custom_validator.png?version=1&modificationDate=1348243106486[image]
====
...
image:/docs/download/attachments/87687911/client_saml_config.png?version=1&modificationDate=1348243123398[image]
====
...
image:/docs/download/attachments/87687911/signedSAML_flow.png?version=1&modificationDate=1348243143288[image]

// View the XML

Much the same as link:#WS-SecurityExample-SAMLTokenServiceFlow[*SAMLTokenService*], this flow uses `SAMLTokenUnsigned` action to validate SAML2 assertions. However, the action in this flow uses a digital signature to verify the trustworthiness of the original authenticator. To validate the digital signature on the message, the SOAP component uses a keystore specified in the *signaturePropFile*. (Refer to link:#WS-SecurityExample-UsernameTokenEncryptedServiceFlow[#UsernameTokenEncryptedService Flow] section above for more information on verifying digital signatures.)
...
image:/docs/download/attachments/87687911/signature_component.png?version=1&modificationDate=1348243159774[image]

// View the XML

As with the link:#WS-SecurityExample-SAMLTokenServiceFlow[SAMLTokenService flow], the SOAP component delegates SAML Token validation to the SAML2 Token Validator. The token validator, in turn, references a custom SAML2 token validator. The `samlCustomValidator` uses a Java class to confirm the contents of the SAML subject are correct. Additionally, this SOAP component validates the digital signature of the message’s original authenticator against a keystore in the `wssecurity.properties` file.
...
image:/docs/download/attachments/87687911/client-server_diagram.png?version=1&modificationDate=1348243177006[image]
...
image:/docs/download/attachments/87687911/service_clients_flow.png?version=1&modificationDate=1348243191241[image]
...
* For more information on the SOAP Component, see link:/docs/display/33X/SOAP+Component+Reference[SOAP Component Reference].
* For more information on WS-security, see link:/docs/display/33X/Enabling+WS-Security[Enabling WS-Security].
