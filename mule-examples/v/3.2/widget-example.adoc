...
[cols=",",]
|===
|image:/documentation-3.2/images/icons/emoticons/warning.gif[image] |These are instructions for running the Widget example in Mule 3.2. To run it in Mile 3.1, see link:/documentation-3.2/display/32X/Widget+Example+%28Mule+3.1%29[here].
