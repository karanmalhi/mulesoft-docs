...
This document assumes that you are familiar with Mule ESB and the link:/docs/display/34X/Mule+Studio+Essentials[Mule Studio interface]. To increase your familiarity with Mule Studio, consider completing one or more link:/docs/display/34X/Basic+Studio+Tutorial[Mule Studio Tutorials].
...
This application also includes several variations of a *client-side Web service* to ensure a functional example. These *service-clients* enable end users to submit salutation requests to the server-side Web service. Refer to the link:#SOAPWebServiceSecurityExample-Client-sideFlows[Client-Side Flows] section below for more details.

This document will help you understand some of the ways you can apply security to a SOAP Web service in Mule ESB applications. To understand more about Mule ESB’s ability to integrate services and systems, access the link:/docs/display/34X/Mule+Examples[Mule examples] and see other applications in action.
...
+
image:/docs/download/attachments/95393751/first_response.png?version=1&modificationDate=1374599068098[image] +
...
+
image:/docs/download/attachments/95393751/second_response.png?version=1&modificationDate=1374599068405[image]
...
. Complete the link:/docs/display/34X/Mule+Examples#MuleExamples-CreateandRunExampleApplications[procedure] to create, then run the Security template in Mule Studio, or the Security example in Mule Standalone (Mule ESB without Studio).
...
+
image:/docs/download/thumbnails/95393751/secure_client.png?version=1&modificationDate=1374599066193[image] +
...
. In the *Console*, Mule displays a menu which lists the different types of requests you can submit to the WS-Security application. +
 +
image:/docs/download/attachments/95393751/console.png?version=1&modificationDate=1374599065831[image] +
...
+
image:/docs/download/attachments/95393751/response.png?version=1&modificationDate=1374599069329[image] +
...
....
image:/docs/download/attachments/95393751/unsecureService.png?version=1&modificationDate=1374599064063[image]
....
...
The request-response **link:/docs/display/34X/HTTP+Endpoint+Reference[HTTP Endpoint] **in this flow receives the end user request. Because it has a two-way message exchange pattern, this HTTP endpoint is responsible for both receiving and returning messages.

A JAX-WS service, the **link:/docs/display/34X/SOAP+Component+Reference[SOAP Component]** in this flow evaluates the message according to its security configurations. In this case, the Web service is unsecure (see image below) so the SOAP component processes all requests it receives.

[tabs]
------
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/SOAP_Component1.png?version=1&modificationDate=1374599066945[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
The **link:/docs/display/34X/Java+Component+Reference[Java Component]** executes a simple script to prepare a personalized salutation for the end user.
...
+
image:/docs/download/attachments/95393751/greeter.png?version=1&modificationDate=1374599066494[image]
+
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/usernameTokenService.png?version=1&modificationDate=1374599063767[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
image:/docs/download/attachments/95393751/usernameTokenSOAP.png?version=1&modificationDate=1374599065421[image]
...
Refer to the link:#SOAPWebServiceSecurityExample-Client-sideFlows[client-side flows] section below for more details.
====
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/usernameTokenSigned.png?version=1&modificationDate=1374599061349[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/properties_secureTokensigned.png?version=1&modificationDate=1374599061028[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
+
image:/docs/download/attachments/95393751/ws_security_properties.png?version=1&modificationDate=1374599065123[image]
====
...
+
image:/docs/download/attachments/95393751/keystore.png?version=1&modificationDate=1374599072483[image]
...
[tab,title="Studio Visual Editor"]
.... 
image:/docs/download/attachments/95393751/UsernameTokenEncrypted.png?version=1&modificationDate=1374599063470[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/tokenEncrypted.png?version=1&modificationDate=1374599064731[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
image:/docs/download/attachments/95393751/client_side.png?version=1&modificationDate=1374599064359[image] +
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/samlToken.png?version=1&modificationDate=1374599063174[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/properties_both.png?version=1&modificationDate=1374599062880[image]
....
...
. Double-click the `SAMLCustomValidator.java` file to open it in a new tab on the Studio canvas (see image below). +
 image:/docs/download/attachments/95393751/SAMLCustomValidator.png?version=1&modificationDate=1374599062581[image]
====
...
The *SOAP Component* in the client-side *samlToken* subflow uses a SAMLCallbackHandler (see Java code below this box) to populate the assertion it sends to the Web Service. (see image below). +
 +
 image:/docs/download/attachments/95393751/client_saml_config.png?version=1&modificationDate=1374599074759[image]
=====
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/signedSamlToken.png?version=1&modificationDate=1374599062285[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
Much the same as link:#SOAPWebServiceSecurityExample-SAMLTokenServiceFlow[*SAMLTokenService*], this flow uses `SAMLTokenUnsigned` action to validate SAML2 assertions. However, the action in this flow uses a digital signature to verify the trustworthiness of the original authenticator. To validate the digital signature on the message, the SOAP component uses a keystore specified in the *signaturePropFile*. (Refer to link:#SOAPWebServiceSecurityExample-UsernameTokenEncryptedServiceFlow[UsernameTokenEncryptedService Flow] section above for more information on verifying digital signatures.)
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/signautre.png?version=1&modificationDate=1374599061981[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
+
image:/docs/download/attachments/95393751/client-server_diagram.png?version=1&modificationDate=1374599061672[image]

Double-click the `service-clients.mflow` file in the package explorer to open the *service-clients* configuration in a separate tab in Mule Studio.
...
 
<mule xmlns="http://www.mulesoft.org/schema/mule/core" xmlns:http="http://www.mulesoft.org/schema/mule/http" xmlns:cxf="http://www.mulesoft.org/schema/mule/cxf" xmlns:tracking="http://www.mulesoft.org/schema/mule/ee/tracking" xmlns:doc="http://www.mulesoft.org/schema/mule/documentation" xmlns:spring="http://www.springframework.org/schema/beans" xmlns:core="http://www.mulesoft.org/schema/mule/core" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="EE-3.3.0" xsi:schemaLocation="
...
    <spring:beans>
        <spring:bean name="samlCallbackHandler" class="com.mulesoft.mule.example.security.SAMLCallbackHandler" id=""/>
    </spring:beans>
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393751/ws-security.png?version=1&modificationDate=1374599067412[image]
....
[tab,title="Studio XML Editor"]
....
[source]
...
* For more information on the SOAP Component, see link:/docs/display/34X/SOAP+Component+Reference[SOAP Component Reference].
* For more information on WS-security, see link:/docs/display/34X/Enabling+WS-Security[Enabling WS-Security].
