...
image:/docs/download/thumbnails/95393752/iteration2.png?version=1&modificationDate=1374599084120[image]An iterative processor, Foreach splits collections into elements, then processes them iteratively without losing any of the message payload. After Foreach splits a message collection and processes the individual elements, it returns a reference to the original message thus resulting in "Java in, Java out" processing.

==== Content-Based Routing

image:/docs/download/thumbnails/95393752/content_routing.png?version=1&modificationDate=1374599083713[image]Mule has the ability to intelligently route a message through different processing pathways according to its content. Using a Choice Router (or Choice Flow Control in Studio), Mule uses an expression to evaluate a message's properties, or part of its payload, then routes it to a specific pathway (i.e. series of message processors). Content-based routing, as this activity is called, dynamically applies routing criteria to a message at runtime.

==== Service Orchestration

image:/docs/download/thumbnails/95393752/orchestrate.png?version=1&modificationDate=1374599083252[image]This term applies to the activity of coordinating calls to several different Web services in order to process a single Web service request. As the name implies, an application, such as this example, can _orchestrate_ the sequence of calls to services.  Like the conductor of an orchestra, a single Mule flow signals when to submit calls to services, ensuring that all the moving pieces work together to produce a single response.

==== Cache

image:/docs/download/thumbnails/95393752/cache_icon.png?version=1&modificationDate=1374599082852[image]Caching message content during processing saves on time and processing load by storing and reusing frequently called data. The cache wrapper (or cache scope in Studio) processes the message, delivers the output, and saves the output (i.e. caches the response). The next time the flow encounters the same kind of request, Mule may offer a cached response rather than invoking, again, a potentially time-consuming process.
...
+
image:/docs/download/attachments/95393752/init.page.png?version=1&modificationDate=1374599087901[image] +
+
...
+
image:/docs/download/attachments/95393752/order_Processing_table2.png?version=1&modificationDate=1374599082540[image] +
+

. Mule processes the order and returns a response which your browser displays in the *Confirmation* tab (see below). +

+
image:/docs/download/attachments/95393752/order_Processing_confirmation.png?version=1&modificationDate=1374599082206[image]
...
....
image:/docs/download/attachments/95393752/orderServiceFlow.png?version=1&modificationDate=1374599081874[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/samsungOrder.png?version=1&modificationDate=1374599081022[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/inhouseOrder.png?version=1&modificationDate=1374599080625[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/priceServiceFlow.png?version=1&modificationDate=1374599080278[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/samsungServiceFlow.png?version=1&modificationDate=1374599079950[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/auditServiceFlow.png?version=1&modificationDate=1374599079498[image]
....
[tab,title="Studio XML Editor"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/defaultErrorHandler.png?version=1&modificationDate=1374599079193[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/dbInitializeFlow.png?version=1&modificationDate=1374599078864[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/95393752/order_processing.png?version=1&modificationDate=1374599081509[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source]
