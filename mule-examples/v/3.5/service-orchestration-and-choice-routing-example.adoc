...
image:/docs/download/thumbnails/122750995/iteration2.png?version=1&modificationDate=1421450471430[image]An iterative processor, Foreach splits collections into elements, then processes them iteratively without losing any of the message payload. After Foreach splits a message collection and processes the individual elements, it returns a reference to the original message thus resulting in "Java in, Java out" processing.

==== Content-Based Routing

image:/docs/download/thumbnails/122750995/content_routing.png?version=1&modificationDate=1421450471677[image]Mule has the ability to intelligently route a message through different processing pathways according to its content. Using a Choice Router, Mule uses an expression to evaluate a message's properties, or part of its payload, then routes it to a specific pathway (i.e. series of message processors). Content-based routing, as this activity is called, dynamically applies routing criteria to a message at runtime.

==== Service Orchestration

image:/docs/download/thumbnails/122750995/orchestrate.png?version=1&modificationDate=1421450471916[image]This term applies to the activity of coordinating calls to several different Web services in order to process a single Web service request. As the name implies, an application, such as this example, can orchestrate the sequence of calls to services.  Like the conductor of an orchestra, a single Mule flow signals when to submit calls to services, ensuring that all the moving pieces work together to produce a single response.

==== Cache

image:/docs/download/thumbnails/122750995/cache_icon.png?version=1&modificationDate=1421450472151[image]Caching message content during processing saves time and processing load by storing and reusing frequently called data. The cache scope processes the message, delivers the output, and saves the output (i.e. caches the response). The next time the flow encounters the same kind of request, Mule may offer a cached response rather than invoking, again, a potentially time-consuming process.
...
+
image:/docs/download/attachments/122750995/init.page.png?version=1&modificationDate=1421450469758[image] +
+
...
+
image:/docs/download/attachments/122750995/order_Processing_table2.png?version=1&modificationDate=1421450472371[image] +
+

. Mule processes the order and returns a response which your browser displays in the *Confirmation* tab (see below). +

+
image:/docs/download/attachments/122750995/order_Processing_confirmation.png?version=1&modificationDate=1421450472590[image]
...
....
image:/docs/download/attachments/122750995/orderService.png?version=1&modificationDate=1421450469285[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750995/samsungOrder.png?version=1&modificationDate=1421450469064[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750995/inhouseOrder.png?version=1&modificationDate=1421450468838[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750995/priceService.png?version=1&modificationDate=1421450468593[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750995/samsungService.png?version=1&modificationDate=1421450468353[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio XML Editor"]
....
image:/docs/download/attachments/122750995/auditService.png?version=1&modificationDate=1421450468123[image]
....
[tab,title="Studio XML Editor"]
....
[source, xml]
...
....
image:/docs/download/attachments/122750995/defaultErrorHandler.png?version=1&modificationDate=1421450467895[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750995/databaseInitialisation.png?version=1&modificationDate=1421450467679[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750995/FullExample.png?version=1&modificationDate=1421450467453[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
