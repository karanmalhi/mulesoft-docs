...
image:/docs/download/thumbnails/122750992/batch.png?version=1&modificationDate=1421450460474[image]link:/docs/display/35X/Batch+Processing[Batch Processing] allows you to split a payload into individual elements to process each individually. This functionality is particularly useful when working with streaming input or when engineering "near real-time" data integration between SaaS applications.

==== Database Connector

image:/docs/download/thumbnails/122750992/icon-database-blue-big+%282%29.png?version=1&modificationDate=1421450461612[image] The link:/docs/display/35X/Database+Connector[Database Connector] provides a standardized way to access to any JDBC relational database, consistently using one same interface for every case. This connector allows you to run diverse SQL operations on your database, including Select, Insert, Update, Delete, and even Stored Procedures.

==== Message Enriching

image:/docs/download/thumbnails/122750992/enriched4+%281%29.png?version=1&modificationDate=1421450460227[image]Mule uses link:/docs/display/35X/Message+Enricher[Message Enrichers] to enrich message payloads with data (i.e. add to the payload), rather than changing payload contents. Mule enriches a message’s payload so that other message processors in the application can access the original payload.
...
Unlike typical Mule projects that are organized into Flows, this project runs a link:/docs/display/35X/Batch+Processing[Batch Process]. The process is divided into three stages where actions have different scopes:
...
image:/docs/download/attachments/122750992/full.png?version=1&modificationDate=1421450461157[image]
...
....
image:/docs/download/thumbnails/122750992/input.png?version=1&modificationDate=1421450462281[image]
....
...
image:/docs/download/attachments/122750992/process.png?version=1&modificationDate=1421450460934[image]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/thumbnails/122750992/step1.png?version=1&modificationDate=1421450460714[image]
....
[tab,title="XML Editor"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/thumbnails/122750992/step2.png?version=1&modificationDate=1421450461831[image]
....
[tab,title="XML Editor"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750992/complete.png?version=1&modificationDate=1421450462054[image]
....
[tab,title="XML Editor"]
....
[source, xml]
...
* Understand link:/docs/display/35X/Batch+Processing[Batch Processing]. 
* Learn more about the link:/docs/display/35X/Datamapper+User+Guide+and+Reference[Datamapper].
* Learn about link:/docs/display/35X/Anypoint+Connectors[Anypoint Connectors].
* Understand the link:/docs/display/35X/Poll+Reference[Poll Scope].
* Read more about the link:/docs/display/35X/Choice+Flow+Control+Reference[Choice Flow Control].
* Read more about the link:/docs/display/35X/Message+Enricher[Message Enricher].
* Learn more about link:/docs/display/35X/DataSense+Query+Language[DataSense Query Language] to write queries in Mule connectors which support DSQL.
