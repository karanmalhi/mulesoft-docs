...
This document assumes that you are familiar with Mule ESB and the link:/docs/display/35X/Anypoint+Studio+Essentials[Anypoint Studio interface]. To increase your familiarity with Mule Studio, consider completing one or more link:/docs/display/35X/Basic+Studio+Tutorial[Anypoint Studio Tutorials].
...
This document will help you understand some of the ways you can apply security to a SOAP Web service in Mule ESB applications. To understand more about Mule ESB’s ability to integrate services and systems, access the link:/docs/display/35X/Mule+Examples[Mule examples] and see other applications in action.
...
. Press *enter* to elicit a response from the WS-Security application (see image below). +
 +
image:/docs/download/attachments/122750987/first_response.png?version=1&modificationDate=1421450425943[image] +
...
. Press *enter* to elicit a new response from the application (see example, below). +
 +
image:/docs/download/attachments/122750987/second_response.png?version=1&modificationDate=1421450426165[image]
...
. Complete the link:/docs/display/35X/Mule+Examples#MuleExamples-CreateandRunExampleApplications[procedure] to create, then run the Security template in Anypoint Studio, or the Security example in Mule Standalone (Mule ESB without Studio).
. In the *Package Explorer*, navigate to `src/main/java`, then expand the `com.mulesoft.mule.example.security` folder to reveal the `SecureClient` file. +
 +
image:/docs/download/thumbnails/122750987/securitype.png?version=1&modificationDate=1421450419784[image] +
...
. In the *Console*, Mule displays a menu which lists the different types of requests you can submit to the WS-Security application. +
 +
image:/docs/download/attachments/122750987/console.png?version=1&modificationDate=1421450424835[image] +
...
. Mule processes the request and returns a response in the console pane which reads, `Hello Mule`. +
 +
image:/docs/download/attachments/122750987/response.png?version=1&modificationDate=1421450426646[image] +
...
....
image:/docs/download/attachments/122750987/unsecureService.png?version=1&modificationDate=1421450423914[image]
....
...
The request-response **link:/docs/display/35X/HTTP+Connector[HTTP Endpoint] **in this flow receives the end user request. Because it has a two-way message exchange pattern, this HTTP endpoint is responsible for both receiving and returning messages.

A JAX-WS service, the **link:/docs/display/35X/CXF+Component+Reference[CXF Component]** in this flow evaluates the message according to its security configurations. In this case, the Web service is unsecure (see image below) so the CXF component processes all requests it receives.

[tabs]
------
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/unsecuresoap.png?version=1&modificationDate=1421450419557[image]
....
...
The **link:/docs/display/35X/Java+Component+Reference[Java Component]** executes a simple script to prepare a personalized salutation for the end user.
...
+
image:/docs/download/attachments/122750987/greeter.png?version=1&modificationDate=1421450419344[image]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/usernameTokenService.png?version=1&modificationDate=1421450423701[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/soap2.png?version=1&modificationDate=1421450419129[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/usernameTokenSigned.png?version=1&modificationDate=1421450422136[image]
....
[tab,title="Studio XML Editoe or Standalone"]
....
[source, xml]
----
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/soap3.png?version=1&modificationDate=1421450418919[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
. Double-click the `wssecurity.properties` file to open it in a new tab on the Studio canvas (see image below).  +
 +
image:/docs/download/attachments/122750987/ws_security_properties.png?version=1&modificationDate=1421450418705[image]
====
...
To validate the digital signature, Mule uses a Java keytool command to verify that the certificate for user `joe` exists in the keystore (see image below). +
 +
 image:/docs/download/attachments/122750987/keystore.png?version=1&modificationDate=1421450428603[image]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/UsernameTokenEncrypted.png?version=1&modificationDate=1421450423482[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/soap4.png?version=1&modificationDate=1421450418489[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
image:/docs/download/attachments/122750987/subflow2.png?version=1&modificationDate=1421450418264[image]

image:/docs/download/attachments/122750987/2encrypt.png?version=1&modificationDate=1421450418041[image] +
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/samlToken.png?version=1&modificationDate=1421450423271[image]
...
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/samldelegate.png?version=1&modificationDate=1421450417820[image]

image:/docs/download/attachments/122750987/samlge.png?version=1&modificationDate=1421450417605[image]
....
...
+
image:/docs/download/attachments/122750987/SAMLCustomValidator.png?version=1&modificationDate=1421450417389[image]
====
...
image:/docs/download/attachments/122750987/saml7.png?version=1&modificationDate=1421450417179[image]
====
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/signedSamlToken.png?version=1&modificationDate=1421450422819[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
[source, xml]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/signature.png?version=1&modificationDate=1421450416964[image]
....
...
This example application includes client side configurations which enable the application to function. The *service-clients* flow in the WS-Security application consists of a flow and several subflows which facilitate client-side submissions to the server side. +
 +
 image:/docs/download/attachments/122750987/client-server_diagram.png?version=1&modificationDate=1421450422356[image]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750987/ws-security.png?version=1&modificationDate=1421450425502[image]
....
[tab,title="Studio XML Editor"]
....
[source, xml]
...
* For more information on the SOAP Component, see link:/docs/display/35X/CXF+Component+Reference[CXF Component Reference].
* For more information on WS-security, see link:/docs/display/35X/Enabling+WS-Security[Enabling WS-Security].
