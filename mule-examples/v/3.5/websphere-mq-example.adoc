...
image:/docs/download/thumbnails/122750988/wmq.png?version=1&modificationDate=1421450432728[image] At times, you may find the need to bridge a communication gap between IBM's message queue product, Websphere MQ, and Mule.  To facilitate message processing across products, Mule uses a WMQ Endpoint. 
...
http://localhost:8086/services/wmqExample +
  +
image:/docs/download/attachments/122750988/WMQ+01.jpg?version=1&modificationDate=1421450433626[image] +
+
...
+
image:/docs/download/attachments/122750988/WMQ+03.jpg?version=1&modificationDate=1421450433845[image] +
+
...
+
image:/docs/download/attachments/122750988/WMQ+04.jpg?version=1&modificationDate=1421450433168[image] +
+
...
+
image:/docs/download/attachments/122750988/WMQ+05.jpg?version=1&modificationDate=1421450432948[image]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750988/global_WMQ_connector.png?version=1&modificationDate=1421450432500[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750988/global_ajax.png?version=1&modificationDate=1421450432285[image]
....
[tab,title="Studio XML Editor or Standalone"]
[source, xml]
----
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750988/wmqFlows.png?version=1&modificationDate=1421450432061[image]
....
[tab,title="Studio XML Editor or Standalone"]
....
