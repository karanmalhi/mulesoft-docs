...
image:/docs/download/thumbnails/122750989/csv_to_sfdc2.png?version=1&modificationDate=1421450439618[image]At times, you may find that you need to connect one or more of your organization's on-premise systems with a SaaS such as Salesforce. Ideally, these independent systems would talk to each other and share data to enable automation of end-to-end business processes. Use Mule applications to facilitate communication between your on-prem system(s) and Salesforce. (Though this use case does not extend as far, you can also use Mule to facilitate communication between SaaS providers.) +

==== DataMapper and FlowRefLookup

image:/docs/download/thumbnails/122750989/flowrefLookup_icon.png?version=1&modificationDate=1421450439381[image] Beyond transforming and mapping data from one format to another, you can use an Anypoint DataMapper Transformer to access other flows in a Mule application to acquire additional information. Use a FlowRefLookup Table to acquire information outside the message, then append it to the payload. 

== Assumptions

This document assumes that you are familiar with Mule and the link:/docs/display/35X/Anypoint+Studio+Essentials[Mule Studio interface]. To increase your familiarity with Studio, consider completing one or more link:/docs/display/35X/Basic+Studio+Tutorial[Mule Studio Tutorials]. Further, this example assumes that you have a basic understanding of link:/docs/display/35X/Mule+Concepts[Mule flows], link:/docs/display/35X/Global+Elements[Mule Global Elements], and Mule Studio's link:/docs/display/35X/Datamapper+User+Guide+and+Reference[Anypoint DataMapper]. 
...
image:/docs/download/attachments/122750989/use_case_graphic3.png?version=1&modificationDate=1421450437919[image]
...
. From the *_force_.com* tab (sliding tab at right), click *New* next to *View Fields*. +
 +
image:/docs/download/thumbnails/122750989/add_new_sfdc_field.png?version=1&modificationDate=1421450438864[image] +
+
...
+
image:/docs/download/attachments/122750989/region_field2.png?version=1&modificationDate=1421450438138[image]

=== Create the Example Application

. **link:/docs/display/35X/Mule+Examples#MuleExamples-template[Create]** the example application in Mule Studio, using the *DataMapper with FlowRefLookup* template. _Do not run the application._
...
....
image:/docs/download/attachments/122750989/global_initial1.png?version=1&modificationDate=1421450436349[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750989/datamapper-with-flowref.png?version=1&modificationDate=1421450437003[image]
....
[tab,title="Studio XML Editor"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750989/groovy.png?version=1&modificationDate=1421450435700[image]
....
[tab,title="Studio XML Editor"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750989/new_flow.png?version=1&modificationDate=1421450437462[image]
....
[tab,title="Studio XML Editor"]
....
[source]
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750989/file+endpoint.png?version=1&modificationDate=1421450435482[image]
...
image:/docs/download/attachments/122750984/global_salesforce.png?version=1&modificationDate=1421450403232[image]
....
[tab,title="Studio XML Editor"]
....
[source]
...
+
image:/docs/download/attachments/122750984/getting_metadata.png?version=1&modificationDate=1421450403010[image] +
+
...
+
image:/docs/download/attachments/122750989/new_mappings_1.png?version=1&modificationDate=1421450436131[image] +
+
...
+
image:/docs/download/attachments/122750989/new_mappings_2.png?version=1&modificationDate=1421450435918[image] +
+
