...
image:/docs/download/thumbnails/122750986/legacy_modern_icon.png?version=1&modificationDate=1421450414674[image]An older, legacy system may be limited in the form of data that it accepts. For example, an older system may only accept input as a file or via FTP. To update such a system so that it accepts more modern input formats, such as Web service calls, Mule can sit in front of a legacy system, converting HTTP requests, for example, to strings. This conversion activity effectively "modernizes" the legacy system so that it accepts HTTP requests. 
...
+
image:/docs/download/attachments/122750986/soapUI_launch.png?version=1&modificationDate=1421450414896[image] +
...
. Click the submit request icon (green "play" button at upper left) to submit the request to the Mule application (see below, left). soapUI displays the response from the Mule application in the response pane (see below, right). +
 +
image:/docs/download/attachments/122750986/soapUI_both.png?version=1&modificationDate=1421450415129[image] +
+
...
. In the *Package Explorer* in Studio, navigate to `src/test/resources/Output`, then hit *F5* to refresh the contents of the Output folder. The order you submitted via soapUI appears as a new ShippingOrder flat file; note the date and time stamp of the new order (see below). Double-click the flat file to open it in Studio and examine the contents. +
 +
image:/docs/download/thumbnails/122750986/legmodpe.png?version=1&modificationDate=1421450414435[image]
...
....
image:/docs/download/attachments/122750986/legmodsoap.png?version=1&modificationDate=1421450414199[image]
....
...
+
image:/docs/download/attachments/122750986/DM_mapping.png?version=1&modificationDate=1421450415827[image]
+
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750986/mule-example-legacy-system-modernization.png?version=1&modificationDate=1421450416055[image]
....
[tab,title="Studio XML Editor"]
....
[source]
