...
image:/docs/download/thumbnails/122750422/mulestudio%281%29.png?version=1&modificationDate=1421449320729[image]
...
image:/docs/download/attachments/122750432/Studio-CBRTutorial_step1_unconfigured.png?version=1&modificationDate=1421449365559[image]
...
+
image:/docs/download/attachments/122750432/Studio-choice1.png?version=1&modificationDate=1421449366013[image]image:/docs/download/attachments/122750432/studio-choice2.png?version=1&modificationDate=1421449366407[image] +
+
...
+
image:/docs/download/attachments/122750432/studio-choice3.png?version=1&modificationDate=1421449366848[image] +
+
...
+
image:/docs/download/attachments/122750432/studio-choice4.png?version=1&modificationDate=1421449367275[image] +
+

. Your choice router should now match the image shown.

+
image:/docs/download/attachments/122750432/studio-choice5.png?version=1&modificationDate=1421449367639[image]
...
image:/docs/download/attachments/122750432/Studio-CBRTutorial_step1_unconfigured_notes.png?version=1&modificationDate=1421449365674[image]
...
image:/docs/download/attachments/122750432/HTTP-unconfig.png?version=1&modificationDate=1421449365308[image]
...
image:/docs/download/attachments/122750432/expressionpe.png?version=1&modificationDate=1421449365189[image]
...
image:/docs/download/attachments/122750432/setlangvar.png?version=1&modificationDate=1421449364852[image]
...
. In the table, click the first empty row under *When*, then enter `#[flowVars.language == 'Spanish']` +
 +
image:/https://developer.mulesoft.com/docs/download/attachments/122750432/cbrChoice1.png?version=1&modificationDate=1421449364642[image]
...
+
image:/docs/download/attachments/122750432/cbrChoice2.png?version=1&modificationDate=1421449364445[image] +
+
...
image:/docs/download/attachments/122750432/cbrSP1.png?version=1&modificationDate=1421449364260[image] +
+
...
+
image:/docs/download/attachments/122750432/cbrSP2.png?version=1&modificationDate=1421449364054[image] +
+
...
+
image:/docs/download/attachments/122750432/cbrSV.png?version=1&modificationDate=1421449363846[image]
+
...
+
image:/docs/download/attachments/122750432/cbrSP3.png?version=1&modificationDate=1421449363654[image] +
...
image:/docs/download/attachments/122750432/cbrLogger.png?version=1&modificationDate=1421449363466[image]
...
+
image:/docs/download/attachments/122750432/cbr-deploy-readout.png?version=1&modificationDate=1421449363240[image]
...
image:/docs/download/attachments/122750432/CBRtutorial_addlogger.png?version=1&modificationDate=1421449374870[image]

Click the *Logger* to open its Properties Editor, then configure as per the table below.

image:/docs/download/attachments/122750432/cbrlogger2.png?version=1&modificationDate=1421449362988[image] +
...
+
image:/docs/download/attachments/122750432/CBR-extracttosubflow.png?version=1&modificationDate=1421449375240[image]
...
+
image:/docs/download/attachments/122750432/AddaSubflow.png?version=1&modificationDate=1421449362793[image]
...
Drag and drop the subflow scope onto your canvas in the empty space underneath your existing flow. +
 +
 image:/docs/download/attachments/122750432/altaddsubflow.png?version=1&modificationDate=1421449362607[image]
+
....
[tab,title="XML Editor or Standalone"]
....
...
 Drag and drop the message processors into their new positions in the subflow scope. +
 +
image:/docs/download/attachments/122750432/altaddsubflow2.png?version=1&modificationDate=1421449362344[image]
+
....
[tab,title="XML Editor or Standalone"]
....
...
Drag and drop a *Flow Reference Component* into the Default box within the Choice scope. +
 +
image:/docs/download/attachments/122750432/altaddsubflow3.png?version=1&modificationDate=1421449362165[image]
+
....
[tab,title="XML Editor or Standalone"]
....
...
Click the *Flow Reference* building block to open its properties tab, then select `CBR_TutorialFlow2` from the *Flow name* drop down menu. +
 +
image:/docs/download/attachments/122750432/configflowref.png?version=1&modificationDate=1421449361955[image]
....
[tab,title="XML Editor or Standalone"]
....
...
+
image:/docs/download/attachments/122750432/AddRR.png?version=1&modificationDate=1421449361760[image]

. Drag the existing three message processors into the Round Robin scope, as shown.
+
image:/docs/download/attachments/122750432/cbr-ec2.png?version=1&modificationDate=1421449376309[image]
...
+
image:/docs/download/attachments/122750432/cbr-ec3.png?version=1&modificationDate=1421449376487[image]

. Press *enter* to start a new line, then paste the code twice to create three sets of processor chains. 
+
image:/docs/download/attachments/122750432/cbr-ec4.png?version=1&modificationDate=1421449376668[image]
...
+
image:/docs/download/attachments/122750432/cbr-ec5.png?version=1&modificationDate=1421449377028[image]

In the visual editor, the subflow looks like this:
+
image:/docs/download/attachments/122750432/cbr-ec-subflow.png?version=1&modificationDate=1421449376847[image]
...
image:/docs/download/attachments/122750432/Studio-stopcbrapp.png?version=1&modificationDate=1421449371676[image]
