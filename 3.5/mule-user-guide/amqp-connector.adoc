...
* Read the link:/docs/display/current/AMQP+Connector+Examples[AMQP Connector Examples] for practical illustrations of common use cases.
* Access the link:/docs/display/current/AMQP+Connector+Reference[AMQP Connector Reference] for a complete list and description of all AMQP connector configuration attributes.
