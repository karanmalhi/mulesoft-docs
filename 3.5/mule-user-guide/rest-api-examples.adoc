...
image:/docs/download/attachments/122752040/rest+api+1.png?version=1&modificationDate=1419860187322[image]
...
image:/docs/download/attachments/122752040/http+listener+basic.png?version=1&modificationDate=1419867081961[image]
...
image:/docs/download/attachments/122752040/http+config+1.png?version=1&modificationDate=1418766173402[image]
...
+
image:/docs/download/attachments/122752040/http+global+element+baconipsum.png?version=1&modificationDate=1419867308706[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
+
image:/docs/download/attachments/122752040/http+connector+basic.png?version=1&modificationDate=1419868383126[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
+
image:/docs/download/attachments/122752040/request+connector+w+params.png?version=1&modificationDate=1419868243527[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
image:/docs/download/attachments/122752040/browser1.png?version=1&modificationDate=1402421099428[image]
...
image:/docs/download/attachments/122752040/yahoo+xml.png?version=1&modificationDate=1419877957205[image]
...
. Create a new Connector Configuration Element and set up the *Host* and *Base Path*:
+
image:/docs/download/attachments/122752040/yahoo+global+element.png?version=1&modificationDate=1419878220587[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
+
image:/docs/download/attachments/122752040/yahoo+http+w+params.png?version=1&modificationDate=1419878751368[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
|*Display Name* |`Byte Array to String` .5+|image:/docs/download/thumbnails/122752040/byte_array_to_str.png?version=1&modificationDate=1402421099442[image]
|*Return Class* |`-`
|*Ignore Bad Input* |no
|*Encoding* |`-`
|*MIME Type* |`-`
...
|===
|Parameter |Value |Configuration window image
|*Display Name* |`Byte Array to String` .4+|image:/docs/download/thumbnails/122752040/byte_array_to_str.png?version=1&modificationDate=1402421099442[image]
...
|===
|Parameter |Value |Configuration window image
|*Display Name* |`Database` .5+|image:/docs/download/attachments/122752040/db_conn_general_tab.png?version=1&modificationDate=1402496843506[image]
...
image:/docs/download/attachments/122752040/db_conn_adv_tab.png?version=1&modificationDate=1402496961619[image]
...
|===
|Parameter |Value |Configuration window image
|*Name* |`Postgres` .5+|image:/docs/download/attachments/122752040/db_conn_general_tab.png?version=1&modificationDate=1402496843506[image]
...
image:/docs/download/attachments/122752040/browser2.png?version=1&modificationDate=1402421099436[image]
...
image:/docs/download/thumbnails/122752040/pgadmin.png?version=1&modificationDate=1402421099541[image]
...
image:/docs/download/attachments/122752040/yahoo+flow+2.png?version=1&modificationDate=1419881239673[image]
...
|===
|Parameter |Value |Configuration window image
|*Display Name* |`JSON to Object` .2+|image:/docs/download/thumbnails/122752040/json.to.object.general.png?version=1&modificationDate=1402421099520[image]
|*Mapper Reference* |`-`
|===
...
|===
|Parameter |Value |Configuration window image
|*Return Class* |`java util.Map` .4+|image:/docs/download/thumbnails/122752040/json.to.object-adv_tab.png?version=1&modificationDate=1402421099514[image]
|*Ignore Bad Input* |`no`
|*Encoding* |`-`
|*MIME Type* |`-`
|===
...
|===
|Parameter |Value |Configuration window image
|*Display Name* |`Database` .5+|image:/docs/download/attachments/122752040/db_conn_json_gral_tab.png?version=1&modificationDate=1402501478553[image]
...
|===
|Parameter |Value |Configuration window image
|*Name* |`Postgres` .5+|image:/docs/download/attachments/122752040/db_global_elem.png?version=1&modificationDate=1402497637228[image]
...
image:/docs/download/thumbnails/122752040/pgadmin-json.png?version=1&modificationDate=1402421099535[image]
