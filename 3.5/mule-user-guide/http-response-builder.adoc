...
image:/docs/download/attachments/122750708/ex+1+2.png?version=1&modificationDate=1421449661499[image]
...
image:/docs/download/attachments/122750708/cookies+headers.png?version=1&modificationDate=1421449662661[image]
...
+
image:/docs/download/attachments/122750708/ex1+1.png?version=1&modificationDate=1421449662421[image]

. Drag an HTTP response builder to your flow after the HTTP Connector.
+
image:/docs/download/thumbnails/122750708/ex1+3.png?version=1&modificationDate=1421449662865[image]
...
+
image:/docs/download/attachments/122750708/ex2+1.png?version=1&modificationDate=1421449662225[image]

. Drag a *Set Payload* component after the HTTP connector.

. Set the Value field to `<HTML><BODY>hello world</BODY></HTML>`.
+
image:/docs/download/attachments/122750708/ex2+2.png?version=1&modificationDate=1421449661976[image]
+
...
+
image:/docs/download/thumbnails/122750708/ex2+flow.png?version=1&modificationDate=1421449661338[image]
