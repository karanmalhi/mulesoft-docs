...
+
image:/docs/download/attachments/122752109/perceptive+flow+1.png?version=2&modificationDate=1419889212277[image]
+
...
+
image:/docs/download/attachments/122752109/perceptive+flow+2.png?version=1&modificationDate=1419889225666[image]
+
...
+
image:/docs/download/attachments/122752109/dataMapping_example.png?version=1&modificationDate=1386797998794[image]
+
...
+
image:/docs/download/thumbnails/122752109/conn.exp.pane.png?version=1&modificationDate=1386799276114[image]

* In the Studio canvas, right-click the connector, then select *Clear DataSense Metadata*.
+
image:/docs/download/thumbnails/122752109/studio.canv.png?version=1&modificationDate=1386799307498[image]
