...
All of the functions and attributes below are usable within link:/docs/display/current/Mule+Expression+Language+MEL[MEL] expressions anywhere in Mule where the context makes sense.
...
image:/docs/download/attachments/126746923/batch+function1.png?version=1&modificationDate=1430148161570[image]

Here you can add the following expression into the Set Payload transformer:

image:/docs/download/attachments/126746923/batch+function2.png?version=1&modificationDate=1430148204102[image]
...
* Read more about using link:/docs/display/current/Mule+Expression+Language+MEL[Mule Expression Language (MEL)]in your application
