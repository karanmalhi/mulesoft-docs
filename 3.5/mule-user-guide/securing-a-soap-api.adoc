...
image:/docs/download/attachments/122752043/CXFsecuritytab.png?version=1&modificationDate=1400523928284[image]
. Click the
...
image:/docs/download/attachments/122752043/Studio-wssecurity-add.png?version=1&modificationDate=1396894267418[image]
+
[TIP]
...
+
image:/docs/download/attachments/122752043/CXFs-addconfigprop.png?version=1&modificationDate=1400524033898[image]

. Enter information in either the *Value* field _OR_ the *Value Reference Field* according to the table below.
+
image:/docs/download/attachments/122752043/usernametoken.png?version=1&modificationDate=1400524071149[image]
+
[cols=",",]
|===
...
+
image:/docs/download/attachments/122752043/Studio-wssecurity-token.png?version=1&modificationDate=1396894463926[image]
+
...
+
image:/docs/download/attachments/122752043/Studio-wssecurity-custom.png?version=1&modificationDate=1396894584610[image]
