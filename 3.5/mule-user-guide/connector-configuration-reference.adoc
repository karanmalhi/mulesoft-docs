...
....
image:/docs/download/attachments/122752030/connector+conf+inf+3.png?version=1&modificationDate=1420489787487[image]
....
...
[tab,title="STUDIO Visual Editor"]
....
image:/docs/download/attachments/122752030/connector+config+ref2.png?version=1&modificationDate=1420493264902[image]
...
[tab,title="STUDIO Visual Editor"]
....
 image:/docs/download/attachments/122752030/connector+config+ref+4.png?version=1&modificationDate=1420493528122[image]
....
[tab,title="XML Editor or Standalone"]
....
[source]
