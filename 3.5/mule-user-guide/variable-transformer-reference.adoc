...
doc:name="Variable"
----
|*Operation* |Set Variable |Select to set a new variable on your message (as shown in example screenshot above). a|[SOURCE]
----
<set-variable>
----
| |Remove Variable |Select to delete an existing variable from your message. a|[SOURCE]
----
<remove-variable>
----
