...
The link:/docs/display/current/HTTP+Request+Connector[HTTP Request Connector] supports four types of authentication:
...
image:/docs/download/attachments/122751350/basic+auth.png?version=1&modificationDate=1421093393803[image]
....
...
image:/docs/download/attachments/123339934/oauth+danceposta.png?version=2&modificationDate=1423075626532[image]
...
image:/docs/download/attachments/123339934/oauth+danceposta+simple.png?version=3&modificationDate=1423075669910[image]
...
*  link:/docs/display/current/HTTP+Request+Connector[HTTP Request Connector]
