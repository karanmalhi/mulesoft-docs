...
*Release Notes:* link:/docs/display/current/HDFS+Connector+Release+Notes[HDFS Connector Release Notes]
...
To use the HDFS connector in your Mule application, you must configure a global HDFS element that can be used by all the HDFS connectors in the application (read more about link:/docs/display/current/Global+Elements[global elements]).
...
+
image:/docs/download/attachments/124486303/1.png?version=1&modificationDate=1425661022528[image]
+
[width="100%",cols=",",options="header"]
|===
...
+
image:/docs/download/attachments/124486303/2.png?version=1&modificationDate=1425661325662[image]
+
[width="100%",cols=",",options="header"]
|===
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/124486303/hdfsflow.png?version=1&modificationDate=1425667562454[image]

. Drag an HTTP connector into the canvas, then select it to open the properties editor console.
. Add a new HTTP Listener Configuration global element:
.. In *General Settings*, click the *Add* button:
+
image:/docs/download/attachments/124486303/4.png?version=1&modificationDate=1425661384950[image]

..  Configure the following HTTP parameters:
+
image:/docs/download/attachments/124486303/5.png?version=1&modificationDate=1425661423952[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/docs/download/attachments/124486303/6.png?version=2&modificationDate=1425661483674[image]
...
+
image:/docs/download/attachments/124486303/7.jpg?version=1&modificationDate=1425661530121[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
|*Display Name* |Write to path log (or any other name you prefer)
|*Message* a|Create file: `#[message.inboundProperties['http.query.params'].path] with message: #[message.inboundProperties['http.query.params'].msg]`
|*Level* |INFO (Default)
|===
...
+
image:/docs/download/attachments/124486303/8.png?version=1&modificationDate=1425661581332[image]
+
[width="100%",cols=",",options="header",]
|===
|Field |Value
...
+
image:/docs/download/attachments/124486303/9.jpg?version=1&modificationDate=1425661620239[image]
+
[width="100%",cols=",",options="header"]
|====
|Field |Value
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/124486303/DeleteFileFlow.png?version=1&modificationDate=1425955278382[image]

. Drag an HTTP connector into the canvas, then select it to open the properties editor console.
. Add a new HTTP Listener Configuration global element:
.. In *General Settings*, click the *Add* button:
 +
 image:/docs/download/attachments/124486303/11.png?version=1&modificationDate=1425661799899[image]

.. Configure the following HTTP parameters:
+
image:/docs/download/attachments/124486303/12.png?version=1&modificationDate=1425661832183[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
.  Reference the HTTP Listener Configuration global element:
+
image:/docs/download/attachments/124486303/13.png?version=1&modificationDate=1425661880069[image]
...
+
image:/docs/download/attachments/124486303/14.jpg?version=1&modificationDate=1425661914595[image]
+
[width="100%",cols=",",options="header"]
|====
|Field |Value
...
. Configure the global element according to the table below.
+
image:/docs/download/attachments/124486303/15.png?version=1&modificationDate=1425661961039[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
. Back in the properties editor of the HDFS connector in your application, configure the remaining parameters according to the table below.
+
image:/docs/download/attachments/124486303/16.jpg?version=1&modificationDate=1425662014692[image]
+
[width="100%",cols=",",options="header"]
|====
|Field |Value
...
* Access HDFS connectorlink:/docs/display/current/HDFS+Connector+Release+Notes[release notes].
* Learn how to link:/docs/display/current/Using+Maven+with+Mule[use Maven with Mule].
