...
timeout="6000"
----
|*Threading Profile* |Optionally, use to customize the threading profile. Refer to link:/docs/display/current/Tuning+Performance[Tuning Performance] for a description of the configurable attributes. For a brief discussion of threading profiles in Scatter-Gather, see the link:#Scatter-Gather-threadprof[section below]. + |Default threading profile a|
[source]
----
...
|===
|Optional Child Element |Description
|*threading-profile* |Allows you to configure the underlying thread pool. Refer to link:/docs/display/current/Tuning+Performance[Tuning Performance] for a list of configurable attributes, all of which can be applied here. For a brief discussion of threading profiles in Scatter-Gather, see the link:#Scatter-Gather-threadprof[section below].
|===
