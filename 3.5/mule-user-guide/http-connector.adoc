...
image:/docs/download/attachments/122750881/Studio-http-gen.png?version=1&modificationDate=1421450117237[image]
...
|*Enable HTTPS* |Check this box to send http://en.wikipedia.org/wiki/HTTP_Secure[HTTPS over SSL protocol]. If you enable HTTPS, ensure that you configure, then reference a link:#HTTPConnector-ReferencesTab[global HTTPS connector] on your endpoint.
...
image:/docs/download/attachments/122750881/studio-http-adv.png?version=1&modificationDate=1421450117014[image]
...
image:/docs/download/attachments/122750881/studio-http-trans.png?version=1&modificationDate=1421450116795[image]
...
image:/docs/download/attachments/122750881/studio-http-settings.png?version=1&modificationDate=1421450116548[image]
