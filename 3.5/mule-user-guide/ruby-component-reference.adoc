...
[TIP]
Placing a Ruby Component is actually the same as placing a link:/docs/display/current/Script+Component+Reference[Script component] and then selecting the Ruby engine.
...
image:/docs/download/attachments/122752212/ruby_general.png?version=1&modificationDate=1398893677686[image]
...
image:/docs/download/attachments/122752212/ruby_advanced.png?version=1&modificationDate=1398893795183[image]
...
* Refer to the generic link:/docs/display/current/Script+Component+Reference[Script Component Reference] to see how a script works with one-way and request-response connectors.
