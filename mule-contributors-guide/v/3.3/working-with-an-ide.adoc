...
. Follow the link:/docs/display/34X/Downloading+and+Launching+Mule+ESB[instructions] to download, install and launch Mule Studio.
. Follow link:/docs/display/34X/Converting+Maven+into+Studio[the procedure] to add the *`studio:studio`* plug in in your Maven `settings.xml` file.
