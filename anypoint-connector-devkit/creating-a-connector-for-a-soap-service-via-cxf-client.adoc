...
+
image:creating-a-connector-for-a-soap-service-via-cxf-client-1.png[image]
+
...
+
image:creating-a-connector-for-a-soap-service-via-cxf-client-2.png[image]
+
...
+
image:creating-a-connector-for-a-soap-service-via-cxf-client-3.png[image]
+
...
+
image:creating-a-connector-for-a-soap-service-via-cxf-client-4.png[image] 
...
image:creating-a-connector-for-a-soap-service-via-cxf-client-5.png[image]
...
See link:/anypoint-connector-devkit/setting-up-api-access[Setting Up Your API Access] for steps that may be required to gain access to other APIs, including how to get access to the WSDL file.
...
image:creating-a-connector-for-a-soap-service-via-cxf-client-6.png[image]
...
. Import or re-import your Maven project to your IDE, as described in "Importing a Maven Project into Eclipse/Anypoint Studio" in link:/anypoint-connector-devkit/creating-an-anypoint-connector-project[Creating an Anypoint Connector Project].
. Look for the folder `target/generated-sources/cxf`.
. Right-click the folder name, then select *Build Path* > *Use as Source Folder*.
+
image:creating-a-connector-for-a-soap-service-via-cxf-client-7.png[image]
...
The different authentication methods are discussed in link:/anypoint-connector-devkit/authentication-methods[Authentication Methods]; find your authentication method and refer to the examples for guidance on how to add authentication handling in the proxy client.
====
...
DevKit enforces JavaDoc documentation of your methods. One of the things you must add is an XML sample of the inputs required by each connector method. link:/anypoint-connector-devkit/annotation-reference[Learn more about Javadoc annotations for DevKit].
...
See link:/anypoint-connector-devkit/connector-reference-documentation[Creating DevKit Connector Documentation] for full information on filling in the JavaDoc for your connector.
...
See link:/anypoint-connector-devkit/installing-and-testing-your-connector-in-studio[Installing and Testing Your Connector] for the steps to follow in order to build your connector and install it into Studio.
...
image:creating-a-connector-for-a-soap-service-via-cxf-client-8.png[image]

image:creating-a-connector-for-a-soap-service-via-cxf-client-9.png[image]
...
* Check out some of the other link:/anypoint-connector-devkit/anypoint-connector-examples[examples]
