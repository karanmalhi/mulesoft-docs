...
For more information, see link:/anypoint-connector-devkit/oauth-v1[OAuth V1] or link:/anypoint-connector-devkit/oauth-v2[OAuth V2].
...
For more information, see link:/anypoint-connector-devkit/http-basic-authentication[HTTP Basic Authentication].
...
|Basic Authentication |link:/anypoint-connector-devkit/connection-management[Connection Management]
|OAuth 1.0 |link:/anypoint-connector-devkit/oauth-v1[OAuth V1]
|OAuth 2.0 |link:/anypoint-connector-devkit/oauth-v2[OAuth V2]
|HTTP Basic Authentication |link:/anypoint-connector-devkit/http-basic-authentication[HTTP Basic Authentication]
|SAML |link:/anypoint-connector-devkit/connection-management[Connection Management]
|Kerberos |link:/anypoint-connector-devkit/connection-management[Connection Management]
|NTLM |link:/anypoint-connector-devkit/connection-management[Connection Management]
|LDAP |link:/anypoint-connector-devkit/connection-management[Connection Management]
|===
