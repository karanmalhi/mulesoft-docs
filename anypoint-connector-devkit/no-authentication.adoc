...
This document assumes you are familiar with the link:/anypoint-connector-devkit/[Anypoint Connector DevKit] and you are ready to implement a configuration in your connector.
