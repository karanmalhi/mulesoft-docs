...
See also: link:/anypoint-connector-devkit/connection-management[Connection Management]  link:#AnnotationReference-cnctan[@Connect]  link:#AnnotationReference-coidan[@ConnectionIdentifier]  link:#AnnotationReference-discan[@Disconnect]  link:#AnnotationReference-invan[@InvalidateConnectionOn]  +
...
See also:  link:/anypoint-connector-devkit/connection-management[Connection Management]   link:#AnnotationReference-cnctan[@Connect]   link:#AnnotationReference-discan[@Disconnect]   link:#AnnotationReference-invan[@InvalidateConnectionOn]   +
 link:#AnnotationReference-recan[@ReconnectOn]   link:#AnnotationReference-valcan[@ValidateConnection]    
...
image:annotation-reference-1.png[image]
...
See also:  link:/anypoint-connector-devkit/connection-management[Connection Management]   link:#AnnotationReference-cnctan[@Connect]   link:#AnnotationReference-coidan[@ConnectionIdentifier]   link:#AnnotationReference-invan[@InvalidateConnectionOn]   +
 link:#AnnotationReference-recan[@ReconnectOn]   link:#AnnotationReference-valcan[@ValidateConnection]    
...
image:annotation-reference-2.png[image]
...
See also:  link:/anypoint-connector-devkit/connection-management[Connection Management]   link:#AnnotationReference-cnctan[@Connect]    link:#AnnotationReference-coidan[@ConnectionIdentifier]    link:#AnnotationReference-discan[@Disconnect]    +
 link:#AnnotationReference-recan[@ReconnectOn]   link:#AnnotationReference-valcan[@ValidateConnection]    
...
Specifies link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language (MEL)] as a method parameter without the DevKit resolving the expression. You can use any MEL code with this annotation.
...
image:annotation-reference-3.png[image]
...
image:annotation-reference-4.png[image]
...
image:annotation-reference-5.png[image]
...
See also:  link:/anypoint-connector-devkit/connection-management[Connection Management]  link:#AnnotationReference-cnctan[@Connect]  link:#AnnotationReference-coidan[@ConnectionIdentifier]  link:#AnnotationReference-discan[@Disconnect]  link:#AnnotationReference-invan[@InvalidateConnectionOn]  link:#AnnotationReference-recan[@ReconnectOn]  
