...
If you have not already installed Anypoint Studio, follow the link:/mule-user-guide/installing[detailed instructions] to install. For a quick introduction to Anypoint Studio, review link:/mule-fundamentals/anypoint-studio-essentials[Anypoint Studio Essentials].
...
+
image:setting-up-your-dev-environment-1.png[image]
+
...
+
image:setting-up-your-dev-environment-2.png[image]
+
...
* *NEXT:*  Continue to the next step by link:/anypoint-connector-devkit/setting-up-api-access[Setting Up API Access]. 
* Jump into link:/anypoint-connector-devkit/creating-an-anypoint-connector-project[Creating an Anypoint Connector Project].
* Eager to begin coding? Use the link:/anypoint-connector-devkit/anypoint-connector-development[Anypoint Connector Development] for a quick walkthrough of the entire development process.
