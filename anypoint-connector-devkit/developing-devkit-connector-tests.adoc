...
* Installed the Anypoint Connector DevKit Plugin as described in  link:/anypoint-connector-devkit/creating-an-anypoint-connector-project[Creating an Anypoint Connector Project]
...
+
image:developing-devkit-connector-tests-1.png[image]
+
...
+
image:developing-devkit-connector-tests-2.png[image]
+
...
After you complete your test suite, you can link:/anypoint-connector-devkit/connector-reference-documentation[complete documentation and samples] for your connector.
