...
image::connector-testing-framework-1.png[image]
...
* link:/anypoint-connector-devkit/developing-devkit-connector-tests[Developing DevKit Connector Tests]
* link:/anypoint-connector-devkit/installing-and-testing-your-connector-in-studio[Installing and Testing Your Connector]
