...
image:adding-datasense-query-language-1.png[image]

*https://github.com/mulesoft/example-connector/tree/basic-dsql[Source Code]*

== Prerequisites

* Familiarity with Anypoint Connectors, link:/mule-user-guide/datasense[DataSense], link:/mule-user-guide/datasense-query-editor[DataSense Query Editor], and link:/anypoint-connector-devkit/adding-datasense-query-language[Adding DataSense Query Language] from a user level.
* Understand Java "@" annotations. See link:/anypoint-connector-devkit/annotation-reference[Annotation Reference].
* Experience with implementing a basic connector with link:/anypoint-connector-devkit/[Anypoint DevKit].
...
* link:/anypoint-connector-devkit/adding-datasense[Enable DataSense] (including `@MetaDataKeyRetriever` and `@MetaDataRetriever` annotated methods).
...
Consider the DSQL query example from the link:/anypoint-connector-devkit/adding-datasense-query-language[Adding DataSense Query Language] documentation:
...
image:adding-datasense-query-language-2.png[image]
...
image:adding-datasense-query-language-3.png[image]
...
image:adding-datasense-query-language-4.png[image]
...
image:adding-datasense-query-language-5.png[image]

In this case, DataMapper handles a list of Authors that only have a firstName field.

== See Also

* **NEXT**: Add support for link:/anypoint-connector-devkit/adding-query-pagination-support[pagination] to your query operation.
* Learn how to add link:/anypoint-connector-devkit/developing-devkit-connector-tests[tests] to your Connector.
* Generate the link:/anypoint-connector-devkit/connector-reference-documentation[Reference Documentation].
