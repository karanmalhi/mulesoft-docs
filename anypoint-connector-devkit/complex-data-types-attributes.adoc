...
* NEXT: Continue to link:/anypoint-connector-devkit/adding-datasense[Add DataSense] to your Connector.
* Learn how to link:/anypoint-connector-devkit/developing-devkit-connector-tests[Test Your Connector].
