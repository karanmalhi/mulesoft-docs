...
** Consumer key
** Consumer secret
. For detailed instructions on creating an application on the Twitter platform, see link:/anyoint-connector-devkit/v/3.7/configure-twitter-for-api-access[Configure Twitter for API Access] .
