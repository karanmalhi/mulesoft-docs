...
** Consumer key
** Consumer secret
. For detailed instructions on creating an application on the Twitter platform, see link:http://www.mulesoft.org/documentation/display/current/Configure+Twitter+for+API+Access[Configure Twitter for API Access] .
