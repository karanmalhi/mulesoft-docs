...
image:/documentation/download/attachments/122752368/6-package.png?version=1&modificationDate=1405524731185[image]

*https://github.com/mulesoft/example-connector/tree/basic-dsql[Source Code]*

== Prerequisites

* Familiarity with Anypoint Connectors, link:/documentation/display/current/DataSense[DataSense], link:/documentation/display/current/DataSense+Query+Editor[DataSense Query Editor], and link:/documentation/display/current/Adding+DataSense+Query+Language[Adding DataSense Query Language] from a user level.
* Understand Java "@" annotations. See link:/documentation/display/current/Annotation+Reference[Annotation Reference].
* Experience with implementing a basic connector with link:/documentation/display/current/Anypoint+Connector+DevKit[Anypoint DevKit].
...
* link:/documentation/display/current/Adding+DataSense[Enable DataSense] (including `@MetaDataKeyRetriever` and `@MetaDataRetriever` annotated methods).
...
Consider the DSQL query example from the link:/documentation/display/current/Adding+DataSense+Query+Language[Adding DataSense Query Language] documentation:
...
image:/documentation/download/attachments/122752368/qb2.png?version=1&modificationDate=1405524731207[image]
...
image:/documentation/download/attachments/122752368/query+builder.png?version=1&modificationDate=1405524731221[image]
...
image:/documentation/download/attachments/122752368/qb3.png?version=1&modificationDate=1405524731213[image]
...
image:/documentation/download/attachments/122752368/dm.png?version=1&modificationDate=1405524731193[image]

In this case, DataMapper handles a list of Authors that only have a firstName field.

== See Also

* **NEXT**: Add support for link:/documentation/display/current/Adding+Query+Pagination+Support[pagination] to your query operation.
* Learn how to add link:/documentation/display/current/Developing+DevKit+Connector+Tests[tests] to your Connector.
