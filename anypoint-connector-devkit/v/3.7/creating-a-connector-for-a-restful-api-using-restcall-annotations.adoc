...
This document assumes you are familiar with RESTful APIs, and with the DevKit connector architecture described in link:/documentation/display/current/Anypoint+Connector+DevKit[Anypoint Connector DevKit].
...
image:/documentation/download/attachments/122752417/image2013-10-15+1%3A49%3A12.png?version=1&modificationDate=1405523832745[image]
...
* The OAuth2 annotations are used on the relevant methods and properties, as described in link:/documentation/display/current/OAuth+V2[OAuth V2]
...
For details on developing connector tests, see link:/documentation/display/current/Developing+DevKit+Connector+Tests[Developing DevKit Connector Tests].
====
...
* Refine the appearance of the connector dialog boxes and XML element through more annotations, as described in link:/documentation/display/current/Defining+Connector+Attributes[Defining Connector Attributes]. 
