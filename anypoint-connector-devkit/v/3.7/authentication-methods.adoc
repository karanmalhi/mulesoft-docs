...
For more information, see link:/documentation/display/current/OAuth+V1[OAuth V1] or link:/documentation/display/current/OAuth+V2[OAuth V2].
...
For more information, see link:/documentation/display/current/HTTP+Basic+Authentication[HTTP Basic Authentication].
...
|Basic Authentication |link:/documentation/display/current/Connection+Management[Connection Management]
|OAuth 1.0 |link:/documentation/display/current/OAuth+V1[OAuth V1]
|OAuth 2.0 |link:/documentation/display/current/OAuth+V2[OAuth V2]
|HTTP Basic Authentication |link:/documentation/display/current/HTTP+Basic+Authentication[HTTP Basic Authentication]
|SAML |link:/documentation/display/current/Connection+Management[Connection Management]
|Kerberos |link:/documentation/display/current/Connection+Management[Connection Management]
|NTLM |link:/documentation/display/current/Connection+Management[Connection Management]
|LDAP |link:/documentation/display/current/Connection+Management[Connection Management]
|===

== See Also

link:/documentation/display/current/Defining+Attributes+Operations+and+Data+Model[Defining Attributes Operations and Data Model]
