...
NOTE:
For more information on configuring an *HTTPS connector*, see the link:/mule-user-guide/v/3.7/https-transport-reference[HTTPS Transport Reference] and link:/anyoint-connector-devkit/v/3.7/tls-configuration[Examples for HTTPS].
