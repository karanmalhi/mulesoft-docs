...
*Note*: To import an existing connector project, see link:http://www.mulesoft.org/documentation/display/current/Creating+a+JAVA+SDK-BASED+CONNECTOR#CreatingaJavaSDK-BasedConnector-importingexisting[Importing an Existing Connector Project].
