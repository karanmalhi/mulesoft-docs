...
. Import or re-import your Maven project to your IDE, as described in Writing Extensions in IntelliJ or "Importing a Maven Project into Eclipse/Mule Studio" in link:/docs/display/34X/Creating+a+Connector+Project[Creating a Connector Project]. 
