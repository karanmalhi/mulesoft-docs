...
Value: `Community`
+
image:/docs/download/attachments/98309862/maven_last_wizard1.png?version=1&modificationDate=1389390586689[image]
...
+
image:/docs/download/attachments/98309862/ExternalResource+%281%29.png?version=1&modificationDate=1397683834858[image]
...
. Use the external resource drop-down to select *Manually Setup External Resource*.
+
image:/docs/download/attachments/98309862/ExternalResource.png?version=1&modificationDate=1389299588932[image]
