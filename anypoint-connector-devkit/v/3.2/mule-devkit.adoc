...
Look at our link:/documentation-3.2/display/32X/Your+First+Cloud+Connector[Your First Cloud Connector] section to get started.
...
* link:/documentation-3.2/display/32X/Publish[Publish] explains how people can submit Mule extensions to the http://www.mulesoft.org/muleforge[MuleForge] site for sharing with the entire Community.

* link:/documentation-3.2/display/32X/Contribute[Contribute] explains how the Community can help improve the Mule DevKit. The Mule DevKit project source code is open to the entire Community.

* link:/documentation-3.2/display/32X/How+the+DevKit+Works[How the Devkit Works] shows how the DevKit works under the covers.

* link:/documentation-3.2/display/32X/Glossary[Glossary] provides quick reference for key terms used in this documentation.
