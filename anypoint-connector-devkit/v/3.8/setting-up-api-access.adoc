...
** Consumer key
** Consumer secret
. For detailed instructions on creating an application on the Twitter platform, see link:/anypoint-connector-devkit/v/3.8/configure-twitter-for-api-access[Configure Twitter for API Access].
