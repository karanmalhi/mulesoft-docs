...
[TIP]
For more information about testing in Mule, consult link:/mule-user-guide/v/3.3/testing-with-mule-esb-3[Testing With Mule ESB 3] and link:/mule-user-guide/v/3.3/functional-testing[Functional Testing].
