...
+
image:/documentation/download/thumbnails/122752408/reset_token.png?version=1&modificationDate=1405523651503[image]
+
...
*NEXT:* Continue to link:/documentation/display/current/Creating+an+Anypoint+Connector+Project[Creating an Anypoint Connector Project] to begin developing your connector.
