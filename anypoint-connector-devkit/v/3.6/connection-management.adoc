...
This document assumes you are familiar with the link:/documentation/display/current/Anypoint+Connector+DevKit[Anypoint Connector DevKit], have already link:/documentation/display/current/Creating+an+Anypoint+Connector+Project[created a connector project], and are ready to implement authentication on your connector. Further, it assumes you are familiar with the various link:/documentation/display/current/Authentication+Methods[authentication methods], have compared the different link:/documentation/display/current/Authentication[authentication support options in Devkit], and chosen Basic Authentication to connect to your API.
...
The specific implementation of these methods depends on the target. For more information on annotations, see the link:/documentation/display/current/Annotation+Reference[Annotation Reference].
