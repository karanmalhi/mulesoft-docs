...
+
image:/documentation/download/attachments/122752411/ArchiveFile.png?version=1&modificationDate=1418664292234[image]

. Click the down arrow next to your project name and unclick *target*: +
+
image:/documentation/download/attachments/122752411/ArchiveDirs.png?version=1&modificationDate=1418664135875[image]
