...
This document assumes you have link:/anypoint-connector-devkit/creating-an-anypoint-connector-project[created a connector project]. 
...
This command creates an update site that you can use to install the connector in Anypoint Studio. For more information about how to package your connector, check link:/anypoint-connector-devkit/packaging-your-connector-for-release[Packaging Your Connector for Release].

The *Install or Update*  feature also automatically installs your connector in Anypoint Studio.

image:installing-and-testing-your-connector-in-studio-1.png[image]
...
+
image:installing-and-testing-your-connector-in-studio-2.png[image]
...
+
image:installing-and-testing-your-connector-in-studio-3.png[image]
+
[cols=",",options="header"]
|===
|Parameter |Value
...
+
image:installing-and-testing-your-connector-in-studio-4.png[image]
+
. In the *My Property*, *Username*, and *Password* fields, enter any string as the value, then click *OK*. +
 +
image:installing-and-testing-your-connector-in-studio-5.png[image]
+
...
+
image:installing-and-testing-your-connector-in-studio-6.png[image]
...
. The application returns the response in your browser (see below).
+
image:installing-and-testing-your-connector-in-studio-7.png[image]
...
* *NEXT STEP:* Implement link:/anypoint-connector-devkit/authentication[authentication] on your connector.
