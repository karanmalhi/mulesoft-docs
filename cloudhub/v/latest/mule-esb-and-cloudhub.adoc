...
CloudHub provides an implementation of the user object store. It places limits on the usage of this to avoid abuse. These are detailed on the link:/cloudhub/managing-application-data-with-object-stores[Object Store] page.
