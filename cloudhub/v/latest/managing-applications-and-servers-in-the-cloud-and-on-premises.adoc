...
The bell icon in the upper right corner lets you manage notifications. For more information, see link:http://www.mulesoft.org/documentation/display/current/Alerts+and+Notifications#AlertsandNotifications-ManagingNotifications[Managing Notifications] in the link:/cloudhub/alerts-and-notifications[Alerts and Notifications] guide.
