...
*Download it from link:http://mule-agent.s3.amazonaws.com/1.3.0/mule-agent-internal-handlers-db-1.3.0.zip[here]*
====


== Agent Configurable Fields

When launching the Mule Agent via the command line, you can include the following parameters.
