...
[NOTE]
====
In the cloud version of the Anypoint Platform, your Mule deployments to the cloud and on premises are managed via a section named *CloudHub*. In the downloadable Aynpoint Platform On Premises Edition, the section that manages your on premise Mule deployments is named *Anypoint Runtime Manager*.

The topics in this document deal with functionality that is common to both.
====
