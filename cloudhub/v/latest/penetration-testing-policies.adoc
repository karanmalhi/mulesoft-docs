...
* Send an email to link:security@mulesoft.com[support] upon start and completion of tests.
* Notify link:security@mulesoft.com[support] of any vulnerabilities found immediately.
