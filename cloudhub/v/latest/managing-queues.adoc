...
* Learn more about the advantages of link:https://developer.mulesoft.com/docs/display/current/CloudHub+Fabric#CloudHubFabric-PersistentQueues[persistent queueing].
