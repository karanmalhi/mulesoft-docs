...
Yes! You can assign a static IP to your application in the *Static IPs* tab on the application settings. Details may be found in the *Static IPs Tab* section in *Deploying your CloudHub Application* page. By default, you are allocated a number of static IPs equal to 2x the number of Production vCores in your subscription. To raise this limit, please contact MuleSoft Support. 
