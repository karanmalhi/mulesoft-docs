...
The steps below should be carried out for every one of the servers that you wish to use. In this walkthrough, we'll run these steps on five different servers.
...
. The Runtime Manager provides you with a generic command to install Mule agent on a server. Click *Copy* to copy this command to your clipboard.
