...
See the link:http://www.mulesoft.org/documentation/display/current/FAQ#FAQ-Technical/Troubleshooting[Cloudhub FAQs] for more things to consider when assigning Static IPs.
