...
TIP: If you are using Anypoint Studio, Maven integration is already solved for you. See link:/munit/v/1.1.0/using-maven-in-anypoint-studio[Using Maven in Anypoint Studio] for details.
