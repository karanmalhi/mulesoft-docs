= MUnit 1.1.0 Migration Guide
:version-info: 3.7.0 and later
:keywords: munit, testing, unit testing, migration

To upgrade to MUnit 1.1.0, you mostly need to modify the `pom.xml` file.
...
MUnit 1.1.0 requires only the following artifacts:
...
MUnit 1.1.0 requires the following properties in the `pom.xml` file:
