...
image::/docs/download/attachments/122751166/hl7_global_gen.png?version=1&modificationDate=1421450591504[image]
...
image::/docs/download/attachments/122751166/hl7_gloabl_advanced.png?version=1&modificationDate=1421450591258[image]
...
|===
|Name |Description |XML
|*Dispatched Pool Factory* |Allows you to reference a TCP dispatcher pool factory other than the default dispatcher factory bean. To add a different dispatcher factory bean ID in Studio, click the image:/docs/download/attachments/122751157/conn.spring.props-addbutton.png?version=1&modificationDate=1421450572641[plus] button next to the combo box. |`dispatcherPoolFactory-ref="sampleBean"`
...
image::/docs/download/attachments/122751166/hl7_global_properties.png?version=1&modificationDate=1421450591015[image]
...
|===
|Name |Description |XML
|*Spring Properties* |Use this tab to enter Spring bean property information. To add a property in Studio, click the image:/docs/download/attachments/122751157/conn.spring.props-addbutton.png?version=1&modificationDate=1421450572641[plus] button under *Spring Properties* |`<spring:property name="com.sample.sampleBean" value="sampleValue"/>`
|===
////
...
image::/docs/download/attachments/122751166/hl7_global_protocol.png?version=1&modificationDate=1421450590759[image]
