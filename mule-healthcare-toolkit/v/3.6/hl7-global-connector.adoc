...
image:/documentation/download/attachments/122752538/hl7_global_gen.png?version=1&modificationDate=1399402048378[image]
...
image:/documentation/download/attachments/122752538/hl7_gloabl_advanced.png?version=1&modificationDate=1399402571122[image]
...
|Allows you to reference a TCP dispatcher pool factory other than the default dispatcher factory bean. To add a different dispatcher factory bean ID in Studio, click the image:/documentation/download/attachments/122752533/conn.spring.props-addbutton.png?version=1&modificationDate=1362522174201[image] button next to the combo box.
|[source]
----
...
image:/documentation/download/attachments/122752538/hl7_global_properties.png?version=1&modificationDate=1399402633102[image]

[width="100%",cols="34a,33a,33a",options="header",]
|===
|Name |Description |XML
|*Spring Properties* |Use this tab to enter Spring bean property information. To add a property in Studio, click the image:/documentation/download/attachments/122752533/conn.spring.props-addbutton.png?version=1&modificationDate=1362522174201[image] button under *Spring Properties.*
|[source,xml]
----
<spring:property name="com.sample.sampleBean" value="sampleValue"/>
----
...
image:/documentation/download/attachments/122752538/hl7_global_protocol.png?version=1&modificationDate=1399402698693[image]
...
name="connectorName"
----
|*Dispatched Pool Factory* |Allows you to reference a TCP dispatcher pool factory other than the default dispatcher factory bean. To add a different dispatcher factory bean ID in Studio, click the image:/documentation/download/attachments/122752533/conn.spring.props-addbutton.png?version=1&modificationDate=1362522174201[image] button next to the combo box.
|[source]
----
dispatcherPoolFactory-ref="sampleBean"
----
