...
image:hl7-endpoint-reference-1.png[image]
...
image:hl7-endpoint-reference-2.png[image]
...
|*(Boolean)* Enables link:/mule-user-guide/business-events[Business Events] for the Endpoint.
|[source]
----
...
image:hl7-endpoint-reference-3.png[image]
...
|XML
|*Connector Reference*
|References an HL7 connector configured as a link:/mule-fundamentals/global-elements[Global Element].
|[source]
----
...
----
|*Connector Reference*
|Allows you to reference an HL7 connector configured as a link:/mule-fundamentals/global-elements[Global Element].
|[source]
----
connector-ref="HL7connectorName"
----
