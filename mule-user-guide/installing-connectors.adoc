...
image:installing-connectors-1.png[image]
...
+
image:installing-connectors-4.png[image]
...
Refer to link:/mule-fundamentals/deploying-mule-applications[Deploying Mule Applications] for more information on managing your user libraries in Studio.
...
* Read more about using link:/mule-user-guide/anypoint-connectors[Anypoint Connectors]. 
...
* Learn how to build your own Mule extensions with link:/anypoint-connector-devkit/[Anypoint Connector DevKit].
* Learn how to link:/mule-user-guide/working-with-multiple-versions-of-connectors[work with multiple versions of connectors].
