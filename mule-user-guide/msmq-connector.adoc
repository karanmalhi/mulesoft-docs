...
*  Install the link:/mule-user-guide/windows-gateway-services-guide[Windows Gateway Service] first before installing and configuring MSMQ.
...
* link:/mule-user-guide/msmq-connector-user-guide[MSMQ User Guide]

=== Set Up Demo Queue in MSMQ

==== Step 1: Create Queue

image:msmq-connector-11.png[image]
...
image:msmq-connector-12.png[image]
...
image:msmq-connector-13.png[image]
...
The sample flows send and receive messages from an existing queue. Transformers put the necessary information on the Mule Message for subsequent operations to consume. The end result looks like this:  +
 image:msmq-connector-14.png[image] +
...
* Refer to the link:/mule-user-guide/msmq-connector-user-guide[user guide] for more information about this connector.
* Read the link:/mule-user-guide/msmq-connector-faqs[FAQs] about the MSMQ Connector.
