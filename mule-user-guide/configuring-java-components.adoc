...
For a real-world example of using `<spring-object/>`, see link:/mule-user-guide/using-spring-beans-as-flow-components[Using Spring Beans as Flow Components].
...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the flow. See link:/mule-user-guide/developing-components[Developing Components] for a more detailed description of their functionality.
...
See link:/mule-user-guide/developing-components[Developing Components] for more information about lifecycles.
...
Binding can be used on Java components and script components. For more information see link:/mule-user-guide/component-bindings[Component Bindings].
...
For more information about pooling and reference documentation for pooling configuration options, see link:/mule-user-guide/tuning-performance[Tuning Performance].
