...
The following imagedatamapper-fixed-width-input-format-1.png[File Connector], reads the fixed-width input file. Then, DataMapper transforms the data into the JSON format, and outputs the result into a second file.

image:datamapper-fixed-width-input-format-1.png[image]

To test the mapping, you can build this flow in Studio, then run the application and check the results in the output file. Alternatively, you can build this flow, then can use DataMapper's link:/mule-user-guide/previewing-datamapper-results-on-sample-data[Preview] feature to view the mapping without running the application.
...
+
image:datamapper-fixed-width-input-format-2.png[image]

. In the *Input* section, click the Edit icon
image:datamapper-fixed-width-input-format-3.png[image] next to the *Type* input field, then select *Fixed Width* from the *Type* drop-down menu. The properties editor *Input* pane displays the input options for the fixed-width format, as shown below.
+
image:datamapper-fixed-width-input-format-4.png[image]
...
+
image:datamapper-fixed-width-input-format-5.png[image]
...
+
image:datamapper-fixed-width-input-format-6.png[image]
...
image:datamapper-fixed-width-input-format-7.png[image]
====
...
+
image:datamapper-fixed-width-input-format-8.png[image]
...
....
DataMapper's link:/mule-user-guide/previewing-datamapper-results-on-sample-data[Preview] feature allows you to see the result of your mapping without actually running the flow. Test by using DataMapper's Preview feature:
...
+
image:datamapper-fixed-width-input-format-9.png[image]
...
+
image:datamapper-fixed-width-input-format-10.png[image]
...
+
image:datamapper-fixed-width-input-format-11.png[image]
...
. In the *Output* pane, click the *Infer Metadata* icon image:datamapper-fixed-width-input-format-12.png[image] , then select **Re-Create Metadata From Input**.
+
image:datamapper-fixed-width-input-format-13.png[image]

DataMapper will automatically recreate the output metadata and display the new mapping, as shown below.

image:datamapper-fixed-width-input-format-14.png[image]
