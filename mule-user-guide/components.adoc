...
|image:components-1.png[Echo Component Reference]
|image:components-2.png[image] |Flow Reference |This building block calls another external flow. The called flow can be one of two types: +
...
|image:components-3.png[Logger Component Reference]
|===
...
|===
|  |Components |Description |Documentation
|image:components-4.png[Groovy Component Reference]
|image:components-5.png[Java Component]
|image:components-6.png[JavaScript Component Reference]
|image:components-7.png[Python Component Reference]
|image:components-8.png[Ruby Component Reference]
|image:components-9.png[Script Component Reference]
|===
...
|===
|  |Components |Description |Documentation
|image:components-10.png[REST Component Reference]
|image:components-11.png[CXF Component Reference]
