...
image:web-service-proxy-pattern-1.png[image]
...
The application serves these static contents from  *src/main/app/xsd* . See  link:/mule-user-guide/http-static-resource-handler[HTTP Static Resource Handler]  for more information about this.
