...
[TIP]
Placing a Python Component is actually the same as placing a link:/mule-user-guide/script-component-reference[Script component] and then selecting the Python engine.
...
image:python-component-reference-1.png[image]
...
image:python-component-reference-2.png[image]
