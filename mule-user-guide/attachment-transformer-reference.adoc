...
The attachment transformer is very similar in functionality to the link:/mule-user-guide/property-transformer-reference[property transformer]. However, attachments are only supported by the following transports: 
...
....
image:attachment-transformer-reference-1.png[image]
...
* Refer to link:/mule-fundamentals/mule-concepts[Mule Concepts] to learn more about message scopes.

* Read about related transformers, the link:/mule-user-guide/property-transformer-reference[property transformer], the link:/mule-user-guide/variable-transformer-reference[variable transformer], and the link:/mule-user-guide/session-variable-transformer-reference[session variable transformer], which you can use to set properties and variables for different scopes.
