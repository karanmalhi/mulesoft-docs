...
[NOTE]
This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, access link:/mule-fundamentals/global-elements[Global Elements] to learn more before proceeding.
...
+
image:mule-digital-signature-processor-1.png[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
...
+
image:mule-digital-signature-processor-2.png[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
...
+
image:mule-digital-signature-processor-3.png[image]
+
[width="100%",cols="34%,33%,33%",options="header",]
|===
|Field |Req'd |Value
...
. Configure the message processor's fields according to the table below.
+
image:mule-digital-signature-processor-4.png[image]
+
[width="100%",cols="34%,33%,33%",options="header",]
|===
|Field |Req'd |Value
...
image:mule-digital-signature-processor-5.png[image]
...
image:mule-digital-signature-processor-6.png[image]
...
Examine the link:/mule-user-guide/anypoint-enterprise-security-example-application[Anypoint Enterprise Security Example Application] which illustrates how to verify the digital signature of a message.
