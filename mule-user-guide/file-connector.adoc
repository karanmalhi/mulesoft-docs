...
image:file-connector-1.png[image]

*Outbound endpoint:*

image:file-connector-2.png[image]
...
image:file-connector-3.png[image]
...
image:file-connector-4.png[image]
...
See the link:/mule-user-guide/file-transport-reference[File Transport Reference] for details on setting the properties for a File endpoint using an XML editor.
