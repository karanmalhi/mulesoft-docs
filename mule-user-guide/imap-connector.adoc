...
image:imap-connector-1.png[image]
...
image:imap-connector-2.png[image]
...
image:imap-connector-3.png[image]
...
image:imap-connector-4.png[image]
...
See the link:/mule-user-guide/imap-transport-reference[IMAP Transport Reference] for details on setting the properties for an IMAP endpoint using an XML editor.
