...
You can share libraries between applications via the link:/mule-user-guide/mule-application-deployment-descriptor[*application deployment descriptor*] attribute.
