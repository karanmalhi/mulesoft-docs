...
image:batch-processing-2.png[image]
...
To build applications with Batch jobs and run them in a test or production environment, you must build the application with an Enterprise runtime. Learn more about link:/mule-user-guide/changing-runtimes-in-studio[Changing Runtimes in Studio].
====

== Assumptions

This document assumes that you are familiar with Anypoint Studio; review the link:/mule-fundamentals/anypoint-studio-essentials[Anypoint Studio Essentials] chapter to learn more about developing with Mule ESB's graphical user interface. This document also assumes you are familiar with link:/mule-user-guide/anypoint-connectors[Anypoint Connectors], and the link:/mule-user-guide/datamapper-user-guide-and-reference[Anypoint DataMapper] transformer that you can use in applications in Studio. Further, this document references http://www.mulesoft.org/documentation/display/current/Understand+Global+Mule+Elements[Global Elements], link:/mule-user-guide/datasense[DataSense] and link:/mule-user-guide/poll-reference[Polls]. 
...
image:batch-processing-3.png[image]
...
Access link:/mule-user-guide/batch-processing-reference[Batch Processing Reference] for more information.
====
...
image:batch-processing-4.png[image]
...
....
image:batch-processing-5.png[image]
....
...
image:batch-processing-6.jpeg[image]

Beyond simple processing of records, there are several things you can do with records within batch steps:

* you can set *record variables* on records and pass them from step to step (link:/mule-user-guide/record-variable[read more])
...
[tab,title="STUDIO Visual Editor"]
....
image:batch-processing-7.png[image]
...
[tab,title="STUDIO Visual Editor"]
....
image:batch-processing-8.png[image]
....
[tab,title="XML Editor"]
....
Note that details in code snippet are abbreviated so as to highlight batch phases, jobs and steps. See link:#BatchProcessing-CompleteCodeExample[Complete Code Example] for more detail.
...
+
image:batch-processing-9.png[image]
...
+
image:batch-processing-10.png[image]
...
[tab,title="STUDIO Visual Editor"]
....
image:batch-processing-11.png[image]
....
[tab,title="XML Editor"]
....
Note that details in code snippet are abbreviated so as to highlight batch phases, jobs and steps. See link:#BatchProcessing-CompleteCodeExample[Complete Code Example] for more detail.
...
[TIP]
Note that this example introduces features not discussed in great detail in this document. Consult link:/mule-user-guide/batch-filters-and-batch-commit[Batch Filters and Batch Commit] and link:/mule-user-guide/record-variable[Record Variable] for more information.

[tabs]
------
[tab,title="STUDIO Visual Editor"]
....
image:batch-processing-13.png[image]
....
[tab,title="XML Editor"]
....
[TIP]
...
. The application first uses a link:/mule-user-guide/file-connector[File connector] to upload a CSV file, then uses a link:/mule-user-guide/datamapper-concepts[DataMapper] to convert the data format into a collection (see mapping below). Each item in the collection represents a lead. Each lead contains a company name, a first name, a last name, a birthday and an email address.
+
image:batch-processing-14.png[image]
...
[start=3]
. Mule begins processing each lead as a record. The first batch step, **`lead-check`**, uses a *Salesforce Connector* wrapped with a link:/mule-user-guide/message-enricher[Message Enricher] to: +
...
[tab,title="STUDIO Visual Editor"]
....
image:batch-processing-15.png[image]
....
[tab,title="XML Editor"]
....
image:batch-processing-16.png[image]
....
------
...
[tab,title="STUDIO Visual Editor"]
....
image:batch-processing-17.png[image]
....
[tab,title="XML Editor"]
....
image:batch-processing-18.png[image]
....
------
...
[tab,title="STUDIO Visual Editor"]
....
image:batch-processing-19.png[image]
....
[tab,title="XML Editor"]
....
image:batch-processing-20.png[image]
....
------
...
* Batch processing does not support the use of link:/mule-user-guide/business-events[Business Events].

* link:/cloudhub/cloudhub-insight[CloudHub Insight] does not support visibility into batch processing.
* link:/mule-management-console/[Mule Management Console (MMC) ]does not support visibility into batch processing.
...
* Learn more about setting and removing link:/mule-user-guide/record-variable[record-level variables].
...
* Learn more about link:/mule-user-guide/anypoint-connectors[Anypoint Connectors].

* Learn more about link:/mule-user-guide/poll-reference[Polling and Watermarks].
