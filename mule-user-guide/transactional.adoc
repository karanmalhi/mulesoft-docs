...
For more information and full details about how to demarcate transactions in your Mule flow, refer to link:/mule-user-guide/transaction-management[Transaction Management].
