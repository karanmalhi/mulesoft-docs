...
This document assumes you are familiar with Mule applications and link:/documentation/display/34X/Message+Processors[message processors], in particular link:/mule-user-guide/routers[routing message processors].

== Scatter-Gather Behavior and Exceptions

image:scatter-gather-1.png[image]
...
image:scatter-gather-2.png[image]


=== General Tab

image:scatter-gather-3.png[image]
...
image:scatter-gather-4.png[image]
...
|*Threading Profile* |Optionally, use to customize the threading profile. Refer to link:/mule-user-guide/tuning-performance[Tuning Performance] for a description of the configurable attributes. For a brief discussion of threading profiles in Scatter-Gather, see the link:#Scatter-Gather-threadprof[section below]. + |Default threading profile a|
|===
....
...
|============
|Optional Child Element |Description
|*threading-profile* |Allows you to configure the underlying thread pool. Refer to link:/mule-user-guide/tuning-performance[Tuning Performance] for a list of configurable attributes, all of which can be applied here. For a brief discussion of threading profiles in Scatter-Gather, see the link:#Scatter-Gather-threadprof[section below].
|============
....
------
...
For details on setting up threading profiles, see link:/mule-user-guide/tuning-performance[Tuning Performance].
...
image:scatter-gather-5.png[image]
...
image:scatter-gather-6.png[image]
