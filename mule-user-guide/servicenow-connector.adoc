...
+
image:servicenow-connector-1.png[image] 
...
* A global ServiceNow element to be used by all the ServiceNow connectors in the application (read more about link:/mule-fundamentals/global-elements[global elements in Mule]).
...
+
image:servicenow-connector-2.png[image]
+
...
+
image:servicenow-connector-3.png[image]
...
+
image:servicenow-connector-4.png[image] +
+
