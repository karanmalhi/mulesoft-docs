...
+
image:using-datamapper-lookup-tables-1.png[image]
+
...
. In the upper-right corner of the dialog, click *Data Source*. The Data Source Editor opens, where you can enter your lookup table data. +
 image:using-datamapper-lookup-tables-2.png[image] 
...
+
image:using-datamapper-lookup-tables-3.png[image]
+
...
+
image:using-datamapper-lookup-tables-4.png[image] 
+
...
+
image:using-datamapper-lookup-tables-5.png[image] +
+

. The *Create DB Lookup* dialog appears. In *Name* field, enter a name for your lookup table. +

+
image:using-datamapper-lookup-tables-6.png[image] +
+
...
image:using-datamapper-lookup-tables-7.png[image] to load the driver from a .JAR file

image:using-datamapper-lookup-tables-8.png[image] to manually specify the classname of the JDBC driver.

|===

+
image:using-datamapper-lookup-tables-9.png[image]
+
...
. Click the *Generate fields from query* button to test your query and to retrieve metadata about the query results from the source database. 
 +
image:using-datamapper-lookup-tables-10.png[image]
+
...
+
image:using-datamapper-lookup-tables-11.png[image] +
+
...
+
image:using-datamapper-lookup-tables-12.png[image] +
+
+
...
+
image:using-datamapper-lookup-tables-13.png[image] +
+
...
+
image:using-datamapper-lookup-tables-14.png[image] +
+
...
+
image:using-datamapper-lookup-tables-15.png[image]
+
[TIP]
...
+
image:using-datamapper-lookup-tables-16.png[image]
+
...
|*Name* |User-defined name for the FlowRef lookup table. .2+|image:using-datamapper-lookup-tables-17.png[image]
...
+
image:using-datamapper-lookup-tables-18.png[image]
+
...
|===
|Parameter |Description |Configuration window image
|*Lookup name* |Name of the lookup, by default the name of the lookup table. .3+|image:using-datamapper-lookup-tables-19.png[image]
...
. The DataMapper view displays lookup table mappings with a double-dotted line, highlighted below. +
 +
image:using-datamapper-lookup-tables-20.png[image] +
