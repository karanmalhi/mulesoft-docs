...
image:microsoft-service-bus-connector-3.png[image]
 +
. Search for a drag the Microsoft Service Bus connector into the canvas, and click to open the properties editor console.
. Click the Connection Configuration green arrow image:microsoft-service-bus-connector-4.png[(plus)]: +

 +
 image:microsoft-service-bus-connector-5.png[image] +

. Click the Service Bus type: +
 +
 image:microsoft-service-bus-connector-6.png[image] +

 +
  +
.  Azure Service Bus: +
 +
 image:microsoft-service-bus-connector-7.png[image] +
...
|*Enable DataSense* |If you intend to employ the Microsoft Service Bus connector in conjunction with a link:/mule-user-guide/datamapper-user-guide-and-reference[DataMapper transformer] to map and transform data, you can make use of Anypoint Studio's link:/mule-user-guide/datasense[DataSense] functionality. You can enable DataSense as part of configuring the global element.
|===
+. Windows Service bus: +
 +

image:microsoft-service-bus-connector-8.png[image]
[cols=",",options="header",]
|===
|Field |Description
|*Name* |Enter a name for the global element.
...
+
image:microsoft-service-bus-connector-9.png[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
* Learn more about the Microsoft Service Bus connector in the link:/mule-user-guide/microsoft-service-bus-connector-faq[Microsoft Service Bus Connector FAQ].
* For code samples that illustrate more advanced scenarios, refer to link:/documentation/download/attachments/123338810/service-bus-connector-samples.zip?version=1&modificationDate=1422537297705[service-bus-connector-samples.zip].
