...
+
image:enabling-maven-support-for-a-studio-project-1.png[image]
...
+
image:enabling-maven-support-for-a-studio-project-2.png[image]
...
+
image:enabling-maven-support-for-a-studio-project-3.png[image]
...
* Learn how to migrate link:/mule-user-guide/importing-a-maven-project-into-studio[a Maven project into Studio].

* Learn how to link:/mule-user-guide/building-a-mule-application-with-maven-in-studio[build new Maven projects] directly in Studio.
