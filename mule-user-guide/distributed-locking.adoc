...
* Access link:/mule-user-guide/mule-high-availability-ha-clusters[Mule High Availability (HA) Clustering] for an overview.

* Learn how to link:/mule-user-guide/creating-and-managing-a-cluster-manually[manually create and manage a cluster,] accessing additional options.

* Learn how to enable link:/mule-user-guide/distributed-file-polling[distributed file polling].
