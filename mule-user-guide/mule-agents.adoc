...
For a list of agents provided with Mule and how to configure them, see link:/mule-user-guide/jmx-management[JMX Management]. You can also create a custom agent as described below.
