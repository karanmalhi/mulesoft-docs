...
|image:choosing-the-right-clustering-topology-1.png[image]
...
image:choosing-the-right-clustering-topology-2.png[image]
...
image:choosing-the-right-clustering-topology-3.png[image]
