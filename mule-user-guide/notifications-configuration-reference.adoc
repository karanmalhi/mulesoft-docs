...
This page provides details on the elements you configure for notifications. If the information appears to be out of date, refresh the page. For more information on notifications, see link:/mule-user-guide/mule-server-notifications[Mule Server Notifications].
