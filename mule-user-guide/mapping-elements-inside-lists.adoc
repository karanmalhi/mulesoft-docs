...
+
image:mapping-elements-inside-lists-1.png[image] +
+
...
In the input pane, attributes are identified by the image:mapping-elements-inside-lists-2.png[image] icon. Additionally, the names of mappable attributes are highlighted in *bold*.
...
+
image:mapping-elements-inside-lists-3.png[image]
...
+
image:mapping-elements-inside-lists-4.png[image]
+
...
[TIP]
For a complete description of DataMapper's Preview feature, see link:/mule-user-guide/previewing-datamapper-results-on-sample-data[Previewing DataMapper Results on Sample Data].

To preview the behavior of the mapping without running your entire mapping flow, click the *Preview* located above the output pane. DataMapper displays the preview view. In the *Input Data* field, enter the path to your input file (or use the folder button to select the file). Then, click image:mapping-elements-inside-lists-5.png[image] to preview the output.

image:mapping-elements-inside-lists-6.png[image]
...
+
image:mapping-elements-inside-lists-7.png[image]

. DataMapper displays the *CSV Properties* window. Click *Print headers*, then click *OK*.
+
image:mapping-elements-inside-lists-8.png[image]
...
+
image:mapping-elements-inside-lists-9.png[image]
...
+
image:mapping-elements-inside-lists-12.png[image]
+
...
+
image:mapping-elements-inside-lists-15.png[image]
+
The mapping editor updates to focus on this mapping:
+
image:mapping-elements-inside-lists-16.png[image] +
+
...
+
image:mapping-elements-inside-lists-17.png[image]
...
image:mapping-elements-inside-lists-18.png[image]
...
[TIP]
To generate a preview of your mapping, click the *Preview* tab in the DataMapper view, then click *Run Mapping*. Consult link:/mule-user-guide/previewing-datamapper-results-on-sample-data[Previewing DataMapper Results on Sample Data] for details.
...
+
image:mapping-elements-inside-lists-19.png[image]
...
+
image:mapping-elements-inside-lists-20.png[image]
+
...
You can also use the *Infer Metadata* tool to automatically update or recreate output metadata. For details, see link:/mule-user-guide/updating-metadata-in-an-existing-mapping[Updating Metadata in an Existing Mapping].
