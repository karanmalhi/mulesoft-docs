...
image:async-scope-reference-1.png[image]
...
An async scope is similar to an *link:/mule-fundamentals/flows-and-subflows[asynchronous flow]* in that:
...
An async scope is similar to a **link:/mule-fundamentals/flows-and-subflows[subflow] **in that it inherits the exception strategy of the main flow. 
...
+
image:async-scope-reference-2.png[image]
+
...
+
image:async-scope-reference-3.png[image]
+
...
+
image:async-scope-reference-4.png[image] +
+
...
For more information about processing strategies, see link:/mule-user-guide/flow-processing-strategies[Flow Processing Strategies].

. Click the image:async-scope-reference-5.png[(plus)] to the right of the *Processing Strategy* field.  +

 +
. In the *Choose Global Type* window, select from the list of available processing strategies, then click *OK*.  +
 
+
image:async-scope-reference-6.png[image] +
+

 +
. Configure the processing strategy as needed. For more information, see link:/mule-user-guide/flow-processing-strategies[Flow Processing Strategies]. +
 +

. Define your processing strategy as a global element, with any necessary configuration or optional fine-tuning. (For more information, see link:/mule-user-guide/flow-processing-strategies[Flow Processing Strategies].) Refer to code sample below.
...
* For more information about processing strategies and how to configure them, see link:/mule-user-guide/flow-processing-strategies[Flow Processing Strategies].
