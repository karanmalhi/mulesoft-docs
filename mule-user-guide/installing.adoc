...
. link:/mule-user-guide/hardware-and-software-requirements[Check hardware and software requirements.]
. link:/mule-user-guide/compatibility[Check system compatibility with platform software.]
. link:/documentation/display/current/Downloading+and+Installing+Mule+ESB[Download, then launch Mule.]
. link:/mule-user-guide/adding-community-runtime[Add Community runtime to AnypointStudio] (_optional_).
. link:/mule-user-guide/installing-an-enterprise-license[Install an Enterprise license] (_optional_).
. link:/mule-user-guide/installing-extensions[Extend Mule with plugins, modules, runtimes and connectors] (_optional_).

[width="100%",cols="34%,33%,33%",]
|===
|image:installing-14.png[image]
