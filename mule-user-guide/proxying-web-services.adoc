...
This type of bridge can be combined with filters for easy message routing. For fast XPath routing of messages, you can use the link:/mule-user-guide/sxc-module-reference[SXC Module Reference].

Alternatively, you can use link:/mule-user-guide/bridge-pattern[Bridge Pattern].
...
See the link:/mule-user-guide/proxying-web-services-with-cxf[Proxying Web Services with CXF] for more details.
