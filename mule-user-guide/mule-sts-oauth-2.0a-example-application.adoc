...
This document assumes that you are familiar with the link:/mule-fundamentals/anypoint-studio-essentials[Anypoint Studio interface]. To increase your familiarity with Anypoint Studio, consider completing one or more link:/mule-fundamentals/first-day-with-mule[Anypoint Studio Tutorials].
...
+
image:mule-sts-oauth-2.0a-example-application-1.png[image]

. Click the *Your Tweetbook Account* link to sign in with Tweetbook.
. Bookstore opens a Tweetbook login in window.
+
image:mule-sts-oauth-2.0a-example-application-2.png[image]
...
image:mule-sts-oauth-2.0a-example-application-3.png[image]
...
+
image:mule-sts-oauth-2.0a-example-application-4.png[image]
...
+
image:mule-sts-oauth-2.0a-example-application-5.png[image]
...
+
image:mule-sts-oauth-2.0a-example-application-6.png[image]
...
+
image:mule-sts-oauth-2.0a-example-application-7.png[image]
...
+
image:mule-sts-oauth-2.0a-example-application-8.png[image]
+
. Tweetbook accepts the token, then gives Bookstore the user’s profile and bookshelf information.
+
image:mule-sts-oauth-2.0a-example-application-9.png[image]
...
+
image:mule-sts-oauth-2.0a-example-application-10.png[image]
...
Refer to link:/mule-user-guide/authorization-grant-types[Authorization Grant Types] for more information on the other types of authorization grants.
...
image:mule-sts-oauth-2.0a-example-application-11.png[image]
...
* For more information on OAuth 2.0a in Mule, refer to link:/mule-user-guide/mule-secure-token-service[Mule Secure Token Service].
