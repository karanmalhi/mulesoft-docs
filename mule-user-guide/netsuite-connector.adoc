...
* A global NetSuite element for use by all the NetSuite connectors in an application. For more information, see link:/mule-fundamentals/global-elements[Mule Global Elements].
...
+
image:netsuite-connector-1.jpeg[image]
+
...
[tab,title="Studio Visual Editor"]
....
image:netsuite-connector-2.png[image]
...
+
image:netsuite-connector-3.png[image]
+
...
+
image:netsuite-connector-4.jpeg[image] 
+
...
. Click the **+** sign next to the *Connector Configuration* field to add a new NetSuite global element. +
 image:netsuite-connector-5.jpeg[image]
...
+
image:netsuite-connector-6.jpeg[image] +
+
