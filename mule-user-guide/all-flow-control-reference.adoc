...
Access the documentation for the link:/mule-user-guide/scatter-gather[Scatter-Gather flow control] to take advantage of the newly-designed functionality.
====
