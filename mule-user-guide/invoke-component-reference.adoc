...
image:invoke-component-reference-1.png[image]
...
+
image:invoke-component-reference-2.png[image]
+
[source]
----
package invoke;
...
* Learn more about link:/mule-user-guide/components[other components] available in Mule.
