...
image:ftp-connector-1.png[image]
...
image:ftp-connector-2.png[image]
...
image:ftp-connector-3.png[image]
...
See the link:/mule-user-guide/ftp-transport-reference[FTP Transport Reference] for details on setting the properties for an FTP endpoint using an XML editor.
