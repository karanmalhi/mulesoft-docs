...
* link:#UsingSpringBeansasFlowComponents-DefiningtheBeans[Defining the Beans]
* link:#UsingSpringBeansasFlowComponents-ConfiguringtheBeans[Configuring the Beans]
* link:#UsingSpringBeansasFlowComponents-ConfiguringtheComponent[Configuring the Component]
* link:#UsingSpringBeansasFlowComponents-UsingJNDIandEJBSessionBeans[Using JNDI and EJB Session Beans]
...
For more information on component configuration, see link:/mule-user-guide/configuring-components[Configuring Components]. For more information on the elements you use to configure components, see link:/mule-user-guide/component-configuration-reference[Component Configuration Reference].
