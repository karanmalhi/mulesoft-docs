...
Using Mule's CXF Component, you can also link:/mule-user-guide/securing-a-soap-api[enable WS-security], specify databindings, and add interceptors to your CXF API. For more information about how Mule leverages the CXF framework, consult the link:/mule-user-guide/cxf-module-reference[CXF Module Configuration Reference].
...
image:publishing-a-soap-api-1.png[image]
...
image:publishing-a-soap-api-2.png[image]

image:publishing-a-soap-api-3.png[image]
...
+
image:publishing-a-soap-api-4.png[image]
+
+
+
...
+
image:publishing-a-soap-api-5.png[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:publishing-a-soap-api-6.png[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:publishing-a-soap-api-7.png[image] +
+
...
+
image:publishing-a-soap-api-8.png[image]
+
...
+
image:publishing-a-soap-api-11.png[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:publishing-a-soap-api-12.png[image] +
+
...
+
image:publishing-a-soap-api-13.png[image]
+
. Configure the *CXF component* as per the image and table below. At runtime, the output of this component is a POJO.
+
image:publishing-a-soap-api-14.png[image] +
+
...
image:publishing-a-soap-api-15.png[image]
...
====
. Drop a *Flow Reference* after your CXF component. This reference will redirect the requests to another flow, where the actual business logic of your API will be carried out. Keep in mind that whatever happens in this second flow, the returned output must match the output declared by the WSDL. +
image:publishing-a-soap-api-16.png[image] +
+
...
Consult the link:/mule-user-guide/securing-a-soap-api[Securing a SOAP API] document to configure the security elements of your API.

== See Also

* Consult the link:/mule-user-guide/cxf-component-reference[CXF Component Reference].
