...
To deploy Mule as a service to Tomcat or Tcat Server, see link:/mule-user-guide/deploying-mule-as-a-service-to-tomcat[Deploying Mule as a Service to Tomcat].
