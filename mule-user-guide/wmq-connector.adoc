...
image:wmq-connector-1.png[image]
...
image:wmq-connector-2.png[image]
...
image:wmq-connector-3.png[image]
...
See the link:/mule-user-guide/mule-wmq-transport-reference[Mule WMQ Transport Reference] for details on setting the properties for a WMQ endpoint using an XML editor.
