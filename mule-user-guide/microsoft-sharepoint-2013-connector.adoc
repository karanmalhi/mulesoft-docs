...
+
image:microsoft-sharepoint-2013-connector-1.png[image] 
. Legacy Connection:
...
+
image:microsoft-sharepoint-2013-connector-2.png[image] 
...
+
image:microsoft-sharepoint-2013-connector-3.png[image]
...
+
image:microsoft-sharepoint-2013-connector-4.png[image] 
...
image:microsoft-sharepoint-2013-connector-5.png[image]
...
image:microsoft-sharepoint-2013-connector-6.png[image]
...
+
image:microsoft-sharepoint-2013-connector-7.png[image] 
...
Example *Query Text*:
+
image:microsoft-sharepoint-2013-connector-8.png[image]
...
image:microsoft-sharepoint-2013-connector-9.png[image]
...
image:microsoft-sharepoint-2013-connector-10.png[image]
...
* link:/mule-user-guide/transformers[Studio Transformers]    
*  link:/mule-user-guide/flow-reference-component-reference[Flow References]
