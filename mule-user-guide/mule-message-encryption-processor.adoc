...
+
image:mule-message-encryption-processor-1.png[image]
...
+
image:mule-message-encryption-processor-2.png[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
...
+
image:mule-message-encryption-processor-3.png[image] +
+
. Set an *Encryption* message processor in the flow in which you wish to encrypt data in the message payload.
. Configure the message processor according the table below.
+
image:mule-message-encryption-processor-4.png[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
...
Mule has the ability to encrypt a message payload, or part of a payload, using http://www.pgpi.org/doc[Pretty Good Privacy (PGP)].  Because of its increased complexity, the topic has earned its own page: refer to the link:/mule-user-guide/pgp-encrypter[PGP Encrypter] document. 
...
image:mule-message-encryption-processor-5.png[image]
...
image:mule-message-encryption-processor-6.png[image]
...
* Examine the link:/mule-user-guide/anypoint-enterprise-security-example-application[Anypoint Enterprise Security Example Application] which illustrates how to encrypt and decrypt a message in a Mule flow.
