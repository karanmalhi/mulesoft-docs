...
* Learn more about link:/mule-user-guide/publishing-a-soap-api[publishing SOAP APIs] with Mule.

* Learn more about link:/mule-user-guide/consuming-a-soap-api[consuming SOAP APIs] with Mule.
