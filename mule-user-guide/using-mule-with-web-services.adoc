...
* link:/mule-user-guide/proxying-web-services[Creating a proxy/gateway to existing Web services] (for example, adding security to an existing Web service)
...
For simple use cases, you may consider using the link:/mule-user-guide/web-service-proxy-pattern[Web Service Proxy Pattern], particularly when you don't need to accomplish much message processing. From Mule, you can use link:/mule-user-guide/using-mule-configuration-patterns[Using Mule Configuration Patterns] to configure (with minor XML configuration) a specific integration feature.

== References

For more information and complete documentation, please read the following:

* link:/mule-user-guide/cxf-module-reference[CXF Module Reference]
* link:/mule-user-guide/supported-web-service-standards[Supported Web Service Standards]
* link:/mule-user-guide/web-service-proxy-pattern[Web Service Proxy Pattern]
* Examples
** link:#[Echo Example]
