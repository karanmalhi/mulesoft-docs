...
image:rest-component-reference-1.png[image]
...
image:rest-component-reference-2.png[image]

== See Also

* For an overview on the recommended ways to publish and consume REST services, see link:/mule-user-guide/publishing-and-consuming-apis-with-mule[Publishing and Consuming APIs with Mule]
