...
image:importing-and-exporting-in-studio-1.png[image]
...
image:importing-and-exporting-in-studio-2.png[image]

[cols=",",options="header"]
|===
|Option |Description
|*Anypoint Studio Project to Mule Deployable Archive* |Export a Mule project to a .zip file.
|*Mule extension Update Site* |Specific to link:/anypoint-connector-devkit/[DevKit] connector extension projects, this option allows you to export the project to an update website. This option only appears if you have installed the DevKit plugin for Anypoint Studio.
|*Mule Project to CloudHub* |Publish your project to link:/cloudhub/[CloudHub] in order to deploy on the cloud.
|*Publish to Application Repository* |Publish your project to the link:/mule-management-console/mmc-walkthrough[Mule Management Console] application repository.
|===
...
+
*image:importing-and-exporting-in-studio-3.png[image]*
...
+
image:importing-and-exporting-in-studio-4.png[image]

== See Also

* Explore a few link:/mule-fundamentals/anypoint-exchange[example applications] in Anypoint Studio.
* Read about link:/mule-user-guide/importing-a-maven-project-into-studio[Importing a Maven Project into Studio].
* Find out more about link:/mule-user-guide/enabling-maven-support-for-a-studio-project[Enabling Maven Support for a Studio Project].
