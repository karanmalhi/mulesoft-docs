...
image:microsoft-dynamics-crm-connector-1.png[image]
...
image:microsoft-dynamics-crm-connector-2.png[image]

To configure the flow:

. Double-click the *HTTP* connector and click the green plus sign image:microsoft-dynamics-crm-connector-3.png[(plus)] to the right of *Connector Configuration*:
+
image:microsoft-dynamics-crm-connector-4.png[image]

. Set *localhost*, port *localhost* and path to *query*
+
image:microsoft-dynamics-crm-connector-5.png[image]

. Double-click *Microsoft Dynamics CRM*.
. Click the green plus symbol image:microsoft-dynamics-crm-connector-6.png[(plus)] to the right of *Connector Configuration*:
+
image:microsoft-dynamics-crm-connector-7.png[image]

. Specify your access to the CRM server: *Username*, *Password*, *Organization Service URL*, and *Authentication Scheme*. Click *OK* - See link:#MicrosoftDynamicsCRMConnector-crmauth[CRM Authentication] for information on each authentication scheme. +
 image:microsoft-dynamics-crm-connector-8.png[image]
...
image:microsoft-dynamics-crm-connector-9.png[image]
...
|Property |Usage
|*Query* a|
DataSense Query Language: The DSQL to run. The query is translated by the connector to a Fetch XML. For more information, see link:/mule-user-guide/datasense-query-language[DataSense Query Language].
...
* link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language]
* link:/mule-user-guide/endpoint-configuration-reference[Configuring Endpoints]
* link:/mule-user-guide/transformers[Transformers]
* link:/mule-user-guide/flow-reference-component-reference[Flow Reference Component Reference]
