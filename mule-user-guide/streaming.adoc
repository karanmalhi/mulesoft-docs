...
* link:/mule-user-guide/cxf-module-reference[CXF]
* link:/mule-user-guide/streaming-data-processing-with-datamapper[DataMapper]
* link:/mule-user-guide/file-transport-reference[File] (set the `streaming` attribute to false to access the File object directly)
* link:/mule-user-guide/ftp-transport-reference[FTP]
* link:/mule-user-guide/http-connector[HTTP] and link:/mule-user-guide/http-connector[HTTPS]
* link:/mule-user-guide/jetty-transport-reference[Jetty] and link:/mule-user-guide/jetty-ssl-transport[Jetty SSL]
* link:/mule-user-guide/servlet-transport-reference[Servlet]
* link:/mule-user-guide/tcp-transport-reference[TCP]
* link:/mule-user-guide/udp-transport-reference[UDP]
...
* link:/mule-user-guide/xslt-transformer[XSLT Transformer]
* link:/mule-user-guide/xmltoxmlstreamreader-transformer[XmlToXMLStreamReader Transformer]
* link:/mule-user-guide/domtoxml-transformer[DomToOutputHandler transformer] (if the incoming XML format is a SAXSource or XMLStreamReader)
* link:/mule-user-guide/sxc-module-reference[SXC filter]
