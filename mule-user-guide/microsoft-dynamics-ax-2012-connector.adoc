...
* Install the link:/mule-user-guide/windows-gateway-services-guide[Windows Gateway Services] 
...
image:microsoft-dynamics-ax-2012-connector-1.png[image]
...
image:microsoft-dynamics-ax-2012-connector-2.png[image]
...
+
image:microsoft-dynamics-ax-2012-connector-3.png[image]
+
...
* link:/mule-user-guide/windows-gateway-services-guide[Windows Gateway Services]
