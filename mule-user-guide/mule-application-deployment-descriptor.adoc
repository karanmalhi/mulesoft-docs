...
|domain |Domain name for this application. Typically used to share common libraries and configuration between applications. See link:/mule-user-guide/shared-resources[Shared Resources] |"default"
...
For details on classloading in MuleMule, including a diagram of the Mule classloading architecture, see link:/mule-user-guide/classloader-control-in-mule[Classloader Control in Mule].
