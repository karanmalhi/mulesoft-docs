...
[TIP]
Placing a Groovy Component is actually the same as placing a link:/mule-user-guide/script-component-reference[Script component] and then selecting the Groovy engine.
...
image:groovy-component-reference-1.png[image]
...
image:groovy-component-reference-2.png[image]
...
* Refer to the generic link:/mule-user-guide/script-component-reference[Script component reference page] to see how a script works with one-way and request-response connectors.
