...
image:ajax-connector-1.png[image]
...
image:ajax-connector-2.png[image]
...
image:ajax-connector-3.png[image]
...
* For details on setting the properties for an Ajax endpoint using an XML editor, see the link:/mule-user-guide/ajax-transport-reference[Ajax Transport Reference] discussion in the Mule ESB User Guide.
