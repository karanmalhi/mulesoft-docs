...
image:siebel-connector-1.png[image]

== Installing and Configuring

=== Installing

You can install a connector in Anypoint Studio using the instructions in link:/mule-fundamentals/anypoint-exchange[Installing a Connector from Anypoint Exchange].
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to arrange for either license. See also link:/mule-user-guide/installing-an-enterprise-license[Installing an Enterprise License].
...
+
image:siebel-connector-2.png[image]

. Enter a name for your new project and leave the remaining options with their default values. +
 image:siebel-connector-3.png[image]
...
[NOTE]
====
If you intend to use a Siebel connector in conjunction with a link:/mule-user-guide/datamapper-user-guide-and-reference[DataMapper transformer] to map and transform data, you can make use of Anypoint Studio's link:/mule-user-guide/datasense[DataSense] functionality. You can enable DataSense as part of configuring the global element. 

* Follow the DataSense instructions to drop the transformer into your flow, then link:/mule-user-guide/testing-connections[test the connection] to Siebel using the Siebel connector. 
...
+
image:siebel-connector-4.png[image]
+
. Click *OK*
...
+
image:siebel-connector-5.png[image]
+
...
image:siebel-connector-8.png[image]
|===
+
.. For the Siebel Business Services connector:
+
image:siebel-connector-9.png[image]
...
image:siebel-connector-10.png[image]

After the jar files are attached, they appear in the lib/siebel directory of your project's root folder.

image:siebel-connector-11.png[image]

If you provide the wrong files (either an invalid jars or a completely different library), Studio displays the following error message: 

image:siebel-connector-12.png[image]
...
+
image:siebel-connector-13.png[image]
+
[width="100%",cols="50%,50%",options="header",]
|===
|Field |Description
...
|*Required Dependencies* |Click *Add File* to attach required jar files to your project's Build path. image:siebel-connector-14.png[image]

|===

. Keep the **Pooling Profile **and the *Reconnection* tabs with their default entries.
. Click *Test Connection* to confirm that the parameters of your global Siebel connector are accurate, and that Mule is able to successfully connect to your instance of Siebel. Read more about link:/mule-user-guide/testing-connections[Testing Connections].
...
+
image:siebel-connector-15.jpeg[image]
+
...
|*Search Expression* |Use link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language (MEL)] to define a search expression that would return a list of business components. |
...
. Configure the connector's parameters according to the table below. +
 image:siebel-connector-16.jpeg[image]
+
...
. Configure the connector's parameters according to the table below. +
+
image:siebel-connector-17.jpeg[image]
+
...
[NOTE]
Refer to documentation on the link:/mule-user-guide/poll-reference[Poll Scope] , link:/mule-user-guide/datamapper-user-guide-and-reference[DataMapper], and the link:/mule-user-guide/salesforce-connector[Salesforce connector] for in-depth information about these Mule elements.

[tabs]
------
[tab,title="Studio Visual Editor"]
....
image:siebel-connector-18.jpeg[image]

. Drag a *Poll Scope* into a new flow.
+
image:siebel-connector-19.jpeg[image] +
+
link:/mule-user-guide/poll-reference[Poll Scope] executes any Mule element you place inside it, at regular intervals. In this case, it is a Siebel endpoint.
. Configure the Poll Scope as follows
+
image:siebel-connector-20.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
. Drag an *Oracle Siebel Business Objects* connector into the space provided by the Poll Scope. +
 image:siebel-connector-21.jpeg[image]  +
+
...
+
image:siebel-connector-24.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:siebel-connector-25.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:siebel-connector-30.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
. Add a *Data Mapper* element between the Logger and the Salesforce connector. It maps fields from the data structure returned by Siebel into the data structure required by Salesforce. +
 image:siebel-connector-31.jpeg[image]
...
+
image:siebel-connector-32.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
|===
|image:siebel-connector-33.png[image] |This is usually the easiest way to go, but given the number of fields to navigate, it may be hard to find the fields you need. Use the search box above the field list to find these quickly.
...
[NOTE]
Refer to documentation on the link:/mule-user-guide/poll-reference[Poll Scope], link:/mule-user-guide/datamapper-user-guide-and-reference[DataMapper], and the link:/mule-user-guide/salesforce-connector[Salesforce Connector] for in depth information about these elements.

[tabs]
------
[tab,title="Studio Visual Editor"]
....
image:siebel-connector-33.jpeg[image] +

. Drag a *Poll Scope*  into a new flow: +
 image:siebel-connector-34.jpeg[image] +
+
link:/mule-user-guide/poll-reference[Poll Scope]  executes the Mule element placed inside it at regular intervals. In this case, it is a Salesforce connector.
+
. Configure the Poll Scope according to the settings below: +
+
image:siebel-connector-35.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
. Drag a *Salesforce Connector* into the space inside the Poll Scope. +
 image:siebel-connector-36.jpeg[image] +
+
...
. Open the *Properties* editor of the Salesforce connector and click the *+* sign to add a new Salesforce global element**.**
+
*image:siebel-connector-37.jpeg[image]*

.  On the Choose Global Type window, click ***Salesforce: Basic authentication***, and then click *Ok*.
+
image:siebel-connector-38.jpeg[image] +
+

. Configure the Salesforce global element properties:
+
image:siebel-connector-39.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
. Configure the Salesforce connector according to the settings below:
+
image:siebel-connector-40.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:siebel-connector-41.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:siebel-connector-45.jpeg[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
. Add a  *Data Mapper* element between the Logger and the Siebel connector. It maps fields from the data structure returned by Salesforce into the data structure required by Siebel. +
 image:siebel-connector-46.jpeg[image]
...
|===
|Element |Description
|Poll |A  link:/mule-user-guide/poll-reference[Poll Scope] executes the Mule element you place inside it at regular intervals. In this case, it is a Salesforce connector.
|===
+
[width="100%",cols="50%,50%",options="header",]
|===
...
* Learn about the link:/mule-user-guide/datamapper-user-guide-and-reference[DataMapper] transformer, the most efficient way to assign mappings to data.
* Read advanced information about the http://www.mulesoft.org/connectors/siebel-connector[Siebel Connector].
* Read more about link:/mule-user-guide/anypoint-connectors[Anypoint Connectors].
