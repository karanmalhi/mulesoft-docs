...
This document assumes you are familiar with working with link:/mule-user-guide/shared-resources[Shared Resources] in Mule.
...
Bitronix integration provides a datasource connection pool for the link:/mule-user-guide/database-connector[Database connector], which you must use whenever you want to implement resource pooling in the database connector.
