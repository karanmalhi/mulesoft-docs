...
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-1.png[image]

image:datamapper-flat-to-structured-and-structured-to-flat-mapping-2.png[image]
...
+
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-3.png[image]
...
+
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-4.png[image]
+
...
+
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-5.png[image]

. Now, map the input fields `Street 2` to `street`, and `ZipCode 2` to `zipCode`. The final mapping should look like the image below.
+
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-6.png[image]

To test your mapping, use the link:/mule-user-guide/previewing-datamapper-results-on-sample-data[Preview] feature by completing the following steps:
...
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-7.png[image]

The imagedatamapper-flat-to-structured-and-structured-to-flat-mapping-8.png[1]/street` retrieves the contents of the `street` element in the first `address` element of `addresses`.
...
+
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-8.png[image]
...
. After assigning the input and output files, click Create mapping. The Data Mapping View should look like the image below.
+
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-9.png[image]
+
...
. Delete this top-level mapping by clicking the image:datamapper-flat-to-structured-and-structured-to-flat-mapping-10.png[image] icon.
...
|*Name* |`Employees` |Suggested value .3+|image:datamapper-flat-to-structured-and-structured-to-flat-mapping-11.png[image]
...
+
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-12.png[image]
...
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-13.png[image]
...
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-14.png[image]
...
|===
|Parameter |Value |Remarks |Configuration window image
|*Name* |`Street1` |Suggested value .5+|image:datamapper-flat-to-structured-and-structured-to-flat-mapping-15.png[image]
|*Type* |`string` |
...
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-16.png[image]
...
image:datamapper-flat-to-structured-and-structured-to-flat-mapping-17.png[image]
