...
image:dotnet-connector-user-guide-1.png[image]
...
image:dotnet-connector-user-guide-4.png[image]

Specify the name of the .NET method you want to invoke:

image:dotnet-connector-user-guide-5.png[image]
...
+
image:dotnet-connector-user-guide-6.png[image]
...
image:dotnet-connector-user-guide-7.png[image]
...
image:dotnet-connector-user-guide-10.png[image] +
...
image:dotnet-connector-user-guide-11.png[image]

Example for a complex mapping:

image:dotnet-connector-user-guide-12.png[image]
...
image:dotnet-connector-user-guide-13.png[image]
...
image:dotnet-connector-user-guide-14.png[image]
...
image:dotnet-connector-user-guide-15.png[image]
...
+
image:dotnet-connector-user-guide-16.png[image]
...
A Mule link:/mule-fundamentals/global-elements[Global Element] allows you to define connector parameters once, then reference the same set of parameters from any number of individual connectors in your application. In this example, we create a .NET global element which will be referenced by the .NET connector in our application's flow.
...
+
image:dotnet-connector-user-guide-17.png[image]
+
...
+
image:dotnet-connector-user-guide-18.png[image]
+
...
+
image:dotnet-connector-user-guide-19.png[image]
+
[width="50%",cols=",",options="header"]
|===
|Parameter |Value
...
image:dotnet-connector-user-guide-20.png[image]
+
[width="50%",cols=",",options="header"]
|===
|Parameter |Value
...
image:dotnet-connector-user-guide-21.png[image]
