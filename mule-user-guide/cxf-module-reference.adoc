...
* link:/mule-user-guide/cxf-module-overview[Overview]
* link:/mule-user-guide/building-web-services-with-cxf[Building Web Services]
* link:/mule-user-guide/consuming-web-services-with-cxf[Consuming Web Services]
* link:/mule-user-guide/proxying-web-services-with-cxf[Proxying Web Services]
* link:/mule-user-guide/using-http-get-requests[Using HTTP GET Requests]
* link:/documentation/display/33X/Bookstore+Example[Bookstore Example]
* link:/mule-user-guide/cxf-module-configuration-reference[Configuration Reference]
* link:/mule-user-guide/wsdl-connectors[Using the WSDL Connector]

*Web Service Standards*

* link:/mule-user-guide/supported-web-service-standards[Supported Web Service Standards]
* link:/mule-user-guide/using-mtom[Using MTOM]
* link:/mule-user-guide/enabling-ws-addressing[Enabling WS-Addressing]
* link:/mule-user-guide/enabling-ws-security[Enabling WS-Security]
