...
image:pop3-connector-1.png[image]
...
image:pop3-connector-2.png[image]
...
image:pop3-connector-3.png[image]
...
image:pop3-connector-4.png[image]
...
See the link:/mule-user-guide/pop3-transport-reference[POP3 Transport Reference] for details on setting the properties for a POP3 endpoint using an XML editor.
