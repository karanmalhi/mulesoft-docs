...
*link:/mule-user-guide/about-the-xml-configuration-file[About the XML Configuration File]* +
...
*link:/mule-user-guide/spring-application-contexts[Spring Application Contexts]* +
...
*link:/mule-user-guide/using-spring-beans-as-flow-components[Using Spring Beans as Flow Components]* +
