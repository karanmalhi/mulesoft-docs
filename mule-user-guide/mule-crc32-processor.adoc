...
. Create and configure the global element through the Global Element tab at the bottom of the canvas, or directly within the CRC32 building block's** **Properties pane by clicking the image:mule-crc32-processor-1.png[(plus)] icon to the right of the *Connector Ref* field. 

. Configure the global element's attributes according to the table below.
+
image:mule-crc32-processor-2.png[image]
+
[cols=",,",options="header",]
|===
...
+
image:mule-crc32-processor-3.png[image]
+
[cols=",,",options="header",]
|=========================
|Attribute |Req'd |Value
...
. Configure the message processor's attributes according to the table below.
+
image:mule-crc32-processor-4.png[image]
+
...
. Click the image:mule-crc32-processor-5.png[(plus)] icon next to the** *Connector Configuration*** field.
