...
Note that you also have the option to use a Poll scope at the beginning of a flow, which also supports Cron expressions and watermarks. Read more about the link:/mule-user-guide/poll-reference[Poll scope].
====
...
image:quartz-connector-1.png[image]
...
image:quartz-connector-2.png[image]
...
image:quartz-connector-3.png[image]
...
* See the link:/mule-user-guide/quartz-transport-reference[Quartz Transport Reference] for details on setting the properties for a Quartz endpoint using an XML editor.
...
* Read about the link:/mule-user-guide/poll-reference[Poll scope].
