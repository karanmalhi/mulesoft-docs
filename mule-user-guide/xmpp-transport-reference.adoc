...
] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_xmpp/namespace-overview.html[SchemaDoc] |image:xmpp-transport-reference-1.png[image] |one-way, request-response |one-way |org.mule.transport:mule-transport-xmpp
