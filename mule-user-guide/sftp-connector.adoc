...
image:sftp-connector-1.png[image]
...
|*Connector Configuration* |Use the dropdown list to select a previously configured connector configuration for this endpoint. If you have not created a connector configuration for this type of endpoint, you can do so from this window by clicking the green plus *image:sftp-connector-2.png[image] to modify a previously created global element.
...
After you click the Connector Configuration's green plus image:sftp-connector-2.png[image], the Global Elements Properties screens appear with tabs for General, Advanced, Properties, Reconnection, File, and Notes. You can specify optional server property information or notes as needed. The rest of the screens are described in this section.

=== Global Element Properties - General Tab

image:sftp-connector-2.png[image]
...
image:sftp-connector-3.png[image]
...
image:sftp-connector-4.png[image]
...
image:sftp-connector-5.png[image]
...
image:sftp-connector-6.png[image]
...
image:sftp-connector-7.png[image]
...
image:sftp-connector-8.png[image] +
...
See the link:/mule-user-guide/sftp-transport-reference[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
