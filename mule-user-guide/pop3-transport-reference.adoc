...
] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3/namespace-overview.html[SchemaDoc] |image:pop3-transport-reference-1.png[image] |one-way |one-way |org.mule.transport:mule-transport-pop3

|POP3S |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc +
]
http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3s/namespace-overview.html[SchemaDoc] |image:pop3-transport-reference-1.png[image] |one-way |one-way |org.mule.transport:mule-transport-pop3s
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You link:/mule-user-guide/endpoint-configuration-reference[configure the endpoints] just as you would with any other transport, with the following additional attributes:
