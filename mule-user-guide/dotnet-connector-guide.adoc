...
* link:/mule-user-guide/dotnet-connector-user-guide[DotNet Connector User Guide]
* link:/mule-user-guide/dotnet-connector-migration-guide[DotNet Connector Migration Guide]
* link:/mule-user-guide/dotnet-connector-faqs[DotNet Connector FAQs]
...
This document assumes that you are familiar with Mule, the link:/mule-fundamentals/anypoint-studio-essentials[Anypoint Studio interface], and link:/mule-fundamentals/global-elements[Global Elements]. Further, it is assumed that you are familiar with the Microsoft .NET Framework.
...
* Anypoint Studio, the graphical interface to Mule ESB. See link:/mule-fundamentals/download-and-launch-anypoint-studio[Download and Launch Anypoint Studio] for details

[WARNING]
====
The .NET connector version 1.0 is incompatible with version 2.0. Please refer to the link:/mule-user-guide/dotnet-connector-migration-guide[.NET connector migration guide] if you are an existing user of .NET connector 1.0.
====
...
|*link:/mule-user-guide/http-connector[HTTP Connector]* |Enables the example application to receive and send HTTP requests.
|*link:/mule-user-guide/set-payload-transformer-reference[Set Payload Transformer]* |The set payload transformer sets the payload to whatever you define. The payload can be a literal string or a Mule Expression.
|*link:/mule-user-guide/datamapper-concepts[DataMapper]* |The DataMapper is a Mule transformer that delivers simple, yet powerful, visual design of complex data transformations for use in Mule flows
|===
...
+
image:dotnet-connector-guide-1.png[image]
...
+
image:dotnet-connector-guide-4.png[image] +

..  Configure the following HTTP parameters:
+
image:dotnet-connector-guide-5.png[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:dotnet-connector-guide-6.png[image]
...
+
image:dotnet-connector-guide-7.png[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:dotnet-connector-guide-8.png[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:dotnet-connector-guide-9.png[image]
...
+
image:dotnet-connector-guide-10.png[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
image:dotnet-connector-guide-11.png[image]
....
[tab,title="XML Code"]
....
[source]
...
+
image:dotnet-connector-guide-12.png[image]
...
* Learn more about the DotNet connector in the link:/mule-user-guide/dotnet-connector-faqs[DotNet Connector FAQs].
