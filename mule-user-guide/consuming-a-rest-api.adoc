...
image:consuming-a-rest-api-1.png[image]
...
image:consuming-a-rest-api-2.png[image]
...
. Click on the green plus sign icon next to Connector Configuration to create a new link:/mule-fundamentals/global-elements[global element] that will encapsulate several configuration parameters for the connector.
. Set the Host to *api.openweathermap.org* and the Port to *80*
+
image:consuming-a-rest-api-3.png[image]
...
+
image:consuming-a-rest-api-4.png[image]
...
+
image:consuming-a-rest-api-5.png[image]
...
+
image:consuming-a-rest-api-6.png[image]
+
[TIP]
====
...
image:consuming-a-rest-api-7.png[image]
...
+
image:consuming-a-rest-api-8.png[image]
...
+
image:consuming-a-rest-api-9.png[image]

. You can also use a link:/mule-user-guide/configuring-properties[property placeholder], then define the value in your *mule-app.properties* file
+
image:consuming-a-rest-api-10.png[image]
+
[TIP]
====
...
[NOTE]
Note that if your use case involves working with an API with complex authentication protocols such as OAuth, you can build your own Anypoint Connector to consume the API. See link:/anypoint-connector-devkit/[Anypoint Connector DevKit] for more details about building connectors.
...
+
image:consuming-a-rest-api-11.png[image]
....
[tab,title="XML Editor or Standalone"]
....
[source]
...
+
image:consuming-a-rest-api-12.png[image]

. Note that you can also replace these with link:/mule-user-guide/configuring-properties[property placeholders] and define the properties in your `mule-app.properties` file.
+
image:consuming-a-rest-api-13.png[image]

. Navigate to your `mule-app.properties` file under `src/main/app` in the Package Explorer.
+
image:consuming-a-rest-api-14.png[image]

. Define the placeholders here, as shown below.
+
image:consuming-a-rest-api-15.png[image]
....
[tab,title="XML Editor or Standalone"]
....
...
Rather than hardcode the values of your credentials, you can define them as link:/mule-user-guide/configuring-properties[property placeholders].
...
[NOTE]
Although the HTTP connector has built-in polling capabilities (described below), you can, instead, configure a *link:/mule-user-guide/poll-reference[Poll]* scope, then place your HTTP endpoint within it. Using a Poll scope allows you to take advantage of more robust polling functionality such as watermarking and scheduling with cron expressions.
...
+
image:consuming-a-rest-api-16.png[image]

. In the Choose Global Type window, select *HTTP Polling*.
+
image:consuming-a-rest-api-17.png[image]
...
+
image:consuming-a-rest-api-18.png[image]
...
+
image:consuming-a-rest-api-19.png[image]
...
+
image:consuming-a-rest-api-20.png[image]

== See Also

* See some link:/mule-user-guide/rest-api-examples[example applications] that consume REST APIs.

* Refer to the reference documentation for the link:#[HTTP connector].

* If the HTTP connector doesn't meet your needs, consider building a connector with the link:/anypoint-connector-devkit/[Anypoint Connector DevKit].
