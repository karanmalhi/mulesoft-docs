...
This document assumes that you are familiar with the link:/mule-fundamentals/anypoint-studio-essentials[Visual Editor in Anypoint Studio], link:/mule-user-guide/anypoint-connectors[Anypoint Connectors], and  link:/mule-fundamentals/global-elements[Global Elements]. Review the link:/mule-fundamentals/first-day-with-mule[First Day with Mule] chapter to learn more about developing with Mule ESB's graphical user interface.
...
+
image:using-a-connector-to-access-an-oauth-api-1.png[image,title="salesforce1.png"] +
+
...
   +
  image:using-a-connector-to-access-an-oauth-api-2.png[image,title="salesforce2.png"]
...
[NOTE]
If you need to deploy to different environments (e.g., production, development) where these parameters need to have different values, please see link:/mule-user-guide/deploying-to-multiple-environments[Deploying to Multiple Environments].
...
+
image:using-a-connector-to-access-an-oauth-api-3.png[image] +
+
...
+
image:using-a-connector-to-access-an-oauth-api-4.png[image] +
+
...
+
image:using-a-connector-to-access-an-oauth-api-5.png[image]  
+
...
image:using-a-connector-to-access-an-oauth-api-6.png[image]
....
...
+
image:using-a-connector-to-access-an-oauth-api-7.png[image] +
+
...
+
image:using-a-connector-to-access-an-oauth-api-8.png[image]
+
...
|*accessTokenUrl* |(_Optional_ ) link:#UsingaConnectortoAccessanOAuthAPI-AccessTokenandAuthorizationURLs[See below]. `  `Example: `https://na1.salesforce.com/services/oauth2/token `
|*authorizationUrl* |(_Optional_ ) link:#UsingaConnectortoAccessanOAuthAPI-AccessTokenandAuthorizationURLs[See below]. `  `Example: `  https://na1.salesforce.com/services/oauth2/authorize  `
|*display* |PAGE
|===
...
+
image:using-a-connector-to-access-an-oauth-api-9.png[image]
+
...
+
image:using-a-connector-to-access-an-oauth-api-10.png[image]
....
...
[tab,title="STUDIO Visual Editor"]
....
image:using-a-connector-to-access-an-oauth-api-11.png[image]
....
[tab,title="XML Editor or Standalone"]
....
[source]
...
* Learn how to access an OAuth API using the link:/mule-user-guide/http-request-connector[HTTP Request Connector]
