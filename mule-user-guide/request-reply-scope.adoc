...
This document assumes that you understand the difference between link:/mule-fundamentals/flows-and-subflows[synchronous and asynchronous flows]. Furthermore, you're also familiar with link:/mule-user-guide/scopes[Scopes] in general.
...
+
image:request-reply-scope-2.png[image]
+
...
+
image:request-reply-scope-3.png[image]
...
* Learn more about link:/mule-fundamentals/flows-and-subflows[synchronous and asynchronous flows].
