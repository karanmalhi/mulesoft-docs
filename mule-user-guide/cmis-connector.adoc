...
* A global element for CMIS for use by all the CMIS connectors in your Mule application. For more information, see link:/mule-fundamentals/global-elements[Mule Global Elements].
...
+
image:cmis-connector-1.png[image]
+
...
[tab,title="Studio Visual Editor"]
....
image:cmis-connector-2.jpeg[image]

. Drag an HTTP endpoint into a new flow, and configure it as follows:
+
image:cmis-connector-3.png[image] +
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:cmis-connector-4.png[image]

. Configure the CMIS global element.
+
image:cmis-connector-5.png[image]
+
[width="100%",cols="34%,33%,33%",options="header",]
|===
...
+
image:cmis-connector-6.png[image]
+
[cols=",",options="header",]
|===
|Field |Vealu
...
+
image:cmis-connector-7.png[image]
+
...
+
image:cmis-connector-8.png[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:cmis-connector-9.png[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
* Learn about link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language] 

* Learn about link:/mule-user-guide/endpoint-configuration-reference[Configuring Endpoints] 
