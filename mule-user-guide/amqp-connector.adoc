...
The AMQP connector is also available as a Studio plugin. View the https://www.mulesoft.com/library/#!/amqp-integration-connector[AMQP connector in Anypoint Exchange]. Connector installation information is available at link:/mule-user-guide/anypoint-connectors[Anypoint Connectors].

== See Also

* Read the link:/mule-user-guide/amqp-connector-examples[AMQP Connector Examples] for practical illustrations of common use cases.
