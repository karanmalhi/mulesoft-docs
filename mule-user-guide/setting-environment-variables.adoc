...
If you're deploying multiple applications through a link:/mule-user-guide/shared-resources[Shared Resources] structure, then you shouldn't set any properties in the project properties files, as there might potentially be conflicts between the various apps that share a domain. Instead, you can set environment variables over the scope of the deployed app, its domain and other apps under that domain. 
...
+
image:setting-environment-variables-1.png[image]
...
+
image:setting-environment-variables-2.png[image]

. Then pick the *Environment* tab, and add the variables you need by clicking the *New* button.
+
image:setting-environment-variables-3.png[image]
...
* Learn more about link:/mule-user-guide/shared-resources[Shared Resources]
* If you're deploying a single application, you can still set up link:/mule-user-guide/configuring-properties[Application Properties]
