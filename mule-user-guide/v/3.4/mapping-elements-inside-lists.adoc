...
. Click *Finish* to load the configurations into the **Data Mapping Editor **(see image below).  +
 +
 image:/docs/download/attachments/95393436/image2013-4-16+14%3A4%3A59.png?version=1&modificationDate=1374598555839[image] +
 +
...
. Click the "eye" icon (see below, top) in the *Input* pane to reveal the individual elements in the lists. The two nested lists in the XML file, `contacts` and `emergency_contacts`, display their respective child elements (below, bottom). +
 +
image:/docs/download/attachments/95393436/image2013-4-16+14%3A9%3A32.png?version=1&modificationDate=1374598555619[image] +
 +
image:/docs/download/attachments/95393436/image2013-4-16+14%3A33%3A18.png?version=1&modificationDate=1374598555391[image]
...
. Hover your mouse over an *input attribute*, identifiable by a blue "e" icon. Mule displays a tooltip hinting which elements in the *output pane* you can map the attribute to. +
 +
image:/docs/download/attachments/95393436/image2013-4-16+14%3A36%3A47.png?version=1&modificationDate=1374598555147[image]
...
+
image:/docs/download/attachments/95393436/image2013-4-16+14%3A41%3A27.png?version=1&modificationDate=1374598554925[image]
...
To preview the behavior of the mapping without running your entire mapping flow, click *Preview* above the output pane: +
 +
image:/docs/download/attachments/95393436/image2013-4-16+15%3A31%3A11.png?version=1&modificationDate=1374598554487[image]
...
. Click *Finish* to load the configurations into the *Data Mapping Console* (see image below). +
 +
image:/docs/download/attachments/95393436/image2013-4-16+16%3A0%3A28.png?version=1&modificationDate=1374598554269[image]
...
+
image:/docs/download/attachments/95393436/image2013-4-16+16%3A15%3A44.png?version=1&modificationDate=1374598554033[image] +
+
...
+
image:/docs/download/thumbnails/95393436/image2013-4-16+17%3A19%3A44.png?version=1&modificationDate=1374598552519[image]

* DataMapper auto-maps all children of emergency_contacts/user that have matching names to children of emergencyContacts.
+
image:/docs/download/attachments/95393436/image2013-4-16+16%3A17%3A16.png?version=1&modificationDate=1374598553799[image]
+
...
+
image:/docs/download/thumbnails/95393436/image2013-4-16+16%3A18%3A47.png?version=1&modificationDate=1374598553585[image]
+
...
+
image:/https://developer.mulesoft.com/docs/download/thumbnails/95393436/image2013-4-16+16%3A20%3A21.png?version=1&modificationDate=1374598553373[image]

.. Click *OK.* The new `phone` attribute is created in the JSON output file. +
image:/docs/download/thumbnails/95393436/image2013-4-16+16%3A21%3A3.png?version=1&modificationDate=1374598553157[image]
+

.. Click the `phone` element in the input pane, then drag it to the newly-created `phone` key in the output pane.
+
image:/docs/download/thumbnails/95393436/image2013-4-16+16%3A22%3A33.png?version=1&modificationDate=1374598552731[image]
+
====
////
+
...
image:/docs/download/thumbnails/95393436/image2013-4-16+17%3A49%3A44.png?version=1&modificationDate=1374598552309[image]

The mapping editor updates to focus on this mapping: 

image:/docs/download/attachments/95393436/image2013-4-16+17%3A50%3A33.png?version=1&modificationDate=1374598552095[image]
...
image:/docs/download/attachments/95393436/image2013-4-16+17%3A53%3A12.png?version=1&modificationDate=1374598551878[image]
...
image:/docs/download/attachments/95393436/image2013-4-16+18%3A0%3A41.png?version=1&modificationDate=1374598551657[image]
