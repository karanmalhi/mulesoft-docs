...
For configuration reference on transports, see link:/mule-user-guide/v/3.6/transports-reference[Transports Reference]. For modules, see link:/mule-user-guide/v/3.7/modules-reference[Modules Reference].
