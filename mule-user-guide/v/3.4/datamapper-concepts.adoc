...
For complete information on MEL, see link:/mule-user-guide/v/3.4/mule-expression-language-mel[Mule Expression Language]. For complete information on CTL syntax and capabilities, including a language and functions reference, download the link:/docs/download/attachments/95393434/Mule+ESB+and+Studio+-+Datamapper+CTL2+Reference.pdf?version=1&modificationDate=1374598548138[CTL2 Documentation].
