...
Within flows, the streamlined architecture of Mule 3 allows link:/docs/display/34X/Using+Transformers[Transformers], link:/docs/display/34X/Using+Filters[Filters], link:/docs/display/34X/Configuring+Components[Components], Routers and other message processing artifacts to be used, and nested, freely as required. They all implement a common MessageProcessor interface and can be used interchangeably.
