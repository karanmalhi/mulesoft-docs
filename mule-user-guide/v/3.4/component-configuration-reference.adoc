...
This page provides details on the elements you configure for components. This information is pulled directly from `mule.xsd` and is cached. For more information on components, see link:/docs/display/34X/Configuring+Components[Configuring Components].
...
See link:/docs/display/34X/Using+Interceptors[Using Interceptors].
