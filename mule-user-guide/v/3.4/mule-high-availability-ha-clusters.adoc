...
* If your application processes messages from a non-transactional transport, use a link:/mule-management-console/v/3.4/reliability-patterns[reliability pattern] to move them to a transactional store such as a VM or JMS store.
...
* Implement link:/mule-management-console/v/3.4/reliability-patterns[reliability patterns] to create high reliability applications.
