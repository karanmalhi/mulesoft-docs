...
* link:#DeploymentDescriptor-Options[Options]
* link:#DeploymentDescriptor-ClassloadlinginMule[Classloadling in Mule]
...
For details on classloading in MuleMule, including a diagram of the Mule classloading architecture, see link:/docs/display/34X/Classloader+Control+in+Mule[Classloader Control in Mule].
