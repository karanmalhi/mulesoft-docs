...
Get more information about installing link:/docs/display/34X/Studio+in+Eclipse[Studio as an Eclipse plug-in].

== See Also 

* Find out what platform software is link:/docs/display/34X/Compatibility[compatible] with the current version of Mule ESB.
