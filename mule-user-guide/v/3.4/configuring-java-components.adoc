...
For a real-world example of using `<spring-object/>`, see link:/documentation/display/current/Using+Spring+Beans+as+Flow+Components[Using Spring Beans as Flow Components].
...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the flow. See link:/documentation/display/current/Developing+Components[Developing Components] for a more detailed description of their functionality.
...
See link:/documentation/display/current/Developing+Components[Developing Components] for more information about lifecycles.
...
Binding can be used on Java components and script components. For more information see link:/documentation/display/current/Component+Bindings[Component Bindings].
...
For more information about pooling and reference documentation for pooling configuration options, see link:/documentation/display/current/Tuning+Performance[Tuning Performance].
