...
image:/docs/download/attachments/95393321/client_validation.png?version=1&modificationDate=1374598362804[image]
...
+
image:/docs/download/attachments/95393321/oauth_global.png?version=1&modificationDate=1374598362601[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Req'd |Value
...
+
image:/docs/download/attachments/95393321/create_client.png?version=1&modificationDate=1374598362407[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Req'd |Value
...
|*Strings* | |Select *Create a List*, then click image:/docs/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[plus] icon to add an `oauth2-provider:scopes` child element to the `oauth2-provider:create-client` element in your config. In the dialog, click *Define*, then enter a space-seperated list of scopes which the client must provide when it uses service.
|===
+
[source]
----
...
+
image:/docs/download/attachments/95393321/validate-Both.png?version=1&modificationDate=1374598362202[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Req'd? |Value
