...
The POP3 connector supports all the link:/docs/display/34X/Configuring+a+Transport#ConfiguringaTransport-commonConfig[common connector attributes and properties] and the following additional attributes:
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You link:/docs/display/34X/Configuring+Endpoints[configure the endpoints] just as you would with any other transport, with the following additional attributes:
...
For more information about transformers, see the link:/docs/display/34X/Email+Transport+Reference#EmailTransportReference-Transformers[Transformers] section in the Email Transport Reference.
...
See link:/docs/display/34X/Transports+Reference[transport matrix].
