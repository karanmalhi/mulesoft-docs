...
* link:#FlowProcessingStrategies-AbouttheSynchronousFlowProcessingStrategy[About the Synchronous Flow Processing Strategy]
* link:#FlowProcessingStrategies-AbouttheQueued-AsynchronousFlowProcessingStrategy[About the Queued-Asynchronous Flow Processing Strategy]
* link:#FlowProcessingStrategies-HowMuleSelectsaFlowProcessingStrategy[How Mule Selects a Flow Processing Strategy]
* link:#FlowProcessingStrategies-ChangingtheProcessingStrategyforYourFlow[Changing the Processing Strategy for Your Flow]
* link:#FlowProcessingStrategies-ForcingaSpecificFlowProcessingStrategy[Forcing a Specific Flow Processing Strategy]
* link:#FlowProcessingStrategies-Fine-TuningaProcessingStrategy[Fine-Tuning a Processing Strategy]
* link:#FlowProcessingStrategies-CreatingaProcessingStrategy[Creating a Processing Strategy]
* link:#FlowProcessingStrategies-ReusingProcessingStrategies[Reusing Processing Strategies]
...
* The flow's inbound endpoint must be notified of all errors that occur during the processing of the message. This situation is discussed further in link:/docs/display/34X/Reliability+Patterns[Reliability Patterns].
