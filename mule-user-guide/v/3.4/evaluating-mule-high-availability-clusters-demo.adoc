...
image:/docs/download/attachments/95393535/topology_4-cluster.png?version=1&modificationDate=1374598732817[image]
...
link:/docs/display/34X/Mule+High+Availability+HA+Clusters[Learn More...]
...
. *A Web application, `WidgetUI`, to apply load to the Mule cluster.* +
 ...
 image:/docs/download/attachments/95393535/widgetUI_modified.png?version=1&modificationDate=1374598727594[image] +

== Get Started!

* link:/docs/display/34X/1+-+Installing+the+Demo+Bundle[1 - Installing the Demo Bundle]
* link:/docs/display/34X/2+-+Creating+a+Cluster[2 - Creating a Cluster]
* link:/docs/display/34X/3+-+Deploying+an+Application[3 - Deploying an Application]
* link:/docs/display/34X/4+-+Applying+Load+to+the+Cluster[4 - Applying Load to the Cluster]
* link:/docs/display/34X/5+-+Witnessing+Failover[5 - Witnessing Failover]
* link:/docs/display/34X/6+-+Troubleshooting+and+Next+Steps[6 - Troubleshooting and Next Steps]
