...
. _Required._ Modify your http://www.mulesoft.org/documentation/display/current/Deploying+Mule+to+WebLogic#DeployingMuletoWebLogic-configuration[WebLogic configuration] by adding elements to the *weblogic.xml* file
. Configure logging as described in http://www.mulesoft.org/documentation/display/current/Deploying+Mule+to+WebLogic#DeployingMuletoWebLogic-logging[Configuring Logging].
