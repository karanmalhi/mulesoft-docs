...
* Perceptive Flow Design only functions with Anypoint connectors which support link:/docs/display/34X/Testing+Connections[connection testing] (see table below).
+
...
+
image:/docs/download/attachments/95393344/basic_flow.png?version=1&modificationDate=1374598401400[image]

. Configure the Salesforce connector, and its corresponding global connector, then test the connection to confirm communication. Refer to link:/docs/display/34X/Testing+Connections[Testing Connections] for details.
. Once you have confirmed successful connection to Salesforce, insert a *DataMapper* before the connector on your canvas.
+
image:/docs/download/attachments/95393344/basic_flow2.png?version=1&modificationDate=1374598401186[image]
...
+
image:/docs/download/attachments/95393344/defined_output.png?version=1&modificationDate=1374598400970[image]
...
+
image:/docs/download/attachments/95393344/dataMapping_example.png?version=1&modificationDate=1374598400748[image]

. Save, then continue to build your Mule application.

== See Also

* Learn more about Anypoint DataMapper through the link:/docs/display/34X/Datamapper+User+Guide+and+Reference[Datamapper User Guide and Reference]. Specifically on the subject of metadata, see link:/docs/display/34X/Defining+DataMapper+Input+and+Output+Metadata[Defining DataMapper Input and Output Metadata].
