...
image:/docs/download/attachments/95393500/Async+scope+schematic.png?version=1&modificationDate=1374598672313[image]
...
+
image:/docs/download/attachments/95393500/Studio_Async_step1.png?version=1&modificationDate=1374598672041[image]
...
+
image:/docs/download/attachments/95393500/Studio_Async_Step2.png?version=1&modificationDate=1374598671768[image]
...
+
image:/docs/download/attachments/95393500/Studio_Async_Step4.png?version=1&modificationDate=1374598670960[image]
....
...
+
image:/docs/download/attachments/95393500/Studio_Async_ScopeProperties_Add.png?version=1&modificationDate=1374598673113[image]

. In the *Choose Global Type* window, select from the list of available processing strategies, then click *OK*.
+
image:/docs/download/attachments/95393500/Studio_Async_ChooseGlobalType.png?version=1&modificationDate=1374598673383[image]
