...
* link:#ConfiguringLogging-TroubleshootingLogging[Troubleshooting Logging]
* link:#ConfiguringLogging-ControllingLoggingfromJMX[Controlling Logging from JMX]
...
You can expose a manager's logging configuration over JMX by configuring a Log4J Jmx agent in your Mule configuration file. See link:/docs/display/35X/JMX+Management#JMXManagement-JmxManagement-Log4JAgent[JMX Management] for more information.
