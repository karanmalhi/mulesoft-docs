...
JSON Path can be used in link:/docs/display/34X/Mule+Expression+Language+MEL[Mule expressions] to query JSON message payloads for filtering or link:/docs/display/34X/Message+Enricher[enrichment].
