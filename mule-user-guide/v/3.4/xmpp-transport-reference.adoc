...
|XMPP |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/xmpp/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_xmpp/namespace-overview.html[SchemaDoc] |image:/documentation/images/icons/emoticons/check.gif[image] |image:/documentation/images/icons/emoticons/check.gif[image] |image:/documentation/images/icons/emoticons/check.gif[image] |image:/documentation/images/icons/emoticons/error.gif[image] |image:/documentation/images/icons/emoticons/error.gif[image] |image:/documentation/images/icons/emoticons/error.gif[image] |one-way, request-response |one-way |org.mule.transport:mule-transport-xmpp
|===
