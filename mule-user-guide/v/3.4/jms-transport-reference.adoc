...
|JMS |http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/jms/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jms/namespace-overview.html[SchemaDoc] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image](client ack, local, XA) |image:http://www.mulesoft.org/documentation/images/icons/emoticons/error.gif[image] |image:http://www.mulesoft.org/documentation/images/icons/emoticons/check.gif[image] |one-way, request-response |one-way |org.mule. http://transportmule-transport-jms/[transport:mule-transport-jms]
|===
...
* Supports local (JMS), distributed (XA), and multi-resource link:/docs/display/34X/Transaction+Management[transactions] _*Enterprise*_
...
*Enterprise*  +
Mule Enterprise includes an link:/docs/display/34X/Mule+WMQ+Transport+Reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
...
*Enterprise* +
Mule Enterprise includes an link:/docs/display/current/Mule+WMQ+Transport+Reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.

http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has link:/docs/display/current/ActiveMQ+Integration[simplified configuration].
...
* link:/docs/display/current/HornetQ+Integration[HornetQ]
* link:/docs/display/current/Open+MQ+Integration[Open MQ]
* link:/docs/display/current/Solace+JMS[Solace JMS]
* link:/docs/display/current/Tibco+EMS+Integration[Tibco EMS] +
