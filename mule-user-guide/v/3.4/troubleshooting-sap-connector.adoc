...
This page contains some common troubleshooting suggestions for the link:/docs/display/34X/MuleSoft+Enterprise+Java+Connector+for+SAP+Reference[SAP Connector].
...
In this example, JCo libraries are informing that the parameter with name _type_ is not valid. The complete list of valid property names can be found link:/docs/display/34X/SAP+JCo+Extended+Properties[here].
