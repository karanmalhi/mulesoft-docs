...
This page provides reference information about the elements and attributes you can configure for the link:/documentation-3.2/display/32X/CXF+Module+Reference[CXF Module Reference].
...
[width="99",cols="20,80",options="header"]
|===
|Name |Description
