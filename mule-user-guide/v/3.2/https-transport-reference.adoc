...
[width="70",cols="10,90",options="header"]
|===
...
For more information on configuring HTTP endpoints, see link:/documentation-3.2/display/32X/HTTP+Transport+Reference[HTTP Transport Reference].
