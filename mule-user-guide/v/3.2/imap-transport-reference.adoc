...
The IMAP connector supports all the link:/documentation-3.2/display/32X/Configuring+a+Transport#ConfiguringaTransport-commonConfig[common connector attributes and properties] and the following additional attributes:
...
IMAP and IMAPS endpoints include details about connecting to an IMAP mailbox. You link:/documentation-3.2/display/32X/Configuring+Endpoints[configure the endpoints] just as you would with any other transport, with the following additional attributes:
