...
[NOTE]
For Mule ESB Community Edition _prior to Mule 3.2_, you must link:#ConfiguringReconnectionStrategies-create[create your own strategies] and link:#ConfiguringReconnectionStrategies-communityConfig[configure them using standard Spring syntax] rather than the mule-ee.xsd schema.
...
image:/documentation-3.2/download/attachments/29425989/ReconnectionTab.png?version=1&modificationDate=1332292152557[image]
