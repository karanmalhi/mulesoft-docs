...
For details on classloading in MuleMule, including a diagram of the Mule classloading architecture, see link:/documentation-3.2/display/32X/Classloader+Control+in+Mule[Classloader Control in Mule].
