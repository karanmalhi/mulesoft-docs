...
While many times you can proxy web services without using CXF (see link:/documentation-3.2/display/32X/Proxying+Web+Services[Proxying Web Services]), there are several cases where you might want to use CXF proxies:
