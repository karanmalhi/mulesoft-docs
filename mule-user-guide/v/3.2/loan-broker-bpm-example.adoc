...
For more information refer to the link:/mule-user-guide/v/3.2/bpm-module-reference[BPM Module Reference] documentation and/or the http://docs.jboss.com/jbpm/v4/userguide/html_single/[jBPM User Guide].