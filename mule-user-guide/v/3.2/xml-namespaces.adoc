...
You can specify the namespace on any XML-based functionality in Mule, including the JXPath filter, Jaxen filter, XPath filter, filter-based splitter, expression splitter, round-robin splitter, JXPath extractor transformer, and XPath expression transformer in the link:/documentation-3.2/display/32X/XML+Module+Reference[XML Module Reference], link:/documentation-3.2/display/32X/XPath+Annotation[XPath Annotation], as well as the SXC filter and filtering router in the link:/documentation-3.2/display/32X/SXC+Module+Reference[SXC Module Reference].
