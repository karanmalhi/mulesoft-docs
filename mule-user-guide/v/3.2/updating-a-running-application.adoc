...
If you are using the Enterprise Edition of Mule, you can use the link:/mule-fundamentals/v/3.2/mule-management-console-3.2.x[Mule Management Console] to update a running application.
