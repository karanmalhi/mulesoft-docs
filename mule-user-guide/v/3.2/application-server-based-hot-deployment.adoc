...
To deploy Mule as a service to Tomcat or Tcat Server, see link:/documentation-3.2/display/32X/Deploying+Mule+as+a+Service+to+Tomcat[Deploying Mule as a Service to Tomcat].
