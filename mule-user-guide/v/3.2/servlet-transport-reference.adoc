...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see link:/documentation-3.2/display/32X/HTTP+Transport+Reference[HTTP Transport Reference].
