...
|image:/documentation-3.2/download/attachments/55575051/HA-arch.png?version=1&modificationDate=1329179276309[image]
|===
...
For details on specific features that are not supported in the current release, see link:#MuleHighAvailability%28Mule3.1only%29-limitations[MULE3USER:Limitations] below.
