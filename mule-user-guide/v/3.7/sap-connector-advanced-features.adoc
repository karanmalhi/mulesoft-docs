...
The SAP Connector provides a wide range of functionalities, beyond the basic ones already described in the link:/mule-user-guide/v/3.7/sap-connector[SAP Documentation]. The present document will help you harness the full potential of your SAP Mule application.
...
IMPORTANT: The key names for these properties must *match* those expected by the JCo libraries. You can check them at link:/mule-user-guide/v/3.7/sap-jco-extended-properties#sap-client-properties[SAP Client Properties] and link:/mule-user-guide/v/3.7/sap-jco-extended-properties#sap-server-properties[SAP Server Properties].
...
* link:https:/mule-user-guide/v/3.7/sap-connector-troubleshooting[SAP Connector Troubleshooting] to handle common problems.
