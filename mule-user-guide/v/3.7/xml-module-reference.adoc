...
In most cases, link:http://www.saxproject.org/about.html[SAX] is used to parse your XML. If you are using CXF or the XmlToXMLStreamReader, link:http://stax.codehaus.org/Home[Stax] is used instead.
