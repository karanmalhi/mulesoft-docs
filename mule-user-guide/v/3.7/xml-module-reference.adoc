...
|link:/mule-user-guide/v/3.7/xmlobject-transformers[XmlToObject <-> ObjectToXml] |Converts XML to a Java object and back again using link:https://web.archive.org/web/20150526105309/http://stax.codehaus.org/Home[XStream].
