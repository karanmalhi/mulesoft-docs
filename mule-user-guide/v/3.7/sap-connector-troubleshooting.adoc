...
[NOTE]
For further information, take a look at link:/mule-user-guide/v/3.7/sap-connector[Share JCo Dependencies Among Multiple Applications].
...
Provide a valid property name. The complete list of extended properties can be found link:/mule-user-guide/v/3.7/sap-advanced-features#jco-extended-properties[here].
...
* link:/mule-user-guide/v/3.7/sap-conector-advanced-features[SAP Connector Advanced Features].
