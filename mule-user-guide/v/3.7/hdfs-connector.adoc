...
The Anypoint Connector for the Hadoop Distributed File System (HDFS) uses as a bi-directional gateway between Mule applications at the link:http://mulesoft.github.io/hdfs-connector/[HDFS Connector GitHub site].
