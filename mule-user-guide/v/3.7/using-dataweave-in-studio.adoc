...
In Anypoint Studio, you can set the parameters of the CSV input through the graphical interface, by selecting the element from the tree view in the input section and then clicking the gear icon.
