...
This document assumes that you are familiar with the link:http://www.mulesoft.org/documentation/display/current/Mule+Studio+Essentials[Visual Editor in Mule Studio], particularly link:/mule-user-guide/v/3.3/studio-building-blocks[Studio Building Blocks]. Review the link:http://www.mulesoft.org/documentation/display/current/Getting+Started+with+Mule+Studio[Getting Started with Mule Studio] chapter to learn more about developing with Mule ESB's graphical user interface.
