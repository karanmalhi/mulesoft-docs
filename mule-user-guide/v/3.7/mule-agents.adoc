...
Mule provides link:/mule-user-guide/v/3.7/jmx-management[several agents for JMX support], including notifications and remote management. You can also create custom agents to plug any functionality into Mule, such as running functionality as a background process or embedding a server in Mule.
...
For a list of agents provided with Mule and how to configure them, see link:/mule-user-guide/v/3.7/jmx-management[JMX Management]. You can also create a custom agent as described below.
