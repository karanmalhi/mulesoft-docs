...
. Download the Windows Gateway Services installer from link:https://repository-master.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.8.0/anypoint-windows-gateway-service-1.8.0.zip[here]. Unzip the software distribution.
