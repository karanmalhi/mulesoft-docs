...
link:https://repository.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.7.0/anypoint-windows-gateway-service-1.7.0.zip[Install Windows Gateway Services]
