...
+
image:oracle_ebs_define_map.png[oracle_ebs_define_map]
+
...
* Access Oracle EBS connector link:/release-notes/oracle-e-business-suite-ebs-connector-release-notes[Oracle E-Business Suite (EBS) Connector Release Notes]
