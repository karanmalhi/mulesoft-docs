...
:keywords: anypoint studio, esb, connector, endpoint, oracle, ebusiness, ebs
...
* Access Oracle EBS connectorlink:/mule-user-guide/v/3.7/oracle-e-business-suite-connector[ release notes].
