...
Writing JAX-RS services is an expansive topic and will not be covered in this guide. However, the https://jersey.java.net/[Jersey] website has an excellent set of samples, and the link:http://jcp.org/aboutJava/communityprocess/final/jsr311/index.html[JAX-RS specification] is helpful as well.
