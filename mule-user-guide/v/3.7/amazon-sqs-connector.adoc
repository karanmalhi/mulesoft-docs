...
|Connector Configuration |Select a global Amazon SQS connector element from the drop-down.
...
----
+
*Note*: The Amazon SDK has been shaded to avoid dependency conflicts, Hence we have to import the MessageAttribute class belonging to the shaded package.
+
