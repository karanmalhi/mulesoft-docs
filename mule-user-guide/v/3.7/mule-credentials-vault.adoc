...
image:multiple-one-one.png[image]
...
+
image:test_properties2.png[image] +
+
...
+
image:setup_encryption.png[image] +
+
...
+
image:encrypted_value.png[image] +
+
