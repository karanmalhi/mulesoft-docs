...
|class |The name of the class that implements the custom protocol |  |See link:/mule-user-guide/v/3.7/tcp-transport-reference[below] for an example of writing a custom protocol
