...
The Siebel Object Manager lets a connector use a generic interface that doesn’t depend on a customized installation. To discover the metadata of Siebel objects in design time, use link:/mule-user-guide/v/3.7/datasense[DataSense] in Anypoint Studio. The Siebel connector takes advantage of the Siebel Repository to show a list of available objects as well as their structures in a Siebel custom installation.
...
[NOTE]
Refer to documentation on the link:/mule-user-guide/v/3.7/poll-reference[Poll Scope] , link:/mule-user-guide/v/3.7/datamapper-user-guide-and-reference[DataMapper], and the link:/mule-user-guide/v/3.7/salesforce-connector[Salesforce connector] for in-depth information about these Mule elements.
...
+
link:/mule-user-guide/v/3.7/poll-reference[Poll Scope] executes any Mule element you place inside it, at regular intervals. In this case, it is a Siebel endpoint.
...
[NOTE]
Refer to documentation on the link:/mule-user-guide/v/3.7/poll-reference[Poll Scope], link:/mule-user-guide/v/3.7/datamapper-user-guide-and-reference[DataMapper], and the link:/mule-user-guide/v/3.7/salesforce-connector[Salesforce Connector] for in depth information about these elements.
...
. Drag a *Poll Scope*  into a new flow: +
 image:poll2.jpeg[poll2] +
+
link:/mule-user-guide/v/3.7/poll-reference[Poll Scope]  executes the Mule element placed inside it at regular intervals. In this case, it is a Salesforce connector.
+
...
|===
|Element |Description
|Poll |A  link:/mule-user-guide/v/3.7/poll-reference[Poll Scope] executes the Mule element you place inside it at regular intervals. In this case, it is a Salesforce connector.
|===
+
[width="100%",cols="50%,50%",options="header",]
|===
