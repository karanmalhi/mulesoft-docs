...
* Custom transformers - performing operations that none of the Mule stock transformers can perform (see link:/mule-user-guide/v/3.7/creating-custom-transformers[here]).
* Custom components - typically Mule-aware or non-business oriented components, as business components are usually simple POJOs coming from pre-existing projects (see: link:/mule-user-guide/v/3.7/developing-components[here]).
