...
Contact the https://developer.mulesoft.com/docs/display/current/Siebel+Connector[MuleSoft Sales Team] to obtain either of these. (Read more about link:/mule-user-guide/v/3.7/installing-an-enterprise-license[Installing an Enterprise License].) 
...
* Access thelink:/release-notes/netsuite-connector-release-notes[NetSuite connector] https://developer.mulesoft.com/docs/display/current/Oracle+E-Business+Suite+Connector[ release notes].
