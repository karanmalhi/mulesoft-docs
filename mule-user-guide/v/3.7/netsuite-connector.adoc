...
NetSuite connector is an operation based connector, which means that when you add the connector to your flow, you need to configure a specific web service for the connector to perform. The NetSuite connector v5.0 supports 56 operations.
