...
+++
Brief explanation of API, protocol or service that your connector leverages
+++
...
| host | +++<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/String.html">String</a>+++ | +++A list of MongoDB instances, with the format <code>host:port</code>, separated by commas.
<pre>
...
[source,xml]
----
<mongo:exists-collection config-ref="Mongo_DB__Configuration" collection="aColllection2"/>
----
...
| 
query  | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the Document query object used to detect the element to update.+++ |  | {nbsp}




| 
element icon:envelope[] | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the Document mandatory object that will replace that one which matches the query.+++ | #[payload] | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++a Document with the update status+++
|======================
...
| 
query  | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the Document query document used to detect the element to update.+++ |  | {nbsp}




| 
element icon:envelope[] | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the Document mandatory document that will replace that one which matches the query.+++ | #[payload] | {nbsp}
...
| 
document icon:envelope[] | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the mandatory Document document to insert.+++ | #[payload] | {nbsp}
...
| 
query icon:envelope[] | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the optional Document query object. Documents that match it will be removed.+++ | #[payload] | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/Iterable.html">Iterable</a><<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>>+++ | +++an iterable that retrieves the resulting collection of Document+++
|======================
...
| 
query icon:envelope[] | +++<a href="https://api.mongodb.org/java/3.1/org/bson/conversions/Bson.html">Bson</a>+++ | +++the optional Document query for counting documents. Only documents matching it will be counted. If unspecified, all documents are counted.+++ | #[payload] | {nbsp}
...
| 
query icon:envelope[] | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the optional Document query document. If unspecified, all documents are returned.+++ | #[payload] | {nbsp}
...
| 
sortBy  | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++indicates the Document used to sort the results+++ |  | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/Iterable.html">Iterable</a><<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>>+++ | +++an iterable of Document+++
|======================
...
| 
query icon:envelope[] | +++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++the mandatory Document query document that the returned object matches.+++ | #[payload] | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>+++ | +++a Document that matches the query. If nothing matches and the failOnNotFound is set to false, null will be returned+++
|======================
...
|======================
|Return Java Type | Description
|+++<a href="http://docs.oracle.com/javase/7/docs/api/java/util/Collection.html">Collection</a><<a href="https://api.mongodb.org/java/3.1/org/bson/Document.html">Document</a>>+++ | +++a collection of Document with indices information+++
|======================
...
| payload icon:envelope[] | +++<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html">Object</a>+++ | *The current message payload is automatically transformed and injected to this parameter.* +++<br>the mandatory content of the new gridfs file. It may be a java.io.File, a byte[] or an InputStream.+++ | #[payload] | {nbsp}
...
| 
contentType  | +++<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/String.html">String</a>+++ | +++the optional content type of the new file+++ |  | {nbsp}




| 
metadata  | +++<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>+++ | +++the optional Document metadata of the new content type+++ |  | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>+++ | +++the new GridFSFile DBObject+++
|======================
...
| 
query icon:envelope[] | +++<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>+++ | +++a DBObject query the optional query+++ | #[payload] | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/Iterable.html">Iterable</a><<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>>+++ | +++a DBObject files iterable+++
|======================
...
| 
query icon:envelope[] | +++<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>+++ | +++the DBObject mandatory query+++ | #[payload] | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>+++ | +++a DBObject+++
|======================
...
| 
query icon:envelope[] | +++<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>+++ | +++the DBObject optional query+++ | #[payload] | {nbsp}
...
|======================
|Return Java Type | Description
|+++<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/Iterable.html">Iterable</a><<a href="https://api.servicename.org/java/3.1/com/mongodb/DBObject.html">DBObject</a>>+++ | +++an iterable of DBObject+++
|======================
