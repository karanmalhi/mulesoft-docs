...
JSON is now natively supported in Mule, meaning you can work with JSON documents and bind them automatically to Java objects. Further information is available in the link:/documentation/display/current/JSON+Module+Reference[JSON Module] configuration reference.
