...
Access the documentation for the link:http://www.mulesoft.org/documentation/display/current/Database+Connector[Database Connector] to take advantage of the newly-designed functionality.
====
...
|===
|Attribute |Description
|*create* |If `true` the database will be created upon first access. See link:http://db.apache.org/derby/docs/10.7/ref/rrefattrib26867.html[the Derby documentation] for details.
