...
If you're coming from the BETA version, you should also check the change in syntax, see the link: https://docs.mulesoft.com/mule-user-guide/v/3.7/munit-1.0-rc-migration-guide[MUnit 1.0-RC Migration Guide]
