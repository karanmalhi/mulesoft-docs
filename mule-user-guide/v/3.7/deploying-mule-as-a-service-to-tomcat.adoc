...
For more information on hot deploying Mule applications, see link:/documentation/display/current/Application+Server+Based+Hot+Deployment[Application Server Based Hot Deployment].
...
. Package your Mule application's configuration files and custom Java classes in a `.war` file (see link:/documentation/display/current/Application+Server+Based+Hot+Deployment[Application Server Based Hot Deployment]).
...
* Learn about deploying Mule applications in the cloud with link:/documentation/display/current/CloudHub[CloudHub].
