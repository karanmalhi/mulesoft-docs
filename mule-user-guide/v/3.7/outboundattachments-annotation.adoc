...
There are no parameters for this annotation and the parameter must be `java.util.Map<String, DataHandler>`. Any outbound attachments set by previous elements in a link:/mule-user-guide/v/3.7/using-flows-for-service-orchestration[Flow] will be accessible and writable in this map.
