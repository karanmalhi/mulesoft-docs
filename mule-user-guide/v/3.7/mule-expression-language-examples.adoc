...
[TIP]
For your convenience, you may download the link:mel_example_project.zip[complete project]. Note that this project is configured specifically for the **Mule 3.6.0 runtime**. Please refer to the 3.5.X documentation for a 3.5.X compatible version.
