...
Take a look at link:/mule-user-guide/v/3.7/using-mule-configuration-patterns[configuration patterns] and link:/mule-user-guide/v/3.7/using-flows-for-service-orchestration[flows].
...
For more information about patterns, read the link:/mule-user-guide/v/3.7/general-configuration-reference[General Configuration Reference].
