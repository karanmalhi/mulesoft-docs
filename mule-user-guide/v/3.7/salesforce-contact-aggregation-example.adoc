...
This document assumes that you are familiar with Mule, the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio interface], link:/mule-fundamentals/v/3.7/global-elements[Global Elements], link:/mule-user-guide/v/3.7/datasense[DataSense], and the link:/mule-user-guide/v/3.7/datamapper-user-guide-and-reference[DataMapper transformer]. Further, it is assumed that you are familiar with Salesforce and have a link:http://developer.force.com/[developerforce] account. Learn more about link:/mule-fundamentals/v/3.7/flows-and-subflows[flows and subflows] to gain more insight into the design of this example.
