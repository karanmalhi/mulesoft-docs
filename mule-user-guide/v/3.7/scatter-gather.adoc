...
This document assumes you are familiar with Mule applications and link:/mule-user-guide/v/3.4/message-processors[message processors], in particular link:/mule-user-guide/v/3.7/routers[routing message processors].
