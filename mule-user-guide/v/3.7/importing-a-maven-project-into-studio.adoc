...
* Learn how to build a complete link:/mule-user-guide/v/3.7/building-a-mule-application-with-maven-in-studio[Studio Maven Project], including tests and dependencies.
