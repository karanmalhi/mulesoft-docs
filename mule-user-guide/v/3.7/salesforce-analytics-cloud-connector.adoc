...
+
link:https://github.com/mulesoft/mulesoft-docs/blob/master/mule-user-guide/v/3.7/resources/CsvDemoTestData.csv[CsvDemoTestData.csv]
...
+
link:./resources/metadata.json[metadata.json]
//need screenshot for the below
...
. Click on *Edit* icon next to the *Type* field of the Input section.
+
...
+
link:./resources/CsvDemoTestData.csv[CsvDemoTestData.csv]
...
+
link:https://github.com/mulesoft/mulesoft-docs/blob/master/mule-user-guide/v/3.7/resources/metadata.json[metadata.json]
//need screenshot for the below
...
. In the *Label* field under *DataSet info* use *Test data set*.
. In the *Name* field under *DataSet info* enter *test_data_set*.
. Double-click on *Message Enricher* and fill in fields as below.
+
