...
This annotation controls how the current message inbound headers are passed into a method. The annotation supports, Map, List, single headers, wildcards and optional entries. It can be used on component entry points and link:/mule-user-guide/v/3.7/transformer-annotation[@Transformer] methods.
