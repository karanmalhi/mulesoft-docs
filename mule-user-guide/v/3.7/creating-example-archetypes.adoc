...
If the example is hosted on MuleForge, additional information is added to your example for linking to its issue tracker, web site, build server, and deployment information.
