...
[source, code, linenums]
----
mvn org.mule.tools:mule-example-archetype:3.5.4:create ...
----
====
+
[NOTE]
...
If the example is hosted on link:http://muleforge.org[MuleForge], additional information is added to your example for linking to its issue tracker, web site, build server, and deployment information.
