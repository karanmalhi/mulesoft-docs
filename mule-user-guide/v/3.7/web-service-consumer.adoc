...
image:wsc_global.png[Studio Global Element example: Name: Web_Service_Consumer, WSDL Location: sample_wsdl_2.txt, Service: StockQuoteService, Port: StockQuotePort, Address: example.com/stockquote]
