...
|*Use Alfresco Extension* |Specify whether the Alfresco Object Factory implementation should be utilized. This is set to true in this example application. |False
