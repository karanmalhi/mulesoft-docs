...
This document presents two usage examples of the database connector. This document assumes you are familiar with the link:/mule-user-guide/v/3.7/database-connector[database connector] as well as with link:/mule-user-guide/v/3.7/datasense[DataSense]; to understand the second example, the reader should also be familiar with the link:/mule-user-guide/v/3.7/datamapper-transformer-reference[DataMapper transformer] and Mule link:/mule-user-guide/v/3.7/batch-processing[batch processing].

== Database Used in the Examples

The examples in this page were written for MySQL. They use one database with two tables. If you wish to create this database and populate it with the sample data used in these examples, you can link:/documentation/download/attachments/122752067/create.sample.db.sql?version=1&modificationDate=1421704803418[download this MySQL script]. The script creates the database, database user and tables, and populates them with 102 rows of data.
...
In this example, a database connector retrieves data from two tables. A link:/mule-user-guide/v/3.7/datamapper-transformer-reference[DataMapper transformer] maps this data to the CSV format. A link:/mule-user-guide/v/3.7/file-connector[file connector] writes the resulting CSV file to disk, and a link:/mule-user-guide/v/3.7/logger-component-reference[logger component] logs processing details to the console.
...
* Learn more about link:/mule-user-guide/v/3.7/datasense[DataSense] and how you can use it to retrieve metadata on remote applications.
