...
This guide helps you use https://en.wikipedia.org/wiki/Dependency_injection[dependency injection]. For registry information, see link:/mule-user-guide/v/3.7/unifying-the-mule-registry[Unifying the Mule Registry].
