...
This property is fully explained in the link:/mule-user-guide/v/3.7/flow-processing-strategies#synchronous-flow-processing-strategy[processing strategy settings] page and a detailed example of how an asynchronous processing strategy works can be found in its specific section within the link:/mule-fundamentals/v/3.7/flows-and-subflows#sts=asynchronous%20Flows[Flow and subflows] page.
