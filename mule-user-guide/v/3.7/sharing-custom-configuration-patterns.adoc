...
For a list of configuration patterns that ship with Mule, see link:/mule-user-guide/v/3.7/using-mule-configuration-patterns[Using Mule Configuration Patterns].
