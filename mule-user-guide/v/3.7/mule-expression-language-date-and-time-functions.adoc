...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see link:/mule-user-guide/v/3.7/mule-expression-language-mel[Mule Expression Language], link:https://docs.mulesoft.com/mule-user-guide/v/3.7/mule-expression-language-basic-syntax[Mule Expression Language Basic Syntax], and the link:https://docs.mulesoft.com/mule-user-guide/v/3.7/mule-expression-language-examples[Mule Expression Lanuguage examples].
...
#[server.dateTime]
----
|server.nanoTime() |Current system time in nanoseconds. Equivalent to link:http://docs.oracle.com/javase/7/docs/api/java/lang/System.html#nanoTime()[System.nanoTime()] and has the same limitations, i.e., should be used only to measure elapsed time, etc. |int a|
[source, code, linenums]
----
#[server.nanoTime()]
----
...
Equivalent to: link:http://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#add(int,%20int)[calendar.add(Calendar.YEAR, add);] http://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#add(int,%20int)[ ] |DateTime
|===
...
A link:http://docs.oracle.com/javase/7/docs/api/java/util/TimeZone.html#getTimeZone(java.lang.String)[TimeZone.getTimeZone()] compatible string. a|
[source, code, linenums]
----
