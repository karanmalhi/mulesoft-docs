...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see link:/mule-user-guide/v/3.7/mule-expression-language-mel[Mule Expression Language], link:http://www.mulesoft.org/documentation/display/current/MEL+Basic+Syntax[MEL Basic Syntax], and the link:http://www.mulesoft.org/documentation/display/current/Mule+Expression+Language+Examples[MEL examples].
