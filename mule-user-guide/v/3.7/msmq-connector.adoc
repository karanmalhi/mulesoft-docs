...
* .NET 4.0 ( link:http://www.microsoft.com/en-US/download/details.aspx?id=17851[http://www.microsoft.com/en-US/download/details.aspx?id=17851] )
* MSMQ Service ( link:http://technet.microsoft.com/en-us/library/cc730960.aspx[http://technet.microsoft.com/en-us/library/cc730960.aspx] )
