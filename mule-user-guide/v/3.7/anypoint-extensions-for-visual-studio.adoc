...
*Note*: See the link:/release-notes/v/latest/dotnet-connector-release-notes[DotNet Connector Release Notes] for information on changes to this software package.
