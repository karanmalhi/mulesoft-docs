...
The AMQP connector is also available as a Studio plugin. View the https://www.mulesoft.com/library/#!/amqp-integration-connector[AMQP connector in Anypoint Exchange]. Connector installation information is available at link:/mule-user-guide/v/3.7/anypoint-connectors[Anypoint Connectors].
