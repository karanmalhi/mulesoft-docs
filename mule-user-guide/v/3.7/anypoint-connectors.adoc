...
== Using a Connector
You can design and "test drive" a connector in Anypoint Studio using the instructions in link:/mule-fundamentals/v/3.7/anypoint-exchange#doint-exchange[Installing a Connector from Anypoint Exchange].
