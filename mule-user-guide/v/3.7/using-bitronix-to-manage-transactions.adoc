...
* Read more about how to link:http://www.mulesoft.org/documentation/display/current/Shared+Resources#SharedResources-BitronixTransactionManager%C2%A0[define a Bitronix transaction manager as a shared resource] for multiple applications associated with a domain.
