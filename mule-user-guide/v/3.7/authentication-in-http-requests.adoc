...
The HTTP Request Connector supports four types of authentication:

* <<Basic Authentication>>
* NTLM authentication
* <<Digest Authentication>>
* *OAuth* authorization with 
* <<How the Authorization Code Grant Type Works - simplified>> grant type
* *OAuth* authorization with 
* <<How the Client Credentials Grant Type Works - simplified>> grant type
