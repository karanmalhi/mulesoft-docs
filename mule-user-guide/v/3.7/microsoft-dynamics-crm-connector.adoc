...
+
image:CRMKerberosConnection.png[image] 
...
+
image:HTTPconfigref.png[image]

. Set *localhost*, port *8081*, and the Path to *query*: +
 +
image:MSDyCRMHTTPconfig.png[image] +
...
image:CRMQueryBuilder.png[image] +
