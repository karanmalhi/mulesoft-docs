...
*Release Notes*: link:/docs/display/current/Microsoft+Dynamics+CRM+Connector+Release+Notes[Microsoft Dynamics CRM Connector Release Notes]

*Samples*: link:/docs/download/attachments/124487132/dynamics-crm-connector-samples.zip?version=2&modificationDate=1430140511709[dynamics-crm-connector-samples.zip]
...
Use the instructions in   https://developer.mulesoft.com/docs/display/current/Anypoint+Exchange#AnypointExchange-InstallingaConnectorfromAnypointExchange[Installing a Connector from Anypoint Exchange] .
...
+
image:/docs/download/attachments/124487132/CRMGlobalType.png?version=1&modificationDate=1434829327946[image] +
...
+
image:/docs/download/attachments/124487132/CRMKerberosConnection.png?version=1&modificationDate=1434830915282[image] 
...
image:/docs/download/attachments/124487132/CRMdemoflow1.png?version=1&modificationDate=1426305803957[image] +

To configure the flow:

. Double-click the *HTTP* connector and click the green plus sign image:/docs/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)] to the right of *Connector Configuration*: +
+
image:/docs/download/attachments/124487132/HTTPconfigref.png?version=1&modificationDate=1426305804001[image]

. Set *localhost*, port *8081*, and the Path to *query*: +
 +
image:/docs/download/attachments/124487132/MSDyCRMHTTPconfig.png?version=1&modificationDate=1426305804030[image] +

. Double-click *Microsoft Dynamics CRM*.
. Click the green plus symbol image:/docs/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)] to the right of *Connector Configuration*: +
+
image:/docs/download/attachments/124487132/CRMConfigRef.png?version=1&modificationDate=1426305803869[image] +
...
. Click *OK* - See link:#MicrosoftDynamicsCRMConnector-crmauth[CRM Authentication] for information on each authentication scheme. +
 +
image:/docs/download/attachments/124487132/CRMproperties.png?version=1&modificationDate=1426305803980[image] +
...
image:/docs/download/attachments/124487132/CRMQueryBuilder.png?version=1&modificationDate=1426305803986[image] +
...
If you do not have Anypoint Platform Gateway Service installed, you can download it from: https://repository-master.mulesoft.org/nexus/content/repositories/releases/org/mule/modules/anypoint-windows-gateway-service/1.3.0/anypoint-windows-gateway-service-1.3.0.zip.
...
Under NTLM authentication settings, set the *Gateway Router Service Address* to the address of the Anypoint Platform Gateway Service. This address is typically https://myserver.com:9000/router.
...
See link:#MicrosoftDynamicsCRMConnector-DataConsiderations[Data Considerations].
...
|Property |Usage
|*Query* a|
DataSense Query Language: The DSQL to run. The query is translated by the connector to a Fetch XML. For more information, see link:/docs/display/current/DataSense+Query+Language[DataSense Query Language].
...
A Party List is typically found on email activities to represent the To, Bcc, and Cc attributes. This type of attribute is accessible as a list of `Map<String, String>` objects where each list item represents an link:#MicrosoftDynamicsCRMConnector-EntityReference[Entity Reference]. +
...
Yes, an example project for Anypoint Studio is available in link:/docs/download/attachments/124487132/dynamics-crm-connector-samples.zip?version=2&modificationDate=1430140511709[dynamics-crm-connector-samples.zip].
...
* link:/docs/display/current/Mule+Expression+Language+MEL[Mule Expression Language]
* link:/docs/display/current/Endpoint+Configuration+Reference[Configuring Endpoints]
* link:/docs/display/current/Transformers[Transformers]
* link:/docs/display/current/Flow+Reference+Component+Reference[Flow Reference Component Reference]
