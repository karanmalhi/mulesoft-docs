...
* link:/mule-user-guide/v/3.7/mule-esb-plugin-for-maven[Mule ESB Plugin For Maven] – Describes the Mule plugin that allows you to control Mule ESB from within Maven
