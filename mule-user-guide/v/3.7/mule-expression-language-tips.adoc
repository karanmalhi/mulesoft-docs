...
This page provides quick tips for using link:/mule-user-guide/v/3.7/mule-expression-language-mel[Mule Expression Language] (MEL), including information contained in the link:/documentation/download/attachments/122752116/refcard-mel.pdf?version=1&modificationDate=1404857929206[MEL Reference Card].

== Assumptions

This document assumes you are familiar with link:http://www.mulesoft.org/documentation/display/current/Mule+Expression+Language+MEL[Mule Expression Language (MEL)].
