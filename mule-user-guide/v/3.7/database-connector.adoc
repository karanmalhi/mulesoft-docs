...
For more information on best design-time practices with DataSense, DataMapper, and DataWeave, see
link:/anypoint-connector-devkit/v/3.7/adding-datasense[Adding DataSense],
link:/mule-user-guide/v/3.4/datamapper-user-guide-and-reference[Anypoint DataMapper User Guide and Reference], and link:/mule-user-guide/v/3.7/dataweave[DataWeave].
