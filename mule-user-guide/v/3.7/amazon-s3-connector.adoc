...
You can install a connector in Anypoint Studio using the instructions in link:/mule-fundamentals/v/3.7/anypoint-exchange[Anypoint Exchange].

=== Updating From an Older Version

Everytime an updated version of a connector is released, Anypoint studio displays a popup in the bottom right corner of your system with the following message: *Updates Available*.
...
. On the Global Mule Configuration Elements window, click *Create*.
. In the *Choose Global Type* wizard, expand *Connector Configuration*, and then click *Amazon S3: Configuration*.
+
...
|===
+
Add a *HTTP Connector* to request the MuleSoft logo from the mulesoft.org site.
+
