...
[NOTE]
You need to have the proper permissions for the folder and files that the connector points to. If not, an exception will be raised and no more files will be processed after the first failed attempt.
