...
This page provides reference information about the elements and attributes you can configure for the link:/documentation/display/current/CXF+Module+Reference[CXF Module Reference] .
