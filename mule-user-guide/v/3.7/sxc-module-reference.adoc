...
The SXC module contains an outbound router and a filter that use the link:http://sxc.codehaus.org[SXC project] for streaming XPath routing.
...
SXC supports a limited subset of XPath expressions. For details, see the link:http://sxc.codehaus.org/XPath[SXC documentation]. To request support for a missing XPath feature, please file a link:http://jira.codehaus.org/browse/SXC[SXC JIRA].
