...
See the link:/mule-user-guide/v/3.7/http-transport-reference[HTTP Transport Reference] for details on setting the properties for a HTTP endpoint using an XML editor.
