...
|*message* |string or link:/mule-user-guide/v/3.7/mule-expression-language-mel[Mule expression] |The content that will be logged to console. In this case, the Mule Expression `#[payload]` will output the message payload.
