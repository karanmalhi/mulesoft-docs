...
* *NEXT STEP:* Graduate to the content of the First Week with Mule chapter, starting with link:/mule-fundamentals/v/3.7/mule-application-architecture[Mule Application Architecture].
