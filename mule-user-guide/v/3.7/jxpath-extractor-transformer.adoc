...
[NOTE]
Mule 3.6.0 includes support for version 3.0 of the XPath standard, which is compatible with XPath 2.0. As part of this upgrade, the JXPath extractor transformer has been deprecated in favor of the `xpath3` function. For details, see link:/mule-user-guide/v/3.7/xml-module-reference[XML Module Reference].
