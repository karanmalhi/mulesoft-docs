...
This page assumes you are familiar with Java annotations (marked with an @). For a brief overview of annotations, see the  http://docs.oracle.com/javase/tutorial/java/annotations/[Java annotations tutorial]. For annotations used in the Anypoint Connector DevKit, see the link:/anypoint-connector-devkit/v/3.7/annotation-reference[Annotations Reference].
