...
image:SAML-Bearer.png[SAML-Bearer]

Required parameters for the OAuth v2.0 configuration: 

image:OAuthv2.0.png[OAuthv2.0]
...
image:salesforce-config.png[salesforce-config]
