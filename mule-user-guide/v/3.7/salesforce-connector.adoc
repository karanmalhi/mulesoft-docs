...
This document assumes that you are familiar with Mule, the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio interface], link:/mule-fundamentals/v/3.7/global-elements[Global Elements], link:/mule-user-guide/v/3.7/datasense[DataSense], and link:/mule-user-guide/v/3.7/batch-processing[batch processing] in Mule. Further, it assumes you are familiar with Salesforce and have a Salesforce link:http://developer.force.com/[developerforce] account.

To use the Salesforce connector, you need:

* *Studio* - An instance of link:https://www.mulesoft.com/lp/dl/mule-esb-enterprise[Anypoint Studio]. If you don't use Anypoint Studio for development, follow the instructions to install  link:http://mulesoft.github.io/salesforce-connector/6.2.3/guide/install.html[Salesforce Maven dependencies] in your `pom.xml` file.
* *Salesforce developer account* - Sign up for one at link:http://developer.force.com/[Salesforce].
* *Security token* - Sign into link:http://developer.force.com/[Salesforce], click your name in the upper right corner, then click *Setup* > *My Personal Information* >  *Reset Security Token*. Then, click *Reset My Security Token*. Salesforce sends your security token via email to your registered email address.
...
+
image:SalesForceMain.png[image]
+
...
+
image:sfdc_outbound.png[image]
+
image:example_batch_output1.png[image]
+
...
+
image:example_batch_input1.png[image]
+
...
+
image:streaming_inbound.png[image]
...
* (c) Learn more about using the link:/mule-user-guide/v/3.7/poll-reference[Poll Scope] to regularly poll Salesforce for new data for your application to process.
...
+
image:SFDCMap.png[image]
+
The flows appear as:
+
image:SFDCflows.png[image]
+
