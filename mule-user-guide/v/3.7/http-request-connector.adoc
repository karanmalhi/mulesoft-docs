...
This connector can also implement HTTPS protocol and encrypt your communications via link:/mule-user-guide/v/3.7/tls-configuration[TLS], it can also implement authentication via basic authentication, OAuth or digest.
