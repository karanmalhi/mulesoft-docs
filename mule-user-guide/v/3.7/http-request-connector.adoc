...
In Studio, to instance this connector as an HTTP Request Connector (and not an HTTP Listener Connector), you must place it into the *Process* section of a flow (that is, anywhere except the beginning).
