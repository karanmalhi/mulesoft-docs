...
image:/docs/download/attachments/131466445/studio-sftp-gen.png?version=1&modificationDate=1434724708113[image]
...
|*Connector Configuration* |Use the dropdown list to select a previously configured connector configuration for this endpoint. If you have not created a connector configuration for this type of endpoint, you can do so from this window by clicking the green plus *image:/docs/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)]* . Click the edit icon image:/docs/download/attachments/131466445/EditIcon.png?version=1&modificationDate=1434724707924[image] to modify a previously created global element.
|*Output Pattern* |
...
After you click the Connector Configuration's green plus image:/docs/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)] or the edit symbol image:/docs/download/attachments/131466445/EditIcon.png?version=1&modificationDate=1434724707924[image], the Global Elements Properties screens appear with tabs for General, Advanced, Properties, Reconnection, File, and Notes. You can specify optional server property information or notes as needed. The rest of the screens are described in this section.

=== Global Element Properties - General Tab

image:/docs/download/attachments/131466445/sftp_gen_gen.png?version=1&modificationDate=1434724708016[image]
...
image:/docs/download/attachments/131466445/sftp_gen_adv.png?version=1&modificationDate=1434724708004[image]
...
image:/docs/download/attachments/131466445/sftp_gen_reconn.png?version=1&modificationDate=1434724708022[image]
...
image:/docs/download/attachments/131466445/sftp_gen_file.png?version=1&modificationDate=1434724708010[image]
...
image:/docs/download/attachments/131466445/studio-sftp-adv.png?version=1&modificationDate=1434724708090[image]
...
image:/docs/download/attachments/131466445/studio-sftp-trans.png?version=1&modificationDate=1434724708120[image]
...
image:/docs/download/attachments/131466445/studio-sftp-file-out.png?version=1&modificationDate=1434724708105[image]

[width="100a",cols="50a,50a",options="header"]
|===
|Field |Description
|*Duplicate Handling* |(_Applies to outbound SFTP endpoint only_).  Defines the behavior in case of duplicates.
...
See the link:/docs/display/current/SFTP+Transport+Reference[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
