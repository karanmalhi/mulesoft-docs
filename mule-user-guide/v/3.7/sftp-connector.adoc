...
You can install a connector in Anypoint Studio using the instructions in link:http://www.mulesoft.org/documentation/display/current/Anypoint+Exchange#AnypointExchange-InstallingaConnectorfromAnypointExchange[Installing a Connector from Anypoint Exchange].
...
image:sftp_gen_reconn.png[image]
...
image:studio-sftp-adv.png[image]
...
image:studio-sftp-trans.png[image]
...
image:studio-sftp-file-out.png[image]
