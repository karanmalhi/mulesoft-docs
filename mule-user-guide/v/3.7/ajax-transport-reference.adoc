...
|Maven Artifact |link:org.mule.http://transportmule-transport-ajax/[transport:mule-transport-ajax] |The group name and artifact name for this transport in http://maven.apache.org/[Maven]
|===
...
[width="100%",cols="30%,20%,10%,40%",options="header"]
|===
