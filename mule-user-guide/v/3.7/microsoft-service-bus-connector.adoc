...
. Click the Connection Configuration green arrow image:/docs/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)]: +
 +
...
|*Enable DataSense* |If you intend to employ the Microsoft Service Bus connector in conjunction with a link:http://www.mulesoft.org/documentation/display/current/Datamapper+User+Guide+and+Reference[DataMapper transformer] to map and transform data, you can make use of Anypoint Studio's link:http://www.mulesoft.org/documentation/display/current/DataSense[DataSense] functionality. You can enable DataSense as part of configuring the global element.
|===
+
. Windows Service bus:
+
...
For code samples that illustrate more advanced scenarios, refer to link:/docs/download/attachments/123338810/service-bus-connector-samples.zip?version=1&modificationDate=1422537297705[service-bus-connector-samples.zip]
...
* For code samples that illustrate more advanced scenarios, refer to link:/docs/download/attachments/123338810/service-bus-connector-samples.zip?version=1&modificationDate=1422537297705[service-bus-connector-samples.zip].
* Learn how to link:/mule-user-guide/v/3.5/installing-connectors[Install and Configure Anypoint™ Connectors] in Anypoint Studio.
* Access MuleSoft’s link:http://forum.mulesoft.org/mulesoft[MuleForge forum] to pose questions and get help from Mule’s broad community of users.
