...
*Release Notes:* link:/docs/display/current/Microsoft+Service+Bus+Connector+Release+Notes[Microsoft Service Bus Connector Release Notes]
...
* Learn more about the Microsoft Service Bus connector in the link:/docs/display/current/Microsoft+Service+Bus+Connector+FAQ[Microsoft Service Bus Connector FAQ].
* For code samples that illustrate more advanced scenarios, refer to link:/docs/download/attachments/123338810/service-bus-connector-samples.zip?version=1&modificationDate=1422537297705[service-bus-connector-samples.zip].
* Learn how to link:/docs/display/35X/Installing+Connectors[Install and Configure Anypoint™ Connectors] in Anypoint Studio.
