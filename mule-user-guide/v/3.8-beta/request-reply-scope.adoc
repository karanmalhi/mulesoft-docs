...
This document assumes that you understand the difference between link:/mule-fundamentals/v/3.7/flows-and-subflows[synchronous and asynchronous flows]. Furthermore, you're also familiar with link:/mule-user-guide/v/3.8-beta/scopes[Scopes] in general.
