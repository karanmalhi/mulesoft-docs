...
In addition, some inbound endpoints can be configured to operate link:/mule-user-guide/v/3.8-beta/transaction-management[transactionally], regardless of their exchange pattern. If a flow is transactional, Mule applies a synchronous processing strategy.
...
* *Wrap a Flow:* You can wrap one or more message processors within your synchronous flow in an link:/mule-user-guide/v/3.8-beta/async-scope-reference[asynchronous scope] to define a processing block that Mule processes asynchronously with the main flow. You can also create an asynchronous flow by wrapping a flow-ref in an asynchronous scope. 
...
[NOTE]
Note that in addition to fine-tuning the attributes of the queued-asynchronous processing strategy, you can also link:/mule-user-guide/v/3.8-beta/tuning-performance[tune performance] of your Mule application by analyzing and configuring thread profiles.
...
. Wrap one or more processors in an link:/mule-user-guide/v/3.8-beta/async-scope-reference[async scope]
...
For more information about configuring the asynchronous scope element, refer to the link:/mule-user-guide/v/3.8-beta/async-scope-reference[Async Scope reference].
...
* The only Message Source that supports non-blocking is the link:/mule-user-guide/v/3.8-beta/http-listener-connector[HTTP Connector Listener].
* The only Message Processor that supports non-blocking is the link:/mule-user-guide/v/3.8-beta/http-request-connector[HTTP Connector Request].
...
* Refer to the link:/mule-user-guide/v/3.8-beta/async-scope-reference[Async Scope Reference] for information on how to embed an asynchronous processing block in an otherwise synchronous flow.
...
* Find out how to link:/mule-user-guide/v/3.8-beta/tuning-performance[tune performance] by analyzing and configuring threading profiles. 
