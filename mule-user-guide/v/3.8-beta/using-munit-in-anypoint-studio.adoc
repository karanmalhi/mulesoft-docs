...
You can debug MUnit tests just like Studio applications, using Studio's debugging perspective (for details on the debugging UI, see link:/mule-user-guide/v/3.8-beta/studio-visual-debugger[Studio Visual Debugger]).
