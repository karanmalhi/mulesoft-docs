...
[NOTE]
If you need to deploy to different environments (for example, production, development) where these parameters need to have different values, see link:/mule-user-guide/v/3.8-beta/deploying-to-multiple-environments[Deploying to Multiple Environments].
...
* Learn how to access an OAuth API using the link:/mule-user-guide/v/3.8-beta/http-request-connector[HTTP Request Connector]
