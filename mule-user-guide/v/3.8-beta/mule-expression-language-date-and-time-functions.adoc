...
This document assumes you are familiar with link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language (MEL)].  Further, this document assumes you are using Mule 3.4.0 or newer. 
...
|*link:/mule-user-guide/v/3.8-beta/mule-expression-language-date-and-time-functions[compare]* a|
...
* Learn more about the link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language (MEL)].
