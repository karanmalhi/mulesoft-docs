...
Refer to link:/mule-user-guide/v/3.8-beta/transaction-management[Transaction Management] for details on how to configure a Multiple Resource transaction.
