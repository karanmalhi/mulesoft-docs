...
The images below illustrate DataMapper's link:/mule-user-guide/v/3.8-beta/datamapper-visual-reference[Script view] displaying the same mapping, in CTL2 (below, at top) and MEL (below, at bottom.
