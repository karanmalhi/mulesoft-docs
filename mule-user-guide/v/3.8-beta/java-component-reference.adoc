...
[TIP]
If all you really want to do with your java class is to modify the Payload of the message in some way, you're probably better off using a link:/mule-user-guide/v/3.8-beta/java-transformer-reference[Java Transformer] rather than a Java Component.
