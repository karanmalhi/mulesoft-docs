...
This document assumes that your are familiar with link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio] and link:http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about link:/mule-user-guide/v/3.8-beta/poll-reference[poll scopes] in Mule.
...
* Learn more about link:/mule-user-guide/v/3.8-beta/poll-reference[Poll Scopes] in Mule.
* Reference link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language MEL].
* Learn more about link:/mule-user-guide/v/3.8-beta/mule-expression-language-date-and-time-functions[MEL Date and Time Functions].
