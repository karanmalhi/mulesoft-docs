...
* Read about link:/mule-user-guide/v/3.8-beta/importing-a-maven-project-into-studio[Importing a Maven Project into Studio].
* Find out more about link:/mule-user-guide/v/3.8-beta/enabling-maven-support-for-a-studio-project[Enabling Maven Support for a Studio Project].
