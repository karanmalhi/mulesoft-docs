...
* Access link:/mule-user-guide/v/3.8-beta/mule-high-availability-ha-clusters[Mule High Availability (HA) Clustering] for an overview.

* Learn how to link:/mule-user-guide/v/3.8-beta/creating-and-managing-a-cluster-manually[manually create and manage a cluster,] accessing additional options.

* Learn how to enable link:/mule-user-guide/v/3.8-beta/distributed-file-polling[distributed file polling].
