...
For more information on hot deploying Mule applications, see link:/mule-user-guide/v/3.8-beta/application-server-based-hot-deployment[Application Server Based Hot Deployment].
...
. Package your Mule application's configuration files and custom Java classes in a `.war` file (see link:/mule-user-guide/v/3.8-beta/application-server-based-hot-deployment[Application Server Based Hot Deployment]).
