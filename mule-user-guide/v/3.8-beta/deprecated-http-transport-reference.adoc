...
You can use the link:/mule-user-guide/v/3.8-beta/https-transport-reference[HTTPS Transport Reference] to create secure connections over HTTP. If you want to secure requests to your HTTP endpoint, the HTTP connector supports HTTP Basic/Digest authentication methods (as well as the Mule generic header authentication). To configure HTTP Basic, you configure a link:/mule-user-guide/v/3.8-beta/configuring-security[Security Endpoint Filter] on an HTTP endpoint.
...
This connector also accepts all the attributes from the link:/mule-user-guide/v/3.8-beta/tcp-transport-reference[TCP connector].
...
The HTTP inbound endpoint attributes override those specified for the link:/mule-user-guide/v/3.8-beta/endpoint-configuration-reference[default inbound endpoint attributes].
...
The HTTP outbound endpoint attributes override those specified for the link:/mule-user-guide/v/3.8-beta/endpoint-configuration-reference[default outbound endpoint attributes].
...
The HTTP endpoint attributes override those specified for the link:/mule-user-guide/v/3.8-beta/endpoint-configuration-reference[default global endpoint attributes].
...
* See how to link:/mule-user-guide/v/3.8-beta/migrating-to-the-new-http-connector[Migrate to the New HTTP Connector]
* Get an overview about the new link:/mule-user-guide/v/3.8-beta/http-connector[HTTP Connector]
* See a reference about the new link:/mule-user-guide/v/3.8-beta/http-connector-reference[HTTP Connector Reference]
