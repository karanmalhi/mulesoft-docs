...
*Demo Starts Here*: link:/mule-user-guide/v/3.8-beta/1-installing-the-demo-bundle[1 - Installing the Demo Bundle]
...
*Learn more*:  link:/mule-user-guide/v/3.8-beta/mule-high-availability-ha-clusters[Mule High Availability (HA) Cluster Overview]
