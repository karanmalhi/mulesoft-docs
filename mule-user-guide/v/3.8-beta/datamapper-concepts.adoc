...
For an overview of the graphical mapping editor, see link:/mule-user-guide/v/3.8-beta/datamapper-visual-reference[DataMapper Visual Reference].
...
|link:/mule-user-guide/v/3.8-beta/mapping-elements-inside-lists[Mapping Elements] |Describes how to map nested listed to flat and structured  data.
|===
...
[TIP]
====
For a detailed explanation about what each part of the GUI is for, see link:/mule-user-guide/v/3.8-beta/datamapper-visual-reference[DataMapper Visual Reference]
====
...
Once two elements are mapped, by default the input will be simply replicated into the output, but if you want you can define transformations that populate the output elements. If you want to define a transformation, you must write a link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[MEL expression] that computes the output value based on the values of input elements.
...
For an illustration of this technique, see link:/mule-user-guide/v/3.8-beta/mapping-elements-inside-lists[Mapping Elements Inside Lists]. 
...
[NOTE]
====
The specifics of using the DataMapper UI to create a mapping flow like this one are covered in link:/mule-user-guide/v/3.8-beta/datamapper-visual-reference[DataMapper Visual Reference].
====
...
For more information on Rules, see "Using Rules to Extract Fields from Complex Structured Data" in link:/mule-user-guide/v/3.8-beta/building-a-mapping-flow-in-the-graphical-mapping-editor[Building a Mapping Flow in the Graphical Mapping Editor] . 
...
For more details on Filters, see  "Setting an Element Mapping XPath Filter" in link:/mule-user-guide/v/3.8-beta/building-a-mapping-flow-in-the-graphical-mapping-editor[Building a Mapping Flow in the Graphical Mapping Editor]. 
...
For more on input and output arguments, see the discussion of "Using Data Mapping Input and Output Arguments" in link:/mule-user-guide/v/3.8-beta/building-a-mapping-flow-in-the-graphical-mapping-editor[Building a Mapping Flow]. For more on lookup tables, see "Using Lookup Tables" in link:/mule-user-guide/v/3.8-beta/building-a-mapping-flow-in-the-graphical-mapping-editor[Building a Mapping Flow].
...
* For a more detailed explanation about what each part of the GUI does, see link:/mule-user-guide/v/3.8-beta/datamapper-visual-reference[DataMapper Visual Reference]

* For complete information on MEL, see link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language]
