...
*Note*: You need an Enterprise license to run applications containing link:/mule-user-guide/v/3.8-beta/anypoint-enterprise-security[Anypoint Enterprise Security] features.
...
Read more about installing link:/mule-user-guide/v/3.8-beta/studio-in-eclipse[Anypoint Studio as an Eclipse Plugin].

`http://download.eclipse.org/eclipse/updates/4.4`
|*MUnit*
|link:/mule-user-guide/v/3.8-beta/munit[MUnit] framework for testing Mule Applications
