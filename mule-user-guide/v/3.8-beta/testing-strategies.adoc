...
Mule provides abstract parent classes to help with unit testing. Turn link:/mule-user-guide/v/3.8-beta/unit-testing[here] for more information about them.
...
To learn more about test messages, and for more testing strategies and approaches, please consult link:http://www.lasalle.edu/~mccoey/cis679/TestDrivenEAI.pdf[Test-Driven Development in Enterprise Integration Projects].
