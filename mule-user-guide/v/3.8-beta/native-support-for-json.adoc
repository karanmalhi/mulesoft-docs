...
JSON is now natively supported in Mule, meaning you can work with JSON documents and bind them automatically to Java objects. Further information is available in the link:/mule-user-guide/v/3.8-beta/json-module-reference[JSON Module] configuration reference.
