...
[TIP]
====
Cipher Suite names can be very lengthy, which can have an impact in the readability of your XML code. To keep things neater, you can instead keep your Cipher Suite names in an link:/mule-user-guide/v/3.8-beta/configuring-properties[external properties file] in your Mule project and refer to it.
