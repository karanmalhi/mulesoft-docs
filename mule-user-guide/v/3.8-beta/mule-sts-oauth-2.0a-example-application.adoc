...
Refer to link:/mule-user-guide/v/3.8-beta/authorization-grant-types[Authorization Grant Types] for more information on the other types of authorization grants.
...
* For more information on OAuth 2.0a in Mule, refer to link:/mule-user-guide/v/3.8-beta/mule-secure-token-service[Mule Secure Token Service].
