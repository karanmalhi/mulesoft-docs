...
* Learn how to build a complete link:/mule-user-guide/v/3.8-beta/building-a-mule-application-with-maven-in-studio[Studio Maven Project], including tests and dependencies.
* Learn how to link:/mule-user-guide/v/3.8-beta/enabling-maven-support-for-a-studio-project["mavenize" an existing Mule project].
