...
All of the functions and attributes below are usable within link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[MEL] expressions anywhere in Mule where the context makes sense.
...
* Read more about using link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language (MEL)]in your application
