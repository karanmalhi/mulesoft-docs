...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a link:/mule-user-guide/v/3.8-beta/java-component-reference[Java Component] that works very similarly.
...
* For more information see the Mule ESB page link:/mule-user-guide/v/3.8-beta/scripting-module-reference[Scripting Module]
* Read more about the link:/mule-user-guide/v/3.8-beta/javascript-component-reference[JavaScript Component]
* Read more about the link:/mule-user-guide/v/3.8-beta/ruby-component-reference[Ruby Component]
* Read more about the link:/mule-user-guide/v/3.8-beta/groovy-component-reference[Groovy Component]
* Read more about the link:/mule-user-guide/v/3.8-beta/python-component-reference[Python Component]
* Read more about the link:/mule-user-guide/v/3.8-beta/java-component-reference[Java Component]
