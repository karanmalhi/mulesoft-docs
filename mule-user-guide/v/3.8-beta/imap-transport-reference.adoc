...
The IMAP connector supports all the link:/mule-user-guide/v/3.8-beta/configuring-a-transport[common connector attributes and properties] and the following additional attributes:
...
IMAP and IMAPS endpoints include details about connecting to an IMAP mailbox. You link:/mule-user-guide/v/3.8-beta/endpoint-configuration-reference[configure the endpoints] just as you would with any other transport, with the following additional attributes:
