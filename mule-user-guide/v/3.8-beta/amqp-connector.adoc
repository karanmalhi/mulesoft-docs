...
The AMQP connector is available as a Studio plugin. View the link:https://www.mulesoft.com/exchange#!/amqp-integration-connector[AMQP connector in Anypoint Exchange]. Connector installation information is available at link:/mule-user-guide/v/3.8-beta/anypoint-connectors[Anypoint Connectors].
...
* Read the link:/mule-user-guide/v/3.8-beta/amqp-connector-examples[AMQP Connector Examples] for practical illustrations of common use cases.

* Access the link:/mule-user-guide/v/3.8-beta/amqp-connector-reference[AMQP Connector Reference] for a complete list and description of all AMQP connector configuration attributes.
