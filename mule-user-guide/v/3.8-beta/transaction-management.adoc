...
|link:/mule-user-guide/v/3.8-beta/single-resource-transactions[Single Resource Transactions] a|
...
|link:/mule-user-guide/v/3.8-beta/multiple-resource-transactions[Multiple Resource Transactions] a|
...
|link:/mule-user-guide/v/3.8-beta/xa-transactions[XA Transactions] a|
* Receives or sends messages to more than one resource.
...
Use link:/mule-user-guide/v/3.8-beta/transactions-configuration-reference[Transactions Configuration Reference] for quick access to attribute configurations.
....
...
_Apply a transaction to a flow that involves a single resource. See link:/mule-user-guide/v/3.8-beta/single-resource-transactions[Single Resource Transaction] for details.
|XA Transaction |Apply a transaction to a flow that involves multiple resources: JMS, VM or JDBC. See link:/mule-user-guide/v/3.8-beta/xa-transactions[XA Transaction] for details.
|Multi Transaction |Apply a transaction to a flow that involves multiple resources: JMS or VM. See link:/mule-user-guide/v/3.8-beta/multiple-resource-transactions[Multiple Resource Transaction] for details.
...
* If you apply an XA transaction to a JMS inbound connector in your flow, you have the option of specifying the polling frequency of the queue. Access link:/mule-user-guide/v/3.8-beta/xa-transactions[XA Transactions] for configuration details.
...
Refer to the link:/mule-user-guide/v/3.8-beta/error-handling[Error Handling] documentation to learn more about Mule's default exception strategy and how to apply exception strategies to flows. Follow the steps below to apply an exception strategy to an individual transaction. 
...
+
. Configure the exception strategy as needed, keeping in mind Mule uses this exception strategy to handle any exceptions thrown while processing the transaction. Reference the link:/mule-user-guide/v/3.8-beta/error-handling[Error Handling] documentation for exception strategy configuration details.
...
* Read more about link:/mule-user-guide/v/3.8-beta/single-resource-transactions[Single Resource Transactions], link:/mule-user-guide/v/3.8-beta/multiple-resource-transactions[Multiple Resource Transactions], and link:/mule-user-guide/v/3.8-beta/xa-transactions[XA Transactions]. 
* Read more about link:/mule-user-guide/v/3.8-beta/error-handling[Exception Strategies].
...
* Use the link:/mule-user-guide/v/3.8-beta/transactions-configuration-reference[Transactions Configuration Reference] for quick reference to transactional attributes.
