...
The SAP Connector provides a wide range of functionalities, beyond the basic ones already described in the link:/mule-user-guide/v/3.8-beta/sap-connector[SAP Documentation]. The present document will help you harness the full potential of your SAP Mule application.
...
IMPORTANT: The key names for these properties must *match* those expected by the JCo libraries. You can check them at link:/mule-user-guide/v/3.8-beta/sap-connector-advanced-features#jco-client-properties[SAP Client Properties] and link:/mule-user-guide/v/3.8-beta/sap-connector-advanced-features#jco-server-properties[SAP Server Properties].
...
[[see-also]]
== See Also
* link:/mule-user-guide/v/3.8-beta/sap-connector[SAP Connector documentation].
* link:/mule-user-guide/v/3.8-beta/sap-connector-troubleshooting[SAP Connector Troubleshooting] to handle common problems.
