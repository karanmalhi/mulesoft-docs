...
For more advanced examples written directly in DataWeave code, see link:/mule-user-guide/v/3.8-beta/dataweave-examples[DataWeave Examples].
...
. Drag a link:/mule-user-guide/v/3.8-beta/web-service-consumer[Web Service Consumer] to your flow. Create a global configuration for it by clicking the green plus sign in its properties editor. In the *WSDL Location* field, paste the following URL: **http://tshirt-service.cloudhub.io/?wsdl**.  Note that all of the other fields in the configuration element are completed automatically when you do this. Then click *Ok*.
...
* See our link:/mule-user-guide/v/3.8-beta/dataweave-reference-documentation[DataWeave Reference Documentation]
* See more advanced examples in link:/mule-user-guide/v/3.8-beta/dataweave-examples[DataWeave Examples]
* Migrate your old DataMapper components automatically using link:/mule-user-guide/v/3.8-beta/dataweave-migrator[DataWeave Migrator Tool]
