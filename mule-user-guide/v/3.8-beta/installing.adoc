...
. link:/mule-user-guide/v/3.8-beta/hardware-and-software-requirements[Check hardware and software requirements.]
. link:/mule-user-guide/v/3.8-beta/compatibility[Check system compatibility with platform software.]
. link:/mule-user-guide/v/3.8-beta/downloading-and-starting-mule-esb[Download, then launch Mule.]
. link:/mule-user-guide/v/3.8-beta/adding-community-runtime[Add Community runtime to AnypointStudio] (_optional_).
. link:/mule-user-guide/v/3.8-beta/installing-an-enterprise-license[Install an Enterprise license] (_optional_).
. link:/mule-user-guide/v/3.8-beta/installing-extensions[Extend Mule with plugins, modules, runtimes and connectors] (_optional_).
