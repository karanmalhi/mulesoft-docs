...
This document assumes that you are familiar with the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Visual Editor in Anypoint Studio], the link:/mule-user-guide/v/3.8-beta/anypoint-connectors[Anypoint Connectors], and the link:/mule-user-guide/v/3.8-beta/dataweave[DataWeave] transformer that you can use to create applications in Studio. Further, this document references link:/mule-user-guide/v/3.8-beta/connecting-using-transports[Connectors] and link:/mule-fundamentals/v/3.7/global-elements[Global Elements.]
...
* Learn how to exploit link:/mule-user-guide/v/3.8-beta/using-perceptive-flow-design[DataSense Perceptive Flow Design].
* Learn how to use the link:/mule-user-guide/v/3.8-beta/using-the-datasense-explorer[DataSense Explorer] to preview to contents of the message
