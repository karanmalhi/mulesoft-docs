...
*Connector Guide*: link:https://docs.mulesoft.com/mule-user-guide/v/3.8-beta/mongodb-connector[MongoDB Connector]
...
For more information see the link:/mule-user-guide/v/3.8-beta/mongodb-connector-migration-guide[MongoDB Connector 4.0.2 Migration Guide]
