...
a|Mule validates against the following application serverss. 
* 7 Tomcat 7
* Tomcat 8
* Weblogic 12c
* Enterprise 6.1
...
Get more information about installing link:/mule-user-guide/v/3.8-beta/studio-in-eclipse[Studio as an Eclipse plug-in].

== See Also

* Find out what platform software is link:/mule-user-guide/v/3.8-beta/compatibility[compatible] with the current version of Mule ESB.
