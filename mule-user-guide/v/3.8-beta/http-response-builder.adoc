...
When the link:/mule-user-guide/v/3.8-beta/http-listener-connector[HTTP Connector works as a listener], you can configure a status code and a status reason on the connector itself, separately for both success and failure scenarios. To generate a response from an HTTP template, use the *link:/mule-user-guide/v/3.8-beta/parse-template-reference[Parse Template]* element.

See link:/mule-user-guide/v/3.8-beta/http-connector[HTTP Connector] for information about the 3.6 and later operation-based HTTP connector. For information on the deprecated HTTP connector, see link:/mule-user-guide/v/3.8-beta/http-connector-deprecated[HTTP Connector - Deprecated].
====
...
* Read about the link:/mule-user-guide/v/3.8-beta/http-connector[HTTP Connector]
