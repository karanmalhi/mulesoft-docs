...
For instructions on how to edit these settings, see link:/mule-user-guide/v/3.8-beta/logging-in-mule[Logging in Mule].

== See Also

* Read more about link:/mule-user-guide/v/3.8-beta/logging-in-mule[Logging in Mule].
* Check the link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language] reference for more ideas on how to format helpful logger messages.
