...
|The link:/mule-user-guide/v/3.8-beta/flow-reference-component-reference[flow reference] in the previous step sent the message to a new flow.
...
* Need more information about the payload or metadata? Try running your application in link:/mule-user-guide/v/3.8-beta/studio-visual-debugger[Debug mode] to inspect your message contents step by step at runtime.
* Get familiar with link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language] so that you can access and manipulate the contents of your message and its environment.
