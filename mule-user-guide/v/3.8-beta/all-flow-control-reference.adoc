...
Access the documentation for the link:/mule-user-guide/v/3.8-beta/scatter-gather[Scatter-Gather flow control] to take advantage of the newly-designed functionality.
====
