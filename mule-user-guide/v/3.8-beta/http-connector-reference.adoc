...
This page serves as a reference for all of the supported attributes and child elements of the link:/mule-user-guide/v/3.8-beta/http-connector[HTTP Connector].
