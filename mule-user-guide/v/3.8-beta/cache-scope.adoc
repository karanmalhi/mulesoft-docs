...
By default, Mule stores all cached responses in an InMemoryObjectStore. <<Creating a Caching Strategy>> and define a new link:/mule-user-guide/v/3.8-beta/mule-object-stores[object store] if you want to customize the way Mule stores cached responses.
...
* Read more about link:/mule-user-guide/v/3.8-beta/scopes[Scopes] in Mule.
