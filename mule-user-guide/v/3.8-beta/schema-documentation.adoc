...
If you are familiar with versions of Mule older than v 3.0, you may want to consult this list of link:/mule-user-guide/v/3.8-beta/notes-on-mule-3.0-schema-changes[schema changes].
