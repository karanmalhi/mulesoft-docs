...
For more information see link:/mule-user-guide/v/3.8-beta/configuring-security[Configuring Security].
...
If you are using CXF, you can configure a client and service to use WS-Security. For details, see link:/mule-user-guide/v/3.8-beta/enabling-ws-security[Enabling WS-Security].
