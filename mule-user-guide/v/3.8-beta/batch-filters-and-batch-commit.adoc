...
* link:/mule-user-guide/v/3.8-beta/batch-processing[Batch Processing] for a full description of the steps the batch job takes in each phase of processing.
...
* Read about the link:/mule-user-guide/v/3.8-beta/batch-processing[basic anatomy] of batch processing in Mule.
