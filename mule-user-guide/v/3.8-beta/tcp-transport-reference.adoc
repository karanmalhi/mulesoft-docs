...
* The link:/mule-user-guide/v/3.8-beta/ssl-and-tls-transports-reference[SSL and TLS Transports], which use TCP with socket-level security. 
...
* Are you communicating with a flow always located in the same Mule application instance? If so, consider use the link:/mule-user-guide/v/3.8-beta/vm-transport-reference[VM transport].
...
* Should messages be secured? If so, use the link:/mule-user-guide/v/3.8-beta/ssl-and-tls-transports-reference[SSL transport].
