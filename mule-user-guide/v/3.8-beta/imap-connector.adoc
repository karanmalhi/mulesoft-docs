...
See the link:/mule-user-guide/v/3.8-beta/imap-transport-reference[IMAP Transport Reference] for details on setting the properties for an IMAP endpoint using an XML editor.
