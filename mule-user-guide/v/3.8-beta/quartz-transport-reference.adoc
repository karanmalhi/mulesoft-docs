...
* See the link:/mule-user-guide/v/3.8-beta/quartz-connector[Quartz Connector] for details on setting the properties for a Quartz endpoint in Studio's visual editor.
