...
* Learn more about link:/mule-user-guide/v/3.8-beta/shared-resources[Shared Resources]
* If you're deploying a single application, you can still set up link:/mule-user-guide/v/3.8-beta/configuring-properties[Application Properties]
