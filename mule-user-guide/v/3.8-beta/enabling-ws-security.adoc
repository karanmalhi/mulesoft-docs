...
To the Mule flow that involves a Web service, add a link:/mule-user-guide/v/3.8-beta/cxf-component-reference[*CXF Component*] to publish, consume, or proxy a Web service. Complete the following steps to configure WS-security on the SOAP component.
...
* Learn more about configuring a link:/mule-user-guide/v/3.8-beta/cxf-component-reference[CXF component] in your Mule application.
