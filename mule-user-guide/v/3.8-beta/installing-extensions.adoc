...
.. Enter a link:/mule-user-guide/v/3.8-beta/studio-update-sites[specific update site URL] from which you wish to download a plugin, module, or connector
...
* link:/mule-user-guide/v/3.8-beta/adding-community-runtime[Mule Community Runtime]  
* link:/mule-user-guide/v/3.8-beta/installing-anypoint-enterprise-security[Anypoint Enterprise Security]
* link:/mule-user-guide/v/3.8-beta/installing-connectors[Anypoint Connectors]
...
and link:/mule-user-guide/v/3.8-beta/mule-plugin-format[Mule Plugin Format].
