...
To build applications with Batch jobs and run them in a test or production environment, you must build the application with an Enterprise runtime. Learn more about link:/mule-user-guide/v/3.8-beta/changing-runtimes-in-studio[Changing Runtimes in Studio].
====
...
* link:/mule-user-guide/v/3.8-beta/datamapper-user-guide-and-reference[Anypoint DataMapper User Guide and Reference]
...
* link:/mule-user-guide/v/3.8-beta/poll-reference[Polls]. 
...
Access link:/mule-user-guide/v/3.8-beta/batch-processing-reference[Batch Processing Reference] for more information.
====
...
* You can set *record variables* on records and pass them from step to step (link:/mule-user-guide/v/3.8-beta/record-variable[read more])

* You can apply filters by adding *accept expressions* within each batch step to prevent the step from processing certain records; for example, you can set a filter to prevent a step from processing any records which failed processing in the preceding step (link:/mule-user-guide/v/3.8-beta/batch-filters-and-batch-commit[read more])

* You can *commit* records in groups, sending them as bulk upserts to external sources or services. (link:/mule-user-guide/v/3.8-beta/batch-filters-and-batch-commit[read more])
...
Read more about link:/mule-user-guide/v/3.8-beta/batch-filters-and-batch-commit[fine-tuning filters] on batch steps to manage failed records at a more granular level.
...
[TIP]
Note that this example introduces features not discussed in great detail in this document. Consult link:/mule-user-guide/v/3.8-beta/batch-filters-and-batch-commit[Batch Filters and Batch Commit] and link:/mule-user-guide/v/3.8-beta/record-variable[Record Variable] for more information.
...
. The application first uses a link:/mule-user-guide/v/3.8-beta/file-connector[File connector] to upload a CSV file, then uses a link:/mule-user-guide/v/3.8-beta/datamapper-concepts[DataMapper] to convert the data format into a collection (see mapping below). Each item in the collection represents a lead. Each lead contains a company name, a first name, a last name, a birthday and an email address.
+
...
[start=3]
. Mule begins processing each lead as a record. The first batch step, `lead-check`, uses a *Salesforce Connector* wrapped with a link:/mule-user-guide/v/3.8-beta/message-enricher[Message Enricher] to:
...
* Batch processing does not support the use of link:/mule-user-guide/v/3.8-beta/business-events[Business Events].
...
* Learn more about setting and removing link:/mule-user-guide/v/3.8-beta/record-variable[record-level variables].
* Learn more about link:/mule-user-guide/v/3.8-beta/batch-processing-reference[MEL expressions] you can use to access batch processing data.
* Read more about link:/cloudhub/cloudhub-fabric[CloudHub support for batch processing].
* Learn more about link:/mule-user-guide/v/3.8-beta/anypoint-connectors[Anypoint Connectors].
* Learn more about link:/mule-user-guide/v/3.8-beta/poll-reference[Polling and Watermarks].
* Learn more about link:/mule-user-guide/v/3.8-beta/datamapper-user-guide-and-reference[DataMapper].
