...
While many times you can proxy web services without using CXF (see link:/mule-user-guide/v/3.8-beta/proxying-web-services[Proxying Web Services]), there are several cases where you might want to use CXF proxies:
...
[TIP]
To send outbound requests to external web services, it's highly recommended that you use the link:/mule-user-guide/v/3.8-beta/web-service-consumer[Web Service Consumer] instead.
