...
Install the link:/mule-user-guide/v/3.8-beta/installing-anypoint-enterprise-security[Anypoint Enterprise Security update] on your instance of Anypoint Studio Enterprise Edition 3.3.2 or later.
...
* link:/mule-user-guide/v/3.8-beta/configuring-the-spring-security-manager[Mule Security Manager], client authentication and authorization on inbound requests as well as credential mapping for outbound calls
* link:/mule-user-guide/v/3.8-beta/setting-up-ldap-provider-for-spring-security[LDAP] and third party identity management system integration
* link:/mule-user-guide/v/3.8-beta/enabling-ws-security[Validation of inbound requests] through the SAML 2.0 federated identity standard
* link:/mule-user-guide/v/3.8-beta/sftp-transport-reference[Secure FTP (SFTP) Transport] that enables Mule flows to read and write to remote directories over the SSH protocol.
...
link:/mule-user-guide/v/3.8-beta/mule-secure-token-service[Apply OAuth 2.0a to my Mule Web service provider] +
link:/mule-user-guide/v/3.8-beta/mule-secure-token-service[Apply OAuth 2.0a to my Mule Web service consumer]
...
link:/mule-user-guide/v/3.8-beta/mule-credentials-vault[Encrypt a properties file]
...
link:/mule-user-guide/v/3.8-beta/mule-message-encryption-processor[Encrypt a message payload] +
link:/mule-user-guide/v/3.8-beta/mule-message-encryption-processor[Decrypt a message payload]
...
link:/mule-user-guide/v/3.8-beta/mule-digital-signature-processor[Add a digital signature to a message in Mule] +
link:/mule-user-guide/v/3.8-beta/mule-digital-signature-processor[Sign part of a message payload] +
link:/mule-user-guide/v/3.8-beta/mule-digital-signature-processor[Verify a digital signature in Mule]
...
link:/mule-user-guide/v/3.8-beta/anypoint-filter-processor[Filter unsecure messages]
...
link:/mule-user-guide/v/3.8-beta/mule-crc32-processor[Apply a CRC to a message] +
 +

== See Also

. Install the link:/mule-user-guide/v/3.8-beta/installing-anypoint-enterprise-security[Anypoint Enterprise Security update] on your instance of Anypoint Studio or Standalone Enterprise 3.3.2 or later.
