...
For details on setting the properties for a JDBC endpoint using an XML editor, consult the link:/mule-user-guide/v/3.8-beta/jdbc-transport-reference[JDBC Transport Reference].
