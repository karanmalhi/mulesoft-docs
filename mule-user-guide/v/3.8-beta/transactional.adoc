...
For more information and full details about how to demarcate transactions in your Mule flow, refer to link:/mule-user-guide/v/3.8-beta/transaction-management[Transaction Management].
