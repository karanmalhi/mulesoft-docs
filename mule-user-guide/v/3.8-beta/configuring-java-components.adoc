...
Java is the default component type in Mule. Mule provides two link:http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/api/component/JavaComponent.html[JavaComponent] implementations:
...
For a real-world example of using `<spring-object/>`, see link:/mule-user-guide/v/3.8-beta/using-spring-beans-as-flow-components[Using Spring Beans as Flow Components].
...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the flow. See link:/mule-user-guide/v/3.8-beta/developing-components[Developing Components] for a more detailed description of their functionality.
...
See link:/mule-user-guide/v/3.8-beta/developing-components[Developing Components] for more information about lifecycles.
...
Binding can be used on Java components and script components. For more information see link:/mule-user-guide/v/3.8-beta/component-bindings[Component Bindings].
...
For more information about pooling and reference documentation for pooling configuration options, see link:/mule-user-guide/v/3.8-beta/tuning-performance[Tuning Performance].
