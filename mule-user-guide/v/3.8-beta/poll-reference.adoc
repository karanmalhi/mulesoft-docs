...
|===
+
. Add more message processors to your flow to perform specific business logic after polling for data. The example below uses a link:/mule-user-guide/v/3.8-beta/logger-component-reference[logger] component. This logger uses the link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[MEL] expression `#[payload]` to log the message payload collected by the Twitter connector every 1000 milliseconds.
+
...
|*message* |string or link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule expression] |The content that logs to console. In this case, the Mule Expression `#[payload]` outputs the message payload.
...
. Run your project in Debug Mode. (Refer to the link:/mule-user-guide/v/3.8-beta/studio-visual-debugger[Visual Debugger] document for greater detail.)
...
Any connector which is enabled for link:/mule-user-guide/v/3.8-beta/auto-paging-in-anypoint-connectors[auto-paging] allows you to process large data sets in separate batches. This capability mitigates for memory overload, but also imposes certain conditions when used in conjunction with watermarks. The following example illustrates the recommended method for using watermarks when polling a connector that auto-pages its response.
...
* Learn how to configure a link:/mule-user-guide/v/3.8-beta/poll-schedulers[polling schedule].
...
* Learn more about link:/mule-user-guide/v/3.8-beta/logger-component-reference[Logger].
* Learn more about link:/mule-user-guide/v/3.8-beta/anypoint-connectors[Anypoint Connectors] and link:/mule-user-guide/v/3.8-beta/auto-paging-in-anypoint-connectors[auto-paging].
* Learn more about link:/mule-user-guide/v/3.8-beta/flow-processing-strategies[flow processing strategies].
