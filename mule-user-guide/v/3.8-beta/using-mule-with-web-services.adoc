...
[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the link:/mule-user-guide/v/3.8-beta/web-service-consumer[Web Service Consumer].
...
* link:/mule-user-guide/v/3.8-beta/proxying-web-services[Creating a proxy/gateway to existing Web services] (for example, adding security to an existing Web service)
...
For more information, you can check the link:/mule-user-guide/v/3.8-beta/consuming-web-services-with-cxf[Consuming Web Services with CXF] documentation.
...
For more information, read the link:/mule-user-guide/v/3.8-beta/consuming-web-services-with-cxf[Consuming Web Services with CXF] documentation.
...
* link:/mule-user-guide/v/3.8-beta/consuming-web-services-with-cxf[Use the JAX-WS Client API].
* link:/mule-user-guide/v/3.8-beta/consuming-web-services-with-cxf[Build a Client Proxy].
...
For more information, read the link:/mule-user-guide/v/3.8-beta/building-web-services-with-cxf[Creating a JAX-WS Service] documentation.
...
For more information, read the link:/mule-user-guide/v/3.8-beta/building-web-services-with-cxf[Creating a WSDL First JAX-WS Service] documentation.
...
For more information, read the link:/mule-user-guide/v/3.8-beta/building-web-services-with-cxf[Creating a simple front-end Web service] documentation.
...
* link:/mule-user-guide/v/3.8-beta/proxying-web-services-with-cxf[Server-side Proxying]
* link:/mule-user-guide/v/3.8-beta/proxying-web-services-with-cxf[Client-side Proxying]

=== Web Service Proxy Pattern

For simple use cases, you may consider using the link:/mule-user-guide/v/3.8-beta/web-service-proxy-pattern[Web Service Proxy Pattern], particularly when you don't need to accomplish much message processing. From Mule, you can use link:/mule-user-guide/v/3.8-beta/using-mule-configuration-patterns[Using Mule Configuration Patterns] to configure (with minor XML configuration) a specific integration feature.
