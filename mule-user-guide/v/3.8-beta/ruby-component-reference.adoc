...
[TIP]
====
Placing a Ruby Component is actually the same as placing a link:/mule-user-guide/v/3.8-beta/script-component-reference[Script component] and then selecting the Ruby engine.
====
