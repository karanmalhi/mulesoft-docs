...
This page summarizes reference information that is helpful for working with Maven and Mule. Refer to link:/mule-user-guide/v/3.8-beta/using-maven-with-mule[Using Maven with Mule] for an introduction and overview.
...
See link:/mule-user-guide/v/3.8-beta/configuring-maven-to-work-with-mule-esb[Configuring Maven to Work with Mule ESB].
