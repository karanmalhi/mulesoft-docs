...
You can expose a manager's logging configuration over JMX by configuring a Log4J2 JMX agent in your Mule configuration file. See link:/mule-user-guide/v/3.8-beta/jmx-management[JMX Management] for more information.
