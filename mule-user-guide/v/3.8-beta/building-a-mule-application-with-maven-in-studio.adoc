...
* Line number 12: This class extends FunctionalTestCase, which is Mule's implementation of an abstract JUnit test case. For more information, see link:/mule-user-guide/v/3.8-beta/functional-testing[Functional Testing].
...
* Read more about link:/mule-user-guide/v/3.8-beta/using-maven-with-mule[Using Maven with Mule].

* Learn how to link:/mule-user-guide/v/3.8-beta/maven-support-in-anypoint-studio[configure your Studio Preferences to work with Maven].
...
* Access additional Maven link:/mule-user-guide/v/3.8-beta/maven-reference[reference] and link:/mule-user-guide/v/3.8-beta/configuring-maven-to-work-with-mule-esb[configuration] information.
