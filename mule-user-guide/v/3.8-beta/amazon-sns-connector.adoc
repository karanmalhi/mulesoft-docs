...
*Release Notes:* link:/release-notes/sns-connector-release-notes[Amazon SNS Connector Release Notes]
...
You can install a connector in Anypoint Studio using the instructions in link:/mule-user-guide/v/3.8-beta/installing-connectors[Installing Connectors].
