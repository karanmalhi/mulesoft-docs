...
The XQuery Module gives users the ability to perform XQuery transformations on XML messages in Mule. This works in a very similar way to the link:/mule-user-guide/v/3.8-beta/xslt-transformer-reference[XSLT Transformer] shipped with Mule.
