...
NOTE: As of September 2015, the muleesb-maven-plugin is deprecated and replaced by the `mule-maven-plugin`, which provides new features and functionality. For details, see link:/mule-user-guide/v/3.8-beta/mule-maven-plugin[Mule Maven Plugin].

The muleesb-maven-plugin allows you to control Mule ESB instances from within a Maven environment. It is part of the framework for developing Mule applications with Maven, an overview of which you can find in link:/mule-user-guide/v/3.8-beta/using-maven-with-mule[Using Maven with Mule]. The plugin allows you to:
...
* For more information about developing Mule applications with Maven, see the overview in link:/mule-user-guide/v/3.8-beta/using-maven-with-mule[Using Maven with Mule], and the guides at  link:/mule-user-guide/v/3.8-beta/building-a-mule-application-with-maven-in-studio[Building a Mule Application with Maven in Studio].
* Learn how to link:/mule-user-guide/v/3.8-beta/importing-a-maven-project-into-studio[import an existing Maven project into Anypoint Studio].
* Access additional Maven link:/mule-user-guide/v/3.8-beta/maven-reference[reference] and link:/mule-user-guide/v/3.8-beta/configuring-maven-pom-files-and-settings[configuration] information.
