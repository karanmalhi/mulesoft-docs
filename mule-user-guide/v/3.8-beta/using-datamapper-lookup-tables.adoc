...
. Click *OK*. At this point, the mapping is complete. Running a link:/mule-user-guide/v/3.8-beta/obtaining-a-preview-of-mapped-data[preview] of the mapping gives the following result:
+
[source, code, linenums]
----
