...
This transformer sets the payload to whatever you define. The payload can be a literal string or a link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression].
...
* Read more about link:/mule-user-guide/v/3.8-beta/transformers[other transformers] available in Mule.
