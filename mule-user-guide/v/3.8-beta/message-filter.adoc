...
A Message Filter may also include nested filters. Nested filters let you apply more complex logic to the filter. See link:/mule-user-guide/v/3.8-beta/logic-filter[Logic Filter] for more details about nesting filters.
