...
*Connector Guide*: link:/mule-user-guide/v/3.8-beta/file-connector[File Connector]
...
For new dateTime functions introduced into MEL with Mule 3.4 and later, see link:/mule-user-guide/v/3.8-beta/mule-expression-language-date-and-time-functions[MEL Date and Time Functions]. 
