...
To the Mule flow that involves an API, add a link:/mule-user-guide/v/3.8-beta/cxf-component-reference[*CXF Component*] to publish, consume, or proxy an API. Complete the following steps to configure WS-security on the CXF component.
