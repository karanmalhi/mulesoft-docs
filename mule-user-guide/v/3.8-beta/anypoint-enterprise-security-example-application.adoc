...
This document assumes that you have link:/mule-user-guide/v/3.8-beta/installing-anypoint-enterprise-security[installed the Anypoint Enterprise Security] extensions.
...
* For more information on encryption in Mule, see link:/mule-user-guide/v/3.8-beta/mule-message-encryption-processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, see link:/mule-user-guide/v/3.8-beta/mule-digital-signature-processor[Mule Digital Signature Processor].
