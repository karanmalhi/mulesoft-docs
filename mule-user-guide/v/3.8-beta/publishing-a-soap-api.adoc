...
Using Mule's CXF Component, you can also link:/mule-user-guide/v/3.8-beta/securing-a-soap-api[enable WS-security], specify databindings, and add interceptors to your CXF API. For more information about how Mule leverages the CXF framework, consult the link:/mule-user-guide/v/3.8-beta/cxf-module-reference[CXF Module Configuration Reference].
...
Consult the link:/mule-user-guide/v/3.8-beta/securing-a-soap-api[Securing a SOAP API] document to configure the security elements of your API.

== See Also

* Consult the link:/mule-user-guide/v/3.8-beta/cxf-component-reference[CXF Component Reference].
