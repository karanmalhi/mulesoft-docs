...
This page provides details on the elements you configure for the security manager. For more information, see link:/mule-user-guide/v/3.8-beta/configuring-security[Configuring Security].
