...
This document assumes you are familiar with Mule, link:/mule-user-guide/v/3.8-beta/anypoint-connectors[Anypoint Connectors],
...
* Learn about link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language (MEL)]
* Learn about link:/mule-user-guide/v/3.8-beta/endpoint-configuration-reference[Configuring Endpoints]
