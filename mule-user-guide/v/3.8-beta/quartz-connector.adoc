...
Note that you also have the option to use a Poll scope at the beginning of a flow, which also supports Cron expressions and watermarks. Read more about the link:/mule-user-guide/v/3.8-beta/poll-reference[Poll scope].
====
...
* See the link:/mule-user-guide/v/3.8-beta/quartz-transport-reference[Quartz Transport Reference] for details on setting the properties for a Quartz endpoint using an XML editor.
...
* Read about the link:/mule-user-guide/v/3.8-beta/poll-reference[Poll scope].
