...
This page describes how to use a standalone CXF-generated client with Mule. This approach is different from the link:/mule-user-guide/v/3.8-beta/consuming-web-services-with-cxf[outbound router] approach, which is typically a more appropriate fit for most applications.
...
Following is an example of how to construct a client using the service that was developed in link:/mule-user-guide/v/3.8-beta/building-web-services-with-cxf[Building Web Services with CXF]:
