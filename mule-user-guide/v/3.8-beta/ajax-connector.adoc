...
* For details on setting the properties for an Ajax endpoint using an XML editor, see the link:/mule-user-guide/v/3.8-beta/ajax-transport-reference[Ajax Transport Reference] discussion in the Mule ESB User Guide.
