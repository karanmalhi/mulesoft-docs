...
|File Transfer |link:/mule-user-guide/v/3.8-beta/file-transport-reference[File Transport]
|Shared Database |link:/mule-user-guide/v/3.8-beta/jdbc-transport-reference[JDBC Transport]
...
|Message Router |link:/mule-user-guide/v/3.8-beta/routers[Message Routers]
|Message Translator |link:/mule-user-guide/v/3.8-beta/using-transformers[Message Transformer]
|Message Endpoint |Inbound & Outbound link:/mule-user-guide/v/3.8-beta/endpoint-configuration-reference[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content Enricher |link:/mule-user-guide/v/3.8-beta/message-enricher[Message Enricher]
|===
...
* link:/mule-user-guide/v/3.8-beta/using-mule-configuration-patterns[Configuring Mule with Patterns]
