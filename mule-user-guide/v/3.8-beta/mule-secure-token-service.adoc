...
The example above briefly describes the *OAuth dance* between client, provider and resource owner. The list below describes the sequential steps in an OAuth dance which employs the Authorization Code link:/mule-user-guide/v/3.8-beta/authorization-grant-types[grant type]. (For a graphical illustration of the dance steps, see the link:/mule-user-guide/v/3.8-beta/mule-sts-oauth-2.0a-example-application[Mule STS OAuth 2.0a Example Application].)
...
. Examine the link:/mule-user-guide/v/3.8-beta/mule-sts-oauth-2.0a-example-application[Mule STS OAuth 2.0a Example Application] which illustrates how to add OAuth 2.0a to a Web service provider in Mule.
. Learn more about link:/mule-user-guide/v/3.8-beta/authorization-grant-types[Authorization Grant Types].
