...
See link:/mule-user-guide/v/3.8-beta/mule-object-stores[Mule Object Stores] for further information about object stores in Mule. The following code sample illustrates how to configure an in-memory store:
...
* Learn more about link:/mule-user-guide/v/3.8-beta/tuning-performance[Tuning Performance] in Mule.
* Learn more about link:/mule-user-guide/v/3.8-beta/scopes[Scopes] in Mule in general.
