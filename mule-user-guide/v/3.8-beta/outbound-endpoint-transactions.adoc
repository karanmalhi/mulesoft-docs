...
This page lists the outbound endpoint transactions of the link:/mule-user-guide/v/3.8-beta/mulesoft-enterprise-java-connector-for-sap-reference[SAP Connector].
