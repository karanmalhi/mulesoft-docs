...
The sections below describe how to use Mule's link:/mule-user-guide/v/3.8-beta/error-handling[*Default Exception Strategy*], a link:/mule-user-guide/v/3.8-beta/rollback-exception-strategy[*Rollback Exception Strategy*] or a link:/mule-user-guide/v/3.8-beta/catch-exception-strategy[*Catch Exception Strategy*] to handle errors in a flow with a CXF Web service.
...
Refer to link:/mule-user-guide/v/3.8-beta/rollback-exception-strategy[Rollback Exception Strategy] for detailed instructions on how to apply one to a flow.
...
Refer to link:/mule-user-guide/v/3.8-beta/catch-exception-strategy[Catch Exception Strategy] for detailed instructions on how to apply one to a flow.
