...
* link:/mule-user-guide/v/3.8-beta/cxf-module-reference[CXF]
* link:/mule-user-guide/v/3.8-beta/streaming-data-processing-with-datamapper[DataMapper]
* link:/mule-user-guide/v/3.8-beta/file-transport-reference[File] (set the `streaming` attribute to false to access the File object directly)
* link:/mule-user-guide/v/3.8-beta/ftp-transport-reference[FTP]
* link:/mule-user-guide/v/3.8-beta/http-connector[HTTP] and link:/mule-user-guide/v/3.8-beta/http-connector[HTTPS]
* link:/mule-user-guide/v/3.8-beta/jetty-transport-reference[Jetty] and link:/mule-user-guide/v/3.8-beta/jetty-ssl-transport[Jetty SSL]
* link:/mule-user-guide/v/3.8-beta/servlet-transport-reference[Servlet]
* link:/mule-user-guide/v/3.8-beta/tcp-transport-reference[TCP]
* link:/mule-user-guide/v/3.8-beta/udp-transport-reference[UDP]
...
* link:/mule-user-guide/v/3.8-beta/domtoxml-transformer[DomToOutputHandler transformer] (if the incoming XML format is a SAXSource or XMLStreamReader)
* link:/mule-user-guide/v/3.8-beta/sxc-module-reference[SXC filter]
