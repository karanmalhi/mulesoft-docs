...
* For more information on the use of Spring, see link:/mule-user-guide/v/3.8-beta/using-spring-beans-as-flow-components[Using Spring Beans as Flow Components] and  link:/mule-user-guide/v/3.8-beta/about-the-xml-configuration-file[About the XML Configuration File].
