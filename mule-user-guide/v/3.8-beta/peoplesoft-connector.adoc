...
NOTE: Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to obtain either of these. Read more about link:/mule-user-guide/v/3.8-beta/installing-an-enterprise-license[Installing an Enterprise License].
...
NOTE: Read more about link:/mule-user-guide/v/3.8-beta/installing-connectors[Installing Connectors].
