...
* *NEXT STEP*: Learn the link:/mule-user-guide/v/3.8-beta/mule-expression-language-basic-syntax[basic syntax of MEL], or dive into link:/mule-fundamentals/v/3.7/mule-application-architecture[Mule Application Architecture].
* Learn better by example? Access our collection of link:/mule-user-guide/v/3.8-beta/mule-expression-language-examples[example apps which use MEL].
