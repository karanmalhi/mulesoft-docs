...
For more information about processing strategies, see link:/mule-user-guide/v/3.8-beta/flow-processing-strategies[Flow Processing Strategies].
...
+
. Configure the processing strategy as needed. For more information, see link:/mule-user-guide/v/3.8-beta/flow-processing-strategies[Flow Processing Strategies].
....
[tab,title="XML Editor or Standalone"]
....

. Define your processing strategy as a global element, with any necessary configuration or optional fine-tuning. (For more information, see link:/mule-user-guide/v/3.8-beta/flow-processing-strategies[Flow Processing Strategies].) Refer to code sample below.
...
* For more information about processing strategies and how to configure them, see link:/mule-user-guide/v/3.8-beta/flow-processing-strategies[Flow Processing Strategies].
