...
For a list of configuration patterns that ship with Mule, see link:/mule-user-guide/v/3.8-beta/using-mule-configuration-patterns[Using Mule Configuration Patterns].
