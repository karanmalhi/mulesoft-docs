...
[TIP]
For a complete description of DataMapper's Preview feature, see link:/mule-user-guide/v/3.8-beta/previewing-datamapper-results-on-sample-data[Previewing DataMapper Results on Sample Data].
...
[TIP]
To generate a preview of your mapping, click the *Preview* tab in the DataMapper view, then click *Run Mapping*. Consult link:/mule-user-guide/v/3.8-beta/previewing-datamapper-results-on-sample-data[Previewing DataMapper Results on Sample Data] for details.
...
You can also use the *Infer Metadata* tool to automatically update or recreate output metadata. For details, see link:/mule-user-guide/v/3.8-beta/updating-metadata-in-an-existing-mapping[Updating Metadata in an Existing Mapping].
