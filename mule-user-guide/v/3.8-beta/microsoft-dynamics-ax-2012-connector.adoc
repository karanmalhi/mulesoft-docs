...
* Install the link:/mule-user-guide/v/3.8-beta/windows-gateway-services-guide[Windows Gateway Services] 
...
* link:/mule-user-guide/v/3.8-beta/windows-gateway-services-guide[Windows Gateway Services]
