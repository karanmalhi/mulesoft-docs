...
* Review the link:/mule-user-guide/v/3.8-beta/datasense[DataSense] functionality. 
* See DataSense in action!  Examine two example applications which were built using DataSense: link:/mule-user-guide/v/3.8-beta/connect-with-salesforce-example[Connect with Salesforce Example].
