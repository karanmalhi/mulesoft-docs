...
Users of link:/mule-user-guide/v/3.8-beta/batch-processing[Batch] processing frequently need the ability to determine a Batch job's instance ID during the execution phases of a Batch job. 
