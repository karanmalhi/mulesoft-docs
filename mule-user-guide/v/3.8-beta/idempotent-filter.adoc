...
* link:/mule-user-guide/v/3.8-beta/routers#idempotent-message-filter[Idempotent Message Filter]
* link:/mule-user-guide/v/3.8-beta/routers#idempotent-secure-hash-message-filter[Secure Message Filter]
