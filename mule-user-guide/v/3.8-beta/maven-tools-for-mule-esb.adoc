...
* Access additional Maven link:/mule-user-guide/v/3.8-beta/maven-reference[Maven Reference] and link:/mule-user-guide/v/3.8-beta/configuring-maven-to-work-with-mule-esb[Configuring Maven to Work with Mule ESB] information.
