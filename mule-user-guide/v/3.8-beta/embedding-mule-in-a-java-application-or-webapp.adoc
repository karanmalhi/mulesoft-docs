...
To interact with the Mule server from your application, JSP, or servlet, you can use the link:/mule-user-guide/v/3.8-beta/using-the-mule-client[Mule Client].
