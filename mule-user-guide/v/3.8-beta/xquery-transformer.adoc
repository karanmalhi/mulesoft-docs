...
The XQuery Module gives users the ability to perform XQuery transformations on XML messages in Mule. This works in a very similar way to the link:/mule-user-guide/v/3.8-beta/xslt-transformer[XSLT Transformer] shipped with Mule.
...
== Supported XQuery Versions
 ...
 For examples on using the XQuery transformer, including the use of features and improvements in version 3.0, see link:/mule-user-guide/v/3.8-beta/xquery-support[XQuery Support].
