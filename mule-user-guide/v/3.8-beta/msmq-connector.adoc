...
*  Install the link:/mule-user-guide/v/3.8-beta/windows-gateway-services-guide[Windows Gateway Service] first before installing and configuring MSMQ.
...
[WARNING]
 *Important*: Install the link:/mule-user-guide/v/3.8-beta/windows-gateway-services-guide[Windows Gateway Service] first before installing and configuring MSMQ.
...
The Windows Gateway Services supports running in a load-balanced configuration to allow for fault tolerance. Visit the link:/mule-user-guide/v/3.8-beta/windows-gateway-services-guide[Windows Gateway Service] documentation for more details.
...
* link:/mule-user-guide/v/3.8-beta/mule-expression-language-mel[Mule Expression Language]
* link:/mule-user-guide/v/3.8-beta/endpoint-configuration-reference[Configuring Endpoints]
...
* link:/mule-user-guide/v/3.8-beta/msmq-connector-user-guide[MSMQ User Guide]
...
* Refer to the link:/mule-user-guide/v/3.8-beta/msmq-connector-user-guide[user guide] for more information about this connector.
* Read the link:/mule-user-guide/v/3.8-beta/msmq-connector-faqs[FAQs] about the MSMQ Connector.
