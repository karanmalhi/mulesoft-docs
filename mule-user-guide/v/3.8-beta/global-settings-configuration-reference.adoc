...
This page provides details on the global settings you configure at the root level of a Mule configuration. For more information on configuration, see link:/mule-user-guide/v/3.8-beta/about-mule-configuration[About Mule Configuration]. For information on threading profiles, see link:/mule-user-guide/v/3.8-beta/tuning-performance[Tuning Performance].
