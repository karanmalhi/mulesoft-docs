...
The attachment transformer is very similar in functionality to the link:/mule-user-guide/v/3.8-beta/property-transformer-reference[property transformer]. However, attachments are only supported by the following transports: 
...
* Read about related transformers, the link:/mule-user-guide/v/3.8-beta/property-transformer-reference[property transformer], the link:/mule-user-guide/v/3.8-beta/variable-transformer-reference[variable transformer], and the link:/mule-user-guide/v/3.8-beta/session-variable-transformer-reference[session variable transformer], which you can use to set properties and variables for different scopes.
