...
See the link:/mule-user-guide/v/3.8-beta/connector-configuration-reference[Connector Configuration Reference] for instructions for configuring connectors for endpoint functions or for operations.

See the link:/mule-user-guide/v/3.8-beta/http-connector[HTTP Connector] for information on this operation-based connector.
...
* Refer to the overview of link:/mule-user-guide/v/3.8-beta/anypoint-connectors[Anypoint Connectors].
