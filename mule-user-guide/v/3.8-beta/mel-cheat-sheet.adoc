...
See also link:/mule-user-guide/v/3.8-beta/mule-expression-language-reference[Mule Expression Language Reference].
...
For more information, see link:/mule-user-guide/v/3.8-beta/xpath[XPath] and
link:/mule-user-guide/v/3.8-beta/mule-expression-language-reference#xpath[MEL XPath].
