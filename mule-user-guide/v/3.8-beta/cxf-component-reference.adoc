...
* Learn more about link:/mule-user-guide/v/3.8-beta/publishing-a-soap-api[publishing SOAP APIs] with Mule.

* Learn more about link:/mule-user-guide/v/3.8-beta/consuming-a-soap-api[consuming SOAP APIs] with Mule.
