...
* For more information on the Choice Flow Control, see the link:/mule-user-guide/v/3.8-beta/routers[Choice] section on the Routing Message Processors page.
