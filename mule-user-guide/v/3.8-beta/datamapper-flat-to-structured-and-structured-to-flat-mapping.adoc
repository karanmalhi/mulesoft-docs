...
To test your mapping, use the link:/mule-user-guide/v/3.8-beta/previewing-datamapper-results-on-sample-data[Preview] feature by completing the following steps:
