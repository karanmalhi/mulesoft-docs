...
Namespaces can be configured in the Mule Configuration using the link:/mule-user-guide/v/3.8-beta/xml-namespaces[XML Namespaces], these will be made available for this annotation.

First declare the namespace using the link:/mule-user-guide/v/3.8-beta/xml-namespaces[Namespace Manager] -
