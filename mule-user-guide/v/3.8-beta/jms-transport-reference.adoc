...
* Supports local (JMS), distributed (XA), and multi-resource link:/mule-user-guide/v/3.8-beta/transaction-management[transactions]  *_Enterprise_*
...
Mule Enterprise includes an link:/mule-user-guide/v/3.8-beta/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
...
http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has link:/mule-user-guide/v/3.8-beta/activemq-integration[simplified configuration].
...
* link:/mule-user-guide/v/3.8-beta/hornetq-integration[HornetQ]
* link:/mule-user-guide/v/3.8-beta/open-mq-integration[Open MQ]
* link:/mule-user-guide/v/3.8-beta/solace-jms[Solace JMS]
* link:/mule-user-guide/v/3.8-beta/tibco-ems-integration[Tibco EMS]
