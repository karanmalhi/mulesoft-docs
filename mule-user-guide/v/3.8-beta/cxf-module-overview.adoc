...
For information about what standards are supported, see link:/mule-user-guide/v/3.8-beta/supported-web-service-standards[Supported Web Service Standards].
