...
. _Optional_: link:/mule-user-guide/v/3.8-beta/adding-community-runtime[Add Community runtime] to your Studio instance.

. _Optional_: link:/mule-user-guide/v/3.8-beta/installing-an-enterprise-license[Acquire an Enterprise license] (recommended for running applications in production).
...
[TIP]
====
The trial version is not suitable for running applications in production. To run applications in production, link:/mule-user-guide/v/3.8-beta/installing-an-enterprise-license[acquire an Enterprise license].
====
....
...
* link:/mule-user-guide/v/3.8-beta/installing-anypoint-enterprise-security[Anypoint Enterprise Security] 

* link:/mule-user-guide/v/3.8-beta/anypoint-connectors[Anypoint Connectors] 

* mailto:sales@mulesoft.com[Contact MuleSoft] to acquire entitlements to access the link:/mule-user-guide/v/3.8-beta/mulesoft-enterprise-java-connector-for-sap-reference[SAP Connector] and/or link:/mule-user-guide/v/3.8-beta/mule-high-availability-ha-clusters[High Availability Clustering]

== See Also

* Learn more about acquiring and installing an link:/mule-user-guide/v/3.8-beta/installing-an-enterprise-license[Installing an Enterprise License].
...
* link:/mule-user-guide/v/3.8-beta/installing-extensions[Extend Mule] with plugins, modules, runtimes, and connectors.

* Access a list of all the link:/mule-user-guide/v/3.8-beta/studio-update-sites[update sites] available for your version of Studio.
