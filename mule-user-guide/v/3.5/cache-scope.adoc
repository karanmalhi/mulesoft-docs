...
By default, Mule stores all cached responses in an InMemoryObjectStore. <<Creating a Caching Strategy>> and define a new link:/docs/display/current/Mule+Object+Stores[object store] if you want to customize the way Mule stores cached responses.
