...
This document assumes familiarity with http://git-scm.com/[git] as a software version control system, and that you are using link:/documentation/display/current/First+30+Minutes+with+Mule[Mule Studio] to build a new application that you intend to manage using git. 
...
+
image:/documentation/download/attachments/122752303/gitignore.png?version=1&modificationDate=1385579824419[image]
...
* Learn about link:/documentation/display/current/Using+Subversion+with+Studio[Using Subversion with Studio].
