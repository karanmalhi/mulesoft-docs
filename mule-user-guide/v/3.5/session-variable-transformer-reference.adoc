...
image:/docs/download/attachments/122752180/session_transformer.png?version=1&modificationDate=1398982467516[image]
...
image:/docs/download/attachments/122752180/session_trans_example.png?version=1&modificationDate=1398982551877[image] +
