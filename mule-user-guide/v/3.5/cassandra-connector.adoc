...
+
image:/docs/download/attachments/122752088/Config.png?version=1&modificationDate=1406713924118[image]
+
...
image:/docs/download/attachments/122752088/cassandra.png?version=1&modificationDate=1420482958559[image]
...
. Click the *+* sign next to the *Connector Configuration* field to add a new global connector configuration: +
 image:/docs/download/attachments/122752088/addconfig.png?version=1&modificationDate=1406796741461[image]
...
+
image:/docs/download/attachments/122752088/cassandra+conf+1.png?version=1&modificationDate=1420483934380[image]
+
[width="100%",cols="50%,50%",options="header",]
|=====
a|
