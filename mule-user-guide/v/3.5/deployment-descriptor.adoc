...
For details on classloading in MuleMule, including a diagram of the Mule classloading architecture, see link:/docs/display/35X/Classloader+Control+in+Mule[Classloader Control in Mule].
