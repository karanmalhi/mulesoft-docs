...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750867/image017.jpg?version=1&modificationDate=1421450055036[image]

. Drag an HTTP endpoint into a new flow, and configure it as follows:  +

+
image:/docs/download/attachments/122750867/http.png?version=1&modificationDate=1421450054720[image] +
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:/docs/download/attachments/122750867/global+element.png?version=1&modificationDate=1421450054402[image]
...
+
image:/docs/download/attachments/122750867/connector+parameters.png?version=1&modificationDate=1421450054087[image]
...
+
image:/docs/download/attachments/122750867/groovy.png?version=1&modificationDate=1421450053102[image]
+
...
+
image:/docs/download/attachments/122750867/second+cmis.png?version=1&modificationDate=1421450053753[image]
+
...
+
image:/docs/download/attachments/122750867/ObjecttoJson.png?version=1&modificationDate=1421450052752[image]
+
...
[tab,title="XML Editor"]
....
image://https://developer.mulesoft.com/docs/download/attachments/122750867/image017.jpg?version=1&modificationDate=1421450055036[image]
