...
For simple use cases, you may consider using the link:/mule-user-guide/v/3.6/web-service-proxy-pattern[Web Service Proxy Pattern], particularly when you don't need to accomplish much message processing. From Mule, you can use link:/mule-user-guide/v/3.6/using-mule-configuration-patterns[Using Mule Configuration Patterns] to configure (with minor XML configuration) a specific integration feature.
