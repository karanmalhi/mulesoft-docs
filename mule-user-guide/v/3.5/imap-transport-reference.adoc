...
|IMAP |[JavaDoc Sechema Doc] |image:/documentation/images/icons/emoticons/check.gif[check] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |one-way |one-way |[org.mule.transport:mule-transport-imap]
|IMAPS |[JaveDoc SchemaDoc] |image:/documentation/images/icons/emoticons/check.gif[check] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |image:/documentation/images/icons/emoticons/error.gif[error] |one-way |one-way |[org.mule.transport:mule-transport-imaps]
|===
