...
+
image:/docs/download/attachments/122750860/installdotnet.png?version=1&modificationDate=1421450029146[image]
+
...
+
image:/docs/download/attachments/122750860/SoftwareUpdates.png?version=1&modificationDate=1421450029752[image]
+
...
. In the *New Project* dialog, select the Class Library template under Visual C#.  Name the Project “Test.SampleComponent”. +
 +
image:/docs/download/attachments/122750860/dotnetnewproject.png?version=1&modificationDate=1421450028666[image]
...
. Use *DotNet Connector* as filter to locate, then select the Global Type: +
 image:/docs/download/attachments/122750860/Global+Type.png?version=1&modificationDate=1421450027279[image] +
...
image:/docs/download/attachments/122750860/GAC.png?version=1&modificationDate=1421450027086[image]
+
...
image:/docs/download/attachments/122750860/Legacy.png?version=1&modificationDate=1421450026890[image]  +
+
...
image:/docs/download/attachments/122750860/Resource.png?version=1&modificationDate=1421450026694[image]
...
image:/docs/download/attachments/122750860/httppc.png?version=1&modificationDate=1421450028460[image]
...
image:/docs/download/attachments/122750860/SetPayload.png?version=1&modificationDate=1421450026292[image]
...
+
image:/docs/download/attachments/122750860/DataMapper1.png?version=1&modificationDate=1421450025830[image]
+
...
image:/docs/download/attachments/122750860/DotNet+Connector.png?version=1&modificationDate=1421450026071[image]
...
image:/docs/download/attachments/122750860/Run+application.png?version=1&modificationDate=1421450025361[image]
