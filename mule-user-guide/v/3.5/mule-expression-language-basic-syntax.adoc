...
image:/documentation/download/attachments/122752115/melsyntax1.png?version=1&modificationDate=1397232497837[image]
...
                                   image:/documentation/download/attachments/122752115/contextob_field.png?version=1&modificationDate=1397167719848[image]           image:/documentation/download/attachments/122752115/flowVars-syntax.png?version=1&modificationDate=1397923520359[image]
...
//regex('^(To|From|Cc):')
//bars in cell
|*xpath* and *regex* provide ways of extracting context information that doesn’t already exist as a single value. 
