...
In most cases, http://www.saxproject.org/about.html[SAX] is used to parse your XML. If you are using CXF or the XmlToXMLStreamReader, link:https://web.archive.org/web/20150526105309/http://stax.codehaus.org/Home[Stax] is used instead.
