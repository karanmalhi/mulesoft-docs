...
+
image:/docs/download/attachments/122752237/splitter_example.png?version=1&modificationDate=1398902436120[image]
+
[cols=",",options="header",]
|===
|Parameter |Value
...
+
image:/docs/download/attachments/122752237/splitter+flow.png?version=1&modificationDate=1420204879630[image]
...
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the link:/docs/display/current/Studio+Visual+Debugger[Visual Debugger]:
...
image:/docs/download/attachments/122752237/collection_agg.png?version=1&modificationDate=1398966033959[image]
...
+
image:/docs/download/thumbnails/122752237/splitter+flow+2.png?version=1&modificationDate=1420206326819[image]
...
+
image:/docs/download/attachments/122752237/splitter+flow+3.png?version=1&modificationDate=1420206396382[image]

. Configure the two VM connectors. Change both their *Queue Path* to `step2`.
+
image:/docs/download/attachments/122752237/vm4.png?version=1&modificationDate=1385501021475[image]
+
...
+
image:/docs/download/attachments/122752237/splitter+flow+4.png?version=1&modificationDate=1420206493414[image]
...
+
image:/docs/download/attachments/122752237/splitter+flow+5.png?version=1&modificationDate=1420206909354[image] +
+
...
+
image:/docs/download/attachments/122752237/splitter+flow+6.png?version=1&modificationDate=1420207054028[image]
+
