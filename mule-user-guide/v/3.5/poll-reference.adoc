...
+
image:/docs/download/thumbnails/122750691/poll_scope.png?version=1&modificationDate=1421449622313[image]
...
+
image:/docs/download/attachments/122750691/poll_connector.png?version=1&modificationDate=1421449630967[image]

. Configure the Twitter Connector
+
image:/docs/download/attachments/122750691/twitter.png?version=1&modificationDate=1421449622065[image]
+
...
+
image:/docs/download/attachments/122750691/poll_flow.png?version=1&modificationDate=1421449631152[image]
....
...
+
image:/docs/download/attachments/122750691/poll_debug.png?version=1&modificationDate=1421449622823[image]
...
+
image:/docs/download/attachments/122750691/poll_startStop.png?version=1&modificationDate=1421449622575[image]
...
image:/docs/download/attachments/122750691/watermark-expbasic.png?version=1&modificationDate=1421449627515[image]
...
image:/docs/download/attachments/122750691/watermark-w-selectors.png?version=1&modificationDate=1421449624108[image]
...
+
image:/docs/download/thumbnails/122750691/poll_flow.png?version=1&modificationDate=1421449631152[image]
...
+
image:/docs/download/attachments/122750691/synchronous.png?version=1&modificationDate=1421449631323[image]

. Configure the *Since Id* attribute of the Twitter connector according to the table below.
+
image:/docs/download/attachments/122750691/watermark.png?version=1&modificationDate=1421449621824[image]
+
[width="100%",cols=",",options="header"]
|===
|Attribute |Value |Description
...
+
image:/docs/download/attachments/122750691/watermark_enable.png?version=1&modificationDate=1421449621584[image]
+
[width="100%",cols=",",options="header"]
|===
...
image:/docs/download/attachments/122750691/watermark-expcomplex.png?version=1&modificationDate=1421449623606[image]
...
+
image:/docs/download/attachments/122750691/ex11.png?version=1&modificationDate=1421449629488[image]
...
+
image:/docs/download/attachments/122750691/salesforce.png?version=1&modificationDate=1421449620889[image]
+
[WARNING]
...
+
image:/docs/download/attachments/122750691/yesterday.png?version=1&modificationDate=1421449621419[image]
+
[width="100%",cols=",",options="header"]
|===
...
+
image:/docs/download/attachments/122750691/ex12.png?version=1&modificationDate=1421449629758[image]
...
+
image:/docs/download/attachments/122750691/ex13.png?version=1&modificationDate=1421449629953[image]

. Configure the Variable to change `lastUpdated` to the following expression: `#[payload['lastUpdated]]`
+
image:/docs/download/attachments/122750691/setvariable.png?version=1&modificationDate=1421449621245[image]
+
[width="100%",cols=",",options="header"]
|===
...
+
image:/docs/download/attachments/122750691/fullex1.png?version=1&modificationDate=1421449630119[image]
....
[tab,title="XML Editor or Standalone"]
....
...
+
image:/docs/download/attachments/122750691/dsql_sfdc.png?version=1&modificationDate=1421449621063[image]
+
[WARNING]
...
+
image:/docs/download/attachments/122750691/poll_watermark_variable.png?version=1&modificationDate=1421449620685[image]
+
[width="100%",cols=",",options="header"]
|===
|Attribute |Description |Sample XML
...
+
image:/docs/download/attachments/122750691/ex22.png?version=1&modificationDate=1421449630414[image]
...
+
image:/docs/download/attachments/122750691/datamapper+clean.png?version=1&modificationDate=1421449623076[image]

. Add a Logger at the end of your flow, outside the foreach scope, to log the value of `lastUpdated`. The logger also allows you to verify that the watermark works.
+
image:/docs/download/attachments/122750691/fullex2.png?version=1&modificationDate=1421449630572[image]
....
------
