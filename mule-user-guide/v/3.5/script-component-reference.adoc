...
*link:#ScriptComponentReference-c[Skip to Code]*
...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a link:/docs/display/current/Java+Component+Reference[Java Component] that works very similarly.

image:/docs/download/attachments/122752211/basic+conf.png?version=1&modificationDate=1416579825255[image]
...
image:/docs/download/attachments/122752211/advanced+conf.png?version=1&modificationDate=1416579846071[image]
...
* For more information see the Mule ESB page link:/docs/display/current/Scripting+Module+Reference[Scripting Module]
* Read more about the link:/docs/display/current/JavaScript+Component+Reference[JavaScript Component]
* Read more about the link:/docs/display/current/Ruby+Component+Reference[Ruby Component]
* Read more about the link:/docs/display/current/Groovy+Component+Reference[Groovy Component]
* Read more about the link:/docs/display/current/Python+Component+Reference[Python Component]
* Read more about the link:/docs/display/current/Java+Component+Reference[Java Component]
