...
Jetty endpoints are configured the same way as link:/mule-user-guide/v/3.7/http-transport-reference[HTTP endpoints]. Note that the Jetty transport can only be used for inbound endpoints.
