...
This page covers more complex configuration of the CXF Component than those described in the basic discussions of link:/docs/display/current/Publishing+a+SOAP+API[publishing a SOAP API] and link:/docs/display/current/Consuming+a+SOAP+API[consuming a SOAP API]. You may also wish to refer to full link:/docs/display/current/CXF+Component+Reference[CXF Component Reference] documentation.
...
+
image:/docs/download/attachments/122752044/global.png?version=1&modificationDate=1396897796334[image]

. Configure the global CXF configuration attributes according to the table below.
+
image:/docs/download/attachments/122752044/global_properties.png?version=1&modificationDate=1396897842818[image]
+
...
+
image:/docs/download/attachments/122752044/select_global.png?version=1&modificationDate=1396897863964[image]
...
+
image:/docs/download/attachments/122752044/CXF-addint.png?version=1&modificationDate=1400534833411[image]

. Double-click the newly created interceptor provider in the *Settings* pane to open the interceptor provider panel.
+
image:/docs/download/attachments/122752044/CXF-clickinter.png?version=1&modificationDate=1400534923211[image]
...
+
image:/docs/download/attachments/122752044/Studio-interceptorssettings.png?version=1&modificationDate=1396895787307[image]
...
+
image:/docs/download/attachments/122752044/CXF-adv.png?version=1&modificationDate=1400535754748[image]
...
* Access full link:/docs/display/current/CXF+Component+Reference[CXF Component Reference] documentation.

* Learn the basics of link:/docs/display/current/Publishing+a+SOAP+API[publishing a SOAP API].

* Learn the basics of link:/docs/display/current/Consuming+a+SOAP+API[consuming a SOAP API].
