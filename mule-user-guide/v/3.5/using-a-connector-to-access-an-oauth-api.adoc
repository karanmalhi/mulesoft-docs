...
This document assumes that you are familiar with the link:/docs/display/current/Anypoint+Studio+Essentials[Visual Editor in Anypoint Studio], link:/docs/display/current/Anypoint+Connectors[Anypoint Connectors], and  link:/docs/display/current/Global+Elements[Global Elements]. Review the link:/docs/display/current/First+Day+with+Mule[First Day with Mule] chapter to learn more about developing with Mule ESB's graphical user interface.
...
[NOTE]
If you need to deploy to different environments (e.g., production, development) where these parameters need to have different values, please see link:/docs/display/current/Deploying+to+Multiple+Environments[Deploying to Multiple Environments].
...
+
image:/docs/download/attachments/122752086/connectorconfiguration.png?version=1&modificationDate=1400168110986[image] +
...
+
image:/docs/download/attachments/122752086/sfdcGE-ckcs.png?version=1&modificationDate=1400168250166[image]
...
+
image:/docs/download/attachments/122752086/oauthcallback.png?version=1&modificationDate=1400168338595[image]  
+
...
|*Default Access Token Id* |n/a |n/a |Not used in this example. Read more about link:#UsingaConnectortoAccessanOAuthAPI-ManagingOAuthTokens[TokenIDs].
|===
...
image:/docs/download/attachments/122752086/sfdc-exception.png?version=1&modificationDate=1400168489290[image]
...
|*path* |`callback` |`callback` |The path of the listener at which your OAuth callback is hosted.
|*defaultAccessTokenId* |n/a |n/a |Not used in this example. Read more about link:#UsingaConnectortoAccessanOAuthAPI-ManagingOAuthTokens[TokenIDs].
|===
...
+
image:/docs/download/attachments/122752086/salesforce+oauth.png?version=1&modificationDate=1421096671094[image]
+
...
|*Operation* |`Authorize`
|*Access Token URL* |(_Optional_) link:#UsingaConnectortoAccessanOAuthAPI-AccessTokenandAuthorizationURLs[See below]. +
 Example: `https://na1.salesforce.com/services/oauth2/token`
|*Authorization URL* |(_Optional_) link:#UsingaConnectortoAccessanOAuthAPI-AccessTokenandAuthorizationURLs[See below]. +
Example: `https://na1.salesforce.com/services/oauth2/authorize`
|*Display* |`PAGE`
|===
+
image:/docs/download/attachments/122752086/sfdc-pe.png?version=1&modificationDate=1400168994638[image]
...
|*accessTokenUrl* |(_Optional_) link:#UsingaConnectortoAccessanOAuthAPI-AccessTokenandAuthorizationURLs[See below].
Example: `https://na1.salesforce.com/services/oauth2/token`
|*authorizationUrl* |(_Optional_) link:#UsingaConnectortoAccessanOAuthAPI-AccessTokenandAuthorizationURLs[See below].
Example: `https://na1.salesforce.com/services/oauth2/authorize`
|*display* |PAGE
|===
+
...
+
image:/docs/download/attachments/122752086/salesforce+oauth+2.png?version=1&modificationDate=1421097345236[image]
...
+
image:/docs/download/attachments/122752086/connectorauthorized.png?version=1&modificationDate=1400169826291[image]
...
image:/docs/download/attachments/122752086/box-ge.png?version=1&modificationDate=1400170505573[image]
...
* Learn how to access an OAuth API using the link:/docs/display/current/HTTP+Request+Connector[HTTP Request Connector]
