...
This transformer can be tested using the following functional test. Note that it uses `FunctionalTestCase`, which is part of Mule's link:/docs/display/current/Functional+Testing[Test support].
