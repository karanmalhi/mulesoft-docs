...
This page summarizes reference information that is helpful for working with Maven and Mule. Refer to link:/documentation/display/current/Using+Maven+with+Mule[Using Maven with Mule] for an introduction and overview.
...
See link:/documentation/display/current/Configuring+Maven+to+Work+with+Mule+ESB[Configuring Maven to Work with Mule ESB].
...
* http://repository.codehaus.org/org/mule/tools/maven-mule-plugin/1.9/[Mule plugin for Maven at Codehaus]
