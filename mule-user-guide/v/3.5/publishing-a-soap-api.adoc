...
+
image:/docs/download/attachments/122750887/SOAP-flow1.png?version=1&modificationDate=1421450149258[image]
+
...
+
image:/docs/download/attachments/122750887/CXF-1.png?version=1&modificationDate=1421450148909[image]
+
image:/docs/download/attachments/122750887/CXF-2.png?version=1&modificationDate=1421450148570[image]
+
...
+
image:/docs/download/attachments/122750887/SOAPflow1.png?version=1&modificationDate=1421450146902[image]

. Configure the CXF component as per the image and table below.
+
image:/docs/download/attachments/122750887/CXF-3.png?version=1&modificationDate=1421450148233[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/docs/download/attachments/122750887/CXFflow2.png?version=1&modificationDate=1421450147897[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/docs/download/attachments/122750887/CXFflow3.png?version=1&modificationDate=1421450147567[image]
+
...
+
image:/docs/download/attachments/122750887/soapflow4.png?version=1&modificationDate=1421450147236[image]
+
...
+
image:/docs/download/attachments/122750887/CXFex2.png?version=1&modificationDate=1421450146571[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/docs/download/attachments/122750887/OrderAPIadv.png?version=1&modificationDate=1421450146219[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/docs/download/attachments/122750887/OrderAPIflow.png?version=1&modificationDate=1421450145491[image]
+
...
+
image:/docs/download/attachments/122750887/SOAPflow1+%281%29.png?version=1&modificationDate=1421450145840[image]

. Configure the *CXF component* as per the image and table below. At runtime, the output of this component is a POJO.
+
image:/docs/download/attachments/122750887/newCXForderapi.png?version=1&modificationDate=1421450145080[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
image:/docs/download/attachments/122750887/newCXForderapi-genfromwsdl.png?version=1&modificationDate=1421450144628[image]
