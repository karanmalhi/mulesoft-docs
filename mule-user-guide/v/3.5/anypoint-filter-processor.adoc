...
+
image:/documentation/download/attachments/122752343/filter3.png?version=1&modificationDate=1354210807858[image]
...
Further, use a security filter to protect your resource against a replay attack. By rejecting messages with a lifespan that exceeds a short timeframe — 30 seconds, for example — Mule protects your application from processing the same message a user maliciously sends multiple times. To be effective, a Mule flow should employ a link:/documentation/display/current/Mule+Digital+Signature+Processor[digital signature], in addition to this type of security filter, to sign the creation time of the message.

[NOTE]
This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, access link:#[Understand Global Elements] to learn more before proceeding.
...
+
image:/documentation/download/attachments/122752343/filters.png?version=1&modificationDate=1399071137699[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
