...
+
image:/docs/download/attachments/122750844/Install.jpg?version=1&modificationDate=1421449974572[image]

. On the *Install* wizard, click the drop-down arrow for the *Work with:* field, the select the Anypoint Connector update site
+
image:/docs/download/attachments/122750844/workwith.jpg?version=1&modificationDate=1421449974287[image]
...
+
image:/docs/download/attachments/122750844/SelectNetSuite.jpg?version=1&modificationDate=1421449973992[image]
...
+
image:/docs/download/attachments/122750844/connectorslist.jpg?version=1&modificationDate=1421449973704[image]
...
+
image:/docs/download/attachments/122750844/Configuration.jpg?version=1&modificationDate=1421449972560[image]
+
...
[tab,title="Studio Visual Editor"]
....
image:/docs/download/attachments/122750844/Flow.jpg?version=1&modificationDate=1421449972274[image]

. Drag an *HTTP* Endpoint into a new flow, and configure it as follows:
+
image:/docs/download/attachments/122750844/http.jpg?version=1&modificationDate=1421449973412[image]
+
...
+
image:/docs/download/attachments/122750844/setpayload.jpg?version=1&modificationDate=1421449973133[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/docs/download/attachments/122750844/global+element.jpg?version=1&modificationDate=1421449972852[image]
