...
. Follow the detailed link:/mule-user-guide/v/3.6/datasense[DataSense] instructions to drop the endpoint into your flow, then link:/mule-user-guide/v/3.7/testing-connections[test the connection] to SAP using the SAP Connector. 
