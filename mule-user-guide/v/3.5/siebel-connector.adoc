...
*Release Notes*: link:/docs/display/current/Siebel+Connector+Release+Notes[Siebel Connector Release Notes]
...
[NOTE]
You can add the JAR files to your Studio project while configuring the Siebel global element. Learn how to configure the link:#SiebelConnector-ge[Siebel connector global element].
...
The Siebel Object Manager lets a connector use a generic interface that doesn’t depend on a customized installation. To discover the metadata of Siebel objects in design time, use link:/docs/display/current/DataSense[DataSense] in Anypoint Studio. The Siebel connector takes advantage of the Siebel Repository to show a list of available objects as well as their structures in a Siebel custom installation.
...
image:/docs/download/attachments/125862322/Integration+architecture.png?version=1&modificationDate=1428653537056[image]
...
Contact the mailto:info@mulesoft.com[MuleSoft Sales Team] to arrange for either license. See also link:/docs/display/current/Installing+an+Enterprise+License[Installing an Enterprise License].
...
. In Studio, select **File **>** New **>** Mule Project**.image:/docs/download/attachments/125862322/PS_0001B_installing_new.png?version=1&modificationDate=1428674012123[image]

. Enter a name for your new project and leave the remaining options with their default values. +
 image:/docs/download/attachments/125862322/New+Project.png?version=1&modificationDate=1428674229509[image]
...
[NOTE]
====
If you intend to use a Siebel connector in conjunction with a link:/docs/display/current/Datamapper+User+Guide+and+Reference[DataMapper transformer] to map and transform data, you can make use of Anypoint Studio's link:/docs/display/current/DataSense[DataSense] functionality. You can enable DataSense as part of configuring the global element. 

* Follow the DataSense instructions to drop the transformer into your flow, then link:/docs/display/current/Testing+Connections[test the connection] to Siebel using the Siebel connector. 
...
+
image:/docs/download/attachments/125862322/connectorconfiguration.png?version=1&modificationDate=1428664027445[image]

. Click *OK*
. Enter the global element properties:
.. For the Oracle Siebel Business Objects connector:
+
image:/docs/download/attachments/125862322/Business+Objects+Config.png?version=1&modificationDate=1428657564163[image]
+
[cols=",",options="header",]
|===
|Field |Description
...
image:/docs/download/attachments/125862322/requireddependencies1.png?version=3&modificationDate=1428661348860[image]

After the jar files are attached, they appear in the `lib\siebel` directory of your project's root folder.

image:/docs/download/attachments/125862322/required+dependencies.png?version=3&modificationDate=1428658500801[image]
...
image:/docs/download/attachments/125862322/depedencies+error.png?version=3&modificationDate=1428658265152[image]
|===

.. For the Siebel Business Services connector:
+
image:/docs/download/attachments/125862322/businessservicesconfig.png?version=1&modificationDate=1428661307389[image]
+
...
+
image:/docs/download/attachments/125862322/integrationobjectconfig.png?version=2&modificationDate=1428662408535[image]
+
[width="100%",cols="50%,50%",options="header",]
|===
|Field |Description
...
image:/docs/download/attachments/125862322/requireddependencies1.png?version=3&modificationDate=1428661348860[image] After jar files are attached, they appear in the `lib/siebel` directory of your project's root folder.
image:/docs/download/attachments/125862322/required+dependencies.png?version=3&modificationDate=1428658500801[image] If you provide the wrong files (either an invalid jars or a completely different library), Studio displays the following error message:  image:/docs/download/attachments/125862322/depedencies+error.png?version=3&modificationDate=1428658265152[image]
|===

. Keep the **Pooling Profile **and the *Reconnection* tabs with their default entries.

. Click *Test Connection* to confirm that the parameters of your global Siebel connector are accurate, and that Mule is able to successfully connect to your instance of Siebel. Read more about link:/docs/display/current/Testing+Connections[Testing Connections].
...
+
image:/docs/download/attachments/125862322/oracl+business+objects+connector.jpg?version=1&modificationDate=1429110820173[image]
+
[cols=",",options="header",]
|===
...
|*Search Expression* | Use link:/docs/display/current/Mule+Expression+Language+MEL[Mule Expression Language (MEL)] to define a search expression that would return a list of business components. |
...
. Configure the connector's parameters according to the table below. +
image:/docs/download/attachments/125862322/oraclebusinessservices.jpg?version=1&modificationDate=1429125730363[image]
...
. Configure the connector's parameters according to the table below.
+
image:/docs/download/attachments/125862322/io22.jpg?version=1&modificationDate=1429124312698[image]
+
[cols=",",options="header",]
|===
|Field |Description |Default Value
...
[NOTE]
Refer to documentation on the link:/docs/display/current/Poll+Reference[Poll Scope] , link:/docs/display/current/Datamapper+User+Guide+and+Reference[DataMapper], and the link:/docs/display/current/Salesforce+Connector[Salesforce connector] for in-depth information about these Mule elements.
...
image:/docs/download/attachments/125862322/example+use+case.jpg?version=1&modificationDate=1429116467187[image]

. Drag a *Poll Scope* into a new flow.
+ image:/docs/download/attachments/125862322/poll2.jpg?version=2&modificationDate=1429125213624[image]
+
A link:/docs/display/current/Poll+Reference[Poll Scope] executes any Mule element you place inside it, at regular intervals. In this case, it is a Siebel endpoint.

. Configure the Poll Scope as follows
+
image:/docs/download/attachments/125862322/pollnew.jpg?version=1&modificationDate=1429123487556[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
[NOTE]
To learn how watermarks work and what each attribute is for, read about  link:/docs/display/current/Managing+Schedules[Poll Schedulers].

. Drag an *Oracle Siebel Business Objects* connector into the space provided by the Poll Scope.
+
image:/docs/download/attachments/125862322/poll.jpg?version=1&modificationDate=1429111918188[image] 
+
...
+
image:/docs/download/attachments/125862322/boconfig.jpg?version=1&modificationDate=1429122465551[image]

. On the Global Element Properties window, configure the global element according to the settings below:
image:/docs/download/attachments/125862322/config.jpg?version=1&modificationDate=1429112458575[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:/docs/download/attachments/125862322/boconfig1.jpg?version=2&modificationDate=1429123166611[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:/docs/download/attachments/125862322/logger.jpg?version=1&modificationDate=1429112595019[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
. Drag a *Salesforce Connector* after the Logger. It uploads the output of the poll into your Salesforce account. +
 image:/docs/download/attachments/125862322/salesforce.jpg?version=1&modificationDate=1429113006278[image]

. Open the Properties editor of the Salesforce connector, and click the *+* sign to add a new Salesforce global element. +
*image:/docs/download/attachments/125862322/salesforce1.jpg?version=1&modificationDate=1429121206503[image]*

. On the Choose Global Type window, click **Salesforce: Basic authentication**, and then click *Ok*.
+
image:/docs/download/attachments/125862322/sfbasicauth.jpg?version=2&modificationDate=1429173909942[image]

. Configure the Salesforce global element properties:
+
image:/docs/download/attachments/125862322/Salesconfig.jpg?version=2&modificationDate=1429123835583[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:/docs/download/attachments/125862322/salesforce2.jpg?version=1&modificationDate=1429121644239[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
image:/docs/download/attachments/125862322/datamapper.jpg?version=1&modificationDate=1429113123647[image]
...
+
image:/docs/download/attachments/125862322/Siebel+to+Salesforce.jpg?version=2&modificationDate=1429116119275[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
[NOTE]
Refer to documentation on the link:/docs/display/current/Poll+Reference[Poll Scope], link:/docs/display/current/Datamapper+User+Guide+and+Reference[DataMapper], and the link:/docs/display/current/Salesforce+Connector[Salesforce Connector] for in depth information about these elements.
...
image:/docs/download/attachments/125862322/example+use+case2.jpg?version=1&modificationDate=1429117099243[image] +

. Drag a *Poll Scope*  into a new flow:
+
image:/docs/download/attachments/125862322/poll2.jpg?version=2&modificationDate=1429125213624[image] +
+
A link:/docs/display/current/Poll+Reference[Poll Scope]  executes the Mule element placed inside it at regular intervals. In this case, it is a Salesforce connector.
...
+
image:/docs/download/attachments/125862322/poll3.jpg?version=1&modificationDate=1429117363234[image]
+
The Salesforce connector is polled at the intervals you specify in the Poll Scope

. Open the *Properties* editor of the Salesforce connector and click the *+* sign to add a new Salesforce global element.
+
*image:/docs/download/attachments/125862322/sf12.jpg?version=1&modificationDate=1429123722312[image]*
...
. Configure the Salesforce connector according to the settings below:
+
image:/docs/download/attachments/125862322/sf22.jpg?version=2&modificationDate=1429123968627[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:/docs/download/attachments/125862322/sftolog.jpg?version=1&modificationDate=1429117729577[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
image:/docs/download/attachments/125862322/logger+to+oracle.jpg?version=1&modificationDate=1429117922954[image]

. Open the *Properties* editor of the Siebel connector and click the *+* sign to add a new *Global Element*:
image:/docs/download/attachments/125862322/io21.jpg?version=1&modificationDate=1429124138391[image] +

. Configure the global element according to the settings below
+
image:/docs/download/attachments/125862322/globalprop1.jpg?version=1&modificationDate=1429118381116[image]
+
[cols=",",options="header",]
|===
|Attribute |Value
...
+
image:/docs/download/attachments/125862322/flow+IO.jpg?version=1&modificationDate=1429118861373[image]
...
|===
|Element |Description
|Poll |A  link:/docs/display/current/Poll+Reference[Poll Scope] executes the Mule element you place inside it at regular intervals. In this case, it is a Salesforce connector.
|===
+
[width="100%",cols="50%,50%",options="header",]
|===
