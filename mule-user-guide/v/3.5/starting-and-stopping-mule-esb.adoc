...
* *NEXT STEP:* Graduate to the content of the First Week with Mule chapter, starting with link:/docs/display/current/Mule+Application+Architecture[Mule Application Architecture].
