...
This document offers examples of applications which use the Database Connector. For full documentation of the connector, access the link:/docs/display/current/Database+Connector[Database Connector] documentation and link:/docs/display/current/Database+Connector+Reference[Database Connector Reference].

== Assumptions

This document presents two usage examples of the database connector. This document assumes you are familiar with the link:/docs/display/current/Database+Connector[database connector] as well as with link:/docs/display/current/DataSense[DataSense]; to understand the second example, the reader should also be familiar with the link:/docs/display/33X/DataMapper+Transformer+Reference[DataMapper transformer] and Mule link:/docs/display/current/Batch+Processing[batch processing].
