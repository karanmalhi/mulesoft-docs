...
image:/docs/download/attachments/122752041/Consume+REST+basic+anatomy.png?version=1&modificationDate=1396630800399[image]
...
image:/docs/download/attachments/122752041/REST-api-address-format.png?version=1&modificationDate=1396289032276[image]
...
+
image:/docs/download/attachments/122752041/ge.png?version=1&modificationDate=1417804955182[image] +
+
...
+
image:/docs/download/attachments/122752041/http2.png?version=1&modificationDate=1417806338478[image] +
+
...
image:/docs/download/attachments/122752041/set+property.png?version=1&modificationDate=1417807207520[image]
...
+
image:/docs/download/attachments/122752041/header1.png?version=1&modificationDate=1417813247730[image]
+
...
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/rest-prop2.png?version=1&modificationDate=1421450182312[image]
+
...
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/rest-prop3.png?version=1&modificationDate=1421450182010[image]
...
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/rest-http-3.png?version=1&modificationDate=1421450181702[image]

. Click the green plus sign next to the *Connector Configuration* field to create a global connector.
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/rest-http-4.png?version=1&modificationDate=1421450180188[image]

. Select *HTTP-HTTPS*, then click *OK.*
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/http-choose-global.png?version=1&modificationDate=1421450181401[image]

. Click the *Security* tab.
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/HTTP-clicksecurity.png?version=1&modificationDate=1421450187584[image]
...
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/http-userpass.png?version=1&modificationDate=1421450180793[image]
...
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/http-userpass-props.png?version=1&modificationDate=1421450180489[image]

. Navigate to your mule-app.properties file under src/main/app in the Package Explorer.
+
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/src-main-app-propertiesfile.png?version=1&modificationDate=1421450186357[image]
...
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/http-polling.png?version=1&modificationDate=1421450179263[image]
...
image:/https://developer.mulesoft.com/docs/download/attachments/122750892/global_polling.png?version=1&modificationDate=1421450183539[image]
...
+
image:/docs/download/attachments/122752041/follow+redirects.png?version=1&modificationDate=1417816443650[image] +
+
...
+
image:/docs/download/attachments/122752041/consume-rest-datamapper.png?version=1&modificationDate=1396282741529[image] +
