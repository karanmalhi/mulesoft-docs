...
See also link:/mule-user-guide/v/3.8-m1/mule-expression-language-reference[Mule Expression Language Reference].
...
For more information, see link:/mule-user-guide/v/3.8-m1/xpath[XPath] and
link:/mule-user-guide/v/3.8-m1/mule-expression-language-reference#xpath[MEL XPath].
