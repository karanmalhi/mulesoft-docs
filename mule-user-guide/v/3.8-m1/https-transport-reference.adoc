...
For more information on configuring HTTP endpoints, see link:/mule-user-guide/v/3.8-m1/deprecated-http-transport-reference[HTTP Transport Reference].
