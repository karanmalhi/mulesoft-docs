...
* For an overview on the recommended ways to publish and consume REST services, see link:/mule-user-guide/v/3.8-m1/publishing-and-consuming-apis-with-mule[Publishing and Consuming APIs with Mule]
