...
* link:/mule-user-guide/v/3.8-m1/routers#idempotent-message-filter[Idempotent Message Filter]
* link:/mule-user-guide/v/3.8-m1/routers#idempotent-secure-hash-message-filter[Secure Message Filter]
