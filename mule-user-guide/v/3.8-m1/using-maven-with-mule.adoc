...
* link:/mule-user-guide/v/3.8-m1/enabling-maven-support-for-a-studio-project[Enabling Maven support for an existing Studio project]
...
* link:/mule-user-guide/v/3.8-m1/maven-tools-for-mule-esb[Maven tools for Mule] is a plugin that provides archetypes for building regular Mule applications, allowing you to develop Mule applications from within Maven
* The link:/mule-user-guide/v/3.8-m1/mule-maven-plugin[Mule Maven plugin] allows you to control Mule instances from within a Maven environment
...
** link:/mule-user-guide/v/3.8-m1/importing-a-maven-project-into-studio[Importing a Maven Project into Studio]
* link:/mule-user-guide/v/3.8-m1/using-maven-in-mule-esb[Using Maven in Mule ESB]
...
* Learn more about link:/mule-user-guide/v/3.8-m1/maven-support-in-anypoint-studio[adjusting your Studio Preferences to work with Maven]. 
...
* Access the link:/mule-user-guide/v/3.8-m1/maven-reference[Maven reference documentation].
