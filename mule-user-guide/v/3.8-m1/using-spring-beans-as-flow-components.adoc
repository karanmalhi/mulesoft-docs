...
For more information on component configuration, see link:/mule-user-guide/v/3.8-m1/configuring-components[Configuring Components]. For more information on the elements you use to configure components, see link:/mule-user-guide/v/3.8-m1/component-configuration-reference[Component Configuration Reference].
