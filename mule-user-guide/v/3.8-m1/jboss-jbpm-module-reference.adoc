...
[WARNING]
This module provides a "Plug-in" for JBoss jBPM to be used with Mule's BPM support. If you have not yet read the general documentation for Mule's link:/mule-user-guide/v/3.8-m1/bpm-module-reference[BPM Support], please read that first and then come back to this page.
