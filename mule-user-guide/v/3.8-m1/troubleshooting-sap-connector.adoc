...
In this example, JCo libraries are informing that the parameter with name _type_ is not valid. The complete list of valid property names can be found link:/mule-user-guide/v/3.8-m1/sap-jco-extended-properties[here].
