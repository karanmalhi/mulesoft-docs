...
You can use JsonPath in link:/mule-user-guide/v/3.8-m1/mule-expression-language-mel[Mule expressions] to query JSON message payloads for filtering or link:/mule-user-guide/v/3.8-m1/message-enricher[enrichment].
