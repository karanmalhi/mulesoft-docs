...
For a list of notification types, see link:/mule-user-guide/v/3.8-m1/notifications-configuration-reference[Notifications Configuration Reference]. For a list of notification listener interfaces, see <<Notification Interfaces>> below.
