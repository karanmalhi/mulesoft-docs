...
The POP3 connector supports all the link:/mule-user-guide/v/3.8-m1/configuring-a-transport[common connector attributes and properties] and the following additional attributes:
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You link:/mule-user-guide/v/3.8-m1/endpoint-configuration-reference[configure the endpoints] just as you would with any other transport, with the following additional attributes:
