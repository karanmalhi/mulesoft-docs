...
The application serves these static contents from  *src/main/app/xsd* . See  link:/mule-user-guide/v/3.8-m1/http-static-resource-handler[HTTP Static Resource Handler]  for more information about this.
