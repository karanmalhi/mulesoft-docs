...
* Access the link:https://www.mulesoft.org/documentation/display/current/AMQP+Connector+Reference[AMQP Connector Reference] for a complete list and description of all AMQP connector configuration attributes.
