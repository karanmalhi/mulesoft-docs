...
For more information about using Mule with servlet containers, see link:/mule-user-guide/v/3.8-m1/embedding-mule-in-a-java-application-or-webapp[Embedding Mule in a Java Application or Webapp]. 
...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see link:/mule-user-guide/v/3.8-m1/file-transport-reference[FTP Transport Reference].
