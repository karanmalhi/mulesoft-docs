...
* Learn how to use the link:/mule-user-guide/v/3.8-m1/mule-esb-plugin-for-maven[Mule ESB plugin for Maven] to control Mule ESB instances from a Maven environment
...
* Access additional Maven link:/mule-user-guide/v/3.8-m1/maven-reference[Maven Reference] and link:/mule-user-guide/v/3.8-m1/configuring-maven-to-work-with-mule-esb[Configuring Maven to Work with Mule ESB] information.
