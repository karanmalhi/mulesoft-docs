...
* link:/mule-user-guide/v/3.8-m1/cxf-module-reference[CXF]
* link:/mule-user-guide/v/3.8-m1/streaming-data-processing-with-datamapper[DataMapper]
* link:/mule-user-guide/v/3.8-m1/file-transport-reference[File] (set the `streaming` attribute to false to access the File object directly)
* link:/mule-user-guide/v/3.8-m1/ftp-transport-reference[FTP]
* link:/mule-user-guide/v/3.8-m1/http-connector[HTTP] and link:/mule-user-guide/v/3.8-m1/http-connector[HTTPS]
* link:/mule-user-guide/v/3.8-m1/jetty-transport-reference[Jetty] and link:/mule-user-guide/v/3.8-m1/jetty-ssl-transport[Jetty SSL]
* link:/mule-user-guide/v/3.8-m1/servlet-transport-reference[Servlet]
* link:/mule-user-guide/v/3.8-m1/tcp-transport-reference[TCP]
* link:/mule-user-guide/v/3.8-m1/udp-transport-reference[UDP]
...
* link:/mule-user-guide/v/3.8-m1/domtoxml-transformer[DomToOutputHandler transformer] (if the incoming XML format is a SAXSource or XMLStreamReader)
* link:/mule-user-guide/v/3.8-m1/sxc-module-reference[SXC filter]
