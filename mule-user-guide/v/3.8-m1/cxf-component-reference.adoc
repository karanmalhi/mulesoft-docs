...
* Learn more about link:/mule-user-guide/v/3.8-m1/publishing-a-soap-api[publishing SOAP APIs] with Mule.

* Learn more about link:/mule-user-guide/v/3.8-m1/consuming-a-soap-api[consuming SOAP APIs] with Mule.
