...
This page lists the outbound endpoint transactions of the link:/mule-user-guide/v/3.8-m1/mulesoft-enterprise-java-connector-for-sap-reference[SAP Connector].
