...
[NOTE]
This page refers to deprecated logging functionality. Please see link:/mule-user-guide/v/3.8-m1/logger-component-reference[Logger Component Reference] for current logging functionality, including Studio support.
