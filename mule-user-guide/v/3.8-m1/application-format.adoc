...
You can share libraries between applications via the link:/mule-user-guide/v/3.8-m1/mule-application-deployment-descriptor[*application deployment descriptor*] attribute.
