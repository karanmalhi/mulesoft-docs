...
See the link:/mule-user-guide/v/3.8-m1/servlet-transport-reference[Servlet Transport Reference] for details on setting the properties for a Servlet endpoint using an XML editor.
