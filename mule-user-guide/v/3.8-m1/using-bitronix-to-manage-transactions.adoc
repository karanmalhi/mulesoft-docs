...
This document assumes you are familiar with working with link:/mule-user-guide/v/3.8-m1/shared-resources[Shared Resources] in Mule.
...
Bitronix integration provides a datasource connection pool for the link:/mule-user-guide/v/3.8-m1/database-connector[Database connector], which you must use whenever you want to implement resource pooling in the database connector.
...
link:/mule-user-guide/v/3.8-m1/shared-resources[define a Bitronix transaction manager as a shared resource] for multiple applications associated with a domain.
