...
These transformers support the link:/mule-user-guide/v/3.8-m1/transformers-configuration-reference[standard transformer attributes]. In addition, they support the following configuration.
