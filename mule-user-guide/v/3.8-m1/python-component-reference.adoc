...
[TIP]
Placing a Python Component is actually the same as placing a link:/mule-user-guide/v/3.8-m1/script-component-reference[Script component] and then selecting the Python engine.
