...
For configuration reference on transports, see link:/mule-user-guide/v/3.8-m1/transports-reference[Transports Reference]. For modules, see link:/mule-user-guide/v/3.8-m1/modules-reference[Modules Reference].
