...
The Jetty SSL transport works exactly the same way as the link:/mule-user-guide/v/3.8-m1/https-transport-reference[HTTPS Transport Reference].
...
If you do not need this level of security, you can use the link:/mule-user-guide/v/3.8-m1/jetty-transport-reference[Jetty Transport Reference] instead.
