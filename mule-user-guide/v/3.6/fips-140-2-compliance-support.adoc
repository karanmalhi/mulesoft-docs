...
+
image:/documentation/download/attachments/122751492/FIPS-install-jars.png?version=1&modificationDate=1400869789594[image]
+
...
+
image:/documentation/download/attachments/122751492/FIPS-register-jar.png?version=1&modificationDate=1400869962659[image]
+
. Adjust the numbering of the other security providers in the file so that they remain sequential.
+
image:/documentation/download/attachments/122751492/FIPS-register-jar-renumber.png?version=1&modificationDate=1400869989929[image]
. Save.
...
+
image:/documentation/download/attachments/122751492/FIPS-wrapper-conf-edit.png?version=1&modificationDate=1397161017133[image]
+
. Save.

When Mule next launches, the startup readout indicates that FIPS security mode is enabled.

image:/documentation/download/attachments/122751492/FIPS-startup.png?version=1&modificationDate=1397161016720[image]
...
link:/documentation/display/current/Anypoint+Enterprise+Security[Anypoint Enterprise Security] version 1.3 supports FIPS security mode. When in FIPS security mode, Mule will not register a security provider, allowing the module to rely on the platform security provider.
