...
This document assumes that you understand the difference between link:/documentation/display/current/Flows+and+Subflows[synchronous and asynchronous flows]. Furthermore, you're also familiar with link:/documentation/display/current/Scopes[Scopes] in general.
...
* Learn more about link:/documentation/display/current/Flows+and+Subflows[synchronous and asynchronous flows].
