...
+
image:/documentation/download/attachments/122752336/global_JCE_Signer_both.png?version=1&modificationDate=1368225656306[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
...
+
image:/documentation/download/attachments/122752336/signature+1.png?version=2&modificationDate=1420811420053[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
...
+
image:/documentation/download/attachments/122752336/global_XML_Signer_Both.png?version=1&modificationDate=1368228637852[image]
+
[width="100%",cols="34%,33%,33%",options="header",]
|===
|Field |Req'd |Value
...
image:/documentation/download/attachments/122752336/enable_language3.png?version=1&modificationDate=1354236532360[image]
...
image:/documentation/download/attachments/122752336/logger1.png?version=1&modificationDate=1399070964972[image]
...
Examine the link:/documentation/display/current/Anypoint+Enterprise+Security+Example+Application[Anypoint Enterprise Security Example Application] which illustrates how to verify the digital signature of a message.
