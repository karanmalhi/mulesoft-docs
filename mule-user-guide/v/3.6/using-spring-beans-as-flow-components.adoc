...
For more information on component configuration, see link:/documentation/display/current/Configuring+Components[Configuring Components]. For more information on the elements you use to configure components, see link:/documentation/display/current/Component+Configuration+Reference[Component Configuration Reference].
