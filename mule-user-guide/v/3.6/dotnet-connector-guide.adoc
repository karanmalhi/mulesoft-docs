...
This document assumes that you are familiar with Mule, the link:/documentation/display/current/Anypoint+Studio+Essentials[Anypoint Studio interface], and link:/documentation/display/current/Global+Elements[Global Elements]. Further, it is assumed that you are familiar with the Microsoft .NET Framework.
...
* Anypoint Studio, the graphical interface to Mule ESB. See link:/documentation/display/current/Download+and+Launch+Anypoint+Studio[Download and Launch Anypoint Studio] for details

[WARNING]
====
The .NET connector version 1.0 is incompatible with version 2.0. Please refer to the link:/documentation/display/current/DotNet+Connector+Migration+Guide[.NET connector migration guide] if you are an existing user of .NET connector 1.0.
====
...
|*link:/documentation/display/current/DataMapper+Concepts[DataMapper]* |The DataMapper is a Mule transformer that delivers simple, yet powerful, visual design of complex data transformations for use in Mule flows
|===
...
+
image:/documentation/download/attachments/123339388/dotnetcomponent.png?version=1&modificationDate=1421959923833[image]
...
+
image:/documentation/download/attachments/123339388/Global+Type.png?version=1&modificationDate=1422011903772[image] +

. Choose *DotNet: External Assembly* and click *OK*.

. Configure the External Assembly global type:
+
image:/documentation/download/attachments/123339388/External+Assembly.png?version=1&modificationDate=1421960553689[image]
+
[width="100%",cols=",",options="header"]
|===
|Parameter | Value
...
+
image:/documentation/download/attachments/123339388/httplistener.png?version=1&modificationDate=1421961001135[image] +

..  Configure the following HTTP parameters:
+
image:/documentation/download/attachments/123339388/httparameters.png?version=1&modificationDate=1421961086969[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/documentation/download/attachments/123339388/httpreference.png?version=1&modificationDate=1421961208445[image]
...
+
image:/documentation/download/attachments/123339388/SetPayload+1.png?version=1&modificationDate=1421954031720[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/documentation/download/attachments/123339388/jsontoexecutecomplex.png?version=1&modificationDate=1421954390863[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
+
image:/documentation/download/attachments/123339388/datamapper-mappingscreen.png?version=1&modificationDate=1421954903931[image]
...
+
image:/documentation/download/attachments/123339388/DotNet+Connectorscreen.png?version=1&modificationDate=1421954992581[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
image:/documentation/download/attachments/123339388/complete+application+flow.png?version=2&modificationDate=1423533295815[image]
....
[tab,title="XML Code"]
....
[source, xml]
...
+
image:/documentation/download/attachments/123339388/Run+application.png?version=1&modificationDate=1421955125400[image]
...
* Refer to the link:/documentation/display/current/DotNet+Connector+Release+Notes[release notes]. 
