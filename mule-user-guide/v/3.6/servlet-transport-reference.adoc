...
For more information about using Mule with servlet containers, see link:/documentation/display/current/Embedding+Mule+in+a+Java+Application+or+Webapp[Embedding Mule in a Java Application or Webapp]. 
...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see link:/documentation/display/current/HTTP+Transport+Reference[HTTP Transport Reference].
