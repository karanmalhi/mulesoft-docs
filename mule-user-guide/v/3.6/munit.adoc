...
Access MUnit's code repository on https://github.com/mulesoft/munit[github], or install the Studio plugin from the link:/mule-user-guide/v/3.6/studio-update-sites[Addons update site] within Studio.
