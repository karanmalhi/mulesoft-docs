...
The XQuery Module gives users the ability to perform XQuery transformations on XML messages in Mule. This works in a very similar way to the link:/documentation/display/current/XSLT+Transformer[XSLT Transformer] shipped with Mule.
...
== Supported XQuery Versions
 ...
 For examples on using the XQuery transformer, including the use of features and improvements in version 3.0, see link:/documentation/display/current/XQuery+Support[XQuery Support].
