...
....
image:/documentation/download/attachments/122752237/Splitter.png?version=1&modificationDate=1398902268155[image] +
...
+
image:/documentation/download/attachments/122752237/splitter_example.png?version=1&modificationDate=1398902436120[image]
+
[cols=",",options="header"]
|===
|Parameter |Value
...
+
image:/documentation/download/attachments/122752237/splitter+flow.png?version=1&modificationDate=1420204879630[image] +
+
...
+
image:/documentation/download/attachments/122752237/variables+diagramv2.png?version=1&modificationDate=1385572072566[image]
+



You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the link:/documentation/display/current/Studio+Visual+Debugger[Visual Debugger]:

image:/documentation/download/attachments/122752237/variables.png?version=1&modificationDate=1385492911997[image]
...
image:/documentation/download/attachments/122752237/diagram+ag+2.png?version=1&modificationDate=1385746695256[image]
...
[tab,title="Studio Visual Editor"]
....
image:/documentation/download/attachments/122752237/collection_agg.png?version=1&modificationDate=1398966033959[image]
...
+
image:/documentation/download/thumbnails/122752237/splitter+flow+2.png?version=1&modificationDate=1420206326819[image]
+
...
+
image:/documentation/download/attachments/122752237/splitter+flow+3.png?version=1&modificationDate=1420206396382[image]
+

. Configure the two VM connectors. Change both their *Queue Path* to `step2`.
+
image:/documentation/download/attachments/122752237/vm4.png?version=1&modificationDate=1385501021475[image] +
+
...
+
image:/documentation/download/attachments/122752237/splitter+flow+4.png?version=1&modificationDate=1420206493414[image]
+
...
+
image:/documentation/download/attachments/122752237/splitter+flow+5.png?version=1&modificationDate=1420206909354[image] +
+
...
+
image:/documentation/download/attachments/122752237/splitter+flow+6.png?version=1&modificationDate=1420207054028[image]
+
...
* Learn more about link:/documentation/display/current/Mule+Expression+Language+MEL[Mule Expression Language (MEL)].
* Learn about other link:/documentation/display/current/All+Flow+Control+Reference[Flow Control] elements.
* Read more about the link:/documentation/display/current/Async+Scope+Reference[Async Scope].
