...
The creation of custom configuration patterns can allow you to reach new levels of productivity with Mule. Follow this tutorial for link:/mule-user-guide/v/3.6/creating-catalog-archetypes[starting to create your own patterns now].
