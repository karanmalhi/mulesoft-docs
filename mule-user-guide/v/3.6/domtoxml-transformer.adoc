...
These transformers support the link:/documentation/display/current/Transformers+Configuration+Reference[standard transformer attributes]. In addition, they support the following configuration.
