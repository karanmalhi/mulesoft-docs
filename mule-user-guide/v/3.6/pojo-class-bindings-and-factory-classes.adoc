...
This document assumes the reader is familiar with the Anypoint DataMapper Transformer. Consult the link:/mule-user-guide/v/3.6/datamapper-user-guide-and-reference[DataMapper User Guide and Reference] document for details. For a listing of all available tools in DataMapper, consult link:/mule-user-guide/v/3.6/datamapper-visual-reference[DataMapper Visual Reference].
