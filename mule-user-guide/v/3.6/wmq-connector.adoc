...
image:/documentation/download/attachments/122752079/2-adv_tab.png?version=1&modificationDate=1419008026517[image]
...
image:/documentation/download/attachments/122752079/3-transformers.png?version=1&modificationDate=1419008088824[image]
...
See the link:/documentation/display/current/Mule+WMQ+Transport+Reference[Mule WMQ Transport Reference] for details on setting the properties for a WMQ endpoint using an XML editor.
