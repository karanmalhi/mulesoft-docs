...
To the Mule flow that involves an API, add a link:/documentation/display/current/CXF+Component+Reference[*CXF Component*] to publish, consume, or proxy an API. Complete the following steps to configure WS-security on the CXF component.
...
+
image:/documentation/download/attachments/122752043/CXFsecuritytab.png?version=1&modificationDate=1400523928284[image]
...
+
image:/documentation/download/attachments/122752043/Studio-wssecurity-add.png?version=1&modificationDate=1396894267418[image]
+
[NOTE]
...
+
image:/documentation/download/attachments/122752043/CXFs-addconfigprop.png?version=1&modificationDate=1400524033898[image]

. Enter information in either the *Value* field _OR_ the *Value Reference Field* according to the table below.
+
image:/documentation/download/attachments/122752043/usernametoken.png?version=1&modificationDate=1400524071149[image]
+
[cols=",",]
|===
...
+
image:/documentation/download/attachments/122752043/Studio-wssecurity-token.png?version=1&modificationDate=1396894463926[image]
+
...
image:/documentation/download/attachments/122752043/Studio-wssecurity-custom.png?version=1&modificationDate=1396894584610[image]
...
For a complete explanation of the example application, see link:/documentation/display/current/Anypoint+Exchange[the Library].
