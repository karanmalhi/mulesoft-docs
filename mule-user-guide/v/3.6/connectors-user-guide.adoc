...
image:/documentation/download/attachments/122752092/jetty+request+response.png?version=1&modificationDate=1418661391200[image]
...
image:/documentation/download/attachments/122752092/jetty+no+response.png?version=1&modificationDate=1418661404610[image]
|===
