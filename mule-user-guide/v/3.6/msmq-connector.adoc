...
image:/documentation/download/attachments/122752076/MMC_PrivateQueues.png?version=1&modificationDate=1406070961963[image]
...
image:/documentation/download/attachments/122752076/msmq_demo_properties.png?version=1&modificationDate=1406071110990[image]
...
image:/documentation/download/attachments/122752076/GlobalElementProperties.png?version=2&modificationDate=1423004985062[image]
...
The sample flows send and receive messages from an existing queue. Transformers put the necessary information on the Mule Message for subsequent operations to consume. The end result looks like this:  +
 image:/documentation/download/attachments/122752076/BuildingFlows.png?version=2&modificationDate=1423006036793[image] +
