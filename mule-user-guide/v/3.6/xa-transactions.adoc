...
[TIP]
Our default and recommended XA Transaction Manager is *Bitronix*, read link:/documentation/display/current/Using+Bitronix+to+Manage+Transactions[Using Bitronix to Manage Transactions] for details on how to implement it in Mule.
...
This property is only applicable if you are using the the default transport, `XaTransactedJmsMessageReceiver` , on JMS inbound connectors configured to use XA transactions. If you are using JBoss transactions, please read link:/documentation/display/current/JBoss+Transaction+Manager+Reference[JBoss Transaction Manager Reference] to learn how to configure the `timeout` value.
...
* Refer to link:/documentation/display/current/Using+Bitronix+to+Manage+Transactions[Using Bitronix to Manage Transactions] to see how to implement our default and recommended XA Transaction Manager +
