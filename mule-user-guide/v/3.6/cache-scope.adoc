...
+
image:/documentation/download/attachments/122752243/cache.png?version=1&modificationDate=1418679466556[image]
...
+
image:/documentation/download/attachments/122752243/cache_scope.png?version=1&modificationDate=1399486996629[image] +
+
...
|Reference to a strategy |Select to configure the cache scope to follow a link:#CacheScope-CreatingaGlobalCachingStrategy[global caching strategy] that you have created; select the global caching strategy from the drop-down menu or create one by clicking the image:/documentation/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)]. |`cachingStrategy-ref="Caching_Strategy"`
...
+
image:/documentation/download/attachments/122752243/caching_strategy_general.png?version=1&modificationDate=1399486996655[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value |Description |XML
...
+
image:/documentation/download/attachments/122752243/caching_strategy_advanced.png?version=1&modificationDate=1399486996646[image]
+
[width="100%",cols=",",options="header"]
|===
|Field| Value |Description |XML
...
By default, Mule stores all cached responses in an InMemoryObjectStore. link:#CacheScope-CreatingaCachingStrategy[Create a caching strategy] and define a new link:/documentation/display/current/Mule+Object+Stores[object store] if you want to customize the way Mule stores cached responses.
...
+
image:/documentation/download/attachments/122752243/cache+flow+2.png?version=1&modificationDate=1418679714405[image]
...
image:/documentation/download/attachments/122752243/reqA.png?version=1&modificationDate=1399486996686[image]

image:/documentation/download/attachments/122752243/reqB.png?version=1&modificationDate=1399486996694[image]

image:/documentation/download/attachments/122752243/reqC.png?version=1&modificationDate=1399486996703[image]

image:/documentation/download/attachments/122752243/reqD.png?version=1&modificationDate=1399486996712[image]
