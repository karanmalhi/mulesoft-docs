...
This document assumes that you are familiar with Mule ESB and its link:/mule-fundamentals/v/3.6/mule-concepts[basic concepts]. Consider reading the chapter, link:/mule-fundamentals/v/3.6/first-30-minutes-with-mule[First 30 Minutes with Mule] to gain familiarity before proceeding. 
...
* *NEXT STEP*: Learn the link:/mule-user-guide/v/3.6/mule-expression-language-basic-syntax[basic syntax of MEL], or dive into link:/mule-fundamentals/v/3.6/mule-application-architecture[Mule Application Architecture].
...
* Learn better by tutorial? Access the link:/mule-fundamentals/v/3.6/mule-message-tutorial[Mule Message Tutorial].
