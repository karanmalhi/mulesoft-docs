...
The AMQP connector is also available as a Studio plugin. View the https://www.mulesoft.com/library/#!/amqp-integration-connector[AMQP connector in Anypoint Exchange]. Connector installation information is available at link:/documentation/display/current/Anypoint+Connectors[Anypoint Connectors].

== See Also

* Read the link:/documentation/display/current/AMQP+Connector+Examples[AMQP Connector Examples] for practical illustrations of common use cases.

* Access the link:/documentation/display/current/AMQP+Connector+Reference[AMQP Connector Reference] for a complete list and description of all AMQP connector configuration attributes.
