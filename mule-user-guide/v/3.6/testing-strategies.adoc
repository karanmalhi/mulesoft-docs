...
Mule provides abstract parent classes to help with unit testing. Turn link:/documentation/display/current/Unit+Testing[here] for more information about them.
