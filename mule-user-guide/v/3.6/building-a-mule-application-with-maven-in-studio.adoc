...
+
image:/documentation/download/attachments/122752104/2013-11-26_16-17-43.png?version=1&modificationDate=1405025401141[image]
...
+
image:/documentation/download/attachments/122752104/NewMuleProjectwMaven.png?version=1&modificationDate=1405025401251[image]
+
[NOTE]
...
+
image:/documentation/download/attachments/122752104/set+payload+basic+flow.png?version=1&modificationDate=1420465980497[image]
...
+
image:/documentation/download/attachments/122752104/Set-payload-hello-world.png?version=1&modificationDate=1405025401267[image]
....
...
+
image:/documentation/download/attachments/122752104/Newclass.png?version=1&modificationDate=1405025401243[image]

.  *Name* your class something like *HelloWorldTestCase*, enter a *Package* name of your choice, then hit *Finish.*
+
image:/documentation/download/attachments/122752104/Maven-newjavaclass.png?version=1&modificationDate=1405025401235[image]
...
* Line number 12: This class extends FunctionalTestCase, which is Mule's implementation of an abstract JUnit test case. For more information, see link:/documentation/display/current/Functional+Testing[Functional Testing].
...
+
image:/documentation/download/attachments/122752104/openpom.png?version=1&modificationDate=1405025401259[image]
+
...
* Read more about link:/documentation/display/current/Using+Maven+with+Mule[Using Maven with Mule].

* Learn how to link:/documentation/display/current/Maven+Support+in+Anypoint+Studio[configure your Studio Preferences to work with Maven].
...
* Learn how to link:/documentation/display/current/Importing+a+Maven+Project+into+Studio[import an existing Maven project into Anypoint Studio].

* Access additional Maven link:/documentation/display/current/Maven+Reference[reference] and link:/documentation/display/current/Configuring+Maven+to+Work+with+Mule+ESB[configuration] information.
