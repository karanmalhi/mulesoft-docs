...
In this example, a database connector retrieves data from two tables. A link:/mule-user-guide/v/3.3/datamapper-transformer-reference[DataMapper transformer] maps this data to the CSV format. A link:/mule-user-guide/v/3.6/file-connector[file connector] writes the resulting CSV file to disk, and a link:/mule-user-guide/v/3.3/logger-component-reference[logger component] logs processing details to the console.
