...
To learn more about endpoints, refer to link:/documentation/display/current/Anypoint+Connectors[Anypoint Connectors].
...
image:/documentation/download/attachments/122752035/Studio-http-gen.png?version=1&modificationDate=1397959041091[image]
...
|*Enable HTTPS* |Check this box to send http://en.wikipedia.org/wiki/HTTP_Secure[HTTPS over SSL protocol]. If you enable HTTPS, ensure that you configure, then reference a link:#HTTPConnector-Deprecated-ReferencesTab[global HTTPS connector] on your endpoint.
...
image:/documentation/download/attachments/122752035/studio-http-adv.png?version=1&modificationDate=1397960449079[image]
...
image:/documentation/download/attachments/122752035/studio-http-trans.png?version=1&modificationDate=1397961222925[image]
...
image:/documentation/download/attachments/122752035/studio-http-settings.png?version=1&modificationDate=1397961560347[image]
...
See the link:/documentation/display/current/HTTP+Transport+Reference[HTTP Transport Reference] for details on setting the properties for a HTTP endpoint using an XML editor.
