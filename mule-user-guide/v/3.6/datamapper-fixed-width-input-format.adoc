...
+
image:/documentation/download/attachments/123339464/5.Field.attr.png?version=2&modificationDate=1422293088313[image]
...
+
image:/documentation/download/thumbnails/123339464/6.add_field.png?version=1&modificationDate=1422293297181[image]
...
+
image:/documentation/download/thumbnails/123339464/7.moveup.png?version=1&modificationDate=1422293592321[image]
...
. In the *Output* pane, click the *Infer Metadata* icon image:/documentation/download/attachments/123339464/infer_metadata.png?version=1&modificationDate=1422295119385[image] , then select **Re-Create Metadata From Input**.
+
image:/documentation/download/thumbnails/123339464/8.recreate_md.png?version=1&modificationDate=1422294292752[image]

DataMapper will automatically recreate the output metadata and display the new mapping, as shown below.

image:/documentation/download/attachments/123339464/9.new_mapping.png?version=1&modificationDate=1422294998821[image]
