...
In addition to the functionality described on this page, you can also use the link:/docs/display/33X/SXC+Module+Reference[SXC Module Reference], which enables efficient XPath XML routing.
...
The XML module contains various XPath filters. For general details on how to use filters, see link:/docs/display/33X/Using+Filters[Filters].
