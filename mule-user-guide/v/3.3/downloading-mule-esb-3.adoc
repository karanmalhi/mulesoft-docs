...
[NOTE]
*This information was current as of Mule 3.3, but the download and installation options have since changed. Please switch to the link:/mule-user-guide/v/3.4/downloading-and-launching-mule-esb[3.4.X] or link:/docs/display/current/Downloading+and+Installing+Mule+ESB[Current] versions of this documentation to learn how to download Mule.*
