...
Access the link:/docs/display/33X/Embedding+Mule+in+a+Java+Application+or+Webapp#[Bookstore example application] to witness Mule as an embedded as a web application inside a Servlet container.
