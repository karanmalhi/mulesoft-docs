...
* link:#ConfiguringEndpoints-BasicConfiguration[Basic Configuration]
* link:#ConfiguringEndpoints-DynamicEndpoints[Dynamic Endpoints]
* link:#ConfiguringEndpoints-MessageProcessors[Message Processors]
* link:#ConfiguringEndpoints-GlobalEndpoints[Global Endpoints]
