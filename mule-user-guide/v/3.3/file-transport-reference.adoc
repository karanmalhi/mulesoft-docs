...
You will also be able to use the following expressions inside attributes (link:#FileTransportReference-expression-filename-parser[check here for more information]):
