...
Mule provides abstract parent classes to help with unit testing. See link:/documentation/display/current/Unit+Testing[Unit Testing] for more information.
...
The FTC supports plenty of configuration options. Read more about it there: link:/documentation/display/current/Functional+Testing[Functional Testing].
