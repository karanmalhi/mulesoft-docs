...
** 5 link:#a1[global elements], 2 link:#a1[local elements], 4 link:#a2[complexTypes], 1 link:#a3[attribute group]
...
a|5 link:#a1[global elements], 2 link:#a1[local elements], 4 link:#a2[complexTypes], 1 link:#a3[attribute group]
