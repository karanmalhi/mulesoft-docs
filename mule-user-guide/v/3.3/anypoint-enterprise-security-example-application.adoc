...
. Download the link:/docs/download/attachments/87687509/anypoint-enterprise-security-example.zip?version=1&modificationDate=1380733660116[*Anypoint Enterprise Security Example Application*].
. Launch *Mule Studio*.
...
+
image:/docs/download/attachments/87687509/mule_enterprise_security_example.png?version=1&modificationDate=1350508308531[image]
...
image::/docs/download/attachments/87687509/verify_signature1.png?version=1&modificationDate=1350508330031[image,align="center"]
...
image:/docs/download/attachments/87687509/global_signature.png?version=1&modificationDate=1350508354970[image]
////
====
...
image::/docs/download/attachments/122752330/encrypt1.png?version=1&modificationDate=1399071875173[image,align="center"]
...
+
image:/docs/download/attachments/87687509/global_XML_encrypt.png?version=1&modificationDate=1350508396434[image]
...
image::/docs/download/attachments/87687509/get_cc_info_response.png?version=1&modificationDate=1350508414815[image,align="center"]
...
image::/docs/download/attachments/87687509/decrypt_XML.png?version=1&modificationDate=1350508430499[image,align="center"]
...
image:/docs/download/attachments/87687509/get_secret_file_response.png?version=1&modificationDate=1350508566183[image]

== Related Materials

* For more information on encryption in Mule, refer to link:/docs/display/33X/Mule+Message+Encryption+Processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, refer to link:/docs/display/33X/Mule+Digital+Signature+Processor[Mule Digital Signature Processor].
