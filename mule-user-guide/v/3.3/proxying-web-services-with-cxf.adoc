...
[TIP]
To send outbound requests to external web services, it's highly recommended that you use the link:/mule-user-guide/v/3.5/web-service-consumer[Web Service Consumer instead].
