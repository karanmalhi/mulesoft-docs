...
link:/mule-user-guide/v/3.3/mule-secure-token-service[Apply OAuth 2.0a to my Mule Web service provider]

link:/mule-user-guide/v/3.3/mule-secure-token-service[Apply OAuth 2.0a to my Mule Web service consumer]
