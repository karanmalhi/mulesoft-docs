...
This page provides reference information about the elements and attributes you can configure for the link:/docs/display/33X/CXF+Module+Reference[CXF Module Reference].
