...
For details on configuring WebLogic JMS in Mule, see link:/docs/display/33X/WebLogic+JMS+Integration[WebLogic JMS Integration].
...
. _Required_. Override commons-lang as described in link:/docs/display/33X/Deploying+Mule+to+WebLogic#DeployingMuletoWebLogic-Overridingcommons-lang[Overriding commons-lang]
. Configure logging as described in link:/docs/display/33X/Deploying+Mule+to+WebLogic#DeployingMuletoWebLogic-ConfiguringLogging[Configuring Logging].
