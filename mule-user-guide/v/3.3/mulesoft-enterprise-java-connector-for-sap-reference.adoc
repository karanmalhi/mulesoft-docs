...
image:/docs/download/attachments/87687635/sap-transport-image-01.png?version=1&modificationDate=1323613662791[image]
...
** link:#MuleSoftEnterpriseJavaConnectorforSAPReference-ReceivingBAPICall[Receiving BAPI calls]
