...
For a list of configuration patterns that ship with Mule, see link:/documentation/display/current/Using+Mule+Configuration+Patterns[Using Mule Configuration Patterns].
