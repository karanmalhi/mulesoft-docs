...
[NOTE]
This document assumes familiarity with the Anypoint DataMapper transformer. For details, see link:/mule-user-guide/v/3.3/datamapper-transformer-reference[DataMapper Transformer Reference].
