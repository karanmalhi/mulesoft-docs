...
If you are using the Enterprise Edition of Mule, you can use the link:/mule-management-console/v/3.3[Mule Management Console] to update a running application.
