...
If you are using the Enterprise Edition of Mule, you can use the link:/docs/display/33X/Mule+Management+Console[Mule Management Console] to update a running application.
