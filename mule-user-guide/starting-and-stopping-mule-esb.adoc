...
* *NEXT STEP:* Graduate to the content of the First Week with Mule chapter, starting with link:/mule-fundamentals/mule-application-architecture[Mule Application Architecture].
