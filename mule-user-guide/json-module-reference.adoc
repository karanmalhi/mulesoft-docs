...
You can use JsonPath in link:/mule-user-guide/mule-expression-language-mel[Mule expressions] to query JSON message payloads for filtering or link:/mule-user-guide/message-enricher[enrichment].
