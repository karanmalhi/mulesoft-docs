...
This document assumes that you have link:/mule-user-guide/installing-anypoint-enterprise-security[installed the Anypoint Enterprise Security] extensions.

It also assumes you are familiar with the link:/mule-fundamentals/anypoint-studio-essentials[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more link:/mule-fundamentals/first-day-with-mule[Anypoint Studio Tutorials].
...
+
image:anypoint-enterprise-security-example-application-1.png[image]
...
image:anypoint-enterprise-security-example-application-2.png[image]
...
image:anypoint-enterprise-security-example-application-3.png[image]
...
image:anypoint-enterprise-security-example-application-4.png[image]
...
+
image:anypoint-enterprise-security-example-application-5.png[image]
...
image:anypoint-enterprise-security-example-application-6.png[image]
...
image:anypoint-enterprise-security-example-application-7.png[image]
...
image:anypoint-enterprise-security-example-application-8.png[image]

== See Also

* For more information on encryption in Mule, refer to link:/mule-user-guide/mule-message-encryption-processor[Mule Message Encryption Processor].
* For more information on signatures in Mule, refer to link:/mule-user-guide/mule-digital-signature-processor[Mule Digital Signature Processor].
