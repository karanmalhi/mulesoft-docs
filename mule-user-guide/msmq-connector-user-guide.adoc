...
image:msmq-connector-user-guide-1.png[image]

For more information, see the link:/mule-user-guide/windows-gateway-services-guide[Windows Gateway Services Guide].
...
image:msmq-connector-user-guide-2.png[image]
...
image:msmq-connector-user-guide-3.png[image]
...
+
image:msmq-connector-user-guide-4.png[image] 
...
+
image:msmq-connector-user-guide-5.png[image] 
...
+
image:msmq-connector-user-guide-6.png[image]
...
+
image:msmq-connector-user-guide-9.png[image] 
...
+
image:msmq-connector-user-guide-10.png[image] 
