...
+
image:poll-reference-1.png[image]
...
+
image:poll-reference-2.png[image]

. Configure the Twitter Connector.
+
image:poll-reference-3.png[image]
+
...
----
 ...
 |You must create a Twitter connector as a link:/mule-fundamentals/global-elements[global element] to reference here. For your Twitter connector, you need a Twitter developer account.
|===
. Add more message processors to your flow to perform specific business logic after polling for data. The example below uses a link:/mule-user-guide/logger-component-reference[logger] component. This logger uses the link:/mule-user-guide/mule-expression-language-mel[MEL] expression `#[payload]` to log the message payload collected by the Twitter connector every 1000 milliseconds.
+
image:poll-reference-4.png[image]
...
|*config-ref* |string |You must create a Twitter connector as a link:/mule-fundamentals/global-elements[global element] to reference here. For your Twitter connector, you need a Twitter developer account. |`config-ref=` `"Twitter"`
...
|*message* |string or link:/mule-user-guide/mule-expression-language-mel[Mule expression] |The content that will be logged to console. In this case, the Mule Expression `#[payload]` will output the message payload.
...
. Run your project in Debug Mode. (Refer to the link:/mule-user-guide/studio-visual-debugger[Visual Debugger] document for greater detail.)
...
+
image:poll-reference-5.png[image]
...
+
image:poll-reference-6.png[image]
...
image:poll-reference-7.png[image]
...
image:poll-reference-8.png[image]
...
+
image:poll-reference-9.png[image]
...
+
image:poll-reference-12.png[image]
+
...
image:poll-reference-13.png[image]

== Using Watermarks with Auto-Paging

Any connector which is enabled for link:/mule-user-guide/auto-paging-in-anypoint-connectors[auto-paging] allows you to process large data sets in separate batches. This capability mitigates for memory overload, but also imposes certain conditions when used in conjunction with watermarks. The following example illustrates the recommended method for using watermarks when polling a connector that auto-pages its response.
...
. Place an *auto-paging-enabled* *connector* inside a *poll* scope as in the previous examples. +
 image:poll-reference-14.png[image]
...
+
image:poll-reference-15.png[image]
[WARNING]
...
+
image:poll-reference-16.png[image]
+
[width="100%",cols="34%,33%,33%",options="header",]
|==============
...
+
image:poll-reference-17.png[image]
...
* Learn how to configure a link:/mule-user-guide/poll-schedulers[polling schedule].
...
* Learn more about link:/mule-user-guide/logger-component-reference[Logger].
* Learn more about link:/mule-user-guide/anypoint-connectors[Anypoint Connectors] and link:/mule-user-guide/auto-paging-in-anypoint-connectors[auto-paging].
* Learn more about link:/mule-user-guide/flow-processing-strategies[flow processing strategies].
