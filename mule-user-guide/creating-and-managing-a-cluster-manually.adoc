...
This page describes manual creation and configuration of a cluster. If you want to create and manage a cluster using the Management Console's graphical interface, see link:/mule-management-console/creating-or-disbanding-a-cluster[Creating or Disbanding a Cluster].
...
* Learn about link:/mule-management-console/deploying%2c-redeploying%2c-or-undeploying-an-application-to-or-from-a-cluster[deploying] and link:/mule-management-console/monitoring-a-cluster[monitoring] clusters.
