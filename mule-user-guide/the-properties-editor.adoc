...
image:the-properties-editor-1.png[image]
...
image:the-properties-editor-2.png[image]
...
* Learn more about link:/mule-fundamentals/elements-in-a-mule-flow[Elements in a Mule Flow].
