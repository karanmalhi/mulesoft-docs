...
To use the HDFS connector in your Mule application, you must configure a global HDFS element that can be used by all the HDFS connectors in the application (read more about  link:/mule-fundamentals/global-elements[global elements] ).
...
+
image:hdfs-connector-1.png[image]
+
[cols=",",options="header"]
|===
...
+
image:hdfs-connector-2.png[image]
+
[width="100%",cols="34%,33%,33%",options="header"]
|===
...
image:hdfs-connector-3.png[image]

. Drag an HTTP connector into the canvas, then select it to open the properties editor console.
. Add a new HTTP Listener Configuration global element:
.. In *General Settings*, click the *Add* button:
+
image:hdfs-connector-4.png[image]
.. Configure the following HTTP parameters:
+
image:hdfs-connector-5.png[image]
+
[width="100%",cols="50%,50%",options="header"]
|===
a|
...
+
image:hdfs-connector-6.png[image]
...
+
image:hdfs-connector-7.jpeg[image]
+
[cols=",",options="header"]
|===
|Field |Value
...
+
image:hdfs-connector-8.png[image]
+
[cols=",",options="header"]
|===
|Field |Value
...
+
image:hdfs-connector-9.jpeg[image]
+
[cols=",",options="header"]
|====
|Field |Value
...
image:hdfs-connector-10.png[image]
...
image:hdfs-connector-11.png[image]

. Drag an HTTP connector into the canvas, then select it to open the properties editor console.
. Add a new HTTP Listener Configuration global element:
.. In *General Settings*, click the *Add* button:
+
image:hdfs-connector-12.png[image]
.. Configure the following HTTP parameters:
+
image:hdfs-connector-13.png[image]
+
[width="100%",cols="50%,50%",options="header"]
|===
a|
...
.  Reference the HTTP Listener Configuration global element:
+
image:hdfs-connector-14.png[image]  +
...
+
image:hdfs-connector-15.jpeg[image]
+
[cols=",",options="header"]
|====
|Field |Value
...
+
image:hdfs-connector-16.png[image]
+
[cols=",",options="header"]
|===
|Field |Value
...
. Back in the properties editor of the HDFS connector in your application, configure the remaining parameters according to the table below.
+
image:hdfs-connector-17.jpeg[image]
+
[cols=",",options="header"]
|====
|Field |Value
...
image:hdfs-connector-18.png[image]
