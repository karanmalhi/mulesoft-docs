...
This document, as well as the rest of the documents that make up the link:/mule-management-console/rest-api-reference[Mule Management Console REST API Reference Guide], are a technical reference only. This document does not provide contextual information such as instructions, use cases or scenarios. To understand this document, you should be familiar with link:/mule-user-guide/[MULE ESB], Clusters and the link:/mule-management-console/using-the-management-console-api[REST API].
...
For a detailed description of the format used in this document, consult link:/documentation/display/current/REST+API+Reference#RESTAPIReference-ContentOrganizationandConventions[Content Organization and Conventions].
