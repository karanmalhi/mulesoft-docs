...
+
image:adding-and-removing-user-libraries-1.png[image]

. In the *Add Library* wizard, click to select the user library you wish to add, then click *Next*.
+
image:adding-and-removing-user-libraries-2.png[image]
...
+
image:adding-and-removing-user-libraries-3.png[image]

. In the *Properties* panel, select *Java Build Path* in the left navigation bar, then click the *Libraries* tab.
+
image:adding-and-removing-user-libraries-4.png[image]
