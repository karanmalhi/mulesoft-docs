...
image:servlet-connector-1.png[image]
...
image:servlet-connector-2.png[image]
...
image:servlet-connector-3.png[image]
...
See the link:/mule-user-guide/servlet-transport-reference[Servlet Transport Reference] for details on setting the properties for a Servlet endpoint using an XML editor.
