...
In addition to the functionality described on this page, you can also use the link:/mule-user-guide/sxc-module-reference[SXC Module Reference], which enables efficient XPath XML routing.
...
* `xpath2()` function, superseded by the link:/mule-user-guide/xpath[xpath3()] function
* JXPath extractor
* JXPath filter
* Jaxen filter

New function: link:/mule-user-guide/xpath[xpath3()], which includes improved return type handling. For details, see link:/mule-user-guide/xpath[XPath].
...
The link:/mule-user-guide/xslt-transformer[XSLT Transformer] now supports XSLT 3.0. The transformer's behavior and syntax remain unaltered, and you can manually select which XSLT version your transformer should use. For details, see the link:/mule-user-guide/xslt-transformer[XSLT Transformer] documentation.
...
The link:/mule-user-guide/xquery-transformer[XQuery Transformer] now supports XQuery 3.0. The transformer's behavior and syntax remain unaltered, and you can manually select which XQuery version your transformer should use. For details, see link:/mule-user-guide/xquery-transformer[XQuery Transformer] and link:/mule-user-guide/xquery-support[XQuery Support].
...
|link:/mule-user-guide/jxpath-extractor-transformer[JXPath Extractor] _*Deprecated*_ |Queries and extracts object graphs using XPath expressions using JXPath. Deprecated in favor of the `xpath3()` function (see link:/mule-user-guide/xpath[XPath]).
...
The XML module contains various XPath filters. For general details on how to use filters, see link:/mule-user-guide/filters[Filters].

=== XPath Filter

[NOTE]
Mule 3.6.0 and later versions support XPath 3.0, which is backwards-compatible with XPath 2.0. On the other hand, XPath 1.0 is deprecated, and while simple expressions may work, some expressions may be incompatible. For details, see link:/mule-user-guide/xpath[XPath].
...
For a detailed description of the `xpath3` function, see link:/mule-user-guide/xpath[XPath].
====
