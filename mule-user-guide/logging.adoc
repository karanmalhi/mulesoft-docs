...
[NOTE]
This page refers to deprecated logging functionality. Please see link:/mule-user-guide/logger-component-reference[Logger Component Reference] for current logging functionality, including Studio support.
...
For more on how to use the Logger component in Studio, see link:/mule-user-guide/logger-component-reference[Logger Component Reference]

You can configure what gets logged, where it gets logged, and how by editing a configuration file that sits in your project. For a description of what you can do through this and instructions on how to set it up, see link:/mule-user-guide/logging-in-mule[Logging in Mule].
