...
This document assumes that your are familiar with link:/mule-fundamentals/anypoint-studio-essentials[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about link:/mule-user-guide/poll-reference[poll scopes] in Mule.
...
image:poll-schedulers-1.png[image]
...
image:poll-schedulers-2.png[image]
...
* Learn more about link:/mule-user-guide/poll-reference[Poll Scopes] in Mule.
* Reference link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language MEL].
* Learn more about link:/mule-user-guide/mule-expression-language-date-and-time-functions[MEL Date and Time Functions].
