...
* Perceptive Flow Design only functions with Anypoint connectors which support link:/mule-user-guide/testing-connections[connection testing]. See link:/mule-user-guide/datasense-enabled-connectors[the list].
...
+
image:using-perceptive-flow-design-1.png[image]
+

. Configure the Salesforce connector, and its corresponding global connector, then test the connection to confirm communication. Refer to link:/mule-user-guide/testing-connections[Testing Connections] for details.
. Once you have confirmed successful connection to Salesforce, insert a *DataMapper* before the connector on your canvas. +

+
image:using-perceptive-flow-design-2.png[image]
+
...
+
image:using-perceptive-flow-design-3.png[image] +
+
...
+
image:using-perceptive-flow-design-4.png[image] +
+

* In the Studio canvas, right-click the connector, then select *Clear DataSense Metadata*. +

+
image:using-perceptive-flow-design-5.png[image]
+
...
* Learn more about Anypoint DataMapper through the link:/mule-user-guide/datamapper-user-guide-and-reference[Datamapper User Guide and Reference]. Specifically on the subject of metadata, see link:/mule-user-guide/defining-datamapper-input-and-output-metadata[Defining DataMapper Input and Output Metadata].
* link:/mule-fundamentals/deploying-mule-applications[Deploy] your application to Mule CloudHub.
