...
image:batch-streaming-and-job-execution-1.png[image]
...
image:batch-streaming-and-job-execution-2.png[image]
...
+
image:batch-streaming-and-job-execution-3.png[image]

. In the Configuration Properties Editor, click the checkbox to enable *Streaming*. +

+
image:batch-streaming-and-job-execution-4.png[image]
...
a|
image:batch-streaming-and-job-execution-5.png[image]
...
image:batch-streaming-and-job-execution-6.png[image]
...
....
image:batch-streaming-and-job-execution-7.png[image]
....
...
* Access the link:/mule-user-guide/batch-processing[full documentation for Batch Processing] for the latest general availability release of Mule.
