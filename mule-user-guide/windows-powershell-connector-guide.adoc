...
This guide draws on information from the link:/mule-user-guide/windows-gateway-services-guide[Windows Gateway Services Guide] and assumes you are using Windows and Anypoint Studio. You can download the Windows version of Studio from the http://www.mulesoft.com/platform/mule-studio[Anypoint Studio site].
...
+
image:windows-powershell-connector-guide-1.png[image]
...
+
image:windows-powershell-connector-guide-2.png[image]
...
Yes, the PowerShell connector passes the script contents to the link:/mule-user-guide/windows-gateway-services-guide[Windows Gateway Service] for execution so can be run on any platform.
...
* link:/mule-user-guide/windows-gateway-services-guide[Windows Gateway Service]  
*  link:/mule-user-guide/msmq-connector-user-guide[MSMQ Connector]
