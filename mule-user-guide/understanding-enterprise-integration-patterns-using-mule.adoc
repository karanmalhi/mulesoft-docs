...
|File Transfer |link:/mule-user-guide/file-transport-reference[File Transport]
|Shared Database |link:/mule-user-guide/jdbc-transport-reference[JDBC Transport]
...
|Message Router |link:/mule-user-guide/routers[Message Routers]
|Message Translator |link:/mule-user-guide/using-transformers[Message Transformer]
|Message Endpoint |Inbound & Outbound link:/mule-user-guide/endpoint-configuration-reference[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content Enricher |link:/mule-user-guide/message-enricher[Message Enricher]
|===
...
* link:/mule-user-guide/using-mule-configuration-patterns[Configuring Mule with Patterns]
