...
This page covers more complex configuration of the CXF Component than those described in the basic discussions of link:/mule-user-guide/publishing-a-soap-api[publishing a SOAP API] and link:/mule-user-guide/consuming-a-soap-api[consuming a SOAP API]. You may also wish to refer to full link:/mule-user-guide/cxf-component-reference[CXF Component Reference] documentation.
...
image:extra-cxf-component-configurations-1.png[(plus)] icon to open the *Global Element Properties* panel.
+
image:extra-cxf-component-configurations-2.png[image]

. Configure the global CXF configuration attributes according to the table below.
+
image:extra-cxf-component-configurations-3.png[image]
+
[cols=",,",options=]
|===
...
+
image:extra-cxf-component-configurations-4.png[image]
...
. Click on the image:extra-cxf-component-configurations-5.png[Interceptor Providers]* CXF uses to add interceptors to interceptor chains; click one of the choices to add an interceptor provider.
+
* `Add in Interceptor`
...
+
image:extra-cxf-component-configurations-7.png[image]
...
+
image:extra-cxf-component-configurations-8.png[image]
...
|*Schema Locations* |Click the image:extra-cxf-component-configurations-9.png[schemaLocation] for additional details.
|===
...
* Access full link:/mule-user-guide/cxf-component-reference[CXF Component Reference] documentation.
* Learn the basics of link:/mule-user-guide/publishing-a-soap-api[publishing a SOAP API].
* Learn the basics of link:/mule-user-guide/consuming-a-soap-api[consuming a SOAP API].
