...
See link:/mule-user-guide/hardware-and-software-requirements[Hardware and Software Requirements] for information about hardware, operating systems, JDEs, and other software required to run Mule ESB, Mule Management Console, or Anypoint Studio.
...
* Already an Eclipse user? Find out about installing link:/mule-user-guide/studio-in-eclipse[Studio as an Eclipse plug-in].
