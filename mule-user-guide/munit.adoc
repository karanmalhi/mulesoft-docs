...
Access MUnit's code repository on https://github.com/mulesoft/munit[github], or install the Studio plugin from the link:/mule-user-guide/studio-update-sites[Addons update site] within Studio.
