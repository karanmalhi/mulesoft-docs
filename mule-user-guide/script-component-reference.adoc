...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a link:/mule-user-guide/java-component-reference[Java Component] that works very similarly.

image:script-component-reference-3.png[image]
...
image:script-component-reference-4.png[image]
...
* For more information see the Mule ESB page link:/mule-user-guide/scripting-module-reference[Scripting Module]
* Read more about the link:/mule-user-guide/javascript-component-reference[JavaScript Component]
* Read more about the link:/mule-user-guide/ruby-component-reference[Ruby Component]
* Read more about the link:/mule-user-guide/groovy-component-reference[Groovy Component]
* Read more about the link:/mule-user-guide/python-component-reference[Python Component]
* Read more about the link:/mule-user-guide/java-component-reference[Java Component]
