...
When the link:/mule-user-guide/http-listener-connector[HTTP Connector works as a listener], you can configure a status code and a status reason on the connector itself, separately for both success and failure scenarios. To generate a response from an HTTP template, use the *link:/mule-user-guide/parse-template-reference[Parse Template]* element.
...
image:http-response-builder-1.png[image]
...
image:http-response-builder-2.png[image]
...
* Read about the link:/mule-user-guide/http-connector[HTTP Connector]
