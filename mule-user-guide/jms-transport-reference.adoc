...
] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jms/namespace-overview.html[SchemaDoc] |image:jms-transport-reference-1.png[image] |one-way, request-response |one-way |org.mule.transport:mule-transport-jms
...
* Supports local (JMS), distributed (XA), and multi-resource link:/mule-user-guide/transaction-management[transactions]  _*Enterprise*_
...
*WebSphere MQ*
 ...
 _*Enterprise*_
Mule Enterprise includes an link:/mule-user-guide/mule-wmq-transport-reference[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
...
http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has link:/mule-user-guide/activemq-integration[simplified configuration].
...
* link:/mule-user-guide/hornetq-integration[HornetQ]
* link:/mule-user-guide/open-mq-integration[Open MQ]
* link:/mule-user-guide/solace-jms[Solace JMS]
* link:/mule-user-guide/tibco-ems-integration[Tibco EMS]
