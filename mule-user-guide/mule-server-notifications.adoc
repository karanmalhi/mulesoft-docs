...
For a list of notification types, see link:/mule-user-guide/notifications-configuration-reference[Notifications Configuration Reference]. For a list of notification listener interfaces, see link:#MuleServerNotifications-interfaces[Notification Interfaces] below.
