...
* Adding properties in the configuration files of applications that use shared resources can result in issues, as these properties will be shared with other apps in the domain and there may be conflicts. You can instead link:/mule-user-guide/setting-environment-variables[set environment variables].
...
+
image:shared-resources-1.png[image] +
+

 +
. Fill in the same fields as you would with a regular Mule Project: 
+
image:shared-resources-2.png[image] +
+
...
image:shared-resources-3.png[image]
...
image:shared-resources-4.png[image]
...
image:shared-resources-5.png[image]
...
image:shared-resources-6.png[image]
...
image:shared-resources-7.png[image]
...
image:shared-resources-8.png[image]
...
+
image:shared-resources-9.png[image]
+
[NOTE]
====
...
image:shared-resources-10.png[image]
...
* Note that although shared resources is limited to the selected connectors and libraries covered in this document, there are ways to share other configuration fragments in Mule. Refer to link:/mule-user-guide/sharing-custom-configuration-fragments[Sharing Custom Configuration Fragments] for details.

== See Also

Access reference documentation for:

* ** link:/mule-user-guide/vm-transport-reference[VM]
** link:/mule-user-guide/database-connector[DB]
** link:/mule-user-guide/jms-transport-reference[JMS]
**  link:/mule-user-guide/http-connector[HTTP Connector]
** link:/mule-user-guide/mule-wmq-transport-reference[WMQ]
** link:/mule-user-guide/jboss-transaction-manager-reference[JBoss]
** link:/mule-user-guide/setting-environment-variables[Set Environment Variables]
