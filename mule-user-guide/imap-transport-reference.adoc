...
|IMAP
a|* http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc]
* http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_imap/namespace-overview.html[SchemaDoc] |image:imap-transport-reference-1.png[image] |one-way |one-way |org.mule.transport:mule-transport-imap

|IMAPS
a|* http://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc]
* http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_imaps/namespace-overview.html[SchemaDoc] |image:imap-transport-reference-1.png[image] |one-way |one-way |org.mule.transport:mule-transport-imaps
|===
...
The IMAP connector supports all the link:/documentation/display/current/Configuring+a+Transport#ConfiguringaTransport-commonConfig[common connector attributes and properties] and the following additional attributes:
...
IMAP and IMAPS endpoints include details about connecting to an IMAP mailbox. You link:/mule-user-guide/endpoint-configuration-reference[configure the endpoints] just as you would with any other transport, with the following additional attributes:
