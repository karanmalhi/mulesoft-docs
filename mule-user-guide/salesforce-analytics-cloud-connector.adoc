...
+
image:salesforce-analytics-cloud-connector-1.png[image]

. Enter a name for your new project and leave the remaining options with their default values.
+
image:salesforce-analytics-cloud-connector-2.jpeg[image]
...
To use the Salesforce Analytics Cloud connector in your Mule application, you must configure a global Salesforce Analytics Cloud element that can be used by all the Salesforce Analytics Cloud connectors in the application (read more aboutlink:/mule-fundamentals/global-elements[global elements]).
...
+
image:salesforce-analytics-cloud-connector-3.jpeg[image]
...
+
image:salesforce-analytics-cloud-connector-4.jpeg[image]
+
[NOTE]
====
In the imagesalesforce-analytics-cloud-connector-5.png[Deploying to Multiple Environments] for instructions on how to manage this.
====
+
[width="100%",cols=",",options="header"]
|===
...
+
image:salesforce-analytics-cloud-connector-5.jpeg[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Description
...
+
image:salesforce-analytics-cloud-connector-6.jpeg[image]
+
[width="100%,cols=",",options="header"]
|=======
|Field |Description
...
. Click *Test Connection* to confirm that the parameters of your global Salesforce Analytics Cloud connector are accurate, and that Mule is able to successfully connect to your instance of Salesforce Analytics Cloud system. Read more about link:/mule-user-guide/testing-connections[Testing Connections].
...
+
image:salesforce-analytics-cloud-connector-7.jpeg[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Description
...
[NOTE]
====
Refer to documentation on link:/mule-user-guide/poll-reference[B]link:/mule-user-guide/batch-processing[atch Processor] and link:/mule-user-guide/datamapper-user-guide-and-reference[Data Mapper]for in-depth information about these Mule elements.
====
...
[tab,title="Studio Visual Editor"]
....
image:salesforce-analytics-cloud-connector-8.jpeg[image]

. Create a Mule project in your Anypoint Studio.

. Drag a Batch processor into the canvas:
+
image:salesforce-analytics-cloud-connector-9.jpeg[image]

. Into the Input section of the Batch processor, drag a File connector and configure it as follows:
+
image:salesforce-analytics-cloud-connector-10.jpeg[image]
+
[width="100%",cols=",",options="header"]
|====
|Field |Value
...
+
image:salesforce-analytics-cloud-connector-14.jpeg[image]
+
[cols=",",options="header",]
|===
|Field |Value
...
+
image:salesforce-analytics-cloud-connector-15.jpeg[image]
+
[cols=",",options="header",]
|=====
|Field |Value
...
+
image:salesforce-analytics-cloud-connector-16.jpeg[image]

. In the *Source* field, select **Payload - InputStream** and click the
image:salesforce-analytics-cloud-connector-17.png[image](Edit) button located to the right of the *Type* drop down list.

. In the *Type* field select *CSV*
+
image:salesforce-analytics-cloud-connector-17.jpeg[image]

. Browse to the folder where you have the input csv file.

. Click *Create Mapping*.
+
image:salesforce-analytics-cloud-connector-18.jpeg[image]
...
+
image:salesforce-analytics-cloud-connector-19.jpeg[image]
...
+
image:salesforce-analytics-cloud-connector-20.jpeg[image]
+
[width="100%",cols=",",options="header"]
|===
|Field |Value
...
* Learn abut link:/mule-user-guide/batch-processing[Batch Processing]. 
