...
+
image:datamapper-visual-reference-1.jpeg[image]
...
image:datamapper-visual-reference-2.jpeg[image] or the drop-down menu to the right of the *Type* input field. DataMapper displays a mapping configuration view according to the input type you selected. The image below displays the configuration view for input type `CSV`.

image:datamapper-visual-reference-3.png[image]

Using this window, you define the input and output mapping properties, including data types and fields (for details, see link:/mule-user-guide/defining-datamapper-input-and-output-metadata[Defining DataMapper Input and Output Metadata]).
...
+
image:datamapper-visual-reference-4.png[image]
...
For details on creating your mapping, see link:/mule-user-guide/defining-datamapper-input-and-output-metadata[Defining DataMapper Input and Output Metadata].

image:datamapper-visual-reference-5.png[image]
...
|4 |Input type input field. Click the edit icon image:datamapper-visual-reference-6.jpeg[image] or the drop-down menu to the right of the input field to select the input type. This will cause the input pane to change allowing you to select between the available types for input data.
...
* image:datamapper-visual-reference-7.png[below])

* image:datamapper-visual-reference-8.png[image]  Save the DataMapper properties

* image:datamapper-visual-reference-9.png[image]  Obtain help
...
For details on defining your mapping, see link:/mule-user-guide/defining-datamapper-input-and-output-metadata[Defining DataMapper Input and Output Metadata].

image:datamapper-visual-reference-10.jpeg[image]

[width="100%",cols=",",options="header"]
|===
|Number |Description
|1 |*Infer Metadata* tool for input metadata. Click to reload or recreate your mapping's input metadata without having to reconfigure your mapping flow from scratch. See link:/mule-user-guide/defining-datamapper-input-and-output-metadata[Defining DataMapper Input and Output Metadata] for details.
|2 a|
...
image:datamapper-visual-reference-11.png[image]

|5 a|
*Show/Hide Unrelated Elements* tool. Default position is open, showing the hide icon image:datamapper-visual-reference-12.png[image].
...
image:datamapper-visual-reference-13.png[image]
...
For more information on structured mapping, see link:/mule-user-guide/datamapper-flat-to-structured-and-structured-to-flat-mapping[Example: Flat-to-Structured and Structured-to-Flat Mapping].
...
|11 |*Infer Metadata* tool for output metadata. Click to reload or recreate your mapping's output metadata without having to reconfigure your mapping flow from scratch. See link:/mule-user-guide/defining-datamapper-input-and-output-metadata[Defining Input and Output Metadata]  for details.
...
|16 a|
*Show/Hide Unrelated Elements* tool. Default position is open, showing the hide icon image:datamapper-visual-reference-14.png[image].
...
image:datamapper-visual-reference-15.png[image]
...
DataMapper's preview feature allows you to test your mapping using a specific input file and preview the results. For details, see link:/mule-user-guide/previewing-datamapper-results-on-sample-data[Previewing DataMapper Results on Sample Data].

image:datamapper-visual-reference-16.png[image]

[width="100%",cols=",",options="header"]
|===
|Number |Description
|1 |*Input Data* input field. Use to select the path of the file to read data from. Alternatively, click the folder image:datamapper-visual-reference-17.png[image]button to the right of the field to select the file using your system's file browser.

|2 a|
*Text* / *Graphic View* selector. Click to switch between graphic view (default, below left) and text view (below right).

image:datamapper-visual-reference-18.png[image] +
...
|5 |*Input Arguments* button. Click to enter input arguments for your preview (for details, see "Using Data Mapping Input and Output Arguments" in link:/mule-user-guide/building-a-mapping-flow-in-the-graphical-mapping-editor[Building a Mapping Flow in the Graphical Mapping Editor]).
...
The image:datamapper-visual-reference-19.png[image] buttons to the right of the graphical mapping editor allow you to toggle between the mapping view and the DataMapper configuration view. The configuration view allows you to quickly configure global parameters for your specific DataMapper transformer.

image:datamapper-visual-reference-20.png[image]
...
|4 |Input source input field. Here you can use link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language] to select an input source other than the message payload, such as message inbound properties, ID, etc.).
...
|7 |Streaming checkbox. Click to enable streaming on this DataMapper. For details on streaming, see link:/mule-user-guide/streaming-data-processing-with-datamapper[Streaming Data Processing with DataMapper].
...
|9 |Input arguments field generator/editor. Use to add input arguments to the mapping. For details, see "Using Data Mapping Input and Output Arguments" in link:/mule-user-guide/building-a-mapping-flow-in-the-graphical-mapping-editor[Building a Mapping Flow in the Graphical Mapping Editor].
|===============
