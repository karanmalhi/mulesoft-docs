...
. Go to the link:/mule-user-guide/anypoint-connectors[Anypoint Connectors] page.
...
For more information on the HTTP operation-based connector, see link:/mule-user-guide/http-connector[HTTP Connector].
====

== Assumptions

This document assumes that you are familiar with Mule and the link:/mule-fundamentals/anypoint-studio-essentials[Anypoint Studio interface]. To increase your familiarity with Studio, consider completing one or more link:/mule-fundamentals/basic-studio-tutorial[Anypoint Studio Tutorials]. Further, this example assumes that you have a basic understanding of link:/mule-fundamentals/mule-concepts[Mule flows], link:/mule-fundamentals/global-elements[Global Elements], and link:/mule-user-guide/anypoint-connectors[Anypoint Connectors].
...
....
image:connector-configuration-reference-1.png[image]
....
...
[tab,title="Studio Visual Editor"]
....
image:connector-configuration-reference-2.png[image]
...
[tab,title="Studio Visual Editor"]
....
 image:connector-configuration-reference-3.png[image]
....
...
|*Transaction* |Lets you select the element to use for a transaction. Use the image:connector-configuration-reference-4.png[(plus)] button to add Mule transactions.
...
Selected global connector configurations can also be defined as *shared resources* for a domain, then referenced by all applications that reference that same domain. For more information, see link:/mule-user-guide/shared-resources[Shared Resources].
...
* Return to the link:/mule-user-guide/anypoint-connectors[Anypoint Connectors] main page.
