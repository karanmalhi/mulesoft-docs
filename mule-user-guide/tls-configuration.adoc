...
* See how to configure the link:/mule-user-guide/http-connector[HTTP Connector]
* See how link:/mule-user-guide/authentication-in-http-requests[authentication] works in the HTTP Connector
* Refer to the link:/mule-user-guide/https-transport-reference[deprecated HTTPS Transport]
