...
....
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of link:/mule-fundamentals/elements-in-a-mule-flow[building blocks] that form the flow (below). 

image:choice-flow-control-reference-2.png[image]
....
...
+
image:choice-flow-control-reference-3.png[image]
...
+
image:choice-flow-control-reference-4.png[image]

. In the Route Properties dialog, enter: `#[flowVars.language == 'Spanish']`
+
image:choice-flow-control-reference-5.png[image]
...
+
image:choice-flow-control-reference-6.png[image]
...
+
image:choice-flow-control-reference-7.png[image]
...
+
image:choice-flow-control-reference-8.png[image]
...
+
image:choice-flow-control-reference-9.png[image] 
...
+
image:choice-flow-control-reference-10.png[image]

. Check the *Otherwise* box (see below), then click *OK*.
+
image:choice-flow-control-reference-11.png[image]
...
+
image:choice-flow-control-reference-12.png[image]
...
image:choice-flow-control-reference-13.png[image]

== See Also

* For more information on the Choice Flow Control, see the link:/mule-user-guide/routers[Choice] section on the Routing Message Processors page.
