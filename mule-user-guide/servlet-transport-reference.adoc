...
For more information about using Mule with servlet containers, see link:/mule-user-guide/embedding-mule-in-a-java-application-or-webapp[Embedding Mule in a Java Application or Webapp]. 
...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see link:/mule-user-guide/http-transport-reference[HTTP Transport Reference].
