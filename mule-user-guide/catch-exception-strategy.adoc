...
....
image:catch-exception-strategy-1.png[image]
....
...
+
image:catch-exception-strategy-4.png[image]
+
[NOTE]
====
...
|*when* |A MEL expression to indicate the kind of exception the catch exception strategy handles when it is embedded within a link:/mule-user-guide/choice-exception-strategy[*Choice Exception Strategy*]. +
...
You can create one or more link:/documentation/display/current/Error+Handling#ErrorHandling-GlobalExceptionStrategies[global exception strategies] to reuse in flows throughout your entire Mule application. First, create a global catch exception strategy, then add a link:/mule-user-guide/reference-exception-strategy[*Reference Exception Strategy*] to a flow to apply the error handling behavior of your new global catch exception strategy.
...
+
image:catch-exception-strategy-5.png[image]
+
[width="100%",cols="50%,50%",options="header",]
|===
|Field |Value
|*Display Name* |Unique name for the exception strategy, if you wish.
|*Execute When* a|A MEL expression to indicate the kind of exception the catch exception strategy handles when it is embedded within a link:/mule-user-guide/choice-exception-strategy[*Choice Exception Strategy*]. +
...
+
image:catch-exception-strategy-6.png[image]
...
Use a link:/mule-user-guide/reference-exception-strategy[reference exception strategy] to instruct a flow to employ the error handling behavior defined by your global catch exception strategy. In other words, you must ask your flow to refer to the global catch exception strategy for instructions on how to handle errors.
...
+
image:catch-exception-strategy-7.png[image]
...
+
image:catch-exception-strategy-8.png[image]
+
[TIP]
====
