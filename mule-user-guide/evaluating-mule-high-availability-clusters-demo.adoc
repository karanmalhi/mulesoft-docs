...
image:evaluating-mule-high-availability-clusters-demo-1.png[image]
...
link:/mule-user-guide/mule-high-availability-ha-clusters[Learn More...]
...
+
image:evaluating-mule-high-availability-clusters-demo-2.png[image]

== Get Started!

link:/mule-user-guide/1-installing-the-demo-bundle[1 - Installing the Demo Bundle]

link:/mule-user-guide/2-creating-a-cluster[2 - Creating a Cluster]

link:/mule-user-guide/3-deploying-an-application[3 - Deploying an Application]

link:/mule-user-guide/4-applying-load-to-the-cluster[4 - Applying Load to the Cluster]

link:/mule-user-guide/5-witnessing-failover[5 - Witnessing Failover]

link:/mule-user-guide/6-troubleshooting-and-next-steps[6 - Troubleshooting and Next Steps]
