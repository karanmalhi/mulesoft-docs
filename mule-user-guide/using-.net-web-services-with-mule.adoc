...
For more information see link:/mule-user-guide/configuring-security[Configuring Security].
...
If you are using CXF, you can configure a client and service to use WS-Security. For details, see link:/mule-user-guide/enabling-ws-security[Enabling WS-Security].
