...
[TIP]
====
Placing a Ruby Component is actually the same as placing a link:/mule-user-guide/script-component-reference[Script component] and then selecting the Ruby engine.
====
...
image:ruby-component-reference-1.png[image]
...
image:ruby-component-reference-2.png[image]
