...
image:expression-transformer-reference-1.png[image]
...
The default value in the *Expression* field is **`#[]`**. You need to type a valid expression within the square brackets. For syntax details see the link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language MEL] documentation.
...
image:expression-transformer-reference-2.png[image]
