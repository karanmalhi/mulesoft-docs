...
To learn more about endpoints, refer to link:/mule-user-guide/anypoint-connectors[Anypoint Connectors].
...
image:http-connector-deprecated-1.png[image]
...
image:http-connector-deprecated-2.png[image]
...
|*Enable default events tracking* |Enable default link:/mule-user-guide/business-events[business event] tracking for this endpoint.
|===
...
image:http-connector-deprecated-3.png[image]
...
image:http-connector-deprecated-4.png[image]
...
See the link:/mule-user-guide/http-transport-reference[HTTP Transport Reference] for details on setting the properties for a HTTP endpoint using an XML editor.
