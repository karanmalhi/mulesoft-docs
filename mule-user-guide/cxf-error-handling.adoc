...
The sections below describe how to use Mule's link:/documentation/display/current/Error+Handling#ErrorHandling-DefaultExceptionStrategy[*Default Exception Strategy*], a link:/mule-user-guide/rollback-exception-strategy[*Rollback Exception Strategy*] or a link:/mule-user-guide/catch-exception-strategy[*Catch Exception Strategy*] to handle errors in a flow with a CXF Web service.
...
Refer to link:/mule-user-guide/rollback-exception-strategy[Rollback Exception Strategy] for detailed instructions on how to apply one to a flow.
...
image:cxf-error-handling-1.png[image]
...
Refer to link:/mule-user-guide/catch-exception-strategy[Catch Exception Strategy] for detailed instructions on how to apply one to a flow.
...
image:cxf-error-handling-2.png[image]
...
image:cxf-error-handling-3.png[image]
