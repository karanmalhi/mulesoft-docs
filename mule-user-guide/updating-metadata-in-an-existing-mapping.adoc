...
image:updating-metadata-in-an-existing-mapping-1.png[image]
...
image:updating-metadata-in-an-existing-mapping-2.png[image]
...
image:updating-metadata-in-an-existing-mapping-3.png[image]
...
2.     In the Input pane of the DataMapper view, click the  *Infer Metadata* icon, then select  *Reload Metadata*. +
 image:updating-metadata-in-an-existing-mapping-4.png[image]

The Input pane in the DataMapper will now display the  `Phone` field, as shown below.

image:updating-metadata-in-an-existing-mapping-5.png[image]
...
2.     In the Output pane in the DataMapper view, click the  *Infer Metadata* icon, then select *Recreate Metadata*. The *Recreate Metadata XML* dialog opens. +
 +
 image:updating-metadata-in-an-existing-mapping-6.png[image]
...
image:updating-metadata-in-an-existing-mapping-7.png[image]
