...
To the Mule flow that involves an API, add a link:/mule-user-guide/cxf-component-reference[*CXF Component*] to publish, consume, or proxy an API. Complete the following steps to configure WS-security on the CXF component.
...
+
image:securing-a-soap-api-1.png[image]

. Click the
image:securing-a-soap-api-2.png[(plus)] icon in the *Add Configuration Element* pane to create a new key-value pair.
+
image:securing-a-soap-api-3.png[image]
+
[NOTE]
...
+
image:securing-a-soap-api-6.png[image]
+
...
image:securing-a-soap-api-7.png[(plus)] button to open a new properties panel in which you can create and configure a new bean. The bean imports the Java class you have built to specify the custom validator's override behavior.
image:securing-a-soap-api-8.png[image]
...
For a complete explanation of the example application, see link:/mule-fundamentals/anypoint-exchange[the Library].
...
* Learn more about configuring a link:/mule-user-guide/cxf-component-reference[CXF component] in your Mule application.
* See link:/mule-fundamentals/anypoint-exchange[examples].
