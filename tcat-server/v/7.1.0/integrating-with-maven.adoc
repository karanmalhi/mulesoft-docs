...
For a complete and working example of a Maven POM file that you can download and try, download link:http://www.mulesoft.org/documentation/download/attachments/51052710/tcat-console-webapp-upload-maven.zip[the Tcat Maven antrun plugin example zip file] and unpack it. The POM file XML that performs the continuous deployment looks like this:
