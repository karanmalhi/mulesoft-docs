...
Download the latest Tcat Server release by going to the Tcat Overview Page link:http://www.mulesoft.com/tcat-server-enterprise-tomcat-application-server and clicking on the *Download Now* button.
...
This section details a few important advanced options. For more information about configuring Tcat Server, please see the link:http://www.mulesoft.org/documentation/download/attachments/25854000/tcat-102010.pdf?version=1&modificationDate=1287625483898[Administration Guide].
