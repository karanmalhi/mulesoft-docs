...
image:tcat-server-metrics-portlet-1.png[tcat-server-metrics-portlet-1] +
...
image:tcat-server-metrics-portlet-2.png[tcat-server-metrics-portlet-2] +
...
image:tcat-jmx-browser-error-count-1.png[tcat-jmx-browser-error-count-1] +
...
image:tcat-jmx-attribute-chart-def-1.png[tcat-jmx-attribute-chart-def-1]
...
image:tcat-server-metrics-portlet-3.png[tcat-server-metrics-portlet-3]
