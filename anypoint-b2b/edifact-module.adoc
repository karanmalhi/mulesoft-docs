...
If you wish, you can also define your own schemas from scratch. See the link:/docs/display/current/EDI+Schema+Language+Reference[EDI Schema Language Reference] for more details.
