...
In the Transport Settings section, you can configure the default options for any B2B-enabled transport connectors, currently AS2 and FTPS.

==== AS2 - Partner

AS2 is a secure transport protocol that enables files to be signed and encrypted to send files
