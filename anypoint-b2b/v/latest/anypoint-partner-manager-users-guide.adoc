...
Drop-down listbox auto-populated with the Home Org's EDI Partner qualifiers. If you need a different value, choose *Custom* in the listbox, then enter a valid qualifier.
