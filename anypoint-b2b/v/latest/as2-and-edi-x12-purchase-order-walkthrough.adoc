...
This document is for a technical audience possessing basic knowledge of link:/mule-user-guide/v/3.7/Datamapper-User-Guide-and-Reference[DataMapper], link:http://modusintegration.github.io/mule-connector-as2/quickstart.html[AS2 Connector], link:/anypoint-b2b/x12-module[X12 Module], and Anypoint Platform.
...
. From your web browser, log in to the Anypoint Partner Manager and then click the home organization view in the top right corner. Copy your API key (reference step 3.2.).
. In Anypoint Studio, click the file _customer.xml_ in the app directory, and select the Global view tab. Double-click the B2B global element configuration and insert the API key you got from the Anypoint Partner Manager.
...
The first stage of the solution is to create a partnership between your organization and the supplier from the Anypoint Partner Manager. A partnership establishes the context in which B2B data can be exchanged between you and your partner. Furthermore, it allows this data to be tracked and viewed from the Anypoint Partner Manager.
...
. Enter your secret API key which is retrieved from your home organization’s *Contacts* settings page in the Anypoint Partner Manager. Remember, the home organization settings is accessed by clicking on the home organization settings link on the upper right corner, next to the home icon:
+
