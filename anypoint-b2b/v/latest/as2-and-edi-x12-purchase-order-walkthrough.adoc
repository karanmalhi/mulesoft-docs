...
+
. If you have an Amazon S3 bucket available, you should select *amazon_s3* as the *File Storage Type*. Setting this option tells the B2B Connector to persist X12 documents and AS2 message content to S3.
+
