...
. From your web browser, log into Anypoint Partner Manager and then click the home organization view in the top right corner. Copy your API key (reference step 3.2.).
