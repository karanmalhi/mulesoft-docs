...
. Login into lAnypoint Partner Manager:
+
...
|City |Heading -> 3100_N1 -> 3400_N4 -> N401 - City Name
|State |Heading -> 3100_N1 -> 3400_N4 -> N402 - State or Province Code
|Zip |Heading -> 3100_N1 -> 3400_N4 -> N403 - Postal Code
|Country |Heading -> 3100_N1 -> 3400_N4 -> N404 - Country Code
