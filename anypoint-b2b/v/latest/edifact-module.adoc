...
If you wish to use the EDIFACT Module in conjunction with Maven,  follow the instructions link:http://mulesoft.github.io/edi-module/guide/install.html[here].
