...
* link:#TransactionManagement-Single-resource(Local)Transactions[Single-resource (Local) Transactions]
* link:#TransactionManagement-Multi-resourceTransactions[Multi-resource Transactions]
* link:#TransactionManagement-XATransactions[XA Transactions]
* link:#TransactionManagement-TransactionManagerLookup[Transaction Manager Lookup]
* link:#TransactionManagement-TransactionCoordination[Transaction Coordination]
* link:#TransactionManagement-Non-TransactionalOutboundEndpoints[Non-Transactional Outbound Endpoints]
