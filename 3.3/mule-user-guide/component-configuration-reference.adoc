...
This page provides details on elements you configure for components. This information is pulled directly from `mule.xsd` and is cached. For more information on components, see link:/docs/display/34X/Configuring+Components[Configuring Components].
...
See link:/docs/display/33X/Using+Interceptors[Using Interceptors].

== Entry Point Resolvers

See link:/docs/display/33X/Entry+Point+Resolver+Configuration+Reference[Entry Point Resolver Configuration Reference].
