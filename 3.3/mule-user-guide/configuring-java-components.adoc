...
For a real-world example of using `<spring-object/>`, see link:/docs/display/33X/Using+Spring+Beans+as+Flow+Components[Using Spring Beans as Flow Components].
...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the flow. See link:/docs/display/33X/Developing+Components[Developing Components] for a more detailed description of their functionality.
...
See link:/docs/display/33X/Developing+Components[Developing Components] for more information about lifecycles.
...
Binding can be used on Java components and script components. For more information see link:/docs/display/33X/Component+Bindings[Component Bindings].
...
For more information about pooling and reference documentation for pooling configuration options, see link:/docs/display/33X/Tuning+Performance[Tuning Performance].
