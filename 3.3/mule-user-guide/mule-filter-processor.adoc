...
* *Creation timestamps* — Where the message’s creation date and time fall outside the filter’s configured acceptable lifespan (i.e. the message is older than expected), Mule does not process the message (see image below). +
 +
image:/docs/download/attachments/87687504/filter3.png?version=1&modificationDate=1354210807858[image]
...
+
image:/docs/download/attachments/87687504/choose_global_filter.png?version=1&modificationDate=1354211083211[image] +
+
...
+
image:/docs/download/thumbnails/87687504/Filter_Flow1.png?version=1&modificationDate=1356717184753[image]
+
