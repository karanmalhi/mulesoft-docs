...
* link:#JerseyModuleReference-ClasspathSettings[Classpath Settings]
* link:#JerseyModuleReference-Writingaservice[Writing a service]
* link:#JerseyModuleReference-DeploytheWebService[Deploy the Web Service]
* link:#JerseyModuleReference-ConsumeaRESTfulWebService[Consume a RESTful Web Service]
* link:#JerseyModuleReference-JSONSupport[JSON Support]
* link:#JerseyModuleReference-ExceptionMappers[Exception Mappers]
* link:#JerseyModuleReference-ContextResolvers[Context Resolvers]
* link:#JerseyModuleReference-SendingJerseyresponsetootherflows[Sending Jersey response to other flows]
* link:#JerseyModuleReference-Furtherhelp[Further help]
