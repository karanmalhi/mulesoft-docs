...
All the nodes in a cluster share memory, as illustrated below: +
 +
 image:/docs/download/attachments/87687469/topology_4-cluster.png?version=1&modificationDate=1348949975994[image]
...
link:/docs/display/33X/Mule+High+Availability+HA+Clusters[Learn More...]
...
. *A Web application, `WidgetUI`, to apply load to the Mule cluster.* +
 ...
 +
image:/docs/download/attachments/87687469/widgetUI_modified.png?version=1&modificationDate=1349717919833[image]

== Get Started!

* link:/docs/display/33X/1+-+Installing+the+Demo+Bundle[1 - Installing the Demo Bundle]
* link:/docs/display/33X/2+-+Creating+a+Cluster[2 - Creating a Cluster]
* link:/docs/display/33X/3+-+Deploying+an+Application[3 - Deploying an Application]
* link:/docs/display/33X/4+-+Applying+Load+to+the+Cluster[4 - Applying Load to the Cluster]
* link:/docs/display/33X/5+-+Witnessing+Failover[5 - Witnessing Failover]
* link:/docs/display/33X/6+-+Troubleshooting+and+Next+Steps[6 - Troubleshooting and Next Steps]
