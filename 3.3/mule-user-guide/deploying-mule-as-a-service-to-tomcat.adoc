...
. Package your Mule application's configuration file and custom Java classes in `.war` file (see link:/docs/display/current/Application+Server+Based+Hot+Deployment[Application Server Based Hot Deployment]).
...
* Learn about deploying Mule application in the cloud with link:/docs/display/current/CloudHub[CloudHub].
