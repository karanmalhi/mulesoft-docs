...
There are a number of different types of alerts that you can set up. You indicate the alert type when you add or create a new alert (covered in link:/docs/display/33X/Defining+SLAs+and+Alerts[Defining SLAs and Alerts]). In addition to the type, you also select the severity level of the alert and, for most alert types, you define parameters for raising that alert.
...
image:/docs/download/attachments/87687458/severity.png?version=1&modificationDate=1300241596412[image]
...
image:/docs/download/attachments/87687458/alerts-view.png?version=1&modificationDate=1299204099816[image]
...
image:/docs/download/attachments/87687458/severity-chart.png?version=1&modificationDate=1300242481794[image]
...
image:/docs/download/attachments/87687458/alerts-unread-notice.png?version=1&modificationDate=1299204188049[image]
