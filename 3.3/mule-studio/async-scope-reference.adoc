...
image:/docs/download/attachments/87688039/Asynch+Schematic.png?version=1&modificationDate=1323107715587[image]
...
By default, the following icon appears in the upper left corner of the Async scope’s title bar: image:/docs/download/attachments/87688039/Asynch+Title.png?version=1&modificationDate=1323107715582[image] . Double-click anywhere on the title bar to open the Properties pane.
...
image:/docs/download/attachments/87688039/Asynch+Properties.png?version=1&modificationDate=1323107715571[image]
...
+
image:/docs/download/attachments/87688039/Asynch+Process+Add.png?version=1&modificationDate=1323108377363[image]

. Click *Processing Strategies* to highlight the icon and display the *drop down arrow* immediately to the right (See: *Below*).
+
image:/docs/download/attachments/87688039/Asynch+Arrow.png?version=1&modificationDate=1323108377369[image]
...
+
image:/docs/download/attachments/87688039/Asynch+List.png?version=1&modificationDate=1323108377373[image]
