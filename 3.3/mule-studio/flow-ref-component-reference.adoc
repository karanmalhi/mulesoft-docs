...
+
image:/docs/download/attachments/122752230/Studio_FlowRef_canvas.png?version=1&modificationDate=1367281098490[image]
...
+
image:/docs/download/attachments/122752230/Studio+flow+reference+properties.png?version=1&modificationDate=1366760116719[image]
+
