...
image:/docs/download/attachments/87687958/flat_flow.png?version=1&modificationDate=1353435753847[image]
...
image:/docs/download/attachments/87687958/across_layers.png?version=1&modificationDate=1353435787393[image]
...
Refer to link:/docs/display/33X/Mule+Application+Architecture[Mule Application Architecture] document for further details on how Mule works.

== link:/docs/display/33X/Getting+Comfortable+with+Studio[Next: Get Comfortable with Mule Studio >>]
