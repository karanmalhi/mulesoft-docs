...
Mule servers communicate to ARM using the link:/mule-agent/v/1.3.0/[the Mule agent]. To add a server to your on-premise ARM, you need to https://s3.amazonaws.com/mulesoft-fileshare/onprem-test/agent-setup-onPrem.jar[download] and install the on-premise version of the agent.
