...
To add a server to your on-premise Anypoint Platform, you need to link:http://mule-agent.s3.amazonaws.com/1.3.1/mule-agent-1.3.1.zip[download] and install the agent.
