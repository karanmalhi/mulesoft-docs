= Sending Data from ARM to External Software
...
In between ARM and the external services is the link:/docs/display/current/The+Mule+Agent[Mule Agent], a module of Mule ESB that enables easy integration and sends event notifications to third party monitoring tools.
...
[NOTE]
Mule Agent 1.2.1 or above is required, the steps to install and configure it are provided below.
...
*Download it from https://s3.amazonaws.com/mulesoft-fileshare/hybrid/agent-setup-onPrem.jar[here]*
====
...
[source, linenums]
----
amc_setup -H 361755d7-c619-42ce-9187-19db7a6d94a0---2 MyMuleAgent
----
...
[source, linenums]
----
amc_setup.bat -H 361755d7-c619-42ce-9187-19db7a6d94a0---2 MyMuleAgent
----

The argument `-H` is an id that references your organization in the Anypoint platform and ARM on premise installation.

The final argument of this command is the name that you assign for your Mule Agent instance, in the above example, `MyMuleAgent`. This name will then be visible when interacting with the agent from your ARM console.
...
[source, linenums]
----
amc_setup -A http://localhost:8080/hybrid/api/v1 -W wss://localhost:8443/mule -C https://dev.anypoint.mulesoft.com/accounts -H 361755d7-c619-42ce-9187-19db7a6d94a0---2 MyMuleAgent
----
...
[source, linenums]
----
amc_setup.bat -A http://localhost:8080/hybrid/api/v1 -W wss://localhost:8443/mule -C https://dev.anypoint.mulesoft.com/accounts -H 361755d7-c619-42ce-9187-19db7a6d94a0---2 MyMuleAgent
----
