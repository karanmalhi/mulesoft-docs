...
You can also use the Applications tab to to deploy, undeploy, and redeploy applications to a cluster of Mule ESB servers (nodes). For further details, see link:/docs/display/34X/Deploying%2C+Redeploying%2C+or+Undeploying+an+Application+To+or+From+a+Cluster[Deploying, Redeploying, or Undeploying an Application To or From a Cluster].
...
image:/docs/download/attachments/95393677/add-deployment.png?version=1&modificationDate=1374598879278[image]

You can also specify a cluster for the group.

image:/docs/download/attachments/95393677/add-deployment_cluster.png?version=1&modificationDate=1374598878348[image]
...
image:/docs/download/attachments/95393677/edit-deployment.png?version=1&modificationDate=1374598878658[image]

You can also deploy, undeploy, or redeploy the group of applications to a cluster.

image:/docs/download/attachments/95393677/edit-deployment_cluster.png?version=1&modificationDate=1374598878002[image]
