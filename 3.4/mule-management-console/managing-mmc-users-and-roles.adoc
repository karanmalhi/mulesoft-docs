...
+
image:/docs/download/attachments/122752000/MMC-usergroups.png?version=1&modificationDate=1399406804072[image]

. Enter the *Name* of the new group, and optionally, a *Description*. 
+
image:/docs/download/attachments/122752000/mmc-addgroup1.png?version=1&modificationDate=1399406804051[image]
...
+
image:/docs/download/attachments/122752000/mmc-addgroup2.png?version=1&modificationDate=1399406804062[image]
