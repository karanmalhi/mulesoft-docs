...
image:/docs/download/thumbnails/95393740/props.general.tab.png?version=1&modificationDate=1374599033255[image]
...
image:/docs/download/thumbnails/95393740/props.adv.tab.png?version=1&modificationDate=1374599033585[image]
...
|===
|Name |Description |XML
|*Dispatched Pool Factory* |Allows you to reference a TCP dispatcher pool factory other than the default dispatcher factory bean. To add a different dispatcher factory bean ID in Studio, click the image:/docs/download/attachments/95393736/conn.spring.props-addbutton.png?version=1&modificationDate=1374599018511[image] button next to the combo box a|`dispatcherPoolFactory-ref="sampleBean"`
...
image:/docs/download/thumbnails/95393740/props.props.png?version=1&modificationDate=1374599034008[image]
...
|===
|Name |Description |XML
|*Spring Properties* |Use this tab to enter Spring bean property information. To add a property in Studio, click the image:/docs/download/attachments/95393736/conn.spring.props-addbutton.png?version=1&modificationDate=1374599018511[image] button under **Spring Properties.** a|`<spring:property name="com.sample.sampleBean" value="sampleValue"/>`
|===
