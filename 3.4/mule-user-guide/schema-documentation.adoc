...
If you are familiar with versions of Mule older than v 3.0, you may want to consult this list of link:/docs/display/current/Notes+on+Mule+3.0+Schema+Changes[schema changes].
