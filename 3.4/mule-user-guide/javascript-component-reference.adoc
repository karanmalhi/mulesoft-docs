image:/docs/download/attachments/95393448/javascript-component-48x32.png?version=1&modificationDate=1374598601698[image]
...
image:/docs/download/attachments/95393448/Javascript2way.png?version=1&modificationDate=1374598600564[image]
...
image:/docs/download/attachments/95393448/Javascript1way.png?version=1&modificationDate=1374598600786[image]
...
To configure the JavaScript component, from the Message Flow canvas double-click the JavaScript icon to open the *Pattern Properties* pane. Use the General tab to specify the file location of the script or simply type in the script on the script text window. The scripting engine is JavaScript. +
 image:/docs/download/attachments/95393448/JavascriptPropGen.png?version=1&modificationDate=1374598600321[image]
...
image:/docs/download/attachments/95393448/JavascriptPropAdv2.png?version=1&modificationDate=1374598601009[image]
...
image:/docs/download/attachments/95393448/JavascriptPropDoc.png?version=1&modificationDate=1374598601227[image]
