...
image:/docs/download/attachments/95393534/cluster.png?version=1&modificationDate=1374598725738[image]
...
image:/docs/download/attachments/95393534/FailoverNoFail.png?version=1&modificationDate=1374598725466[image]
...
image:/docs/download/attachments/95393534/FailoverNode2Fail.png?version=1&modificationDate=1374598726228[image]
...
image:/docs/download/attachments/95393534/cluster-diagram.png?version=1&modificationDate=1374598725987[image]
...
* Cluster lifecycle management and control. See link:/docs/display/34X/Managing+Mule+High+Availability+%28HA%29+Clusters[Managing Mule High Availability (HA) Clusters].
* Cluster and node performance monitoring. See link:/docs/display/34X/Monitoring+a+Cluster[Monitoring a Cluster].
...
image:/docs/download/attachments/95393534/topology_4-cluster.png?version=1&modificationDate=1374598726465[image]
...
image:/docs/download/attachments/95393534/load_balancing.png?version=1&modificationDate=1374598726709[image]
...
* If your application processes messages from a non-transactional transport, use a link:/docs/display/34X/Reliability+Patterns[reliability pattern] to move them to a transactional store such as a VM or JMS store.
...
* Implement link:/docs/display/34X/Reliability+Patterns[reliability patterns] to create high reliability applications.
...
* If your link:/docs/display/34X/Message+Sources[custom message source] does not use a message receiver to define node http://en.wikipedia.org/wiki/Polling_(computer_science)[polling], then you must configure your message source to implement a ClusterizableMessageSource interface. +
