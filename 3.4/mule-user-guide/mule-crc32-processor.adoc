...
+
image:/docs/download/attachments/95393326/GlobalCRC32Calculation5.png?version=1&modificationDate=1374598380983[image]
+
[cols=",,",options="header",]
|===
...
+
image:/docs/download/attachments/95393326/CRC32Calculation2.png?version=1&modificationDate=1374598379961[image]
+
[cols=",,",options="header",]
|===========================
|Attribute |Req'd |Value
...
+
image:/docs/download/attachments/95393326/CRC32Filter3.png?version=1&modificationDate=1374598380817[image]
+
