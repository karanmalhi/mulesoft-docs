...
+
image:/docs/download/attachments/95393324/global_JCE_Signer_both.png?version=1&modificationDate=1374598372497[image]
+
[cols=",,",options="header",]
|===
|Field |Req'd |Value
...
+
image:/docs/download/attachments/95393324/JCE_sign1.png?version=1&modificationDate=1374598373868[image]
...
image:/docs/download/attachments/95393324/global_XML_Signer_Both.png?version=1&modificationDate=1374598372347[image]
+
[width="100%",cols="34%,33%,33%",options="header",]
|===
|Field |Req'd |Value
...
+
image:/docs/download/attachments/95393324/xml_sign_local.png?version=1&modificationDate=1374598372182[image]
+
[width="100%",cols="34%,33%,33%",options="header",]
|===
|Field |Req'd |Value
...
[tab,title="STUDIO Visual Editor"]
....
image:/docs/download/attachments/95393324/enable_language3.png?version=1&modificationDate=1374598372954[image]
....
...
[tab,title="STUDIO Visual Editor"]
....
image:/docs/download/attachments/95393324/add_message.png?version=1&modificationDate=1374598372729[image]
....
[tab,title="XML or Standalone Editor"]
....
[source]
