...
image:/docs/download/thumbnails/98310291/mulestudio.png?version=1&modificationDate=1389627668966[image]
After learning some of the basic functionality in the link:/docs/display/34X/Basic+Studio+Tutorial[Basic] and link:/docs/display/34X/Content-Based+Routing+Tutorial[Content-Based Routing Tutorials], it's time to try your hand at developing a more complex application which makes use of **Anypoint Connectors**.
...
This tutorial assumes that you have link:/docs/display/34X/Download+and+Launch+Mule+Studio[downloaded and installed Mule Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, please review the brief introduction to the link:/docs/display/34X/Mule+Studio+Essentials[Mule Studio interface] and the document describing link:/docs/display/34X/Global+Elements[Global Elements in Mule]. Further, consider following the link:/docs/display/34X/Basic+Studio+Tutorial[Basic] and link:/docs/display/34X/Content-Based+Routing+Tutorial[Content-based Routing] tutorials.
...
+
image:/docs/download/attachments/98310291/devacct1.png?version=1&modificationDate=1389627668811[image]
+
...
. Optionally, access the *Settings* tab to adjust the *Application Type* from `Read only` to `Read and Write`. Use the radio buttons under *Application Type* to adjust the setting, then save your changes. +
 +
image:/docs/download/attachments/98310291/devacct4.png?version=1&modificationDate=1389627668845[image]  +

. Access the *Details* tab. Create an *Access Token* by clicking the button at the bottom of the screen (see image below). +

+
image:/docs/download/attachments/98310291/devacct2.png?version=1&modificationDate=1389627668823[image] +
+
...
However, if you wanted to expose such an application publicly, you would need to configure your application to link:/docs/display/34X/Using+a+Connector+to+Access+an+OAuth+API[authenticate via OAuth].
====
+
...
.. Access token secret +
 +
image:/docs/download/attachments/98310291/devacct3.png?version=1&modificationDate=1389627668834[image]

== Modeling a Flow with a Connector

Launch Mule Studio and create a new Mule Project named `Connector Tutorial`. If you need more directions on launching Studio and creating a project, please refer to the link:/docs/display/34X/Basic+Studio+Tutorial[Basic Studio Tutorial]. 
...
|*link:/docs/display/34X/Foreach[Foreach scope]* |processes each item in a POJO iteratively
|*link:/docs/display/34X/Logger+Component+Reference[Logger component]* |logs messages or activity based on the value of a Mule expression; find this in the Components section of the palette at the right of the screen
|===

Drag and drop these building blocks into place on the canvas to visually construct, or model, a flow, as shown below.

image:/docs/download/attachments/98310291/foreach2.png?version=1&modificationDate=1389627668878[image]
...
image:/docs/download/attachments/98310291/connector_tutorial_activities.png?version=1&modificationDate=1389627668801[image] +
...
image:/docs/download/attachments/98310291/http2.png?version=1&modificationDate=1389627668914[image] +
...
image:/docs/download/attachments/98310291/twt2.png?version=1&modificationDate=1389627669103[image]
...
Read more about link:/docs/display/34X/Global+Elements[Global Elements in Mule].
...
+
image:/docs/download/attachments/98310291/twt3.png?version=1&modificationDate=1389627669117[image]

. Enter values for the fields according to the table below.
+
image:/docs/download/attachments/98310291/twt4.png?version=1&modificationDate=1389627669131[image] +
...
image:/docs/download/attachments/98310291/foreach.png?version=1&modificationDate=1389627668856[image]
...
image:/docs/download/attachments/98310291/log1.png?version=1&modificationDate=1389627668952[image]
...
+
image:/docs/download/attachments/98310291/started_connector_app.png?version=1&modificationDate=1389627669044[image]
...
+
image:/docs/download/attachments/98310291/tweets.png?version=1&modificationDate=1389627669066[image] +
+
...
image:/docs/download/attachments/98310291/Studio-stopcbrapp.png?version=1&modificationDate=1389627669055[image]
...
==== ~image:/docs/download/thumbnails/98310291/icon-question-blue-big%281%29+%282%29.png?version=1&modificationDate=1389627668938[image] ~ Hints
...
There are a few ways to accomplish this task, one of which is to add the extra text to the tweet inside a new variable. However, you can take a shortcut using the link:/docs/display/34X/Set+Payload+Transformer+Reference[set payload] transformer. Replace the content of the entire payload using an expression composed of multiple parts, such as the following the following:
...
image:/docs/download/attachments/98310291/set+payload2.png?version=1&modificationDate=1389627669019[image]
...
image:/docs/download/attachments/98310291/twp.png?version=1&modificationDate=1389627669077[image]

==== image:/docs/download/thumbnails/98310291/icon-checkmark-blue-big%283%29+%281%29.png?version=1&modificationDate=1389627668927[image] Answer
...
image:/docs/download/attachments/98310291/solution.png?version=1&modificationDate=1389627669033[image]

[NOTE]
====
image:http://www.mulesoft.org/documentation/images/icons/emoticons/information.png[image]Keep in mind that for this example to work, you must manually configure the following values of the global Twitter connector ( ` twitter:config `element):
...
* *NEXT STEP:* Learn how to link:/docs/display/34X/Starting+and+Stopping+Mule+ESB[start and stop Mule] from the command line.
* See http://www.mulesoft.org/connectors[specific documentation for each connector].
* Import link:/docs/display/34X/Installing+Connectors[additional connectors] into your instance of Studio.
