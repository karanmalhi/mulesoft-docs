...
image:/docs/download/attachments/98310269/scripting_components.png?version=1&modificationDate=1389625355202[image]
...
image:/docs/download/attachments/98310269/rest_soap.png?version=1&modificationDate=1389625355194[image]

[TIP]
*APIkit* offers a new and improved way of building a REST API. Access the link:#[APIkit Documentation] to learn how to build REST APIs in a few hours or days.
...
image:/docs/download/attachments/98310269/http_components.png?version=1&modificationDate=1389625355173[image]

== Other Components

Finally, Mule includes several other components designed to meet rather specific needs.

image:/docs/download/attachments/98310269/misc_components.png?version=1&modificationDate=1389625355184[image]
...
* *NEXT STEP*: Read on about link:/docs/display/34X/Mule+Transformers[transformers].
