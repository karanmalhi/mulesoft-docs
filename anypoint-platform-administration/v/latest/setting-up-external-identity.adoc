...
MuleSoft currently supports link:https://www.pingidentity.com/en/products/pingfederate.html[PingFederate] and https://forgerock.org/openam/[OpenAM] for external identity management.
