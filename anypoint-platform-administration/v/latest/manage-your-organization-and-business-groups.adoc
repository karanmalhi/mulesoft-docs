...
The external identity section displays information about your link:http://en.wikipedia.org/wiki/Federated_identity[federated identity] provider (if you have one enabled). The following identity providers are supported:
