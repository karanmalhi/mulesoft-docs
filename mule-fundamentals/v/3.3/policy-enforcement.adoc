...
For information on the elements you can configure for the Security Manager, see link:/mule-user-guide/v/3.3/security-manager-configuration-reference[Security Manager Configuration Reference]. The following sections provide links to information on configuring different types of security managers.
...
* link:/mule-user-guide/v/3.3/encryption-strategies[Encryption Strategies] - Secure your messages by encrypting them.
* link:/mule-user-guide/v/3.3/pgp-security[PGP Security] - Secure your messages by encrypting them with PGP.
