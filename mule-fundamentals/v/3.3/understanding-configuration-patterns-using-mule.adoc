...
This example illustrates the goal of minimal configuration: nothing needs to be configured except what is absolutely required. To learn more about the capabilities of the bridge pattern, see link:/mule-user-guide/v/3.3/bridge-pattern[Bridge Pattern],
...
To learn more about the capabilities of the simple service pattern, see link:/mule-user-guide/v/3.3/simple-service-pattern[Simple Service Pattern],
