...
image:/docs/download/thumbnails/122750428/filter2.png?version=1&modificationDate=1421449351635[image]
...
image:/docs/download/thumbnails/122750428/wrapper2.png?version=1&modificationDate=1421449351814[image]Mule
...
image:/docs/download/thumbnails/122750428/router2.png?version=1&modificationDate=1421449351465[image]Mule *routers* – or *flow controls*, as they're known in Anypoint Studio – function much as their name implies: to direct or otherwise control messages within a flow.
