...
image:/docs/download/thumbnails/122750431/connector.png?version=1&modificationDate=1421449360453[image] **link:/docs/display/35X/Anypoint+Connectors[Anypoint Connectors]** receive or send messages between Mule and one or more external sources, such as files, databases, or Web services. Connectors can act as message sources by working as inbound endpoints, they can act as a message processor that performs an operation in middle of a flow, or they can fall at the end of a flow and act as the recipient of the final payload data. 
...
image:/docs/download/attachments/122750431/endpointbased.png?version=1&modificationDate=1421449358739[image]
...
image:/docs/download/attachments/122750431/operationbased.png?version=1&modificationDate=1421449358551[image]
...
* *NEXT STEP*: Read on about link:/docs/display/35X/Mule+Components[components].
