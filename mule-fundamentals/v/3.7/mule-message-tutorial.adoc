...
. Go to a browser and request link:http://localhost:8081.[http://localhost:8081]. Your browser should print a map similar to the following: `{favorite_animal=mule, favorite_color=blue, favorite_day=Wednesday}`
====
