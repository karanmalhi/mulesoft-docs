...
. Learn how to get started designing your API with API Designer link:https://developer.mulesoft.com/docs/display/current/Walkthrough+Intro+Create[here].
. Next, follow link:https://developer.mulesoft.com/docs/display/current/Walkthrough+Build[this guide] to implement your API in Anypoint Studio
. To get started managing APIs, jump to the link:https://developer.mulesoft.com/docs/display/current/Walkthrough+Manage[Manage your API walkthrough].
