...
In the link:/mule-fundamentals/v/3.7/basic-studio-tutorial[Basic Studio Tutorial], you got to know Anypoint Studio and built a simple "Hello, World" application.
...
Launch Anypoint Studio and create a new Mule Project named CBR Tutorial. If you need more directions on launching Studio and creating a project, refer to the link:/mule-fundamentals/v/3.7/basic-studio-tutorial[Basic Studio Tutorial]. 
