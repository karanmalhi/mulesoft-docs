...
* Examine an link:http://www.mulesoft.org/documentation/display/current/Flow+Architecture+Advanced+Use+Case[advanced use case] showing a more complex flow architecture that uses several child flows.
