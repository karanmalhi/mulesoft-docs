...
link:/mule-fundamentals/v/3.7/first-day-with-mule[image:firstDay.png[firstDay]]      link:/mule-fundamentals/v/3.7/first-week-with-mule[image:first_week3.png[first_week3]]
