...
This document assumes that you are familiar with the link:http://www.mulesoft.org/documentation/display/current/Mule+Studio+Essentials[Visual Editor in Anypoint Studio]. Review the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio Essentials] document to learn more about developing with Mule ESB's graphical user interface.
