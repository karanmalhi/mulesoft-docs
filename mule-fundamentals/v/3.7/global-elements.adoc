...
 link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Visual Editor in Anypoint Studio]. Review the link:/mule-fundamentals/v/3.7/anypoint-studio-essentials[Anypoint Studio Essentials] document to learn more about developing with Mule ESB's graphical user interface.
...
* *NEXT STEP:* Use what you've learned to follow the link:/mule-fundamentals/v/3.7/basic-studio-tutorial[Basic Studio Tutorial]. +
