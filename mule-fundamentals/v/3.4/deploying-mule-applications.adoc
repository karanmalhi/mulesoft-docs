...
. If you have a *Mule Community* account, simply log into https://anypoint.mulesoft.com[the Anypoint Platform] using your Community credentials. If you do not have a community account, you can create an account there.
. Next, visit link:https://anypoint.mulesoft.com[the ANypoint Platform] to then go to CloudHub's interface.
