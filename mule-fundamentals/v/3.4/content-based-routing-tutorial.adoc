...
image:mulestudioicon.png[mulestudio%281%29] In the link:/docs/display/34X/Basic+Studio+Tutorial[Basic Studio Tutorial], you got to know Mule Studio and built a simple "Hello, World" application.
