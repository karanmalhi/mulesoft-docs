...
* *NEXT STEP:* Learn more about the link:/mule-fundamentals/v/3.4/elements-in-a-mule-flow[elements in a Mule flow].
* Skip ahead in this syllabus to the link:/mule-fundamentals/v/3.4/basic-studio-tutorial[Basic Studio Tutorial].
