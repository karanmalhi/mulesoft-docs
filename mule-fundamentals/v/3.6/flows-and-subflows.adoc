...
image:/documentation/download/attachments/122751591/standard_synchronous.png?version=1&modificationDate=1386184258483[image]

image:/documentation/download/attachments/122751591/standard_asynchronous.png?version=1&modificationDate=1386117982194[image]
...
* In clusters of Mule servers, messages can migrate between nodes when sent to an asynchronous flow. This allows for *load balancing between nodes* and higher performance of application. (See our link:/documentation/display/current/Flow+Architecture+Advanced+Use+Case[advanced use case] for an example.)
...
image:/documentation/download/attachments/122751591/subflow_example.png?version=1&modificationDate=1386184834142[image]
...
image:/documentation/download/attachments/122751591/sync_example.png?version=1&modificationDate=1386186194835[image]
...
image:/documentation/download/attachments/122751591/async_flow_example.png?version=1&modificationDate=1386195358479[image]
...
|Asynchronous Flow |Flow Reference wrapped within an link:/documentation/display/current/Async+Scope+Reference[Async Scope] |asynchronous |not inherited
|===
