...
<<Add to Mule>>]     image:/documentation/download/thumbnails/122751614/add_with_devkit.png?version=1&modificationDate=1386876992849Dev Kit]     image:/documentation/download/thumbnails/122751614/add_to_OSS.png?version=1&modificationDate=1386877018937Add to OSS]
