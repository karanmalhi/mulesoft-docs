...
image:/documentation/download/thumbnails/122751580/mulestudio%281%29.png?version=1&modificationDate=1405024031207[image]This exercise is designed to introduce you to Anypoint Studio and help you get comfortable building applications.
...
+
image:/documentation/download/attachments/122751580/workspacelauncher.png?version=1&modificationDate=1405024032072[image]
+
...
+
image:/documentation/download/attachments/122751580/WelcomeScreen.png?version=1&modificationDate=1405024032009[image]
...
+
image:/documentation/download/attachments/122751580/new.png?version=1&modificationDate=1417727065112[image]
+
. Click *Finish* to create the project.
. In the *Package Explorer*, `Basic Tutorial.xml` appears inside the `src/main/app` folder.
+
image:/documentation/download/attachments/122751580/packages.png?version=1&modificationDate=1417727160364[image]
+
...
+
image:/documentation/download/attachments/122751580/blank+canvas.png?version=2&modificationDate=1420213821987[image]
+
...
image:/documentation/download/attachments/122751580/flow.png?version=1&modificationDate=1417727446682[image]
...
+
image:/documentation/download/attachments/122751580/add+http.png?version=1&modificationDate=1417727729846[image]
+
...
+
image:/documentation/download/attachments/122751580/add+logger.png?version=1&modificationDate=1417727896871[image]
+
...
+
image:/documentation/download/attachments/122751580/add+set+payload.png?version=1&modificationDate=1417727816144[image]
+
...
image:/documentation/download/thumbnails/122751580/Studio_Palette_filter.png?version=1&modificationDate=1405024031859[image]
...
image:/documentation/download/attachments/122751580/explanation.png?version=1&modificationDate=1417729626346[image]
...
+
image:/documentation/download/attachments/122751580/http+path.png?version=1&modificationDate=1428696302048[image]
+
...
+
image:/documentation/download/attachments/122751580/http+basic+*.png?version=1&modificationDate=1425301097495[image]
+
...
+
image:/documentation/download/attachments/122751580/global+element.png?version=1&modificationDate=1417730518265[image]
+
...
+
image:/documentation/download/attachments/122751580/canvas_tabs_xml.png?version=1&modificationDate=1405024031016[image]
+
...
+
image:/documentation/download/attachments/122751580/canvas_tabs_flow.png?version=1&modificationDate=1405024030994[image]  
+
...
+
image:/documentation/download/attachments/122751580/logger+for+path.png?version=3&modificationDate=1418222476592[image]
+
...
+
image:/documentation/download/attachments/122751580/set+payload1.png?version=1&modificationDate=1417732002607[image] +
+
...
+
image:/documentation/download/attachments/122751580/set+payload2.png?version=2&modificationDate=1417785099396[image]
+
[NOTE]
...
+
image:/documentation/download/attachments/122751580/run.png?version=1&modificationDate=1417732270090[image]
+
...
+
image:/documentation/download/attachments/122751580/BasicTutorial_Console_started.png?version=1&modificationDate=1405024030731[image]
...
+
image:/documentation/download/attachments/122751580/BasicTutorial_Browser.png?version=1&modificationDate=1405024030668[image]
+
...
image:/documentation/download/attachments/122751580/stopbasictutorial.png?version=1&modificationDate=1405024031407[image]
...
+
image:/documentation/download/attachments/122751580/add+filter.png?version=1&modificationDate=1417733194064[image]
+
...
+
image:/documentation/download/attachments/122751580/filter+new.png?version=1&modificationDate=1418221749566[image]
+
...
+
image:/documentation/download/attachments/122751580/add+file.png?version=1&modificationDate=1417733369806[image]
+
