...
image:/documentation/download/thumbnails/122751598/mulestudio%281%29+%281%29.png?version=1&modificationDate=1405021891412[image]
...
+
image:/documentation/download/attachments/122751598/basic+flow.png?version=1&modificationDate=1418243532091[image]
...
----
+
image:/documentation/download/attachments/122751598/log+output.png?version=2&modificationDate=1418246918021[image]
...
+
image:/documentation/download/attachments/122751598/deploy-success.png?version=1&modificationDate=1405021891015[image]
...
+
image:/documentation/download/attachments/122751598/basic+flow+2.png?version=1&modificationDate=1418247363528[image]
+
...
+
image:/documentation/download/attachments/122751598/variable.png?version=1&modificationDate=1418247611480[image]
...
+
image:/documentation/download/attachments/122751598/set-var-auto.png?version=1&modificationDate=1405021891476[image]
...
+
image:/documentation/download/attachments/122751598/set-var-exp2.png?version=1&modificationDate=1405021891534[image]
...
image:/documentation/download/attachments/122751598/metadata+in.png?version=1&modificationDate=1418311000062[image]

*Note* that the path variable appears in the Out view, reflecting what you have configured within this message processor.

image:/documentation/download/attachments/122751598/metadata+out.png?version=1&modificationDate=1418311012725[image]
...
+
image:/documentation/download/attachments/122751598/breakpoints.png?version=1&modificationDate=1418307552036[image]

. Click *Mule Debug* in the upper left corner of the Studio application to switch to the Mule Debug perspective.
+
image:/documentation/download/attachments/122751598/debug+view.png?version=1&modificationDate=1418307781661[image]
...
+
image:/documentation/download/attachments/122751598/debugging+flow.png?version=1&modificationDate=1418308055131[image]
...
+
image:/documentation/download/attachments/122751598/debugger+con+globitos.png?version=1&modificationDate=1418311400983[image]
...
+
image:/documentation/download/attachments/122751598/exloring+query+params.png?version=1&modificationDate=1418311640818[image]
...
. Press F8 or click the Resume icon (image:/documentation/download/thumbnails/122751598/Resume+icon.png?version=1&modificationDate=1405021891458[image]) to prompt Mule to unpause processing and continue to the next breakpoint, which, in this example, is the Logger. Note that the Variables tab now includes one entry.
+
image:/documentation/download/attachments/122751598/Debug-newvariable.png?version=1&modificationDate=1405021890910[image]
...
image:/documentation/download/attachments/122751598/Debug-var-edit.png?version=1&modificationDate=1405021890928[image]
...
. With your flow paused at your Logger breakpoint, open the Mule Expression Evaluator by clicking the image:/documentation/download/thumbnails/122751598/x+plus+y.png?version=1&modificationDate=1405021891674[image] icon. In the yellow box that opens, you can test out any MEL expression. Mule will immediately evaluate the expression, relative to the breakpoint in your flow where your message is currently paused, and either return a value or throw an exception.
...
+
image:/documentation/download/attachments/122751598/logger-config-mel.png?version=1&modificationDate=1405021891095[image]
...
==== image:/documentation/download/thumbnails/122751598/hints.png?version=1&modificationDate=1405021891070[image] Hints
...
==== image:/documentation/download/thumbnails/122751598/answer.png?version=1&modificationDate=1405021890815[image] Answer
...
+
image:/documentation/download/attachments/122751598/expression-mel.png?version=1&modificationDate=1405021891026[image]
...
image:/documentation/download/attachments/122751598/mel-ec-flow.png?version=1&modificationDate=1405021891152[image]
