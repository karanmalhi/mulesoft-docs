...
image:/documentation/download/thumbnails/122751579/global.png?version=1&modificationDate=1386009592448[image]In Mule, a *Global Element* is one that you configure once, then reference many times from elements within multiple flows. Rather than repeatedly writing the same code to apply the same configuration to multiple elements in flows, you can create one global element that details your configurations or transport details. Then, you can instruct any number of elements across flows in your Mule application to reference the global element for specifics on how to behave.  +
...
+
image:/documentation/download/attachments/122751579/GEtab.png?version=1&modificationDate=1398806402789[image] +

. Click *Create* to add a new global element. +

+
image:/documentation/download/attachments/122751579/GEcreate.png?version=1&modificationDate=1398806831852[image] +
...
+
image:/documentation/download/attachments/122751579/chooseglobaltype.png?version=1&modificationDate=1398806869293[image] +
...
+
image:/documentation/download/attachments/122751579/connectorconfiguration.png?version=1&modificationDate=1398807124671[image] +
...
image:/documentation/download/attachments/122751579/createvsedit.png?version=1&modificationDate=1398808638562[image]
====
....
...
* *NEXT STEP:* Use what you've learned to follow the link:/documentation/display/current/Basic+Studio+Tutorial[Basic Studio Tutorial]. +
