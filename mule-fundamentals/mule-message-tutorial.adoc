...
This tutorial also assumes that you have a basic understanding of the link:/mule-fundamentals/mule-message-structure[Mule message structure].
...
....
. Launch Anypoint Studio and create a new Mule Project. If you need more directions on launching Studio and creating a project, please refer to the link:/mule-fundamentals/basic-studio-tutorial[Basic Studio Tutorial]. 
. Model a flow on the canvas of the visual editor, as shown.
+
image:mule-message-tutorial-2.png[image]
...
----
+
image:mule-message-tutorial-3.png[image]
...
+
image:mule-message-tutorial-4.png[image]
...
----
+
image:mule-message-tutorial-5.png[image]
...
+
image:mule-message-tutorial-6.png[image]
+
...
+
image:mule-message-tutorial-7.png[image]
...
+
image:mule-message-tutorial-8.png[image]
...
+
image:mule-message-tutorial-9.png[image]
...
+
image:mule-message-tutorial-14.png[image]
...
+
image:mule-message-tutorial-15.png[image]
...
+
image:mule-message-tutorial-16.png[image]
...
. Press F8 or click the Resume icon (image:mule-message-tutorial-17.png[image]) to prompt Mule to unpause processing and continue to the next breakpoint, which, in this example, is the Logger. Note that the Variables tab now includes one entry.
+
image:mule-message-tutorial-18.png[image]
...
image:mule-message-tutorial-19.png[image]
...
. With your flow paused at your Logger breakpoint, open the Mule Expression Evaluator by clicking the image:mule-message-tutorial-20.png[image] icon. In the yellow box that opens, you can test out any MEL expression. Mule will immediately evaluate the expression, relative to the breakpoint in your flow where your message is currently paused, and either return a value or throw an exception.
...
For more ideas on MEL expressions to test out in the Mule Expression Evaluator, refer to the link:/mule-user-guide/mule-expression-language-basic-syntax[syntax guide] or borrow some from the collection of introductory link:/mule-user-guide/mule-expression-language-examples[MEL examples].
...
+
image:mule-message-tutorial-21.png[image]
...
==== ~image:mule-message-tutorial-22.png[image] ~Hints +
...
==== ~image:mule-message-tutorial-23.png[image] ~Answer
...
+
image:mule-message-tutorial-24.png[image]
...
+
image:mule-message-tutorial-25.png[image]
...
* **NEXT STEP:** Learn how to link:/mule-user-guide/starting-and-stopping-mule-esb[start and stop Mule] from the command line.
* Refer to the main link:/mule-user-guide/mule-expression-language-mel[MEL documentation] including the collection of link:/mule-user-guide/mule-expression-language-examples[examples], which demonstrate how to use MEL expressions in a variety of other message processors.
* Access the Mule Expression Language link:/mule-user-guide/mule-expression-language-reference[reference] page for a searchable listing of context objects and their fields, operations, and functions. 
* Learn more about link:/mule-user-guide/studio-visual-debugger[Visual Debugger], the link:/mule-user-guide/logger-component-reference[Logger], and link:/mule-user-guide/datasense[DataSense].
* If you haven't already, try out some of our other tutorials, all of which involve using MEL expressions: +
** link:/mule-fundamentals/basic-studio-tutorial[Basic Studio Tutorial]
** link:/mule-fundamentals/content-based-routing-tutorial[Content-Based Routing Tutorial]
** link:/mule-fundamentals/anypoint-connector-tutorial[Anypoint Connector Tutorial]
