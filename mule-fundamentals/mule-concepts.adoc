...
image:mule-concepts-1.png[image]
...
....
image:mule-concepts-2.png[image]
....
...
image:mule-concepts-3.png[image]
...
When you configure the individual elements that link together to make your flow or batch job, you can use link:/mule-user-guide/mule-expression-language-mel[Mule Expression Language] to extract information about the message or its environment and instruct Mule to make processing decisions based on that information.

== See Also

* *NEXT STEP:* Learn more about the link:/mule-fundamentals/elements-in-a-mule-flow[elements in a Mule flow].
* Find out more about link:/mule-user-guide/batch-processing[Batch Processing]. +
