...
image:mule-exception-strategies-2.png[image]
...
* A link:/mule-user-guide/transaction-management[Transactional Scope] may include its own exception strategy, regardless of what you define at Flow level +
...
* *NEXT STEP*: Read on about the structure of a  link:/mule-fundamentals/mule-message-structure[Mule message].
* See the link:/mule-fundamentals/anypoint-exchange[examples].
* Learn more about configuring the link:/mule-user-guide/catch-exception-strategy[catch], link:/mule-user-guide/rollback-exception-strategy[rollback], link:/mule-user-guide/reference-exception-strategy[reference], and link:/mule-user-guide/choice-exception-strategy[choice] exception strategies.
