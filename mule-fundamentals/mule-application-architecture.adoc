...
Typically, a message source comes in the form of an link:/mule-user-guide/anypoint-connectors[*Anypoint Connector*]. 
...
image:mule-application-architecture-1.png[image]
...
Under certain conditions, flows do not need to be triggered by message sources. For instance, a link:/mule-user-guide/flow-reference-component-reference[Flow Reference Component] can trigger a different flow in the same application. Similarly, the link:/mule-user-guide/async-scope-reference[Async Scope] can trigger a another flow that executes asynchronously, (i.e. in parallel with the originating flow).
...
image:mule-application-architecture-2.png[image]
...
image:mule-application-architecture-3.png[image]

For further details, see link:/mule-user-guide/flow-processing-strategies[Flow Processing Strategies].
...
Studio provides four pre-packaged error handling strategies to handle exceptions thrown at various points during the message processing sequence. For details, see link:/mule-user-guide/error-handling[Error Handling].
...
image:mule-application-architecture-4.png[image]
...
image:mule-application-architecture-5.png[image]
...
* call various other link:/mule-fundamentals/flows-and-subflows[flows]  +

== See Also

* *NEXT STEP:* Learn about how link:/mule-fundamentals/flows-and-subflows[flows and subflows] work together in an application.
* Examine an link:/mule-fundamentals/flow-architecture-advanced-use-case[advanced use case] showing a more complex flow architecture.
