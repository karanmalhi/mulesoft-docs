...
+
image:anypoint-studio-essentials-1.png[image]
...
image:anypoint-studio-essentials-2.png[image]
...
image:anypoint-studio-essentials-3.png[image]
...
+
image:anypoint-studio-essentials-4.png[image]
...
image:anypoint-studio-essentials-5.png[image]
...
image:anypoint-studio-essentials-6.png[image]

Note that the *DataSense Explorer* at the right side of the properties editor provides helpful information about the data structure and metadata of your message as it enters and exits this particular building block. You can toggle the DataSense Explorer on and off by clicking this icon: ~image:anypoint-studio-essentials-7.png[image]~
...
image:anypoint-studio-essentials-8.png[image]

Find out more about using expressions to access and manipulate the Mule message in the link:/mule-fundamentals/mule-message-tutorial[Mule Message Tutorial].

== See Also 

* *NEXT STEP:* link:/mule-fundamentals/build-a-hello-world-application[Build an application in Anypoint Studio].
* Learn more about flows in link:/mule-fundamentals/mule-application-architecture[Mule Application Architecture].
* Skip ahead to learn about link:/mule-fundamentals/mule-message-structure[message structure].
