...
* *NEXT STEP:* Learn more about the ways in which you can link:/mule-fundamentals/extending-mule[extend Mule] beyond its out-of-the-box distribution.
