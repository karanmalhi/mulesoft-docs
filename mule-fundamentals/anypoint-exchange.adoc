...
*APIs* are RAML files that describe an API's structure, they can be referenced by an link:/mule-user-guide/http-request-connector[HTTP Request Connector] to expose metadata to Studio.
...
|image:anypoint-exchange-1.png[image]
...
image:anypoint-exchange-2.png[image]

* By searching for a connector that you don't have in your palette, and clicking *Search the Exchange for _<connector>_* : +
image:anypoint-exchange-3.png[image]

* Through Anypoint Studio's drop-down menu:  *File* > *New* > *Project From Template*
* On the link:/mule-user-guide/http-request-connector[HTTP Request Connector] 's global element, through the link *Search RAML Exchange*
...
image:anypoint-exchange-4.png[image]
...
[NOTE]
Some connectors may be viewable via Exchange but not yet installable through it, they soon will be. If the connector you need is not yet available for installation in Exchange, you can install it using the link:/mule-user-guide/installing-connectors[install new software] menu.
...
+
image:anypoint-exchange-5.png[image]
...
+
image:anypoint-exchange-6.png[image]
...
+
image:anypoint-exchange-7.png[image]
+
...
+
image:anypoint-exchange-8.png[image]
...
. The example is now complete! You can deploy it to see what's its outcome, run it on link:/mule-user-guide/studio-visual-debugger[debug mode] to examine what occurs with the Mule Message on each step, or modify it at will.
...
+
image:anypoint-exchange-11.png[image]
+
...
+
image:anypoint-exchange-12.png[image] 
+
...
+
image:anypoint-exchange-14.png[image]
...
image:anypoint-exchange-15.png[image]
...
image:anypoint-exchange-16.png[image]
...
image:anypoint-exchange-17.png[image]
...
+
image:anypoint-exchange-18.png[image,title="import2.png"]
+
...
+
image:anypoint-exchange-19.png[image,title="import3e.png"]
+
...
+
image:anypoint-exchange-20.png[image,title="using1e.png"]
...
* Learn the different ways you can link:/mule-fundamentals/deploying-mule-applications[Deploy] your app.
