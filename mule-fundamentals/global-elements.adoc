...
image:global-elements-1.png[image]In Mule, a *Global Element* is one that you configure once, then reference many times from elements within multiple flows. Rather than repeatedly writing the same code to apply the same configuration to multiple elements in flows, you can create one global element that details your configurations or transport details. Then, you can instruct any number of elements across flows in your Mule application to reference the global element for specifics on how to behave.  +
...
+
image:global-elements-2.png[image] +

. Click *Create* to add a new global element. +

+
image:global-elements-3.png[image] +
...
+
image:global-elements-4.png[image] +
...
+
image:global-elements-5.png[image] +
...
image:global-elements-6.png[image]
====
....
...
* *NEXT STEP:* Use what you've learned to follow the link:/mule-fundamentals/basic-studio-tutorial[Basic Studio Tutorial]. +
