...
image:basic-studio-tutorial-1.png[image]This exercise is designed to introduce you to Anypoint Studio and help you get comfortable building applications.

This tutorial walks you through how to use Anypoint Studio to build a simple HTTP request-response application. After creating and running the example locally, you are able to apply what you have learned to create link:/mule-fundamentals/content-based-routing-tutorial[more complex applications].
...
+
image:basic-studio-tutorial-2.png[image]
+
...
+
image:basic-studio-tutorial-3.png[image]
...
+
image:basic-studio-tutorial-6.png[image]
+
...
|*link:/mule-user-guide/logger-component-reference[Logger Component]* |Logs messages or activity based on the value of a Mule expression. Find this in the Components section of the palette.
|*link:/mule-user-guide/set-payload-transformer-reference[Set Payload Transformer]* |Modifies your payload into a "Hello, World" message. Find this in the Transformers section of the palette.
|===
...
image:basic-studio-tutorial-7.png[image]

More detailed instructions:

If necessary, consult this link:/mule-fundamentals/anypoint-studio-essentials[quick overview] on how to use the visual editor to drag and drop building blocks from the palette onto the canvas.
...
+
image:basic-studio-tutorial-8.png[image]
+
...
+
image:basic-studio-tutorial-9.png[image]
+
...
+
image:basic-studio-tutorial-10.png[image]
+
...
image:basic-studio-tutorial-11.png[image]
...
image:basic-studio-tutorial-12.png[image]
...
. Click the HTTP building block in your flow to open its link:/mule-user-guide/the-properties-editor[Properties Editor]. 
...
+
image:basic-studio-tutorial-13.png[image]
+
. For this element to work, you must reference an abstract element called a *Connector Configuration*, which is a kind of link:/mule-fundamentals/global-elements[Global Element] that contains several of the high level necessary configuration properties. One single Connector Configuration element can be referenced by as many HTTP connectors as you like. Create a new Connector Configuration element by clicking the green plus sign next to the Connector Configuration field.
+
image:basic-studio-tutorial-14.png[image]
+
...
+
image:basic-studio-tutorial-15.png[image]
+
...
+
image:basic-studio-tutorial-16.png[image]
+
...
+
image:basic-studio-tutorial-17.png[image]  
+
...
+
image:basic-studio-tutorial-18.png[image]
+
The String `#[message.inboundProperties.'http.request.path']` is a simple link:/mule-user-guide/mule-expression-language-mel[Mule expression] which evaluates to the requested property of the message as it passes this point in the flow. Including this message here instructs Mule to log this information in the application log files, which can be useful in more complex use cases, when you need to track the payload at different points in your flow.
...
+
image:basic-studio-tutorial-19.png[image] +
+
This field supports link:/mule-user-guide/mule-expression-language-mel[Mule expressions], which take the form of a string enclosed with `#[]`. If you enter a Mule expression here, Mule evaluates it at runtime and returns or uses the results for further processing. Note that this field also accepts literals, so you can enter any string here to instruct Mule to set that string as your new payload. In this tutorial, however, you use an expression to create a dynamic message.
...
+
image:basic-studio-tutorial-20.png[image]
+
[NOTE]
...
+
image:basic-studio-tutorial-21.png[image]
+
...
+
image:basic-studio-tutorial-22.png[image]
...
+
image:basic-studio-tutorial-23.png[image]
+
...
image:basic-studio-tutorial-24.png[image]
...
+
image:basic-studio-tutorial-25.png[image]
+
...
+
image:basic-studio-tutorial-26.png[image]
+
...
To achieve this, add another message processor to your flow to direct Mule to write your payload to a link:/mule-user-guide/file-connector[file]. You also need to use another Mule expression that you haven't seen before in order to log and use the link:/documentation/display/current/Mule+Expression+Language+Reference#MuleExpressionLanguageReference-ContextObjects[unique message id]. Use the hints below if you need help.

image:basic-studio-tutorial-27.png[image] *Hints*
...
Try adding a link:/mule-user-guide/file-connector[File Connector] after the Set Payload transformer in your flow. 
...
image:basic-studio-tutorial-28.png[image] *Answer*
...
+
image:basic-studio-tutorial-29.png[image]
+
...
Congratulations! You earned your extra credit. You're all set to go on to the link:/mule-fundamentals/content-based-routing-tutorial[Content-Based Routing Tutorial].

== See Also

* *NEXT STEP:* Continue the hands-on learning experience with the link:/mule-fundamentals/content-based-routing-tutorial[Content-Based Routing Tutorial].
...
* Get a deeper explanation about the Mule message and anatomy of a Mule flow in link:/mule-fundamentals/mule-concepts[Mule Concepts].
