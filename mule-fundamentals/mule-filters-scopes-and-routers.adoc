...
image:mule-filters-scopes-and-routers-4.png[image]
...
* *NEXT STEP*: Read on about link:/mule-fundamentals/mule-exception-strategies[exception strategies].
* Skip ahead to understand the structure of a link:/mule-fundamentals/mule-message-structure[Mule message].
* View link:/mule-fundamentals/anypoint-exchange[examples].
