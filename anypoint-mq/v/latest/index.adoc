...
|link:/anypoint-mq/mq-queues-and-exchanges[Anypoint MQ Queues and Exchanges] |Creating queues, exchanges and client applications using Anypoint Platform.
...
The steps that follow help you use Anypoint MQ. You can test this same workflow in the link:/anypoint-mq/mq-tutorial[Anypoint MQ Tutorial].
