...
. Click *Queue*.
+
image:mq-qx.png[Create Queue or Exchange decision click box]
+
In the *Create Queue* window:
+
image:mq-create-demo-queue.png[mq-create-demo-queue, width="315"]
+
.. Specify a name. For this tutorial, use `MyDemoQueue`. You can
leave the rest of the options as they appear.
.. Click *Save Changes*.
. In the Destinations screen, click the queue *Type* to list its details:
+
...
+
image:mq-click-type.png[mq-click-type]
+
