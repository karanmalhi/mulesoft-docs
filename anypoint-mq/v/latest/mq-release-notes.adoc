...
This is the first beta release of Anypoint MQ, MuleSoft’s cloud and enterprise messaging service.  This release you perform advanced asynchronous messaging scenarios between your applications and is fully integrated with Anypoint Platform, offering role based access control, client application management, and connectors.
