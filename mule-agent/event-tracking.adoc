...
image:/docs/download/attachments/122751359/event_tracking.png?version=1&modificationDate=1421251570795[image]
...
[cols=",",]
|===
|image:/docs/images/icons/emoticons/information.png[image] |Bear in mind that performance may be affected depending on the debugging level.
...
[cols=",",]
|===
|image:/docs/images/icons/emoticons/information.png[image] |If `globalTrackingLevel` is not specified, the default value is `NONE`.
