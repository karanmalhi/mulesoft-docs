...
To run both transports, you need to modify the `mule-agent.yml` by hand and do a merge as follow:
...
transports:
  websocket.transport:
    ...
    security:
      keyStorePassword: f3b533c4-4036-4a17-a572-4d6da6a5f508
      keyStoreAlias: agent
      keyStoreAliasPassword: f3b533c4-4036-4a17-a572-4d6da6a5f508
      handshake:
        enabled: true
        body:
          agentVersion: 1.1.0
